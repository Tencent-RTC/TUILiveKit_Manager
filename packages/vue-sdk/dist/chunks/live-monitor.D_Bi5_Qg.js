...
import { I as a, G as Ht, g as yt, H as cr, E as _n, B as bn, z as zr, D as be, n as lr, W as lt } from "./en-US.CSjM9toh.js";
import { w as In, bc as Ln, b1 as Sn, a2 as Tn, a9 as wn, aG as An, aE as Rn, m as Mn, u as On, cr as Dn, cq as xn, c2 as Un, c1 as kn, aT as W, N as Nt, a_ as Pn, bS as Br, bT as Hr, b8 as Fn, b as Gn, _ as Vn, bj as Kr, bn as Wn, a1 as zn, cf as fr, cl as Bn, bD as gr, cj as Hn, ci as Kn, ch as Yn, bN as $n, bC as qn, au as Xn, bM as jn, bF as Zn, aV as Jn, a0 as Qn, ar as vr, A as je, O as ke, aU as ea, bi as ta, bp as ra, bs as Ut, i as Ue, ap as na, bU as Yr, x as dr, a4 as aa, c5 as ia, as as Er, Z as Nr, aB as oa, cg as sa, aj as ca, aW as la, R as da, b6 as ua, a6 as ha, aM as ma, $ as Kt, bv as pa, aX as $r, bL as fa, bg as Ot, c0 as ga, a8 as va, ae as Ea, V as Rt, ac as Na, bo as Ca, aZ as tt, k as ya, by as Cr, D as _a, a as Ke, bw as ba, q as Ze, r as Me, o as Oe, p as gt, bV as Ia, z as qr, F as Pe, b2 as La, y as Xr, aP as Sa, v as Ta, bu as yr, s as _r, t as wa, T as Yt, d as vt, f as Ae, C as Re, S as Aa, aF as Ra } from "./main-layout.WBxy2WWr.js";
import { c as Ma, g as Oa, s as ur, a as Da, D as xa, d as Ua, e as ka, m as Pa, b as Fa, P as Ga } from "./gift-category.qmtjx5qb.js";
  ...
  mr(() => {
    ...
    const x = () => {
      ...
      for (const { column: ae } of L)
        z[ae.key] !== void 0 && (le[ae.key] = Fa(z[ae.key], ae.minWidth, ae.maxWidth));
      C.current = le;
    }, $ = () => {
      var K;
      const V = C.current;
      ...
      const O = ((K = w.current) == null ? void 0 : K.clientWidth) ?? 0, U = Ua(
        r,
        V,
        O,
        B
...
function Ao() {
  ...
  const v = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__, [h, N] = _(v), [m, T] = _(null), [w, E] = _(!1), [S, R] = _("chat"), [C, I] = _(!0), { successMsg: P, errorMsg: B } = ki(), [H, D] = _(null), [Z, j] = _(!1), [X, M] = _(!1), L = ba(), y = Ve({
    action: async () => {
  ...
  return (i) => {
    const {
      ...
      },
      {
        ...
        render: (f) => /* @__PURE__ */ u("div", { className: "gift-lang-tags", children: [
          f.languageList && f.languageList.length > 0 ? f.languageList.map((g) => {
            const v = La(g), h = Xr[v], N = h ? Pe[h] : null;
            return /* @__PURE__ */ e(
              "span",
              {
      ...
      },
      {
        ...
        render: (f) => /* @__PURE__ */ e("span", { className: "gift-create-time", children: Sa(f.createdAt) })
      }
    ];
