...
function Oo() {
 ...
 ` + t.stack;
      ...
      C.use = function(e) {
        ...
        var r = this;
        return ze([tr(this), er(this, e?.type), function(i, o) {
...
`), a = e.isWhiteList && e.config.assetLog, s = e.config.slowAssetLog && i, u = { level: i ? e.LogType.SLOW_ASSET_REQUEST : e.LogType.ASSERT_REQUEST, msg: o, ext1: n.toString() || "", errorMsg: "", originFrom: e.getOriginFrom() };
        ...
        function t(i) {
          ...
          i && (i = i.target || i.srcElement, !(o = i?.src || i?.href) || typeof o != "string" || -1 < window.location.href.indexOf(o) || (i = typeof ((i = r.api) == null ? void 0 : i.resourceTypeHandler) == "function" ? (i = r.api) == null ? void 0 : i.resourceTypeHandler(o) : "", a = performance.getEntriesByType(n.collectEntryType).find(function(l) {
            return l.name === o;
          }), We(o, r.hostUrl)) || (s = n.getFromParam(e), u = Number((u = a) == null ? void 0 : u.responseStatus), u = Number.isFinite(u) && 0 < u ? u : 400, u = { url: Kn(o), status: u, duration: Number((a?.duration || 0).toFixed(2)), method: "get", type: i || "static", isHttps: Et(o), urlQuery: qe(o, !0), nextHopProtocol: "", domainLookup: 0, connectTime: 0, from: s }, n.publish(u, e)));
        }
        ...
        return { url: Kn(e.name), method: "get", duration: Number(e.duration.toFixed(2)), status: o, type: r || "static", isHttps: Et(e.name), nextHopProtocol: e.nextHopProtocol || "", urlQuery: qe(e.name, !0), domainLookup: St(e.domainLookupEnd - e.domainLookupStart), connectTime: St(e.connectEnd - e.connectStart), transferSize: 0 < i ? i : -1, from: n };
      ...
      function C(e) {
        ...
        this.isGetSample = !1, this.isHidden = !1, this.config = { version: 0, delay: 1e3, onError: !0, repeat: 60, random: 1, aid: !0, device: !0, pagePerformance: !0, webVitals: !0, speedSample: !0, onClose: !0, reportLoadPackageSpeed: !0, hostUrl: "https://rumt-zh.com", env: "production", url: "", offlineUrl: "", whiteListUrl: "", rateLimitUrl: "", pvUrl: "", speedUrl: "", customTimeUrl: "", performanceUrl: "", performanceUrlForHippy: "", webVitalsUrl: "", eventUrl: "", setDataReportUrl: "", memoryUrl: "", reportImmediately: !0, gzip: !0 }, this.isWhiteList = !1, this.whitelistUseGzip = !0, this.whitelistUseGzipReady = !1, this.lifeCycle = new _i(), this.bean = {}, this.rateLimitConfigs = null, this.rateLimitReady = !1, this.rateLimitSampled = !1, this.rateLimitPool = [], this.normalLogPipeline = ze([Rt(this, 5), Fi, function(g, m) {
          var b = t.config;
        ...
        }, ur(this)]), this.eventPipeline = ze([Rt(this, 10), (r = this, function(g) {
...
`) + n + " header " + i + ": " + o : r;
      ...
      var yr, wr, hn, gn, ie, kt, At, Oe, st, br, It, Ge, Sr, mn, vn, Er, yn, wn, Rr = !(P.isIE = function() {
        return "ActiveXObject" in window;
      }), xe = [], Tr = /^\/[^/]/, Or = !1, pe = [], Ve = { maxRetryCount: 10, retryInterval: function(e) {
        return 1e3 * (2 << e);
        ...
        var n = this, r = e.api, r = { name: this.name, traceRequestHeader: r != null && r.injectTraceHeader ? this.traceRequestHeader : null, getCurrentFrom: function() {
          ...
          var d, h;
          We(u, e.hostUrl) || (d = a.headers ? a.headers.get("content-type") : "", (h = pn(e, d || "", u)) === "fetch" ? a.clone().text().then(function(g) {
...
`), Y = (q.payload = l?.body, q.ret = L, q.isErr = +N, q.from = f || n.getFromParam(t), { msg: Y, code: L, trace: v, errorMsg: "", from: f || n.getFromParam(t), originFrom: p, level: R.API_RESPONSE }), U = e.slowApiLog && mr(q?.duration, e, q);
          ...
          var d, h, g, m, b;
          throw We(u, e.hostUrl) || (d = pn(e, "", u), h = ((h = e.api) == null ? void 0 : h.reqHeaders) || [], g = at(l?.headers, h, "req"), m = cn(l?.headers), b = (h = e.api) != null && h.apiDetail ? it(l?.body, (h = e.api) == null ? void 0 : h.reqParamHandler, { url: u }) : "", setTimeout(function() {
...
` + g);
        ...
        var n, r = this, i = { name: this.name, ignoreHackReg: (i = e.api) == null ? void 0 : i.ignoreHackReg, traceRequestHeader: (i = e.api) != null && i.injectTraceHeader ? this.traceRequestHeader : null, getCurrentFrom: function() {
          ...
          var l, c, f = Date.now(), p = ((e?.api || {}).injectTraceHeader && (c = (l = hr()).host, l = (c = r.traceRequestHeader.generate(o.aegisUrl, {}, { host: c, pathname: l.pathname }) || {}).name, c = c.value, l) && c && o.setRequestHeader(l, c), o.addEventListener("loadend", function() {
            ...
            We(w, e.hostUrl) || o.failType === "abort" || (g = "", (o.failType || !o.status || 400 <= o.status) && (g = o.failType || "failed"), m = Date.now() - f, b = o.getResponseHeader("content-type") || "", y = pn(e, b, w), setTimeout(function() {
...
message: ` + i, level: R.CONSOLE_LOG, errorMsg: "", originFrom: t.getOriginFrom() }));
      ...
      Ge = { passive: !0, capture: !0 }, Sr = /* @__PURE__ */ new Date(), mn = function(e, t) {
        ...
        }, addEventListener("pointerup", i, Ge), addEventListener("pointercancel", o, Ge)) : mn(t, e));
      }, yn = function(e) {
      ...
      function En() {
        return Ke < 0 && (Ke = Dr(), Hr(), Xe(function() {
          setTimeout(function() {
            Ke = Dr(), Hr();
          }, 0);
        })), { get firstHiddenTime() {
      ...
      function Ir(e, t) {
        t = t || {}, Ft(function() {
          var n, r = En(), i = he("FCP"), o = $e("paint", function(a) {
          ...
          o && (n = ge(e, i, jr, t.reportAllChanges), Xe(function(a) {
      ...
      var Pe, ut, _r, Ht, Tn, _e, Fr = -1, Xe = function(e) {
        ...
        document.visibilityState === "hidden" && -1 < Ke && (Ke = e.type === "visibilitychange" ? e.timeStamp : 0, so());
      }, Hr = function() {
        ...
        if (ot() && typeof window.PerformanceObserver == "function" && typeof performance.getEntriesByName == "function") try {
          Cn.set(e, { isWebVitalsReported: !1, hasFirstEntry: !1, custom: null }), Ir(Je), l = Je, c = {}, Ft(function() {
            function p(y) {
              (y = y[y.length - 1]) && y.startTime < g.firstHiddenTime && (m.value = Math.max(y.startTime - On(), 0), m.entries = [y], d());
            }
            var d, h, g = En(), m = he("LCP"), b = $e("largest-contentful-paint", p);
            ...
            var p;
            "interactionCount" in performance || (Tn = Tn || $e("event", ao, { type: "event", buffered: !0, durationThreshold: 0 }));
            function d(b) {
            ...
            var h = he("INP"), g = $e("event", d, { durationThreshold: (p = i.durationThreshold) != null ? p : 40 }), m = ge(r, h, Jr, i.reportAllChanges);
      ...
      function H(e) {
        ...
        s.sendNow = !1, s.isReportReady = !1, s.reportRequestQueue = [], s.speedLogPipeline = ze([Rt(s), (i = s.config, function(f, p) {
          ...
          !i.speedSample || m <= 0 ? p(f) : (d = i?.id || "0", h = Be[d] || {}, Array.isArray(f) ? (g = f.filter(function(b) {
            ...
            return y ? (h[b.url] = 1 + ~~h[b.url], Be[d] = h) : Ne[d] || sn(d), y;
          })).length && p(g) : !h[f.url] || h[f.url] < m ? (h[f.url] = 1 + ~~h[f.url], Be[d] = h, p(f)) : Ne[d] || sn(d));
        }), (r = s, function(f, p) {
          xr(function(d) {
...
It is recommended that you contact us for feedback and thank you for your support.`, "color: red"), s.sendSDKError(f);
      ...
      function ii(e) {
        try {
          ...
          return s === !0 ? x({}, Ye) : (n = "containerMatchers" in (t = s) || "ignoreMatchers" in t, r = "containers" in t || "ignoreContainers" in t, i = _n(x({}, Ye), t), n ? (ui(i.containerMatchers) || (i.containerMatchers = ni(Ye.containerMatchers)), typeof i.ignoreMatchers == "object" && i.ignoreMatchers !== null || (i.ignoreMatchers = ni(Ye.ignoreMatchers)), i.containers = [], i.ignoreContainers = []) : r && (o = ri(i.containers), a = ri(i.ignoreContainers), i.containers = o.length ? o : Q(Ye.containers), i.ignoreContainers = a, i.containerMatchers = { tagName: [], id: [], className: [] }, i.ignoreMatchers = { tagName: [], id: [], className: [] }), i);
        } catch {
          return x({}, Ye);
        }
      }
      ...
      var ai = function(r) {
        ...
        var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, m, b, y, w, v, L, N, k, I, F, q, Y, U, D, j, J, Ce, Ze, ee, pt, te, ke, et, Dn, zt = this;
              ...
              switch (bt.label) {
                case 0:
                  ...
                  return vt = v <= De, yt = !1, jn = { samePointerMap: {}, maximumSamePointer: {} }, d || (oe = Gt.map(function(B) {
                    ...
                    return ne[1] - B[1];
                  })[0], hi = zn[0], oe = { samePointerMap: Qt, maximumSamePointerClass: hi, maximumSamePointerCounter: zn[1] }, jn = { samePointerMap: oe.samePointerMap, maximumSamePointer: ((nt = {})[di = oe.maximumSamePointerClass] = oe = oe.maximumSamePointerCounter, nt) }, Hn = oe, nt = yo.some(function(B) {
                    return di.startsWith(B);
                  }), yt = L <= oe && !nt), vt || yt ? [3, 1] : (k = !1, I = null, [3, 8]);
                case 1:
                  return k ? (oe = I?.whitePointCount >= v, nt = I?.samePointCount >= L, qn = oe && nt ? "both" : oe ? "whitePoint" : "sameElement", Wn = t ? "error" : "domChange", Jt = window.innerWidth, Xt = window.innerHeight, pi = Math.round(I?.samePointCount / w * 100), Ie = { whitePointCount: I?.whitePointCount, samePointCount: I?.samePointCount, maximumSamePointer: I?.maximumSamePointer, linkMsg: I?.linkMsg }, mt = function(B, ne) {
...
linkError: ` + Ie.linkMsg : ""), level: R.BLANK_SCREEN, errorMsg: B || null, originFrom: e.getOriginFrom() }, e.normalLogPipeline(ne);
          ...
          var W;
          k || zt.isAwaitingClientScreenshot || N === Qe.ERROR && !t || (N = t ? Qe.ERROR : Qe.DOM_CHANGE, clearTimeout(n), W = ii(e).debounceDuration, n = setTimeout(function() {
            return K(zt, void 0, void 0, function() {
              return se(this, function(X) {
                switch (X.label) {
                  case 0:
        ...
        }, window.addEventListener("pagehide", et), window.addEventListener("beforeunload", et), window.addEventListener("visibilitychange", Dn), this.destroyBlanckScreenDetect = function() {
          window.removeEventListener("pagehide", et), window.removeEventListener("beforeunload", et), window.removeEventListener("visibilitychange", Dn), e.lifeCycle.remove("errorOccurred", D), j?.disconnect();
        });
      }, destroy: function() {
...
function Ao(E = Co) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  vi.has(T) || (vi.add(T), He("app_init", "live_manager", E));
}
...
function Io(E) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  yi.has(T) || (yi.add(T), He("capability", E, "on"));
}
...
function Mo(E) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  wi.has(T) || (wi.add(T), He("feature_use", E));
}
let bi = null;
function No(E) {
  if (E === bi) return;
