import { bL as D, bM as $, s as I, p as C, f as g, t as j } from "./main-layout.CIXEryLk.js";
import { s as P, t as R, a as _, f as F } from "./utils.StpHZqNO.js";
import { aS as G, ax as q, S as H } from "./layout.BnSS-XVq.js";
import { j as k } from "./logger.S-YFOdFg.js";
class K extends $ {
  constructor(t, e, s) {
...
function L(n) {
  ...
  for (let r = 0; r < p.length; r++) {
    const c = p[r], S = p.length - r - 1, O = S > 0 ? f : 0, w = h > 0 ? o : 0, U = d + w + c + (S > 0 ? o + O : 0), T = y - U, B = Math.max(60, T - i - u);
    if (M > B || T < V + u)
      break;
    d += w + c, h++;
  }
