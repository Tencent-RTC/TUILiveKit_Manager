...
import { c as vi } from "./logger.pnqt7v8K.js";
import { I as E } from "./layout.BInVXJga.js";
import { aA as bi, b1 as pt, b9 as gt, b3 as wi, ba as yi, b0 as zi, b2 as Ri, an as Ai } from "./main-layout.7dM7GuCv.js";
import { i as Si, g as Mi } from "./svga.DC02l1-t.js";
import { U as xi, k as Ei, u as vt, i as Ci, h as Ti, v as Ii, a as Wi } from "./upload.cidDdOp0.js";
import { u as Di } from "./usePreviewUrl.BmyegPlc.js";
import { a as Li } from "./useAsyncAction.Bpo66Dzi.js";
...
Ot.render = function(e, t, i, o, s, n) {
  ...
  return v(), C("div", { class: n.classes.root }, [x(r, { class: n.classes.draggable, onDrag: t[1] || (t[1] = function(h) {
...
function Xi(e) {
  ...
  return (Array.isArray(i) ? i : [i]).forEach((function(c) {
    ...
    L((u = typeof c == "function" ? c({ coordinates: l, imageSize: o, visibleArea: h }) : c).width) && L(u.height) || (l = (function(d, f) {
      var b = p(p(p({}, d), ee({ width: f.width, height: f.height, sizeRestrictions: s, aspectRatio: r })), { left: 0, top: 0 });
      return a(b, { left: d.left, top: d.top });
    })(l, p(p({}, l), u))), L(u.left) && L(u.top) || (l = a(l, p(p({}, l), u)));
  })), l;
}
function Ni(e) {
  e.event;
  ...
  e.stencilReference;
  var a, l, c, u = p({}, o), d = p({}, s), f = p({}, n);
  a = R(f), l = R(u), c === void 0 && (c = 1e-3), (a === 0 || l === 0 ? Math.abs(l - a) < c : Math.abs(l / a) < 1 + c && Math.abs(l / a) > 1 - c) || (u = p(p({}, u), ee({ sizeRestrictions: r, width: u.width, height: u.height, aspectRatio: { minimum: R(f), maximum: R(f) } })));
...
function Yi(e) {
  ...
  if (s && n && t.type !== "manipulateImage") {
    ...
    var c = He(a = V(a, h.width * o.width / (a.width * l.width)), i({ visibleArea: a, type: "resize" }));
    a = V(a, c), c !== 1 && (l.height /= c, l.width /= c), a = O(a = $(a, fe(P(h), P(a))), i({ visibleArea: a, type: "move" })), h = O(h, Ue(K(a), r));
  }
...
function Zi(e) {
  ...
  if (t.type === "setCoordinates") {
    ...
    h > a ? n = V(n, Math.min(r.width / n.width, me(n, s({ visibleArea: n, type: "resize" })))) : a > h && (n = V(n, Math.min(r.height / n.height, me(n, s({ visibleArea: n, type: "resize" }))))), n = O(n = $(n, Oe(pe(r, K(n)))), s({ visibleArea: n, type: "move" }));
  }
...
function Ki(e) {
  ...
  return R(l) > R(n) ? i = (t = a.height * l.height / n.height) * R(a) : t = (i = a.width * l.width / n.width) / R(a), ee({ width: i, height: t, aspectRatio: r, sizeRestrictions: h });
}
function Qi(e) {
  var t = e.getAreaRestrictions, i = e.coordinates, o = e.imageSize, s = R(e.boundaries);
  if (i) {
    var n = { height: Math.max(i.height, o.height), width: Math.max(i.width, o.width) }, r = Ut({ width: R(n) > s ? n.width : n.height * s, height: R(n) > s ? n.width / s : n.height }, Ge(t())), h = { left: i.left + i.width / 2 - r.width / 2, top: i.top + i.height / 2 - r.height / 2, width: r.width, height: r.height }, a = Re(i, K(p({ left: 0, top: 0 }, o))), l = {};
    return !a.left && !a.right && h.width <= o.width && (l.left = 0, l.right = o.width), !a.top && !a.bottom && h.height <= o.height && (l.top = 0, l.bottom = o.height), O(h, l);
  }
  var c = R(o);
...
function Ji(e) {
  var t = e.event, i = e.coordinates, o = e.visibleArea, s = e.sizeRestrictions, n = e.getAreaRestrictions, r = e.positionRestrictions, h = e.adjustStencil, a = t.scale, l = t.move, c = p({}, o), u = p({}, i), d = 1, f = 1, b = a.factor && Math.abs(a.factor - 1) > 1e-3;
  ...
  a.factor && b && (a.factor < 1 ? (f = Math.max(a.factor, w.stencil.minimum)) > 1 && (f = 1) : a.factor > 1 && (f = Math.min(a.factor, Math.min(w.area.maximum, w.stencil.maximum))) < 1 && (f = 1)), f && (c = V(c, f, a.center));
  var A = i.left - o.left, T = o.width + o.left - (i.width + i.left), B = i.top - o.top, te = o.height + o.top - (i.height + i.top);
  return c = O(c = $(c, pe(c, { left: r.left !== void 0 ? r.left - A * f : void 0, top: r.top !== void 0 ? r.top - B * f : void 0, bottom: r.bottom !== void 0 ? r.bottom + te * f : void 0, right: r.right !== void 0 ? r.right + T * f : void 0 })), n({ visibleArea: c, type: "move" })), u.width = u.width * f, u.height = u.height * f, u.left = c.left + A * f, u.top = c.top + B * f, u = O(u, Ue(K(c), r)), a.factor && b && h && (a.factor > 1 ? d = Math.min(w.area.maximum, a.factor) / f : a.factor < 1 && (d = Math.max(u.height / c.height, u.width / c.width, a.factor / f)), d !== 1 && (c = $(c = O(c = V(c, d, a.factor > 1 ? a.center : P(u)), n({ visibleArea: c, type: "move" })), Oe(pe(u, K(c)))))), { coordinates: u, visibleArea: c };
}
function en(e) {
  var t = e.aspectRatio, i = e.getAreaRestrictions, o = e.coordinates, s = e.visibleArea, n = e.sizeRestrictions, r = e.positionRestrictions, h = e.imageSize, a = e.previousImageSize, l = e.angle, c = p({}, o), u = p({}, s), d = ne(P(p({ left: 0, top: 0 }, a)), l);
  return (c = p(p({}, ee({ sizeRestrictions: n, aspectRatio: t, width: c.width, height: c.height })), ne(P(c), l))).left -= d.left - h.width / 2 + c.width / 2, c.top -= d.top - h.height / 2 + c.height / 2, u = V(u, He(u, i({ visibleArea: u, type: "resize" }))), { coordinates: c = O(c, r), visibleArea: u = O(u = $(u, fe(P(c), P(o))), i({ visibleArea: u, type: "move" })) };
}
function tn(e) {
  ...
  if (c || u) {
    var d = ne({ left: h.width / 2, top: h.height / 2 }, -o), f = ne(P(a), -o), b = ne({ left: c ? d.left - (f.left - d.left) : f.left, top: u ? d.top - (f.top - d.top) : f.top }, o);
    a = $(a, fe(b, P(a))), f = ne(P(l), -o), l = O(l = $(l, fe(b = ne({ left: c ? d.left - (f.left - d.left) : f.left, top: u ? d.top - (f.top - d.top) : f.top }, o), P(l))), s({ visibleArea: l, type: "move" }));
  }
  return { coordinates: a, visibleArea: l };
}
function xt(e) {
  var t = e.directions, i = e.coordinates, o = e.positionRestrictions, s = o === void 0 ? {} : o, n = e.sizeRestrictions, r = e.preserveRatio, h = e.compensate, a = p({}, t), l = G(i, a).width, c = G(i, a).height;
  ...
  var u = Re(G(i, a), s);
  h && (u.left && u.left > 0 && u.right === 0 ? (a.right += u.left, a.left -= u.left) : u.right && u.right > 0 && u.left === 0 && (a.left += u.right, a.right -= u.right), u.top && u.top > 0 && u.bottom === 0 ? (a.bottom += u.top, a.top -= u.top) : u.bottom && u.bottom > 0 && u.top === 0 && (a.top += u.bottom, a.bottom -= u.bottom), u = Re(G(i, a), s));
  var d = { width: 1 / 0, height: 1 / 0, left: 1 / 0, right: 1 / 0, top: 1 / 0, bottom: 1 / 0 };
  if (q.forEach((function(w) {
    var A = u[w];
    A && a[w] && (d[w] = Math.max(0, 1 - A / a[w]));
  })), r) {
  ...
  if (l = G(i, a).width, c = G(i, a).height, a.right + a.left && (l > n.maxWidth ? d.width = (n.maxWidth - i.width) / (a.right + a.left) : l < n.minWidth && (d.width = (n.minWidth - i.width) / (a.right + a.left))), a.bottom + a.top && (c > n.maxHeight ? d.height = (n.maxHeight - i.height) / (a.bottom + a.top) : c < n.minHeight && (d.height = (n.minHeight - i.height) / (a.bottom + a.top))), r) {
...
et.render = function(e, t, i, o, s, n) {
  ...
  return v(), C(r, { class: n.classes.wrapper, "vertical-position": i.verticalPosition, "horizontal-position": i.horizontalPosition, disabled: i.disabled, onDrag: n.onDrag, onDragEnd: n.onDragEnd, onEnter: n.onEnter, onLeave: n.onLeave }, { default: j((function() {
    return [x("div", { class: n.classes.default }, null, 2)];
  })), _: 1 }, 8, ["class", "vertical-position", "horizontal-position", "disabled", "onDrag", "onDragEnd", "onEnter", "onLeave"]);
};
var sn = Y("vue-simple-line"), an = Y("vue-simple-line-wrapper"), tt = { name: "SimpleLine", components: { LineWrapper: Ht }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, position: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  return { hover: !1 };
}, computed: { classes: function() {
  return { root: D(sn(_({}, this.position, !0)), this.defaultClass, this.hover && this.hoverClass), wrapper: D(an(_({}, this.position, !0)), this.wrapperClass) };
} }, methods: { onDrag: function(e) {
  this.$emit("drag", e);
}, onEnter: function() {
  this.hover = !0;
...
tt.render = function(e, t, i, o, s, n) {
  var r = F("LineWrapper");
  return v(), C(r, { class: n.classes.wrapper, position: i.position, disabled: i.disabled, onDrag: n.onDrag, onDragEnd: n.onDragEnd, onEnter: n.onEnter, onLeave: n.onLeave }, { default: j((function() {
    return [x("div", { class: n.classes.root }, null, 2)];
  })), _: 1 }, 8, ["class", "position", "disabled", "onDrag", "onDragEnd", "onEnter", "onLeave"]);
};
var Fe = Y("vue-bounding-box"), rn = ["east", "west", null], hn = ["south", "north", null], Bt = { name: "BoundingBox", props: { width: { type: Number }, height: { type: Number }, transitions: { type: Object }, handlers: { type: Object, default: function() {
  ...
  t === "west" ? h.left -= n : t === "east" && (h.right += n), i === "north" ? h.top -= r : i === "south" && (h.bottom += r), !i && t ? o = "width" : i && !t && (o = "height"), this.resizable && this.$emit("resize", new Ui(h, { allowedDirections: { left: t === "west" || !t, right: t === "east" || !t, bottom: i === "south" || !i, top: i === "north" || !i }, preserveAspectRatio: e.nativeEvent && e.nativeEvent.shiftKey, respectDirection: o }));
} }, emits: ["resize", "resize-end"] };
Bt.render = function(e, t, i, o, s, n) {
  return v(), C("div", { ref: "box", class: n.classes.root, style: n.style }, [he(e.$slots, "default"), x("div", null, [(v(!0), C(ye, null, ct(n.lineNodes, (function(r) {
    return v(), C(Pe(r.component), { key: r.name, "default-class": r.class, "hover-class": r.hoverClass, "wrapper-class": r.wrapperClass, position: r.name, disabled: r.disabled, onDrag: function(h) {
  ...
  })), 128))]), (v(!0), C(ye, null, ct(n.handlerNodes, (function(r) {
    return v(), C("div", { key: r.name, style: r.wrapperStyle, class: r.wrapperClass }, [(v(), C(Pe(r.component), { "default-class": r.class, "hover-class": r.hoverClass, "wrapper-class": r.wrapperClass, "horizontal-position": r.horizontalDirection, "vertical-position": r.verticalDirection, disabled: r.disabled, onDrag: function(h) {
      return n.onHandlerDrag(h, r.horizontalDirection, r.verticalDirection);
    }, onDragEnd: t[2] || (t[2] = function(h) {
      return n.onEnd();
  ...
  return new Promise((function(t, i) {
    try {
      if (e) if (/^data:/i.test(e)) t((function(a) {
        ...
        for (var l = atob(a), c = l.length, u = new ArrayBuffer(c), d = new Uint8Array(u), f = 0; f < c; f++) d[f] = l.charCodeAt(f);
        return u;
      })(e));
...
var Ft = { props: { touchMove: { type: Boolean, required: !0 }, mouseMove: { type: Boolean, required: !0 }, touchResize: { type: Boolean, required: !0 }, wheelResize: { type: [Boolean, Object], required: !0 }, eventsFilter: { type: Function, required: !1 } }, beforeMount: function() {
  ...
  if (this.wheelResize && this.processEvent(e)) {
    var t = this.$refs.container.getBoundingClientRect(), i = t.left, o = t.top, s = 1 + this.wheelResize.ratio * (r = e.deltaY || e.detail || e.wheelDelta, (h = +r) == 0 || Lt(h) ? h : h > 0 ? 1 : -1), n = { left: e.clientX - i, top: e.clientY - o };
...
var De = Y("vue-preview"), Vt = { props: { coordinates: { type: Object }, transitions: { type: Object }, image: { type: Object, default: function() {
  ...
  if (this.coordinates && this.image) {
    ...
    return n.transform = `translate(
				`.concat(-this.coordinates.left / e - r.rotate.left - r.scale.left, "px,").concat(-this.coordinates.top / e - r.rotate.top - r.scale.top, "px) ") + _t(t), this.transitions && this.transitions.enabled && (n.transition = "".concat(this.transitions.time, "ms ").concat(this.transitions.timingFunction)), n;
  }
  return {};
}, size: function() {
...
Xt.render = function(e, t, i, o, s, n) {
  var r = F("preview");
  return v(), C(r, It(e.$attrs, { fill: !0 }), null, 16);
};
...
var dn = ["transitions"], J = Y("vue-advanced-cropper"), Nt = { name: "Cropper", components: { BackgroundWrapper: Ke }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  ...
  n.widthFrozen && (a.left = 0, a.right = 0), n.heightFrozen && (a.top = 0, a.bottom = 0), q.forEach((function(Z) {
    l[Z] || (a[Z] = 0);
  }));
  var c = G(r, a = xt({ coordinates: r, directions: a, sizeRestrictions: n, positionRestrictions: s })).width, u = G(r, a).height, d = h.preserveRatio ? R(r) : _e(c / u, o);
  if (d) {
    var f = h.respectDirection;
    if (f || (f = r.width >= r.height || d === 1 ? "width" : "height"), f === "width") {
      var b = c / d - r.height;
      if (l.top && l.bottom) {
        var w = a.top, A = a.bottom;
        a.bottom = We(b, A, w), a.top = We(b, w, A);
      } else l.bottom ? a.bottom = b : l.top ? a.top = b : l.right ? a.right = 0 : l.left && (a.left = 0);
    } else if (f === "height") {
      var T = r.width - u * d;
      if (l.left && l.right) {
        var B = a.left, te = a.right;
        a.left = -We(T, B, te), a.right = -We(T, te, B);
      } else l.left ? a.left = -T : l.right ? a.right = -T : l.top ? a.top = 0 : l.bottom && (a.bottom = 0);
    }
    a = xt({ directions: a, coordinates: r, sizeRestrictions: n, positionRestrictions: s, preserveRatio: !0, compensate: h.compensate });
  }
  return c = G(r, a).width, u = G(r, a).height, (d = h.preserveRatio ? R(r) : _e(c / u, o)) && Math.abs(d - c / u) > 1e-3 && q.forEach((function(Z) {
    l[Z] || (a[Z] = 0);
  })), qe({ event: new Qe({ left: -a.left, top: -a.top }), coordinates: { width: i.width + a.right + a.left, height: i.height + a.top + a.bottom, left: i.left, top: i.top }, positionRestrictions: s });
  ...
  var t = e.visibleArea, i = e.coordinates, o = e.aspectRatio, s = e.sizeRestrictions, n = e.positionRestrictions, r = p(p({}, i), ee({ width: i.width, height: i.height, aspectRatio: o, sizeRestrictions: { maxWidth: t.width, maxHeight: t.height, minHeight: Math.min(t.height, s.minHeight), minWidth: Math.min(t.width, s.minWidth) } }));
  return r = O(r = $(r, fe(P(i), P(r))), Ue(K(t), n));
  ...
  var r = Oe(pe(s, K(n = V(n, He(n, o({ visibleArea: n, type: "resize" }))))));
  return n.width < s.width && (r.left = 0), n.height < s.height && (r.top = 0), n = O(n = $(n, r), o({ visibleArea: n, type: "move" }));
  ...
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i = t.transitions, o = i !== void 0 && i, s = Oi(t, dn), n = this.processAutoZoom(e, this.visibleArea, this.coordinates, s), r = n.visibleArea, h = n.coordinates, a = n.changed;
  ...
  if (this.$refs.canvas) {
    var e = this.$refs.canvas, t = this.$refs.image, i = this.imageTransforms.rotate !== 0 || this.imageTransforms.flip.horizontal || this.imageTransforms.flip.vertical ? (function(h, a, l) {
      var c = l.rotate, u = l.flip, d = { width: a.naturalWidth, height: a.naturalHeight }, f = kt(d, c), b = h.getContext("2d");
      h.height = f.height, h.width = f.width, b.save();
      var w = ne(P(p({ left: 0, top: 0 }, d)), c);
      return b.translate(-(w.left - f.width / 2), -(w.top - f.height / 2)), b.rotate(c * Math.PI / 180), b.translate(u.horizontal ? d.width : 0, u.vertical ? d.height : 0), b.scale(u.horizontal ? -1 : 1, u.vertical ? -1 : 1), b.drawImage(a, 0, 0, d.width, d.height), b.restore(), h;
    ...
    return (function(h, a, l, c, u) {
      ...
      d.drawImage(a, l.left + f, l.top + b, l.width, l.height, f * (h.width / l.width), b * (h.height / l.height), h.width, h.height);
  ...
  if (!this.transitionsOptions.enabled) {
    ...
    var r = Ji(z(z({}, this.getPublicProperties()), {}, { event: n ? this.normalizeEvent(e) : e, getAreaRestrictions: this.getAreaRestrictions, imageRestriction: this.imageRestriction, adjustStencil: !this.stencilSize && this.settings.resizeImage.adjustStencil })), h = r.visibleArea, a = r.coordinates;
  ...
  if (L(t) && (t = L(s) ? n : s), L(i) && (i = L(s) ? r : s), !e && (L(t) || L(i))) {
...
const pn = { class: "image-upload-container" }, gn = {
  ...
  setup(e, { expose: t, emit: i }) {
    ...
    ce(() => n.modelValue, (m) => {
      T.value = m, k.value = "", m && n.uploadEnabled && (A.value = !0), n.deferUpload && (B.value = null, Z(null), ge.value = !1, ve.value = !1, r("fileReady", null));
    ...
    async function at(m) {
      ...
      if (!Ti(m, n.maxSize)) {
        ae.error(s(E.FILE_SIZE_EXCEEDS_MB, { max: n.maxSize }));
        return;
      }
      try {
        ...
        o.error("ImageUpload", `File load failed: ${H.message || s(E.FILE_LOAD_FAILED)}`, H), ae.error(H.message || s(E.FILE_LOAD_FAILED));
        return;
      }
      if (n.cropEnabled) {
        ...
        try {
          ...
          ae.error(s(E.IMAGE_LOAD_FAILED)), ie.value = !1;
        } finally {
          Ae.value = !1;
        }
      } else
    ...
    async function ht(m) {
      if (n.deferUpload) {
        B.value = m, Z(m);
        const g = zi(m), M = Ri(m);
        ge.value = M, ve.value = g, r("fileReady", m), g && Gt(previewUrl);
        return;
      }
      d.value = !0, f.value = 0;
      try {
        ...
        r("update:modelValue", g.url), w.value = g.provider || "", ae.success(s(E.UPLOAD_SUCCESS));
      } catch (g) {
        const M = g instanceof Error ? g : new Error(String(g));
        o.error("ImageUpload", `Upload failed: ${M.message || s(E.NETWORK_ERROR)}`, M), ae.error(`${s(E.UPLOAD_FAILED_WITH_ERROR, { error: M.message || s(E.NETWORK_ERROR) })}`);
      } finally {
        d.value = !1, f.value = 0;
      }
    }
    ...
    function ai(m) {
      m?.stopPropagation(), X.cancelValidation(), se.value = !1, k.value = "", r("update:modelValue", ""), T.value = "", w.value = "", d.value = !1, f.value = 0, b.value = !1, we(), n.deferUpload && (B.value = null, Z(null), ge.value = !1, ve.value = !1, r("fileReady", null));
    }
    function ri(m) {
    ...
    return t({
      ...
      reset() {
        X.reset(), B.value = null, Z(null), ge.value = !1, ve.value = !1, we(), T.value = n.modelValue || "", w.value = "", k.value = "", d.value = !1, f.value = 0, b.value = !1, n.uploadEnabled && (A.value = !!n.modelValue), r("fileReady", null);
      },
      /**
...
}), no = /* @__PURE__ */ Pi(Fn, [["__scopeId", "data-v-1a396a8f"]]);
export {
  no as I
};
