...
import { c as gi } from "./logger.DRLw23-l.js";
import { I } from "./layout.C535EJPV.js";
import { az as vi, b1 as ft, b9 as pt, b3 as bi, ba as wi, b0 as yi, b2 as zi, am as Ri } from "./main-layout.Dtg_jOYA.js";
import { i as Ai, g as Si } from "./svga.DC02l1-t.js";
import { U as Mi, k as xi, u as gt, i as Ei, h as Ci, v as Ti, a as Wi } from "./upload.DYI0V-zp.js";
import { u as Ii } from "./usePreviewUrl.ChqMuO_Z.js";
import { a as Di } from "./useAsyncAction.eiurFTju.js";
...
function _i(e) {
  ...
  return (Array.isArray(i) ? i : [i]).forEach((function(u) {
    ...
    D((c = typeof u == "function" ? u({ coordinates: l, imageSize: o, visibleArea: h }) : u).width) && D(c.height) || (l = (function(d, f) {
      var w = p(p(p({}, d), te({ width: f.width, height: f.height, sizeRestrictions: s, aspectRatio: a })), { left: 0, top: 0 });
...
function Ni(e) {
  ...
  e.stencilReference;
  var r, l, u, c = p({}, o), d = p({}, s), f = p({}, n);
  r = R(f), l = R(c), u === void 0 && (u = 1e-3), (r === 0 || l === 0 ? Math.abs(l - r) < u : Math.abs(l / r) < 1 + u && Math.abs(l / r) > 1 - u) || (c = p(p({}, c), te({ sizeRestrictions: a, width: c.width, height: c.height, aspectRatio: { minimum: R(f), maximum: R(f) } })));
...
function Xi(e) {
  ...
  if (s && n && t.type !== "manipulateImage") {
    ...
    var u = Le(r = V(r, h.width * o.width / (r.width * l.width)), i({ visibleArea: r, type: "resize" }));
    r = V(r, u), u !== 1 && (l.height /= u, l.width /= u), r = L(r = k(r, me(P(h), P(r))), i({ visibleArea: r, type: "move" })), h = L(h, Oe(q(r), a));
  }
...
function Yi(e) {
  ...
  if (t.type === "setCoordinates") {
    ...
    h > r ? n = V(n, Math.min(a.width / n.width, fe(n, s({ visibleArea: n, type: "resize" })))) : r > h && (n = V(n, Math.min(a.height / n.height, fe(n, s({ visibleArea: n, type: "resize" }))))), n = L(n = k(n, Pe(pe(a, q(n)))), s({ visibleArea: n, type: "move" }));
  }
...
function Ki(e) {
  ...
  if (i) {
    var n = { height: Math.max(i.height, o.height), width: Math.max(i.width, o.width) }, a = Ht({ width: R(n) > s ? n.width : n.height * s, height: R(n) > s ? n.width / s : n.height }, Ge(t())), h = { left: i.left + i.width / 2 - a.width / 2, top: i.top + i.height / 2 - a.height / 2, width: a.width, height: a.height }, r = ze(i, q(p({ left: 0, top: 0 }, o))), l = {};
    return !r.left && !r.right && h.width <= o.width && (l.left = 0, l.right = o.width), !r.top && !r.bottom && h.height <= o.height && (l.top = 0, l.bottom = o.height), L(h, l);
  }
  var u = R(o);
...
function Qi(e) {
  var t = e.event, i = e.coordinates, o = e.visibleArea, s = e.sizeRestrictions, n = e.getAreaRestrictions, a = e.positionRestrictions, h = e.adjustStencil, r = t.scale, l = t.move, u = p({}, o), c = p({}, i), d = 1, f = 1, w = r.factor && Math.abs(r.factor - 1) > 1e-3;
  ...
  r.factor && w && (r.factor < 1 ? (f = Math.max(r.factor, b.stencil.minimum)) > 1 && (f = 1) : r.factor > 1 && (f = Math.min(r.factor, Math.min(b.area.maximum, b.stencil.maximum))) < 1 && (f = 1)), f && (u = V(u, f, r.center));
  var S = i.left - o.left, O = o.width + o.left - (i.width + i.left), K = i.top - o.top, Q = o.height + o.top - (i.height + i.top);
  return u = L(u = k(u, pe(u, { left: a.left !== void 0 ? a.left - S * f : void 0, top: a.top !== void 0 ? a.top - K * f : void 0, bottom: a.bottom !== void 0 ? a.bottom + Q * f : void 0, right: a.right !== void 0 ? a.right + O * f : void 0 })), n({ visibleArea: u, type: "move" })), c.width = c.width * f, c.height = c.height * f, c.left = u.left + S * f, c.top = u.top + K * f, c = L(c, Oe(q(u), a)), r.factor && w && h && (r.factor > 1 ? d = Math.min(b.area.maximum, r.factor) / f : r.factor < 1 && (d = Math.max(c.height / u.height, c.width / u.width, r.factor / f)), d !== 1 && (u = k(u = L(u = V(u, d, r.factor > 1 ? r.center : P(c)), n({ visibleArea: u, type: "move" })), Pe(pe(c, q(u)))))), { coordinates: c, visibleArea: u };
}
function Ji(e) {
  var t = e.aspectRatio, i = e.getAreaRestrictions, o = e.coordinates, s = e.visibleArea, n = e.sizeRestrictions, a = e.positionRestrictions, h = e.imageSize, r = e.previousImageSize, l = e.angle, u = p({}, o), c = p({}, s), d = ne(P(p({ left: 0, top: 0 }, r)), l);
  return (u = p(p({}, te({ sizeRestrictions: n, aspectRatio: t, width: u.width, height: u.height })), ne(P(u), l))).left -= d.left - h.width / 2 + u.width / 2, u.top -= d.top - h.height / 2 + u.height / 2, c = V(c, Le(c, i({ visibleArea: c, type: "resize" }))), { coordinates: u = L(u, a), visibleArea: c = L(c = k(c, me(P(u), P(o))), i({ visibleArea: c, type: "move" })) };
}
function en(e) {
  ...
  if (u || c) {
    var d = ne({ left: h.width / 2, top: h.height / 2 }, -o), f = ne(P(r), -o), w = ne({ left: u ? d.left - (f.left - d.left) : f.left, top: c ? d.top - (f.top - d.top) : f.top }, o);
    r = k(r, me(w, P(r))), f = ne(P(l), -o), l = L(l = k(l, me(w = ne({ left: u ? d.left - (f.left - d.left) : f.left, top: c ? d.top - (f.top - d.top) : f.top }, o), P(l))), s({ visibleArea: l, type: "move" }));
  }
...
function Mt(e) {
  ...
  var c = ze(G(i, r), s);
  h && (c.left && c.left > 0 && c.right === 0 ? (r.right += c.left, r.left -= c.left) : c.right && c.right > 0 && c.left === 0 && (r.left += c.right, r.right -= c.right), c.top && c.top > 0 && c.bottom === 0 ? (r.bottom += c.top, r.top -= c.top) : c.bottom && c.bottom > 0 && c.top === 0 && (r.top += c.bottom, r.bottom -= c.bottom), c = ze(G(i, r), s));
...
var Fe = Y("vue-bounding-box"), rn = ["east", "west", null], an = ["south", "north", null], $t = { name: "BoundingBox", props: { width: { type: Number }, height: { type: Number }, transitions: { type: Object }, handlers: { type: Object, default: function() {
...
$t.render = function(e, t, i, o, s, n) {
  return v(), E("div", { ref: "box", class: n.classes.root, style: n.style }, [he(e.$slots, "default"), M("div", null, [(v(!0), E(we, null, lt(n.lineNodes, (function(a) {
  ...
  })), 128))]), (v(!0), E(we, null, lt(n.handlerNodes, (function(a) {
  ...
  return new Promise((function(t, i) {
    try {
      if (e) if (/^data:/i.test(e)) t((function(r) {
        ...
        for (var l = atob(r), u = l.length, c = new ArrayBuffer(u), d = new Uint8Array(c), f = 0; f < u; f++) d[f] = l.charCodeAt(f);
        return c;
      })(e));
...
var un = ["transitions"], ee = Y("vue-advanced-cropper"), Nt = { name: "Cropper", components: { BackgroundWrapper: qe }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  ...
  n.widthFrozen && (r.left = 0, r.right = 0), n.heightFrozen && (r.top = 0, r.bottom = 0), Z.forEach((function(_) {
    l[_] || (r[_] = 0);
  }));
  ...
  if (d) {
    ...
    if (f || (f = a.width >= a.height || d === 1 ? "width" : "height"), f === "width") {
      ...
      if (l.left && l.right) {
        ...
        r.left = -Te(O, K, Q), r.right = -Te(O, Q, K);
      } else l.left ? r.left = -O : l.right ? r.right = -O : l.top ? r.top = 0 : l.bottom && (r.bottom = 0);
    }
    r = Mt({ directions: r, coordinates: a, sizeRestrictions: n, positionRestrictions: s, preserveRatio: !0, compensate: h.compensate });
  }
  return u = G(a, r).width, c = G(a, r).height, (d = h.preserveRatio ? R(a) : je(u / c, o)) && Math.abs(d - u / c) > 1e-3 && Z.forEach((function(_) {
    l[_] || (r[_] = 0);
  ...
  return a = L(a = k(a, me(P(i), P(a))), Oe(q(t), n));
  ...
  var a = Pe(pe(s, q(n = V(n, Le(n, o({ visibleArea: n, type: "resize" }))))));
  return n.width < s.width && (a.left = 0), n.height < s.height && (a.top = 0), n = L(n = k(n, a), o({ visibleArea: n, type: "move" }));
  ...
  if (this.$refs.canvas) {
    var e = this.$refs.canvas, t = this.$refs.image, i = this.imageTransforms.rotate !== 0 || this.imageTransforms.flip.horizontal || this.imageTransforms.flip.vertical ? (function(h, r, l) {
      var u = l.rotate, c = l.flip, d = { width: r.naturalWidth, height: r.naturalHeight }, f = Ut(d, u), w = h.getContext("2d");
      h.height = f.height, h.width = f.width, w.save();
      var b = ne(P(p({ left: 0, top: 0 }, d)), u);
      return w.translate(-(b.left - f.width / 2), -(b.top - f.height / 2)), w.rotate(u * Math.PI / 180), w.translate(c.horizontal ? d.width : 0, c.vertical ? d.height : 0), w.scale(c.horizontal ? -1 : 1, c.vertical ? -1 : 1), w.drawImage(r, 0, 0, d.width, d.height), w.restore(), h;
    ...
    return (function(h, r, l, u, c) {
      ...
      d.drawImage(r, l.left + f, l.top + w, l.width, l.height, f * (h.width / l.width), w * (h.height / l.height), h.width, h.height);
...
const fn = { class: "image-upload-container" }, pn = {
  ...
  setup(e, { expose: t, emit: i }) {
    ...
    Ai(mt.Parser);
    const n = e, a = i, h = ke(() => n.placeholder || s(I.CLICK_OR_DRAG_TO_UPLOAD_COVER_IMAGE)), r = ke(() => n.acceptHint || s("Supports JPG/PNG/GIF/WebP max {max}MB", { max: n.maxSize })), l = C(null), u = C(null), c = C(!1), d = C(0), f = C(!1), w = C(""), b = C(!n.uploadEnabled), S = C(n.modelValue), O = C(null), { previewUrl: K, setPreview: Q } = Ii(), _ = C(!1), ge = C(!1), {
      containerRef: Xt,
      playUrl: Yt
    ...
    ce(() => n.modelValue, (m) => {
      S.value = m, U.value = "", m && n.uploadEnabled && (b.value = !0), n.deferUpload && (O.value = null, Q(null), _.value = !1, ge.value = !1, a("fileReady", null));
    ...
    async function st(m) {
      ...
      try {
        ...
        re.error($.message || s(I.FILE_LOAD_FAILED));
        return;
      }
      if (n.cropEnabled) {
        ...
        try {
          ...
          re.error(s(I.IMAGE_LOAD_FAILED)), ie.value = !1;
        } finally {
          Re.value = !1;
        }
      } else
    ...
    async function at(m) {
      if (n.deferUpload) {
        O.value = m, Q(m);
        const g = yi(m), x = zi(m);
        _.value = x, ge.value = g, a("fileReady", m), g && Gt(previewUrl);
        return;
      }
      c.value = !0, d.value = 0;
      try {
        ...
        a("update:modelValue", g.url), w.value = g.provider || "", re.success(s(I.UPLOAD_SUCCESS));
      } catch (g) {
        const x = g instanceof Error ? g : new Error(String(g));
        re.error(`${s("Upload Failed With Error", { error: x.message || s(I.NETWORK_ERROR) })}`);
      } finally {
        c.value = !1, d.value = 0;
      }
    }
    ...
    function si(m) {
      m?.stopPropagation(), N.cancelValidation(), se.value = !1, U.value = "", a("update:modelValue", ""), S.value = "", w.value = "", c.value = !1, d.value = 0, f.value = !1, be(), n.deferUpload && (O.value = null, Q(null), _.value = !1, ge.value = !1, a("fileReady", null));
    }
    function ri(m) {
    ...
    return t({
      ...
      reset() {
        N.reset(), O.value = null, Q(null), _.value = !1, ge.value = !1, be(), S.value = n.modelValue || "", w.value = "", U.value = "", c.value = !1, d.value = 0, f.value = !1, n.uploadEnabled && (b.value = !!n.modelValue), a("fileReady", null);
      },
      /**
