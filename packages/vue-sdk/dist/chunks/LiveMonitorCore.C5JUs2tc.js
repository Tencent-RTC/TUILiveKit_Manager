import { g as f, aH as d, aI as L, aJ as p, e as S } from "./main-layout.DI9Xn1Ek.js";
import { ad as y, aA as c, aC as v, I as l, aB as u, d as C, az as I } from "./en-US.CklcmnrB.js";
async function U(n, t = 50) {
  return y(`/chat/${n}/messages`, { limit: t });
}
async function N(n, t) {
  const e = v().credentials?.userId || "admin";
...
async function M(n, t, e, i) {
  const r = i || v().credentials?.userId || "admin";
...
class k {
  ...
  async updateLive(t) {
    ...
    this.setLoading(i, !0), this.setError(null);
    try {
      await p(e, t), this.currentLive && (this.currentLive = { ...this.currentLive, ...t }, this.notifyStateChange({ currentLive: this.currentLive })), this.setLoading(i, !1);
    } catch (r) {
      const s = r instanceof Error ? r : new Error(String(r));
