import { useState as u, useRef as V, useEffect as $, useCallback as a } from "react";
import { au as ce, as as ue, m as le, u as de, bI as fe, bJ as ge, br as me, R as he, Q as be } from "./main-layout.CAk7EHcz.js";
import { c as z, n as Me, h as s, j as B } from "./logger.BVGT9iyh.js";
import { aL as F, aM as ve, Y as we, aN as O, ay as K, I as ye, aO as pe, af as Le, aP as Se, ag as Ce, aQ as Pe, aG as Te } from "./layout.DpmHfGro.js";
import "tdesign-react";
const h = z("RiskControl");
function De(c) {
  const { liveId: t, pageSize: w } = c, [b, p] = u("cloud"), [L, M] = u(!1), [S, C] = u(0), [P, x] = u(!0), [T, R] = u([]), [A, D] = u(1), [_, U] = u(0), [o, i] = u(!1), [m, G] = u([]), [Q, W] = u([]), [j, d] = u(!1), [H, f] = u(null), v = V(!0);
  $(() => {
    v.current = !0, Me("risk_control");
    const e = (r) => {
      const g = r === "cloud";
      (g ? K : O)({ pageSize: 1 }).then(() => {
  ...
  const J = a(async () => {
    ...
    try {
      let r;
      return b === "custom" ? r = await O({ pageSize: w, liveId: t, ...e }) : r = await K({ pageSize: w, liveId: t, ...e }), v.current && (R(r.list || []), D(e.pageNum || 1), U(r.total || 0)), r;
    } catch (r) {
...
function Ne() {
  const [c, t] = u([]), [w, b] = u(!0), [p, L] = u(null), M = V(!0);
  l || (l = new he({
    onStateChange: (o) => {
      N.forEach((i) => i(o));
    },
  ...
  }, []), R = a(async (o) => l.fetchLiveDetail(o), []), A = a(async (o) => l.fetchLiveStats(o), []), D = a((o) => {
    l?.setCurrentLive(o);
