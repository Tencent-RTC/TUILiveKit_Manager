...
import { a5 as m, P as n } from "./en-US.Cyn41QJd.js";
import { ax as k, bk as x } from "./main-layout.0SrlHtaV.js";
import { useUIKit as S } from "@tencentcloud/uikit-base-component-vue3";
import { u as L } from "./useAsyncAction.CeUdmKXy.js";
const y = ["title", "aria-label"], G = ["src", "alt"], R = {
  ...
  setup(o) {
    const s = o, e = f(""), l = f(!1), a = _(() => s.name ? `${s.name}头像` : "主播头像"), r = _(() => k(s.name));
    A(() => s.src, (c) => {
