...
import { w as vt, c as mt } from "./logger.rNWqpx5t.js";
...
import { I as y } from "./layout.BFdpDTDu.js";
import { g as le, bp as We, bz as Et, bo as St, ay as Dt, by as Pt, br as xt } from "./main-layout.G3PkFHlB.js";
import { i as At, g as bt } from "./PreviewUrlController.KM17Oi3R.js";
import { U as zt, u as Ve, k as It, i as Mt, h as Nt, v as Ut, g as Lt } from "./upload.DXa_mkyh.js";
import { s as Ke } from "./svga.min.Zof6g_Kl.js";
import { M as Y } from "./useAsyncAction.CPEKpj24.js";
import { u as Ot, a as Tt } from "./useT.ZeI7ggL6.js";
var Pe = function(a, r) {
...
const Rr = dt(function({
  ...
  const { t: f } = _t(), de = s || f(y.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), J = q(null), [N, b] = S(!1), [L, O] = S(0), [Be, Q] = S(!1), [fe, ne] = S(""), [x, X] = S(!h), [z, ie] = S(r), [ve, G] = S(!1), [V, T] = S(""), A = q(null);
  ...
  const $ = q(null), { previewUrl: Z, setPreview: K } = Ot(), [Je, me] = S(!1), [ge, ae] = S(!1), {
    containerRef: Qe,
    playUrl: xe,
    stopAnimation: ar
  ...
  ft(H, () => ({
    ...
    reset: () => {
      A.current.reset(), $.current = null, K(null), me(!1), ae(!1), ie(r || ""), ne(""), T(""), b(!1), O(0), Q(!1), h && X(!!r), _?.(null);
    },
