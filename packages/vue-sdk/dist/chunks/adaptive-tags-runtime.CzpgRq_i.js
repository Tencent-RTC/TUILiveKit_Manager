import { c3 as D, c4 as $, s as T, p as C, d as j, t as R, f as g, e as P, b3 as _, c5 as F, c6 as G } from "./main-layout.DjCTrpgR.js";
import { aw as q, I as H } from "./layout.LLpP3S0z.js";
import { j as k } from "./logger.rNWqpx5t.js";
class K extends $ {
  constructor(e, t, s) {
      ...
      z((t) => {
        ...
        return t.forEach((n) => {
          ...
          z(() => {
            ...
            return g(
              _(s, 10, n, r, i).then((l) => (k("av_moderation"), k("moderation"), l))
            );
          }),
...
function A(o) {
  const e = o.roomIdText ?? o.liveIdText ?? "", {
    ...
    minVisibleTags: d = 2,
    maxVisibleTags: m = 99
  } = o, M = x("live-id-badge", e), E = i + M, w = t - n, u = s.map(
    (a) => x("live-card-tag-overlay", a)
  ), f = x("live-card-tag-overlay live-card-tag-more", "...");
  let p = 0, h = 0;
  for (let a = 0; a < u.length; a++) {
    const c = u[a], y = u.length - a - 1, O = y > 0 ? f : 0, I = h > 0 ? r : 0, U = p + I + c + (y > 0 ? r + O : 0), S = w - U, B = Math.max(60, S - i - l);
    if (M > B || S < E + l)
      break;
    p += I + c, h++;
  }
