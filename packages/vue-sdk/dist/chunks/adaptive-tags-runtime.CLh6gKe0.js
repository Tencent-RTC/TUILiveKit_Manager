import { bJ as B, bK as z, s as I, p as C, f as g, t as D } from "./main-layout.Bwa83IG1.js";
import { s as P, t as R, a as j, f as F } from "./utils.CPJqv6Oy.js";
import { aM as _, aw as G, R as q } from "./layout.xMYH3d3a.js";
class H extends z {
  constructor(e, t, s) {
...
function $(n) {
  const e = n.roomIdText ?? n.liveIdText ?? "", {
    ...
    minVisibleTags: l = 2,
    maxVisibleTags: m = 99
  } = n, M = x("live-id-badge", e), L = i + M, w = t - r, p = s.map(
    (o) => x("live-card-tag-overlay", o)
  ), f = x("live-card-tag-overlay live-card-tag-more", "...");
  let d = 0, h = 0;
  for (let o = 0; o < p.length; o++) {
    const c = p[o], y = p.length - o - 1, E = y > 0 ? f : 0, S = h > 0 ? a : 0, O = d + S + c + (y > 0 ? a + E : 0), T = w - O, U = Math.max(60, T - i - u);
    if (M > U || T < L + u)
      break;
    d += S + c, h++;
  }
