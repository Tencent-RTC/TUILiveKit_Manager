...
import { w as Wo, az as Ho, aB as Yo, bP as jo, cb as Xo, cc as Ko, u as qo, m as Zo, aL as te, N as bi, aS as Qo, bO as Jo, b as es, bD as dn, bE as hn, _ as ts, b7 as Ra, ba as is, a1 as ns, bp as Kn, c6 as as, c0 as qn, by as Zn, br as os, c4 as ss, c3 as ls, c2 as rs, bz as cs, at as us, bo as ds, bq as hs, ay as vs, a0 as ms, an as Qn, b6 as fs, aM as gs, A as Wt, O as bt, i as Ke, bf as ti, al as La, bF as xa, x as Vi, a3 as ps, bS as bs, ao as Jn, Z as ea, aw as ys, au as ta, c1 as Es, ag as _s, aO as ws, R as Cs, aP as Na, aZ as Is, bi as ia, aG as As, a5 as Ms, a as Ot, bx as Ts, b4 as xi, bN as Ss, a7 as Rs, bk as na, aR as gt, k as Ls, D as xs, v as Ns, bh as aa, s as oa, aJ as ks, aX as ka, aV as ii, aY as Da, q as Ht, r as Je, o as et, p as hi, z as Oa, F as Ut, bG as Ds, t as Os, T as nn, d as vi, f as st, C as lt, S as Us, aA as $s } from "./main-layout.ztHD0x6R.js";
import { c as Ps, s as vn, D as Fs, a as Vs, m as zs, b as Gs, d as Bs, e as Ws, P as Hs } from "./gift-category.qmtjx5qb.js";
import { S as Ys, R as js, a9 as Xs, F as Ks, M as r, Y as an, Z as Rn, b as qs, aa as Zs, V as Qs, U as Js, g as Yi, aq as el, n as oi, j as Ua, z as tl, $ as il, a2 as nl, ai as sa } from "./en-US.B3IHgsij.js";
...
import { a as rl } from "./moderation-store.BsAJzNHQ.js";
let ni = null;
function cl() {
  return ni || (ni = new Wo({
    onStateChange: (e) => {
...
function ul(e) {
  ...
  const R = async () => {
    ...
    u.value = !0;
    try {
      const O = await Xs({ pageSize: i, liveId: n, ...W });
    ...
    try {
      ...
      await js({ ids: W.ids, items: O, liveId: W.liveId ?? n });
    } catch (O) {
      throw console.error("[useRiskControlState] approveTextModerationItems failed:", O), O;
    }
  }, ie = async (W) => {
    try {
      await Ys({ content: W.keywords.join(","), liveId: n });
    } catch (O) {
...
const dl = { class: "monitor-header" }, hl = { class: "monitor-title-section" }, vl = { class: "monitor-title" }, ml = { class: "monitor-header-actions" }, fl = /* @__PURE__ */ Te({
  ...
  setup(e) {
    const n = e, i = I(""), s = I(!1), o = P(() => n.name ? `${n.name}头像` : "主播头像"), a = P(() => Qo(n.name));
    Me(() => n.src, (d) => {
...
function Ul(e, n) {
  const i = I(/* @__PURE__ */ new Map()), s = new es({
...
function Pl(e, n) {
  ...
  const M = () => {
    ...
    if (!(k.length === 0 || d.value)) {
      M(), h = S;
      try {
        const { startTime: w, endTime: ee } = G(), ce = await Zs(k, 10, w, ee);
  ...
  const q = async (N, S, k) => {
    ...
    try {
      ...
      if (ee === 2025 || ee === 70005 || typeof ce != "number" && ((w = ce.message) != null && w.includes("USER_SIG_ILLEGAL"))) {
        Qs(), Js(), localStorage.removeItem("tuiLiveMonitor-userInfo"), require("vue-router").useRouter().push("/config-required");
        return;
      }
      Y.error(i("No search results for", { keyword: S })), await O();
    } finally {
...
}), gm = /* @__PURE__ */ ci(Hl, [["__scopeId", "data-v-03f55f17"]]);
function la(e, n) {
  var i = Object.keys(e);
...
const Tr = { class: "image-upload-container" }, Sr = {
  ...
  setup(e, { expose: n, emit: i }) {
    ...
    async function Re(x) {
      ...
      try {
        await rs(x, o.accept, o.skipSvgaValidation);
      } catch (Ae) {
    ...
    async function $e() {
      if (!(!L.value || !g.value))
        try {
          const { canvas: x } = g.value.getResult(), J = await us(x, "image/jpeg", 0.92);
      ...
      return y(), C("div", Tr, [
        ...
        e.modelValue && (R.value || !e.uploadEnabled) ? (y(), C("div", {
          ...
          t(Kn)(e.modelValue) ? (y(), C("div", {
            ...
            ref: he,
            class: "svga-preview-container"
          }, null, 512)) : t(os)(e.modelValue) ? (y(), C("video", {
            key: 1,
            src: e.modelValue,
            muted: "",
            loop: "",
  ...
  setup(e, { emit: n }) {
    ...
    const U = P(() => {
      var $;
      return i((($ = fs(p.value.seatTemplate)) == null ? void 0 : $.descKey) || "");
    }), D = P(() => gs(p.value.seatTemplate)), L = P(() => T.value ? ie.value === "error" ? `OBS 配置失败：${G.value}` : K.value ? "OBS 已配置完成，可直接复制下方推流信息。" : q.value ? `OBS 已配置完成，但推流信息生成失败：${q.value}` : "OBS 已配置完成。" : ""), F = P(() => ie.value === "error" || !!q.value), N = ($) => {
      le.value = !!$;
    }, S = async ($, j) => {
      try {
...
}), Cc = /* @__PURE__ */ ci(wc, [["__scopeId", "data-v-75c8a872"]]), Et = /* @__PURE__ */ Te({
  __name: "SlotRenderer",
  props: {
    slotComponent: {
    ...
    P(() => p.value.filter((O) => O.key.trim()).length), Me([() => {
      ...
      if (D && U) {
        ...
        h.value = {
          liveName: L || "",
          coverUrl: F || ""
        }, F ? M.value = await ys(F) : M.value = ea;
        try {
    ...
    const le = () => {
      ...
      if (a.room) {
        ...
        try {
          ...
          const D = _s(p.value), L = ws(R.value, D);
          await K({
...
}), xc = /* @__PURE__ */ ci(Lc, [["__scopeId", "data-v-a7458de9"]]), Nc = {
  key: 0,
  ...
  props: {
    ...
    fitContentMaxRows: { type: Number, default: Fs }
  },
  setup(e) {
    function n() {
    ...
    const R = (L) => L.fitContent || i.fitContent && L.width === void 0, M = (L) => typeof L == "number" ? `${L}px` : L, T = (L) => {
      ...
      const F = ((S = l.value) == null ? void 0 : S.clientWidth) ?? 0, N = Bs(
        i.columns,
        L,
        F,
        R
      );
      Ws(u.value, N) || (u.value = N);
    }, le = () => {
      q(), Q();
    }, he = () => {
  ...
  setup(e) {
    var h;
    const { t: n } = ke(), i = _i(), { endLive: s } = Pt(), o = (h = Yi().components) == null ? void 0 : h.roomList, a = new Cs({
      endLive: s,
      onEnterLive: (p) => {
    ...
    const g = P(() => Is({ hasExtraColumn: !!(o != null && o.tableExtraColumns) }).map((b) => ({
      ...b,
            ...
            return [
              f(Zi, {
                ...
                "cell-createdAt": E(({ row: le }) => [
                  c("span", jc, v(t(As)(le.createdAt)), 1)
                ]),
  ...
  setup(e) {
    const { t: n } = ke(), i = e, { loginUserInfo: s } = $a(), { currentLive: o } = Pt(), { audienceList: a, disableSendMessage: l } = Pa(), d = P(() => i.currentLive || o.value), u = (U) => new TextEncoder().encode(U).length, g = I(!1), m = I({ top: 0, left: 0 }), h = I(null), p = I(""), b = I(!1), R = I(null), M = I(null), T = I(null), ie = P(() => b.value || !i.liveId || !p.value.trim()), G = (U) => a.value.find((D) => D.userId === U), K = (U) => {
      ...
      setup(U) {
        var k, w;
        const D = U.message.sender.nameCard || U.message.sender.userName || U.message.sender.userId, L = U.message.sender.userId === ((w = (k = d.value) == null ? void 0 : k.liveOwner) == null ? void 0 : w.userId), F = U.message.messageType === 0 ? U.message.textContent : U.message.data || "", N = Ts(F), S = () => N.map((ee, ce) => ee.type === "emoji" ? Zt("img", {
          key: ce,
          class: "message-emoji",
          src: ee.src,
          alt: ee.key
...
const Wh = { class: "live-control-container" }, Hh = { class: "live-control-viewport" }, Yh = { class: "right-sidebar" }, Ri = 20, jh = /* @__PURE__ */ Te({
  ...
  setup(e) {
    ...
    const en = P(
      ...
      s.value && (na(_, en.value) || (z ? (confirmDialogTitle.value = a(r.CONFIRM_UNMUTE_USER), confirmDialogContent.value = a("Unmute Confirm", { name: A }), confirmAction.value = async () => {
        try {
        ...
        try {
          await F(_, Ls), Pe("success", a("Muted Success", { name: A })), ui();
        } catch (H) {
          const { code: Z, info: ge } = xt(H), we = H instanceof Error ? H : new Error(String(H)), Fe = Z ? gt(Z, ge) : we.message || a(r.UNKNOWN_HOST);
      ...
      s.value && (na(_, en.value) || (z ? (confirmDialogTitle.value = a(r.CONFIRM_UNBAN_USER), confirmDialogContent.value = a("Unban Confirm", { name: A }), confirmAction.value = async () => {
        try {
        ...
        try {
          await S(_, xs), Pe("success", a("Banned Success", { name: A })), di();
        } catch (H) {
          const { code: Z, info: ge } = xt(H), we = H instanceof Error ? H : new Error(String(H)), Fe = Z ? gt(Z, ge) : we.message || a(r.UNKNOWN_HOST);
...
}), bm = /* @__PURE__ */ ci(jh, [["__scopeId", "data-v-099c334b"]]), Xh = { class: "gift-config-container" }, Kh = { class: "gift-config-page-header" }, qh = { class: "gift-config-title" }, Zh = { class: "gift-config-actions" }, Qh = { class: "gift-search-input" }, Jh = { class: "gift-id" }, ev = { class: "gift-id-text" }, tv = { class: "gift-thumbnail" }, iv = ["src", "alt"], nv = { key: 1 }, av = ["onClick"], ov = { class: "gift-lang-tags" }, sv = ["onClick"], lv = {
  key: 1,
          ...
          c("div", Zh, [
            c("div", Qh, [
              f(He, {
                ...
                clearable: "",
                status: t(aa)(h.value, t(oa)) ? "error" : "default",
                tips: t(aa)(h.value, t(oa)) ? t(o)(t(r).INPUT_EXCEEDS_LENGTH_LIMIT) : "",
                "onUpdate:modelValue": $,
                onEnter: j,
                onClear: Se
              }, {
  ...
  setup(e) {
    const n = _i(), { t: i } = ke(), s = Fa(), o = new Os({
      actions: {
