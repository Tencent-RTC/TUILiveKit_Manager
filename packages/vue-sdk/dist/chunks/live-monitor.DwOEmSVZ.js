...
import { s as Wo, av as Ho, ax as Yo, aG as te, H as bi, aM as jo, b as Xo, bq as dn, br as hn, W as Ko, aZ as Ra, a$ as qo, Z as Zo, be as Kn, bL as Qo, bl as qn, bg as Jo, bJ as es, bI as ts, bH as is, bm as ns, ap as as, bd as os, bf as ss, au as ls, Y as rs, aj as Zn, aY as cs, aH as us, A as Wt, J as bt, g as Ke, b4 as ti, ah as La, bs as xa, t as Vi, $ as ds, ak as Qn, V as Jn, as as hs, aq as ea, bG as vs, ac as ms, aJ as fs, N as gs, aT as ps, b7 as ta, aC as bs, a1 as ys, a as Ot, bk as Es, aW as xi, a3 as _s, b9 as ia, aL as gt, i as ws, D as Cs, r as Is, b6 as na, p as aa, aF as As, aR as Na, aP as ii, aS as ka, n as Ht, o as Je, l as et, m as hi, v as Da, w as Ut, bt as Ms, q as Ts, P as nn, d as vi, e as st, C as lt, O as Ss, aw as Rs } from "./main-layout.dRhXLbre.js";
import { c as Ls, s as vn, D as xs, a as Ns, m as ks, b as Ds, d as Os, e as Us, P as $s } from "./gift-category.qmtjx5qb.js";
import { b9 as Ps, aL as Fs, c as Vs, aM as zs, ap as Gs, e as Bs, b as Ws, a3 as Hs, aT as Ys, aY as r, b2 as an, b3 as Rn, b8 as js, d as Xs, b5 as Ks, i as qs, h as Zs, D as Yi, k as Qs, aR as oa, X as oi, aI as Js, W as Oa, aA as el, Q as Ua, ax as tl, z as il, E as nl, au as sa } from "./upload.HR7xdC-w.js";
import { LiveView as al, useLoginState as $a, useLiveAudienceState as Pa, LiveAudienceList as ol, useLiveListState as sl } from "tuikit-atomicx-vue3";
import { BarrageList as ll } from "tuikit-atomicx-vue3/live";
import { a as rl } from "./moderation-store.DpCJ9ZU8.js";
let ni = null;
function cl() {
  return ni || (ni = new Wo({
    onStateChange: (e) => {
...
function ul(e) {
  ...
  return {
    ...
    banMember: async (W) => {
      ...
      h.value = !0, p.value = null;
      try {
        await Vs(n, W.memberAccounts, W.duration, W.reason), await K();
      } catch (O) {
    ...
    unbanMember: async (W) => {
      ...
      h.value = !0, p.value = null;
      try {
        await Fs(n, W.memberAccounts), await K();
      } catch (O) {
...
const dl = { class: "monitor-header" }, hl = { class: "monitor-title-section" }, vl = { class: "monitor-title" }, ml = { class: "monitor-header-actions" }, fl = /* @__PURE__ */ Te({
  ...
  setup(e) {
    const n = e, i = I(""), s = I(!1), o = P(() => n.name ? `${n.name}头像` : "主播头像"), a = P(() => jo(n.name));
    Me(() => n.src, (d) => {
...
function Ul(e, n) {
  const i = I(/* @__PURE__ */ new Map()), s = new Xo({
...
function Pl(e, n) {
  ...
  const M = () => {
    ...
    if (!(k.length === 0 || d.value)) {
      M(), h = S;
      try {
        const { startTime: w, endTime: ee } = G(), ce = await Ks(k, 10, w, ee);
  ...
  const q = async (N, S, k) => {
    ...
    try {
      ...
      if (ee === 2025 || ee === 70005 || typeof ce != "number" && ((w = ce.message) != null && w.includes("USER_SIG_ILLEGAL"))) {
        qs(), Zs(), localStorage.removeItem("tuiLiveMonitor-userInfo"), require("vue-router").useRouter().push("/config-required");
        return;
      }
      Y.error(i("No search results for", { keyword: S })), await O();
    } finally {
...
}), gm = /* @__PURE__ */ ci(Hl, [["__scopeId", "data-v-dc7db050"]]);
function la(e, n) {
  var i = Object.keys(e);
...
const Tr = { class: "image-upload-container" }, Sr = {
  ...
  setup(e, { expose: n, emit: i }) {
    ...
    async function Re(x) {
      ...
      try {
        await is(x, o.accept, o.skipSvgaValidation);
      } catch (Ae) {
    ...
    async function $e() {
      if (!(!L.value || !g.value))
        try {
          const { canvas: x } = g.value.getResult(), J = await as(x, "image/jpeg", 0.92);
      ...
      return y(), C("div", Tr, [
        ...
        e.modelValue && (R.value || !e.uploadEnabled) ? (y(), C("div", {
          ...
          t(Kn)(e.modelValue) ? (y(), C("div", {
            ...
            ref: he,
            class: "svga-preview-container"
          }, null, 512)) : t(Jo)(e.modelValue) ? (y(), C("video", {
            key: 1,
            src: e.modelValue,
            muted: "",
            loop: "",
  ...
  setup(e, { emit: n }) {
    ...
    }, p = I(Zn()), b = I([]), R = I(!1), M = I(!1), T = I(!1), ie = I(""), G = I(""), K = I(null), q = I(""), Q = I(null), le = I(!1), { loading: he, execute: Ee } = On({
      action: async () => {
        let $ = "";
        try {
          $ = await xa({
    ...
    const U = P(() => {
      var $;
      return i((($ = cs(p.value.seatTemplate)) == null ? void 0 : $.descKey) || "");
    }), D = P(() => us(p.value.seatTemplate)), L = P(() => T.value ? ie.value === "error" ? `OBS 配置失败：${G.value}` : K.value ? "OBS 已配置完成，可直接复制下方推流信息。" : q.value ? `OBS 已配置完成，但推流信息生成失败：${q.value}` : "OBS 已配置完成。" : ""), F = P(() => ie.value === "error" || !!q.value), N = ($) => {
      le.value = !!$;
    }, S = async ($, j) => {
      try {
      ...
      var $;
      p.value = Zn(), b.value = [], R.value = !1, M.value = !1, T.value = !1, ie.value = "", G.value = "", K.value = null, q.value = "", le.value = !1, ($ = Q.value) == null || $.reset();
    }, ce = () => {
  ...
  setup(e, { emit: n }) {
    ...
    }), g = (O) => te(O), m = (O) => te(O), h = I(Qn()), p = I([]), b = I(!1), R = I([]), M = I(Jn), T = I(null), ie = I(!1), { loading: G, execute: K } = On({
      action: async (O) => {
        var D, L;
    ...
    P(() => p.value.filter((O) => O.key.trim()).length), Me([() => {
      ...
      if (D && U) {
        ...
        h.value = {
          liveName: L || "",
          coverUrl: F || ""
        }, F ? M.value = await hs(F) : M.value = Jn;
        try {
          const S = await s(N), k = ea(S == null ? void 0 : S.customInfo);
          p.value = k, b.value = k.length > 0, R.value = k.map((w) => w.key);
        } catch {
          const S = "CustomInfo" in D ? D.CustomInfo : D.customInfo, k = ea(S);
          p.value = k, b.value = k.length > 0, R.value = k.map((w) => w.key);
        }
      }
    }, { immediate: !0 });
    const le = () => {
      ...
      var O;
      p.value = [], b.value = !1, R.value = [], ie.value = !1, (O = T.value) == null || O.reset(), h.value = Qn(), d("update:visible", !1);
    }, W = async () => {
      if (a.room) {
        ...
        try {
          ...
          const D = ms(p.value), L = fs(R.value, D);
          await K({
  ...
  setup(e) {
    ...
    const R = (L) => L.fitContent || i.fitContent && L.width === void 0, M = (L) => typeof L == "number" ? `${L}px` : L, T = (L) => {
      ...
      const F = ((S = l.value) == null ? void 0 : S.clientWidth) ?? 0, N = Os(
        i.columns,
        L,
        F,
        R
      );
      Us(u.value, N) || (u.value = N);
    }, le = () => {
      q(), Q();
    }, he = () => {
  ...
  style: { width: "auto" }
}, ku = { class: "dialog-footer" }, pm = /* @__PURE__ */ Te({
  __name: "live-list",
  setup(e) {
    var h;
    ...
    const g = P(() => ps({ hasExtraColumn: !!(o != null && o.tableExtraColumns) }).map((b) => ({
      ...b,
        ...
        c("div", Pc, [
          ...
          c("div", Vc, [
            f(R, {
              ...
              style: { width: "220px" },
              clearable: "",
              status: t(ta)(l.value.searchInput, t(bi)) ? "error" : "default",
              tips: t(ta)(l.value.searchInput, t(bi)) ? t(n)(t(r).INPUT_EXCEEDS_LENGTH_LIMIT) : "",
            ...
            return [
              f(Zi, {
                ...
                "cell-createdAt": E(({ row: le }) => [
                  c("span", jc, v(t(bs)(le.createdAt)), 1)
                ]),
      ...
      return y(), C("section", Wu, [
        ...
        c("div", ju, [
          ...
          c("div", Ku, [
            ...
            ], 64)) : e.sdkReady ? (y(), se(t(al), { key: 1 })) : ue("", !0),
  ...
  setup(e) {
    const { t: n } = ke(), i = e, { loginUserInfo: s } = $a(), { currentLive: o } = Pt(), { audienceList: a, disableSendMessage: l } = Pa(), d = P(() => i.currentLive || o.value), u = (U) => new TextEncoder().encode(U).length, g = I(!1), m = I({ top: 0, left: 0 }), h = I(null), p = I(""), b = I(!1), R = I(null), M = I(null), T = I(null), ie = P(() => b.value || !i.liveId || !p.value.trim()), G = (U) => a.value.find((D) => D.userId === U), K = (U) => {
      ...
      setup(U) {
        var k, w;
        const D = U.message.sender.nameCard || U.message.sender.userName || U.message.sender.userId, L = U.message.sender.userId === ((w = (k = d.value) == null ? void 0 : k.liveOwner) == null ? void 0 : w.userId), F = U.message.messageType === 0 ? U.message.textContent : U.message.data || "", N = Es(F), S = () => N.map((ee, ce) => ee.type === "emoji" ? Zt("img", {
          key: ce,
          class: "message-emoji",
          src: ee.src,
          alt: ee.key
  ...
  setup(e, { emit: n }) {
    const i = e, s = n, { login: o, loginUserInfo: a } = $a(), { joinLive: l, leaveLive: d, subscribeEvent: u, unsubscribeEvent: g, LiveListEvent: m } = sl(), h = I(!1), p = I(""), b = I(!1), R = I(""), M = P(
      () => {
        var K;
...
const Wh = { class: "live-control-container" }, Hh = { class: "live-control-viewport" }, Yh = { class: "right-sidebar" }, Ri = 20, jh = /* @__PURE__ */ Te({
  ...
  setup(e) {
    ...
    const ze = I([]), ne = I(1), ve = O, Oe = I(0), x = I([]), J = P(
      ...
      if (!ve.value && s.value)
        try {
          ...
          const Fe = await il(he.value), Ci = await nl();
      ...
      try {
        await sa([_.id]), Y.info(a(r.DELETED)), await Mt([_.id]);
      } catch (A) {
      ...
      const _ = [...x.value];
      try {
        await sa(_), Y.info(a(r.DELETED)), await Mt(_);
      } catch (A) {
    ...
    const en = P(
      ...
      s.value && (ia(_, en.value) || (z ? (confirmDialogTitle.value = a(r.CONFIRM_UNMUTE_USER), confirmDialogContent.value = a("Unmute Confirm", { name: A }), confirmAction.value = async () => {
        try {
        ...
        try {
          await F(_, ws), Pe("success", a("Muted Success", { name: A })), ui();
        } catch (H) {
          const { code: Z, info: ge } = xt(H), we = H instanceof Error ? H : new Error(String(H)), Fe = Z ? gt(Z, ge) : we.message || a(r.UNKNOWN_HOST);
      ...
      s.value && (ia(_, en.value) || (z ? (confirmDialogTitle.value = a(r.CONFIRM_UNBAN_USER), confirmDialogContent.value = a("Unban Confirm", { name: A }), confirmAction.value = async () => {
        try {
        ...
        try {
          await S(_, Cs), Pe("success", a("Banned Success", { name: A })), di();
        } catch (H) {
          const { code: Z, info: ge } = xt(H), we = H instanceof Error ? H : new Error(String(H)), Fe = Z ? gt(Z, ge) : we.message || a(r.UNKNOWN_HOST);
...
}), bm = /* @__PURE__ */ ci(jh, [["__scopeId", "data-v-4b574841"]]), Xh = { class: "gift-config-container" }, Kh = { class: "gift-config-page-header" }, qh = { class: "gift-config-title" }, Zh = { class: "gift-config-actions" }, Qh = { class: "gift-search-input" }, Jh = { class: "gift-id" }, ev = { class: "gift-id-text" }, tv = { class: "gift-thumbnail" }, iv = ["src", "alt"], nv = { key: 1 }, av = ["onClick"], ov = { class: "gift-lang-tags" }, sv = ["onClick"], lv = {
  key: 1,
...
}, Tv = { class: "category-select-footer" }, mi = 0, Li = 2147483647, Jt = 1, ei = 99, ym = /* @__PURE__ */ Te({
  __name: "gift-config",
  setup(e) {
    var Mt;
    ...
    return At(async () => {
      L.value = await Oa(), Fi.on("languageChanged", wi), await l.init();
    }), Ei(() => {
              ...
              "cell-languageList": E(({ row: X }) => [
                c("div", ov, [
                  X.languageList && X.languageList.length > 0 ? (y(!0), C(pe, { key: 0 }, Ne(X.languageList, (be) => (y(), C("span", {
                    key: t(ii)(be),
                    class: "gift-lang-tag",
                    onClick: (Xt) => Oe(X.id, t(Na)(t(ii)(be)))
                  }, v(t(o)(t(ka)(t(ii)(be)))), 9, sv))), 128)) : (y(), C("span", lv, "-")),
                  f(t(Pi), {
          ...
          default: E(() => [
            c("div", mv, [
              ...
              c("table", pv, [
                ...
                c("tbody", null, [
                  (y(!0), C(pe, null, Ne(t(Da), (X) => (y(), C("tr", { key: X }, [
            ...
            "cell-languageList": E(({ row: $ }) => [
              c("div", Vv, [
                $.languageList && $.languageList.length > 0 ? (y(!0), C(pe, { key: 0 }, Ne($.languageList, (j) => (y(), C("span", {
                  ...
                  onClick: (Se) => O($.id, j)
                }, v(t(i)(t(ka)(t(ii)(j)))), 9, zv))), 128)) : (y(), C("span", Gv, "-")),
                f(t(Pi), {
          ...
          default: E(() => [
            c("div", Xv, [
              ...
              c("table", Zv, [
                ...
                c("tbody", null, [
                  (y(!0), C(pe, null, Ne(t(Da), ($) => (y(), C("tr", { key: $ }, [
