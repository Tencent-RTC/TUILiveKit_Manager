...
import { aT as _n, a3 as bn, b as In, e as Ln, ap as Sn, aM as Tn, c as wn, aL as An, b9 as Rn, aY as a, b8 as Mn, b2 as Ht, D as yt, b3 as cr, i as On, h as Dn, d as zr, b5 as xn, aX as be, ax as lr, aR as fr, X as lt, aI as Un, W as Br, aA as kn } from "./upload.BFIaIzq9.js";
import { s as Pn, ax as Fn, av as Gn, aG as W, H as Nt, aM as Vn, bq as Hr, br as Yr, b as Wn, W as zn, aZ as Kr, a$ as Bn, Z as Hn, bL as Yn, be as gr, bJ as Kn, bI as $n, bH as qn, bm as Xn, bd as jn, am as Zn, bl as Jn, bg as Qn, aI as ea, Y as ta, aj as vr, A as je, J as ke, aH as ra, aY as na, b1 as aa, b4 as Ut, g as Ue, ah as ia, bs as $r, t as dr, $ as oa, ak as Er, V as Nr, as as sa, bG as ca, ac as la, aJ as da, N as ua, aT as ha, a1 as ma, aC as pa, X as Yt, b7 as fa, bk as ga, aW as Ot, a3 as va, a8 as Ea, R as Rt, a6 as Na, b0 as Ca, aL as tt, i as ya, b9 as Cr, D as _a, a as Ye, n as Ze, o as Me, l as Oe, m as gt, bt as ba, v as qr, w as Pe, aP as Ia, u as Xr, aF as La, r as Sa, b6 as yr, p as _r, q as Ta, P as Kt, d as vt, e as Ae, C as Re, O as wa, aw as Aa } from "./main-layout.BU1yumQ_.js";
import { c as Ra, g as Ma, s as ur, a as Oa, D as Da, d as xa, e as Ua, m as ka, b as Pa, P as Fa } from "./gift-category.qmtjx5qb.js";
...
function Jr(r) {
  ...
  const B = A(async () => {
    ...
    R(!0), I(null);
    try {
      await Sn(n, b.memberAccounts, b.muteTime), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await Tn(n, b.memberAccounts), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await wn(n, b.memberAccounts, b.duration, b.reason), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    R(!0), I(null);
    try {
      await An(n, b.memberAccounts), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    if (!n) throw new Error("liveId is required");
    try {
      return await Rn(n, "default", "您的内容涉嫌违规");
    } catch (b) {
...
function Pt({
  ...
  return !o || p ? /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: Vn(n) }) : /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: /* @__PURE__ */ e(
    "img",
    {
      src: o,
      alt: d,
...
const Za = ({
  ...
  var H, D, Z, j, X;
  const { t: h } = ve(), { startPlay: N, stopPlay: m } = mt(), T = (H = yt().components) == null ? void 0 : H.liveMonitor, w = ((D = r.avatarUrl) == null ? void 0 : D.trim()) || "", E = (c == null ? void 0 : c.avatarUrl) || ((Z = r.anchor) == null ? void 0 : Z.avatarUrl) || w || Hr(r), S = (c == null ? void 0 : c.nick) || ((j = r.anchor) == null ? void 0 : j.nick) || Yr(r, h(a.UNKNOWN_HOST)), R = ((X = r.stats) == null ? void 0 : X.viewCount) ?? 0, C = _e(() => `live_monitor_view_${r.liveId}`, [r.liveId]), I = ee(""), P = ee(0), B = ee(null);
  return J(() => {
    const M = r.liveId;
    if (!M) return;
    const L = ++P.current;
    ...
    return (async () => {
      ...
      try {
        ...
        !y && P.current === L && ($ === kt.LOGIN_TIMEOUT || $ === kt.USER_SIG_ILLEGAL) && (On(), Dn(), localStorage.removeItem("tuiLiveMonitor-userInfo"), window.location.href = "/#/config-required");
      }
    })(), () => {
      y = !0, P.current += 1;
      const $ = I.current || M;
  ...
  const { pageSize: n, isSearchModeRef: t, isUnmountedRef: i, pageVersionRef: c } = r, [o, s] = _(/* @__PURE__ */ new Map()), p = ee(null), l = ee(""), d = A(() => {
    ...
    l.current = S;
    try {
      const { startTime: R, endTime: C } = f(), I = await xn(E, 10, R, C);
...
const Ft = on(function({
  ...
  const k = A(async (Q) => {
    ...
    if (T) {
      ne.current = Q, le(Q);
      const oe = Q.type.startsWith("video/"), Ee = jn(Q);
...
function Ai({ visible: r, onClose: n, onSuccess: t, uploadEnabled: i = !1, extraFieldsSlot: c, onCreate: o }) {
  ...
  const { t: s } = ve(), p = ta.map((F) => ({
    ...
    try {
      await ia(F), x("success", s(a.COPY_LABEL_COPIED, { label: te }));
    } catch (he) {
    ...
    ge,
    {
      ...
      children: N ? (
        ...
        /* @__PURE__ */ u(ut, { className: "create-live-form", labelWidth: lt(100), children: [
          ...
          /* @__PURE__ */ e(de, { label: s(a.LAYOUT_TEMPLATE), requiredMark: !0, help: s(((se = na(l.seatTemplate)) == null ? void 0 : se.descKey) || ""), children: /* @__PURE__ */ e(
            sr,
            {
              options: p,
          ...
          aa(l.seatTemplate) && /* @__PURE__ */ e(de, { label: s(a.MAX_SEATS), help: s(a.MAX_SEATS_HELP), children: /* @__PURE__ */ e(
            Qt,
            {
...
function Ri({ visible: r, live: n, onClose: t, onSuccess: i, uploadEnabled: c = !1, extraFieldsSlot: o, onUpdate: s, onFetchDetail: p }) {
  ...
  J(() => {
    n != null && n.coverUrl ? sa(n.coverUrl).then(w) : w(Nr);
  ...
  const X = () => {
    ...
    try {
      ...
      const Y = la(g), ne = da(m.current, Y);
      await H({
...
function Vt({
  ...
  mr(() => {
    ...
    const x = () => {
      ...
      const O = ((Y = w.current) == null ? void 0 : Y.clientWidth) ?? 0, U = xa(
        r,
        V,
        O,
        B
...
function Ao() {
  ...
  J(() => (l.init(), () => l.dispose()), []);
  const f = Ui(), g = _e(() => ha({ hasExtraColumn: !!(s != null && s.tableExtraColumns) }).map((y) => {
    switch (y.key) {
      case "liveId":
        return {
          ...y,
      ...
      case "createdAt":
        return {
          ...
          render: (x) => /* @__PURE__ */ e("span", { className: "live-list-text", children: pa(x.createdAt) })
        };
      case "customer-extra":
        return {
          ...y,
      ...
      /* @__PURE__ */ u("div", { className: "header-actions", children: [
        /* @__PURE__ */ e(
          fe,
          {
            ...
            suffixIcon: /* @__PURE__ */ e(rr, { size: 16 }),
            style: { width: 220 },
            status: W(w) > Yt ? "error" : "default",
            tips: W(w) > Yt ? n(a.INPUT_EXCEEDS_LENGTH_LIMIT) : ""
          }
        ),
        /* @__PURE__ */ e(
          K,
...
const Gi = 12 * 1024, Vi = (r) => new TextEncoder().encode(r).length, ct = { current: {} }, Wi = st.memo(
  ({ message: r, style: n }) => {
    var l, d;
    const t = r.sender.userId, i = t === ct.current.anchorUserId, c = r.sender.nameCard || r.sender.userName || t, o = r.messageType === 0 ? r.textContent : r.data || "", s = ga(o);
    return /* @__PURE__ */ u(
      "div",
      {
...
function Ro() {
  ...
  const F = ht({
    ...
    onSuccess: (k) => {
      var Fe;
      if (!k) return;
      const re = (Fe = k.anchor) == null ? void 0 : Fe.userId, ce = Yr(k, re || "-"), we = Hr(k);
      if (k.anchor ? Y({
