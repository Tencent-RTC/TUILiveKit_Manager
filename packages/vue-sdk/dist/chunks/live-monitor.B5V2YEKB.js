...
import { useUIKit as fe, i18next as Dt } from "@tencentcloud/uikit-base-component-react";
...
import { MessagePlugin as At, Dialog as pe, Button as K, Input as me, Select as sr, InputNumber as Qt, Checkbox as gn, Card as Wr, Tabs as Bt, Switch as vn, Tooltip as xe, Loading as En, Textarea as Nn } from "tdesign-react";
...
import { c as ma, g as pa, s as lr, a as fa, D as ga, d as va, e as Ea, m as Na, b as Ca, P as ya } from "./gift-category.qmtjx5qb.js";
...
const Za = ({
  ...
  var H, D, Z, j, X;
  const { t: h } = fe(), { startPlay: N, stopPlay: m } = mt(), S = (H = yt().components) == null ? void 0 : H.liveMonitor, w = ((D = r.avatarUrl) == null ? void 0 : D.trim()) || "", E = (c == null ? void 0 : c.avatarUrl) || ((Z = r.anchor) == null ? void 0 : Z.avatarUrl) || w || zr(r), M = (c == null ? void 0 : c.nick) || ((j = r.anchor) == null ? void 0 : j.nick) || Br(r, h(a.UNKNOWN_HOST)), O = ((X = r.stats) == null ? void 0 : X.viewCount) ?? 0, y = _e(() => `live_monitor_view_${r.liveId}`, [r.liveId]), I = te(""), P = te(0), z = te(null);
  return ee(() => {
    const A = r.liveId;
    if (!A) return;
    const L = ++P.current;
  ...
  const {
    ...
    fetchLiveDetail: l,
    isUnmountedRef: d
  } = r, f = _t(), { t: g } = fe(), [v, h] = b({ visible: !1, liveId: "", liveName: "", closing: !1 }), [N, m] = b({ visible: !1, liveId: "", liveName: "" }), [S, w] = b(!1), E = te(!1), [M, O] = b(!1), y = T((X, A) => {
...
const wo = () => {
  const { t: r } = fe(), { init: n, stopPlay: t, endLive: i, fetchLiveDetail: c, currentLive: o } = mt(), {
    currentPage: s,
    hasMoreData: p,
    loading: l,
    hasLiveData: d,
...
const Ft = an(function({
  ...
  const { t: y } = fe(), I = p || y(a.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), P = te(null), [z, H] = b(!1), [D, Z] = b(0), [j, X] = b(!1), [A, L] = b(""), [C, x] = b(!g), [$, _] = b(n), [W, F] = b(!1), [R, U] = b(""), Y = te(null);
  ...
  on(O, () => ({
    ...
    validateImageUrl: async (Q, se) => {
      ...
      try {
        ...
        const ze = ge instanceof Error ? ge : new Error(String(ge));
  ...
  const k = T(async (Q) => {
    ...
    if (S) {
      ne.current = Q, le(Q);
      const se = Q.type.startsWith("video/"), ge = Dn(Q);
      Se(se), J(ge), w == null || w(Q);
      return;
    }
    H(!0), Z(0);
    try {
      ...
      const ge = se instanceof Error ? se : new Error(String(se));
      q.error(y(a.UPLOAD_FAILED_WITH_ERROR, { error: ge.message || y(a.NETWORK_ERROR) }));
    } finally {
      H(!1), Z(0);
    }
  }, ce = async () => {
    ...
    g && !C && /* @__PURE__ */ u(ue, { children: [
      ...
      /* @__PURE__ */ e(
        "input",
        {
          ...
          onChange: (Q) => {
            var ge;
            const se = (ge = Q.target.files) == null ? void 0 : ge[0];
...
function Ri({ visible: r, live: n, onClose: t, onSuccess: i, uploadEnabled: c = !1, extraFieldsSlot: o, onUpdate: s, onFetchDetail: p }) {
  var _, W;
  const { t: l } = fe(), [d, f] = b(vr()), [g, v] = b([]), [h, N] = b(!1), m = te([]), [S, w] = b(Er), [E, M] = b(!1), [O, y] = b(""), [I, P] = b(""), { loading: z, execute: H } = ht({
    action: async (F) => {
...
const Gi = 12 * 1024, Vi = (r) => new TextEncoder().encode(r).length, ct = { current: {} }, Wi = st.memo(
  ...
  const { t: s } = fe(), { loginUserInfo: p } = Xr(), { audienceList: l, disableSendMessage: d } = Ba(), [f, g] = b(!1), [v, h] = b({ top: 0, left: 0 }), [N, m] = b(null), [S, w] = b(""), [E, M] = b(!1), O = te(null), y = te(null), I = n;
  ct.current.t = s;
...
function Mo() {
  const { t: r } = fe(), n = jr(), t = _t(), i = lo(), c = te(null);
...
function Oo() {
  const { t: r } = fe(), n = _t(), t = jr(), i = te(null);
...
function mt() {
  ...
  he || (he = new ua({
    ...
    l.current = !1, ot = !1, Ct.delete(p), setTimeout(() => {
      ot || (he == null || he.destroy(), he = null, oe == null || oe.destroy(), oe = null);
    }, 100);
  }), []);
  const d = T((P) => {
    he == null || he.init(P), oe == null || oe.goToFirstPage().catch((z) => {
    ...
    return s.pageData;
  }, []), g = T(async (P) => he.createLive(P), []), v = T(async (P) => he.updateLive(P), []), h = T(async (P) => he.endLive(P), []), N = T(async (P) => he.fetchLiveDetail(P), []), m = T(async (P) => he.fetchLiveStats(P), []), S = T((P) => {
    he == null || he.setCurrentLive(P);
  }, []), w = T(async (P) => he.stopPlay(P), []), E = T(async (P) => he.startPlay(P), [w]), M = T(() => (oe == null ? void 0 : oe.nextPage()) ?? Promise.resolve(), []), O = T(() => (oe == null ? void 0 : oe.prevPage()) ?? Promise.resolve(), []), y = T(() => (oe == null ? void 0 : oe.goToFirstPage()) ?? Promise.resolve(), []), I = T(() => (oe == null ? void 0 : oe.refreshCurrentPage()) ?? Promise.resolve(), []);
  return {
    init: d,
    liveList: r,
    hasMore: t,
