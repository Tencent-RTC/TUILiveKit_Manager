import { bq as g, bo as p, g as d } from "./main-layout.D1ZA8pmk.js";
import { a as w, v } from "./PreviewUrlController.hXJPBpPi.js";
import { aR as m, L as b } from "./layout.CKxcF5ct.js";
...
async function N(r, t = "cover", a) {
  ...
  if (e.code !== 0)
    throw new b(e.message || "", e.code, void 0, "uploadImage");
  return e.data;
}
export {
  u as I,
