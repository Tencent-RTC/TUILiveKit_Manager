...
import { aW as gt, g as wt, I as m, c as Ct } from "./layout.CKxcF5ct.js";
...
import { g as pe, bo as Ge, by as Dt, bn as xt, ax as At, bx as bt, bq as Mt } from "./main-layout.D1ZA8pmk.js";
import { i as zt, g as It } from "./PreviewUrlController.hXJPBpPi.js";
import { U as Nt, u as Ze, k as Ut, i as Ot, h as Lt, v as Tt, g as Wt } from "./upload.GtMjhtad.js";
import { s as Je } from "./svga.min.Zof6g_Kl.js";
import { M as $ } from "./useAsyncAction.BEfuTbHp.js";
import { u as Ft, a as Vt } from "./useT.BpiWhAmu.js";
var Ae = function(a, r) {
...
const Er = vt(function({
  ...
  const { t: f } = Pt(), { opSuccess: ve, opFailed: G } = Ct(f), ie = s || f(m.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), U = Y(null), [M, Z] = S(!1), [K, k] = S(0), [Qe, ee] = S(!1), [me, ae] = S(""), [x, X] = S(!h), [b, se] = S(r), [ge, j] = S(!1), [W, O] = S(""), A = Y(null);
