...
import { c as ne, D as se, a as ie, b as le, m as oe, d as ce } from "./action-buttons.CpIwJxCI.js";
function ae(r) {
  const l = h(r);
  l.current = r, V(() => {
    const a = () => l.current();
...
function me({
  ...
  I(() => {
    ...
    const n = () => {
      ...
      for (const { column: c } of e)
        v[c.key] !== void 0 && (B[c.key] = ce(v[c.key], c.minWidth, c.maxWidth));
      S.current = B;
    }, m = () => {
      const o = S.current;
  ...
  return V(() => {
  ...
  }, []), /* @__PURE__ */ W("div", { ref: _, className: `fixed-header-table ${i}`.trim(), children: [
    ...
    /* @__PURE__ */ s("div", { ref: R, className: `fixed-header-table__body ${z}`.trim(), style: P, children: $ ? /* @__PURE__ */ s("div", { className: "fixed-header-table__loading", children: G }) : l.length === 0 ? /* @__PURE__ */ s("div", { className: "fixed-header-table__empty", children: K }) : /* @__PURE__ */ W(
      "table",
      {
        ref: A,
        className: `fixed-header-table__table ${u}`.trim(),
