...
import { c as wi } from "./logger.rNWqpx5t.js";
import { I as M } from "./layout.LLpP3S0z.js";
import { g as yi, bo as vt, bx as bt, bq as zi, by as Ri, bn as Ai, bp as Mi, aE as Si } from "./main-layout.DjCTrpgR.js";
import { i as xi, g as Ei } from "./PreviewUrlController.BpR7cymA.js";
import { U as Ci, k as Ti, u as wt, i as Ii, h as Wi, v as Di, a as Pi } from "./upload._M0taK95.js";
import { u as Li, a as Oi } from "./useSvgaPlayer.C9PMwodW.js";
import "./useAsyncAction.Bu5lrvze.js";
import { _ as Hi } from "./_plugin-vue_export-helper.CHgC5LLL.js";
function yt(e, t) {
  var i = Object.keys(e);
...
}, zt(Te = { path: ki, exports: {}, require: function(e, t) {
  return (function() {
...
var ze = function(e, t) {
  ...
  if (this.touches.length) {
    if (this.touches.length === 1 && i.length === 1) {
      ...
      this.$emit("drag", new Bi(e, o, { left: i[0].clientX, top: i[0].clientY }, { left: this.touches[0].clientX, top: this.touches[0].clientY }, this.anchor));
    }
    this.touches = i;
  }
}, processEnd: function() {
...
var ji = Z("vue-line-wrapper"), kt = { name: "LineWrapper", components: { DraggableElement: tt }, props: { position: { type: String, required: !0 }, disabled: { type: Boolean, default: !1 } }, computed: { classname: function() {
  var e;
  return ji((V(e = {}, this.position, !0), V(e, "disabled", this.disabled), e));
} }, emits: ["leave", "enter", "drag", "drag-end"] };
...
var K = ["left", "right", "top", "bottom"], _i = ["left", "right"], Fi = ["top", "bottom"], Vi = ["left", "top"], Xi = ["fill-area", "fit-area", "stencil", "none"], Mt = { left: 0, top: 0, width: 0, height: 0 };
function St(e, t, i) {
...
function Ct(e) {
  ...
  } else d.width !== 1 / 0 && _i.forEach((function(w) {
    a[w] *= d.width;
  })), d.height !== 1 / 0 && Fi.forEach((function(w) {
    a[w] *= d.height;
  }));
  return a;
}
...
var sn = Z("vue-simple-handler"), an = Z("vue-simple-handler-wrapper"), it = { name: "SimpleHandler", components: { HandlerWrapper: Ut }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, horizontalPosition: { type: String }, verticalPosition: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  return { hover: !1 };
  ...
  return { default: D(sn(t), this.defaultClass, this.hover && this.hoverClass), wrapper: D(an(t), this.wrapperClass) };
...
var rn = Z("vue-simple-line"), hn = Z("vue-simple-line-wrapper"), nt = { name: "SimpleLine", components: { LineWrapper: kt }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, position: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  return { hover: !1 };
}, computed: { classes: function() {
  return { root: D(rn(V({}, this.position, !0)), this.defaultClass, this.hover && this.hoverClass), wrapper: D(hn(V({}, this.position, !0)), this.wrapperClass) };
} }, methods: { onDrag: function(e) {
  this.$emit("drag", e);
}, onEnter: function() {
  this.hover = !0;
...
var Xe = Z("vue-bounding-box"), ln = ["east", "west", null], cn = ["south", "north", null], _t = { name: "BoundingBox", props: { width: { type: Number }, height: { type: Number }, transitions: { type: Object }, handlers: { type: Object, default: function() {
  ...
  t === "west" ? h.left -= n : t === "east" && (h.right += n), i === "north" ? h.top -= r : i === "south" && (h.bottom += r), !i && t ? o = "width" : i && !t && (o = "height"), this.resizable && this.$emit("resize", new $i(h, { allowedDirections: { left: t === "west" || !t, right: t === "east" || !t, bottom: i === "south" || !i, top: i === "north" || !i }, preserveAspectRatio: e.nativeEvent && e.nativeEvent.shiftKey, respectDirection: o }));
...
var un = Z("vue-draggable-area"), Ft = { name: "DraggableArea", props: { movable: { type: Boolean, default: !0 }, activationDistance: { type: Number, default: 20 } }, computed: { classnames: function() {
  return { default: un() };
} }, beforeMount: function() {
  window.addEventListener("mouseup", this.onMouseUp, { passive: !1 }), window.addEventListener("mousemove", this.onMouseMove, { passive: !1 }), window.addEventListener("touchmove", this.onTouchMove, { passive: !1 }), window.addEventListener("touchend", this.onTouchEnd, { passive: !1 });
}, beforeUnmount: function() {
...
var mn = ["transitions"], ee = Z("vue-advanced-cropper"), Gt = { name: "Cropper", components: { BackgroundWrapper: Je }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  return ot;
  ...
  s || (s = this.stencilSize ? Gi : this.autoZoom ? Zi : qi);
  ...
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i = t.transitions, o = i !== void 0 && i, s = Ui(t, mn), n = this.processAutoZoom(e, this.visibleArea, this.coordinates, s), r = n.visibleArea, h = n.coordinates, a = n.changed;
  ...
  var t = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], i = this.visibleArea && t ? Ni(this.sizeRestrictions, this.visibleArea) : this.sizeRestrictions, o = this.visibleArea && t ? We(this.positionRestrictions, this.visibleArea) : this.positionRestrictions;
  return Yi({ transform: e, coordinates: this.coordinates, imageSize: this.imageSize, sizeRestrictions: i, positionRestrictions: o, aspectRatio: this.getAspectRatio(), visibleArea: this.visibleArea });
}, resetCoordinates: function() {
  var e = this;
  if (this.$refs.image) {
    this.$refs.cropper, this.$refs.image;
    var t = this.defaultSize;
    t || (t = this.stencilSize ? Ji : Qi);
    var i = this.sizeRestrictions;
    i.minWidth, i.minHeight, i.maxWidth, i.maxHeight;
    var o = de(t) ? t({ boundaries: this.boundaries, imageSize: this.imageSize, aspectRatio: this.getAspectRatio(), sizeRestrictions: this.sizeRestrictions, stencilSize: this.getStencilSize(), visibleArea: this.visibleArea }) : t, s = this.defaultPosition || Ki, n = [o, function(r) {
      var h = r.coordinates;
  ...
  return this.appliedImageTransforms = z(z({}, this.defaultImageTransforms), {}, { flip: z({}, this.defaultImageTransforms.flip) }), this.updateBoundaries().then((function() {
    ...
    var t, i, o, s, n, r, h = e.defaultVisibleArea || en;
  ...
  if (!this.transitionsOptions.enabled) {
    ...
    var r = tn(z(z({}, this.getPublicProperties()), {}, { event: n ? this.normalizeEvent(e) : e, getAreaRestrictions: this.getAreaRestrictions, imageRestriction: this.imageRestriction, adjustStencil: !this.stencilSize && this.settings.resizeImage.adjustStencil })), h = r.visibleArea, a = r.coordinates;
...
Gt.render = function(e, t, i, o, s, n) {
  return v(), E("div", { ref: "cropper", class: n.classes.cropper }, [x("div", { ref: "stretcher", class: n.classes.stretcher }, null, 2), x("div", { class: n.classes.boundaries, style: n.boundariesStyle }, [(v(), E(Oe(i.backgroundWrapperComponent), { class: n.classes.cropperWrapper, "wheel-resize": n.settings.resizeImage.wheel, "touch-resize": n.settings.resizeImage.touch, "touch-move": n.settings.moveImage.touch, "mouse-move": n.settings.moveImage.mouse, onMove: n.onManipulateImage, onResize: n.onManipulateImage }, { default: F((function() {
    ...
    }), ["prevent"])) }, null, 46, ["crossorigin", "src"])], 2), x("div", { class: n.classes.foreground, style: n.boundariesStyle }, null, 6), It((v(), E(Oe(i.stencilComponent), Dt({ ref: "stencil", image: n.image, coordinates: s.coordinates, "stencil-coordinates": n.stencilCoordinates, transitions: n.transitionsOptions }, i.stencilProps, { onResize: n.onResize, onResizeEnd: n.onResizeEnd, onMove: n.onMove, onMoveEnd: n.onMoveEnd }), null, 16, ["image", "coordinates", "stencil-coordinates", "transitions", "onResize", "onResizeEnd", "onMove", "onMoveEnd"])), [[Wt, s.imageLoaded]]), i.canvas ? (v(), E("canvas", pn, null, 512)) : G("", !0), i.canvas ? (v(), E("canvas", gn, null, 512)) : G("", !0)];
  })), _: 1 }, 8, ["class", "wheel-resize", "touch-resize", "touch-move", "mouse-move", "onMove", "onResize"]))], 6)], 2);
};
const vn = { class: "image-upload-container" }, bn = {
  key: 0,
...
}, An = { class: "image-upload-progress-circle" }, Mn = ["stroke-dasharray"], Sn = ["src"], xn = ["src"], En = {
  key: 2,
...
}, Fn = { class: "image-crop-footer" }, Vn = { class: "btn-content" }, Xn = /* @__PURE__ */ ui({
  __name: "ImageUpload",
  props: {
    modelValue: { default: "" },
    type: { default: "cover" },
  ...
  setup(e, { expose: t, emit: i }) {
    const o = wi("ImageUpload"), { t: s } = bi(), { opSuccess: n, opFailed: r } = bindI18nHelpers(s);
    xi(gt.Parser);
    const h = e, a = i, l = Ee(() => h.placeholder || s(M.CLICK_OR_DRAG_TO_UPLOAD_COVER_IMAGE)), c = Ee(() => h.urlPlaceholder || s(M.ENTER_IMAGE_URL)), u = Ee(() => h.acceptHint || s(M.SUPPORTS_IMAGE_FORMATS_MAX_MB, { max: h.maxSize })), d = T(null), m = T(null), b = T(!1), w = T(0), I = T(!1), L = T(""), C = T(!h.uploadEnabled), U = T(h.modelValue), _ = T(null), { previewUrl: $e, setPreview: Ae } = Li(), ge = T(!1), ve = T(!1), {
      containerRef: Zt,
      playUrl: qt
    } = Oi({ loop: 1, autoPlay: !0 }), Be = T(null);
    let be = null;
    function we() {
      if (be) {
        try {
    ...
    async function ht(f) {
      ...
      try {
        await Di(f, h.accept, h.skipSvgaValidation);
      } catch (S) {
    ...
    async function ti() {
      if (!(!oe.value || !m.value))
        try {
          const { canvas: f } = m.value.getResult(), g = await Pi(f, "image/jpeg", 0.92);
    ...
    return t({
      ...
      return v(), A("div", vn, [
        e.uploadEnabled && e.showUrlInput ? (v(), A("div", bn, [
          W("button", {
        ...
        C.value || !e.uploadEnabled ? (v(), A("div", wn, [
          x(S, {
            "model-value": U.value,
            ...
            e.maxBytes ? {
              name: "suffix",
              fn: F(() => [
                se.value ? (v(), A("span", yn, $(y(s)(y(M).VALIDATING)), 1)) : (v(), A("span", {
                  key: 1,
        ...
        B.value && (C.value || !e.uploadEnabled) ? (v(), A("div", zn, $(B.value), 1)) : G("", !0),
        e.uploadEnabled && !C.value ? (v(), A(ye, { key: 3 }, [
          y($e) ? (v(), A("div", {
            ...
            !b.value && L.value ? (v(), A("span", En, $(L.value.toUpperCase()), 1)) : G("", !0),
            !b.value && I.value ? (v(), A("span", Cn, $(y(r)(y(M).OP_UPLOAD, y(M).IMAGE)), 1)) : !b.value && !L.value ? (v(), A("span", Tn, $(y(s)(y(M).PENDING_UPLOAD)), 1)) : G("", !0),
            b.value ? G("", !0) : (v(), A("div", In, [
              W("button", {
        ...
        e.modelValue && (C.value || !e.uploadEnabled) ? (v(), A("div", {
          ...
          y(vt)(e.modelValue) ? (v(), A("div", {
            ...
            ref: Be,
            class: "svga-preview-container"
          }, null, 512)) : y(zi)(e.modelValue) ? (v(), A("video", {
            key: 1,
            src: e.modelValue,
            muted: "",
            loop: "",
...
}), so = /* @__PURE__ */ Hi(Xn, [["__scopeId", "data-v-2cf08bba"]]);
export {
  so as I
};
