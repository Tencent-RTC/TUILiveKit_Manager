...
import { ag as O, ai as $, bm as B, bD as G, bE as W, u as j, m as Q, H as X, bF as Y, ah as J } from "./main-layout.DMGRi_CK.js";
import { c as R, r as i } from "./logger.DfjyL4S7.js";
import { M as Z, Y as ee, X as te, af as re, ai as ae } from "./en-US.BxRaQHCQ.js";
...
function he(c) {
  ...
  return {
    ...
    unbanMember: async (t) => {
      ...
      e.value = !0, o.value = null;
      try {
        await G(r, t.memberAccounts), await C(), i("risk_control", "unban", !0, r);
      } catch (a) {
    ...
    sendViolationWarning: async () => {
      if (!r) throw new Error("liveId is required");
      try {
        const t = await B(r, "default", Z.VIOLATION_SUGGESTION_DEFAULT);
