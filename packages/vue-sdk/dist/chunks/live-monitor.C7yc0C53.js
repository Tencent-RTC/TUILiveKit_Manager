...
import { au as ce, as as ue, m as le, u as de, bI as fe, bJ as ge, br as me, R as he, Q as be } from "./main-layout.D1Nd74n1.js";
import { c as z, n as Me, h as s, j as B } from "./logger.BVGT9iyh.js";
import { aL as F, aM as ve, Y as we, aN as O, ay as V, V as ye, aO as pe, af as Le, aP as Se, ag as Ce, aQ as Pe, aG as Te } from "./layout.CDdU53J3.js";
import "tdesign-react";
const h = z("RiskControl");
function De(c) {
  const { liveId: t, pageSize: w } = c, [b, p] = u("cloud"), [L, M] = u(!1), [S, C] = u(0), [P, x] = u(!0), [T, R] = u([]), [A, D] = u(1), [_, U] = u(0), [o, i] = u(!1), [m, G] = u([]), [Q, W] = u([]), [j, d] = u(!1), [H, f] = u(null), v = K(!0);
  $(() => {
    v.current = !0, Me("risk_control");
    const e = (r) => {
      const g = r === "cloud";
      (g ? V : O)({ pageSize: 1 }).then(() => {
  ...
  const J = a(async () => {
    ...
    try {
      let r;
      return b === "custom" ? r = await O({ pageSize: w, liveId: t, ...e }) : r = await V({ pageSize: w, liveId: t, ...e }), v.current && (R(r.list || []), D(e.pageNum || 1), U(r.total || 0)), r;
    } catch (r) {
