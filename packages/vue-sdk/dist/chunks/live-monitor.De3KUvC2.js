import { useState as l, useRef as q, useEffect as U, useCallback as n } from "react";
import { ai as J, ag as Z, m as ee, u as te, bE as re, bD as ae, bm as ne, H as oe, bF as se, ah as ie } from "./main-layout.zkqp5e6A.js";
import { c as B, r as s } from "./logger.DfjyL4S7.js";
import { ai as ce, af as ue, M as le, X as de, Y as fe } from "./en-US.BxRaQHCQ.js";
import "tdesign-react";
const b = B("RiskControl");
function Le(i) {
  const { liveId: e, pageSize: v } = i, [M, h] = l(!1), [y, w] = l(0), [L, T] = l([]), [x, I] = l(1), [_, R] = l(0), [D, C] = l(!1), [k, E] = l([]), [r, c] = l([]), [g, d] = l(!1), [$, f] = l(null), p = q(!0);
  U(() => (p.current = !0, () => {
    p.current = !1;
  }), []);
  const K = n(async () => {
...
function Se() {
  const [i, e] = l([]), [v, M] = l(!0), [h, y] = l(null), w = q(!0);
  u || (u = new oe({
    onStateChange: (r) => {
      F.forEach((c) => c(r));
    },
    ...
    return m.add(c), o && c(o.getSnapshot()), () => {
      w.current = !1, F.delete(r), m.delete(c);
    };
  }, []);
  const L = n((r) => {
