...
import { s as mt } from "./svga.min.oQNdj2nc.js";
import { useUIKit as pi } from "@tencentcloud/uikit-base-component-vue3";
import { c as gi } from "./logger.DfjyL4S7.js";
import { Z as I } from "./error-message.BVYzOzgW.js";
import { aq as vi, aS as ft, a_ as pt, aU as bi, a$ as wi, aR as yi, aT as zi, ad as Ri } from "./main-layout.DNAtZmGx.js";
import { i as Ai, g as Si } from "./svga.DC02l1-t.js";
import { U as Mi, k as xi, u as gt, i as Ei, h as Ci, v as Ti, a as Wi } from "./upload.DS3rw9rR.js";
import { u as Ii } from "./usePreviewUrl.CH-75hRy.js";
import { a as Di } from "./useAsyncAction.DLKsoMoX.js";
...
function Ni(e) {
  ...
  var w = Le(d = V(d, c.width * i.width / (d.width * f.width)), t({ visibleArea: d, type: "resize" }));
  return w !== 1 && (d = V(d, w), c = V(c, w)), d = L(d = k(d, me(P(c), P(d))), t({ visibleArea: d, type: "move" })), { coordinates: c = L(c, Oe(q(d), h)), visibleArea: d };
}
function Xi(e) {
  ...
  if (s && n && t.type !== "manipulateImage") {
    ...
    a = V(a, u), u !== 1 && (l.height /= u, l.width /= u), a = L(a = k(a, me(P(h), P(a))), i({ visibleArea: a, type: "move" })), h = L(h, Oe(q(a), r));
  }
...
function Yi(e) {
  ...
  if (t.type === "setCoordinates") {
    ...
    h > a ? n = V(n, Math.min(r.width / n.width, fe(n, s({ visibleArea: n, type: "resize" })))) : a > h && (n = V(n, Math.min(r.height / n.height, fe(n, s({ visibleArea: n, type: "resize" }))))), n = L(n = k(n, Pe(pe(r, q(n)))), s({ visibleArea: n, type: "move" }));
  }
...
function Qi(e) {
  ...
  a.factor && w && (a.factor < 1 ? (f = Math.max(a.factor, b.stencil.minimum)) > 1 && (f = 1) : a.factor > 1 && (f = Math.min(a.factor, Math.min(b.area.maximum, b.stencil.maximum))) < 1 && (f = 1)), f && (u = V(u, f, a.center));
  var S = i.left - o.left, O = o.width + o.left - (i.width + i.left), K = i.top - o.top, Q = o.height + o.top - (i.height + i.top);
  return u = L(u = k(u, pe(u, { left: r.left !== void 0 ? r.left - S * f : void 0, top: r.top !== void 0 ? r.top - K * f : void 0, bottom: r.bottom !== void 0 ? r.bottom + Q * f : void 0, right: r.right !== void 0 ? r.right + O * f : void 0 })), n({ visibleArea: u, type: "move" })), c.width = c.width * f, c.height = c.height * f, c.left = u.left + S * f, c.top = u.top + K * f, c = L(c, Oe(q(u), r)), a.factor && w && h && (a.factor > 1 ? d = Math.min(b.area.maximum, a.factor) / f : a.factor < 1 && (d = Math.max(c.height / u.height, c.width / u.width, a.factor / f)), d !== 1 && (u = k(u = L(u = V(u, d, a.factor > 1 ? a.center : P(c)), n({ visibleArea: u, type: "move" })), Pe(pe(c, q(u)))))), { coordinates: c, visibleArea: u };
}
function Ji(e) {
  ...
  return (u = p(p({}, te({ sizeRestrictions: n, aspectRatio: t, width: u.width, height: u.height })), ne(P(u), l))).left -= d.left - h.width / 2 + u.width / 2, u.top -= d.top - h.height / 2 + u.height / 2, c = V(c, Le(c, i({ visibleArea: c, type: "resize" }))), { coordinates: u = L(u, r), visibleArea: c = L(c = k(c, me(P(u), P(o))), i({ visibleArea: c, type: "move" })) };
}
function en(e) {
  ...
  if (u || c) {
    var d = ne({ left: h.width / 2, top: h.height / 2 }, -o), f = ne(P(a), -o), w = ne({ left: u ? d.left - (f.left - d.left) : f.left, top: c ? d.top - (f.top - d.top) : f.top }, o);
    a = k(a, me(w, P(a))), f = ne(P(l), -o), l = L(l = k(l, me(w = ne({ left: u ? d.left - (f.left - d.left) : f.left, top: c ? d.top - (f.top - d.top) : f.top }, o), P(l))), s({ visibleArea: l, type: "move" }));
  }
...
var un = ["transitions"], ee = Y("vue-advanced-cropper"), Nt = { name: "Cropper", components: { BackgroundWrapper: qe }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  ...
  return r = L(r = k(r, me(P(i), P(r))), Oe(q(t), n));
...
Nt.render = function(e, t, i, o, s, n) {
  return v(), E("div", { ref: "cropper", class: n.classes.cropper }, [M("div", { ref: "stretcher", class: n.classes.stretcher }, null, 2), M("div", { class: n.classes.boundaries, style: n.boundariesStyle }, [(v(), E(De(i.backgroundWrapperComponent), { class: n.classes.cropperWrapper, "wheel-resize": n.settings.resizeImage.wheel, "touch-resize": n.settings.resizeImage.touch, "touch-move": n.settings.moveImage.touch, "mouse-move": n.settings.moveImage.mouse, onMove: n.onManipulateImage, onResize: n.onManipulateImage }, { default: B((function() {
    ...
    }), ["prevent"])) }, null, 46, ["crossorigin", "src"])], 2), M("div", { class: n.classes.foreground, style: n.boundariesStyle }, null, 6), Et((v(), E(De(i.stencilComponent), Tt({ ref: "stencil", image: n.image, coordinates: s.coordinates, "stencil-coordinates": n.stencilCoordinates, transitions: n.transitionsOptions }, i.stencilProps, { onResize: n.onResize, onResizeEnd: n.onResizeEnd, onMove: n.onMove, onMoveEnd: n.onMoveEnd }), null, 16, ["image", "coordinates", "stencil-coordinates", "transitions", "onResize", "onResizeEnd", "onMove", "onMoveEnd"])), [[Ct, s.imageLoaded]]), i.canvas ? (v(), E("canvas", dn, null, 512)) : X("", !0), i.canvas ? (v(), E("canvas", mn, null, 512)) : X("", !0)];
...
const fn = { class: "image-upload-container" }, pn = {
  ...
  setup(e, { expose: t, emit: i }) {
    ...
    Ai(mt.Parser);
    const n = e, r = i, h = ke(() => n.placeholder || s(I.CLICK_OR_DRAG_TO_UPLOAD_COVER_IMAGE)), a = ke(() => n.acceptHint || s("Supports JPG/PNG/GIF/WebP max {max}MB", { max: n.maxSize })), l = C(null), u = C(null), c = C(!1), d = C(0), f = C(!1), w = C(""), b = C(!n.uploadEnabled), S = C(n.modelValue), O = C(null), { previewUrl: K, setPreview: Q } = Ii(), _ = C(!1), ge = C(!1), {
      containerRef: Xt,
      playUrl: Yt
    ...
    function Se() {
      if (!Ae.value) return;
      const m = Ae.value.clientWidth, g = Ae.value.clientHeight || 320, x = m / g, $ = n.aspectRatio || 16 / 9;
      let le, J;
      $ > x ? (le = Math.min(m, 500), J = le / $) : (J = Math.min(g, 320), le = J * $), nt.value = { width: Math.round(le), height: Math.round(J) };
    }
    ce(ie, async (m) => {
    ...
    ce(() => n.skipSvgaValidation, (m) => {
      N.updateSkipSvgaValidation(!!m);
    });
    const Ue = ke(() => vi(S.value));
    ce(() => n.modelValue, (m) => {
      S.value = m, U.value = "", m && n.uploadEnabled && (b.value = !0), n.deferUpload && (O.value = null, Q(null), _.value = !1, ge.value = !1, r("fileReady", null));
    ...
    async function rt(m) {
      if (n.deferUpload) {
        O.value = m, Q(m);
        const g = yi(m), x = zi(m);
        _.value = x, ge.value = g, r("fileReady", m), g && Gt(previewUrl);
        return;
      }
      c.value = !0, d.value = 0;
      try {
        const g = await gt(m, n.type, (x) => {
          d.value = x;
        });
    ...
    function ii(m) {
      m && typeof m == "object" && "target" in m && m.preventDefault(), N.handleUrlBlur(
        S.value,
        n.maxBytes
      );
    }
    function ni(m) {
      typeof m == "string" && (S.value = m, U.value = "", N.cancelValidation(), se.value = !1);
    }
    function oi(m) {
      m && typeof m == "object" && "target" in m && m.preventDefault(), N.handleUrlEnter(
        S.value,
        n.maxBytes
      );
    }
    function si(m) {
      m?.stopPropagation(), N.cancelValidation(), se.value = !1, U.value = "", r("update:modelValue", ""), S.value = "", w.value = "", c.value = !1, d.value = 0, f.value = !1, be(), n.deferUpload && (O.value = null, Q(null), _.value = !1, ge.value = !1, r("fileReady", null));
    }
    function ai(m) {
    ...
    return t({
      ...
      reset() {
        N.reset(), O.value = null, Q(null), _.value = !1, ge.value = !1, be(), S.value = n.modelValue || "", w.value = "", U.value = "", c.value = !1, d.value = 0, f.value = !1, n.uploadEnabled && (b.value = !!n.modelValue), r("fileReady", null);
      },
      /**
      ...
      return v(), A("div", fn, [
        ...
        e.uploadEnabled && !b.value ? (v(), A(we, { key: 3 }, [
          y(K) ? (v(), A("div", {
            ...
            !c.value && f.value ? (v(), A("span", Mn, H(y(s)(y(I).UPLOAD_FAILED)), 1)) : !c.value && !w.value ? (v(), A("span", xn, H(y(s)(y(I).PENDING_UPLOAD)), 1)) : X("", !0),
