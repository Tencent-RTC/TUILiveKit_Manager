...
import { P as h } from "./PreviewUrlController.D1r9dOPU.js";
import { s as d } from "./svga.min.Zof6g_Kl.js";
import { h as V, b4 as G } from "./shared-state.Bf8CkvaR.js";
...
function j(n = {}) {
  ...
  async function m(e) {
    ...
    f();
    const l = i.value, c = new d.Player(l);
    r = c;
    const w = G();
    if (!w) {
