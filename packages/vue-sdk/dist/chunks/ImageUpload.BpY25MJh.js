...
import { q as ft, c as mt } from "./logger.DRLw23-l.js";
...
import { I as W } from "./layout.5hoGLPKE.js";
import { az as le, b1 as Le, ba as St, b0 as _t, ae as Et, b9 as Pt, b3 as xt } from "./main-layout.DZAH01ts.js";
import { i as Dt, g as bt } from "./svga.DC02l1-t.js";
import { U as zt, u as Oe, k as Mt, i as At, h as It, v as Nt, g as Ut } from "./upload.BgSyI6V-.js";
import { s as $e } from "./svga.min.Zof6g_Kl.js";
import { M as Y } from "./useAsyncAction.C0qrahtw.js";
import { u as Tt } from "./usePreviewUrl.O79KeX0m.js";
import { u as Wt } from "./useSvgaPlayer.BqPjB7q1.js";
var Pe = function(a, r) {
...
const Rr = ht(function({
  ...
  const { t: v } = Rt(), k = s || v(W.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), J = X(null), [N, F] = S(!1), [b, M] = S(0), [he, Q] = S(!1), [de, ne] = S(""), [x, q] = S(!d), [z, ie] = S(r), [fe, j] = S(!1), [L, U] = S(""), D = X(null);
  D.current || (D.current = new zt({
    setValidating: j,
    setError: U,
    onConfirm: e
  ...
  dt(Z, () => ({
    ...
    get hasUrlError() {
      return x ? !!(L || g && z.trim() && le(z.trim()) > g) : !1;
    },
    get urlInputValue() {
      return z;
    },
    ...
    reset: () => {
      D.current.reset(), K.current = null, $(null), me(!1), ae(!1), ie(r || ""), ne(""), U(""), F(!1), M(0), Q(!1), d && q(!!r), I?.(null);
    },
    ...
    uploadPendingFile: async () => {
      ...
      try {
        ...
        return K.current = null, ne(f.provider || ""), Q(!1), f.url;
      } catch (f) {
        throw Q(!0), f;
      } finally {
        F(!1), M(0);
  ...
  }), [t, x, fe, L, z, O, r, g, e, v]), H(() => {
    ie(r), r && d && q(!0), w && (K.current = null, $(null), ae(!1), I?.(null));
  }, [r]), H(() => {
    d && r ? q(!0) : d && q(!1);
  }, [d]), H(() => {
    if (!R) return;
    let p = !1;
    (x || !d) && (L || g && z.trim() && le(z.trim()) > g) && (p = !0), R(p);
  }, [x, L, z, g, d, R]);
  const De = X(r);
  H(() => {
  ...
  H(() => {
    ...
    const p = ge.current, f = new $e.Player(p);
  ...
  const [Qe, ee] = S(!1), [te, be] = S(""), [et, ze] = S({ x: 0, y: 0 }), [tt, Me] = S(1), [Ae, Ie] = S(null), [ar, rt] = S(null), [Ne, Ue] = S(!1), ot = Ce((p, f) => {
    Ie(f);
  }, []), [nt, Te] = S(!1), re = X(null);
  H(() => () => {
  ...
  const we = Ce(async (p) => {
    ...
    p?.stopPropagation(), D.current.cancelValidation(), j(!1), U(""), e(""), ie(""), ne(""), F(!1), M(0), Q(!1), w && (K.current = null, $(null), me(!1), ae(!1), I?.(null));
  };
  return /* @__PURE__ */ A("div", { className: `image-upload-container ${P}`, children: [
    ...
    (x || !d) && /* @__PURE__ */ h("div", { className: "image-upload-url-input", children: /* @__PURE__ */ h(
      Ct,
      {
        ...
        suffix: g ? fe ? /* @__PURE__ */ h("span", { className: "input-suffix-validating", children: v("Validating") }) : /* @__PURE__ */ A("span", { className: `input-suffix-count${le(z) > g ? " byte-overflow" : ""}`, children: [
          le(z),
          "/",
          g
        ] }) : void 0
      ...
      O ? /* @__PURE__ */ A(
        "div",
        {
          ...
          children: [
            N ? (
              // 正在上传时显示进度条覆盖层
              /* @__PURE__ */ h("div", { className: "image-upload-uploading-overlay", children: /* @__PURE__ */ h("div", { className: "image-upload-progress-circle", children: /* @__PURE__ */ A("svg", { viewBox: "0 0 36 36", className: `progress-ring${b <= 0 ? " indeterminate" : ""}`, children: [
                /* @__PURE__ */ h(
                  "path",
                  {
