...
import { bl as gt, h as wt, b5 as Ct, I as m, b4 as yt, d as Rt } from "./shared-state.Bf8CkvaR.js";
import { UploadIcon as Ve, CloseIcon as _t, ImageIcon as Et, CutIcon as St } from "tdesign-icons-react";
import { Button as ue, Input as Pt, Dialog as Dt } from "tdesign-react";
import { useUIKit as xt } from "@tencentcloud/uikit-base-component-react";
import { g as pe, bf as Ge, bp as bt, be as At, at as Mt, bo as zt, bh as It } from "./main-layout.OEkSp6vd.js";
import { U as Nt, u as Ze, k as Ut, i as Ot, h as Lt, v as Tt, g as Wt } from "./upload.BUq-1ot2.js";
import { s as Je } from "./svga.min.Zof6g_Kl.js";
import { M as $ } from "./useAsyncAction.R1AlIQqh.js";
import { u as Ft, a as Vt } from "./useT.CDh8p6A1.js";
var be = function(a, r) {
  ...
  function y() {
    if (!a) {
      ...
      if (h = /\b(iPhone|iP[ao]d)/.exec(_), w = /\b(iP[ao]d)/.exec(_), p = /Android/i.exec(_), D = /FBAN\/\w+;/i.exec(_), C = /Mobile/i.exec(_), g = !!/Win64/.exec(_), R) {
        ...
        var X = /(?:Trident\/(\d+.\d+))/.exec(_);
        n = X ? parseFloat(X[1]) + 4 : r, e = R[2] ? parseFloat(R[2]) : NaN, t = R[3] ? parseFloat(R[3]) : NaN, o = R[4] ? parseFloat(R[4]) : NaN, o ? (R = /(?:Chrome\/(\d+\.\d+))/.exec(_), i = R && R[1] ? parseFloat(R[1]) : NaN) : i = NaN;
      } else
        r = e = t = i = o = NaN;
      if (N) {
        if (N[1]) {
...
var xe, qe;
function Xt() {
  return qe || (qe = 1, xe = Ht()), xe;
}
var qt = Xt();
const Yt = /* @__PURE__ */ gt(qt);
...
`, ir = 1, ar = 3, sr = 1, cr = (
  ...
  (function(a) {
    ...
    return r.prototype.componentDidMount = function() {
      ...
      var e = this, t, o = this.props, i = o.image, n = o.video, s = o.mediaProps, c = o.cropperProps, l = o.transform, p = o.crop, g = p.x, h = p.y, w = o.rotation, D = o.zoom, C = o.cropShape, y = o.showGrid, I = o.roundCropAreaPixels, _ = o.style, R = _.containerStyle, N = _.cropAreaStyle, X = _.mediaStyle, f = o.classes, ve = f.containerClassName, G = f.cropAreaClassName, ie = f.mediaClassName, U = (t = this.state.mediaObjectFit) !== null && t !== void 0 ? t : this.getObjectFit();
...
const _r = vt(function({
  ...
  const { t: f } = xt(), { opSuccess: ve, opFailed: G } = Rt(f), ie = s || f(m.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), U = Y(null), [M, Z] = S(!1), [K, k] = S(0), [Qe, ee] = S(!1), [me, ae] = S(""), [x, q] = S(!h), [A, se] = S(r), [ge, j] = S(!1), [W, O] = S(""), b = Y(null);
  b.current || (b.current = new Nt({
    setValidating: j,
    setError: O,
    onConfirm: e
  }, R)), b.current.updateCallbacks({
    setValidating: j,
    setError: O,
    onConfirm: e
  }), b.current.updateSkipSvgaValidation(R);
  ...
  mt(X, () => ({
    ...
    get hasUrlError() {
      return x ? !!(W || C && A.trim() && pe(A.trim()) > C) : !1;
    },
    get urlInputValue() {
      return A;
    },
    ...
    reset: () => {
      b.current.reset(), B.current = null, J(null), we(!1), ce(!1), se(r || ""), ae(""), O(""), Z(!1), k(0), ee(!1), h && q(!!r), _?.(null);
    },
    ensureUrlValidated: async () => x ? await b.current.ensureUrlValidatedWithErrorCheck(
      A,
      r || "",
      !!W,
      C
  ...
  }), [t, x, ge, W, A, F, r, C, e, f]), H(() => {
    se(r), r && h && q(!0), I && (B.current = null, J(null), ce(!1), _?.(null));
  }, [r]), H(() => {
    h && r ? q(!0) : h && q(!1);
  }, [h]), H(() => {
    if (!N) return;
    let u = !1;
    (x || !h) && (W || C && A.trim() && pe(A.trim()) > C) && (u = !0), N(u);
  }, [x, W, A, C, h, N]);
  const Me = Y(r);
  H(() => {
  ...
  const Re = _e(async (u) => {
    ...
    if (I) {
      B.current = u, J(u);
      const v = u.type.startsWith("video/"), E = At(u);
      we(v), ce(E), _?.(u);
      return;
    }
    Z(!0), k(0);
    ...
    u?.stopPropagation(), b.current.cancelValidation(), j(!1), O(""), e(""), se(""), ae(""), Z(!1), k(0), ee(!1), I && (B.current = null, J(null), we(!1), ce(!1), _?.(null));
  };
  return /* @__PURE__ */ z("div", { className: `image-upload-container ${y}`, children: [
    h && l && /* @__PURE__ */ z("div", { className: "image-upload-mode-switch", children: [
      /* @__PURE__ */ d(
        ue,
        {
          ...
          onClick: () => {
            b.current.cancelValidation(), j(!1), O(""), q(!1);
          },
      ...
      /* @__PURE__ */ d(
        ue,
        {
          ...
          className: `mode-switch-btn ${x ? "active" : ""}`,
          onClick: () => {
            b.current.cancelValidation(), j(!1), O(""), q(!0);
          },
    ...
    (x || !h) && /* @__PURE__ */ d("div", { className: "image-upload-url-input", children: /* @__PURE__ */ d(
      Pt,
      {
        value: A,
        onChange: (u) => {
          se(String(u)), O(""), b.current.cancelValidation(), j(!1);
        },
        onFocus: pt,
        onBlur: ht,
        onEnter: dt,
        ...
        suffix: C ? ge ? /* @__PURE__ */ d("span", { className: "input-suffix-validating", children: f(m.VALIDATING) }) : /* @__PURE__ */ z("span", { className: `input-suffix-count${pe(A) > C ? " byte-overflow" : ""}`, children: [
          pe(A),
          "/",
          C
        ] }) : void 0
        ...
        /* @__PURE__ */ d(
          "div",
          {
            ...
            children: M ? /* @__PURE__ */ z("div", { className: "image-upload-progress", children: [
              ...
              /* @__PURE__ */ d(Et, { size: "32", strokeWidth: 1.2 }),
    ...
    r && (x || !h) && /* @__PURE__ */ d(
      "div",
      {
        ...
        children: Ge(r) ? /* @__PURE__ */ d("div", { ref: ye, className: "svga-preview-container" }) : It(r) ? /* @__PURE__ */ d("video", { src: r, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ d("img", { src: r, alt: "preview", onError: (u) => {
    ...
    /* @__PURE__ */ d(
      Dt,
      {
        ...
        footer: /* @__PURE__ */ z(le, { children: [
          ...
          /* @__PURE__ */ d(ue, { shape: "round", theme: "primary", onClick: ct, disabled: Le || !re, icon: /* @__PURE__ */ d(St, { size: "14" }), children: f(m.CONFIRM_CROP) })
        ] }),
