import { jsxs as A, jsx as h, Fragment as se } from "react/jsx-runtime";
import * as V from "react";
import { forwardRef as ht, useRef as X, useState as S, useImperativeHandle as dt, useEffect as H, useCallback as Ce } from "react";
...
import { Z as W } from "./error-message.BVYzOzgW.js";
import { aq as le, aS as Le, a$ as St, aR as _t, a6 as Et, a_ as Pt, aU as xt } from "./main-layout.DNAtZmGx.js";
import { i as Dt, g as zt } from "./svga.DC02l1-t.js";
import { U as bt, u as Oe, k as Mt, i as At, h as It, v as Nt, g as Ut } from "./upload.DS3rw9rR.js";
import { s as Ke } from "./svga.min.oQNdj2nc.js";
import { M as Y } from "./useAsyncAction.DlQYyzbJ.js";
import { u as Tt } from "./usePreviewUrl.DAGpJyb4.js";
import { u as Wt } from "./useSvgaPlayer.DLC-Fchr.js";
var Pe = function(a, r) {
...
function Lt() {
  if (Ve) return ye;
  Ve = 1;
  var a = !1, r, e, t, o, i, n, s, c, l, u, d, m, C, g, P;
  function w() {
    if (!a) {
      a = !0;
      ...
      if (m = /\b(iPhone|iP[ao]d)/.exec(y), C = /\b(iP[ao]d)/.exec(y), u = /Android/i.exec(y), g = /FBAN\/\w+;/i.exec(y), P = /Mobile/i.exec(y), d = !!/Win64/.exec(y), R) {
        r = R[1] ? parseFloat(R[1]) : R[5] ? parseFloat(R[5]) : NaN, r && document && document.documentMode && (r = document.documentMode);
        var v = /(?:Trident\/(\d+.\d+))/.exec(y);
        n = v ? parseFloat(v[1]) + 4 : r, e = R[2] ? parseFloat(R[2]) : NaN, t = R[3] ? parseFloat(R[3]) : NaN, o = R[4] ? parseFloat(R[4]) : NaN, o ? (R = /(?:Chrome\/(\d+\.\d+))/.exec(y), i = R && R[1] ? parseFloat(R[1]) : NaN) : i = NaN;
      } else
        r = e = t = i = o = NaN;
      if (Z) {
        if (Z[1]) {
...
`, tr = 1, rr = 3, or = 1, nr = (
  ...
  (function(a) {
    ...
    return r.prototype.componentDidMount = function() {
      ...
      var e = this, t, o = this.props, i = o.image, n = o.video, s = o.mediaProps, c = o.cropperProps, l = o.transform, u = o.crop, d = u.x, m = u.y, C = o.rotation, g = o.zoom, P = o.cropShape, w = o.showGrid, I = o.roundCropAreaPixels, y = o.style, R = y.containerStyle, Z = y.cropAreaStyle, v = y.mediaStyle, k = o.classes, J = k.containerClassName, N = k.cropAreaClassName, F = k.mediaClassName, z = (t = this.state.mediaObjectFit) !== null && t !== void 0 ? t : this.getObjectFit();
      return V.createElement("div", {
        ...
        alt: "",
        className: ue("reactEasyCrop_Image", z === "contain" && "reactEasyCrop_Contain", z === "horizontal-cover" && "reactEasyCrop_Cover_Horizontal", z === "vertical-cover" && "reactEasyCrop_Cover_Vertical", F)
      }, s, {
        src: i,
        ref: this.imageRef,
        style: _(_({}, v), {
        ...
        loop: !0,
        muted: !0,
        className: ue("reactEasyCrop_Video", z === "contain" && "reactEasyCrop_Contain", z === "horizontal-cover" && "reactEasyCrop_Cover_Horizontal", z === "vertical-cover" && "reactEasyCrop_Cover_Vertical", F)
      }, s, {
        ref: this.videoRef,
        ...
        "data-testid": "cropper",
        className: ue("reactEasyCrop_CropArea", P === "round" && "reactEasyCrop_CropAreaRound", w && "reactEasyCrop_CropAreaGrid", N)
      }, c)));
    }, r.defaultProps = {
      zoom: 1,
      rotation: 0,
...
const Rr = ht(function({
  ...
  const { t: v } = Rt(), k = s || v(W.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), J = X(null), [N, F] = S(!1), [z, M] = S(0), [he, Q] = S(!1), [de, ne] = S(""), [x, q] = S(!d), [b, ie] = S(r), [fe, j] = S(!1), [L, U] = S(""), D = X(null);
  D.current || (D.current = new bt({
    setValidating: j,
    setError: U,
    onConfirm: e
  }, y)), D.current.updateCallbacks({
    setValidating: j,
    setError: U,
    onConfirm: e
  }), D.current.updateSkipSvgaValidation(y);
  const $ = X(null), { previewUrl: O, setPreview: K } = Tt(), [Be, me] = S(!1), [ve, ae] = S(!1), {
    containerRef: Je,
    playUrl: xe,
    stopAnimation: ir
  ...
  dt(Z, () => ({
    ...
    get hasUrlError() {
      return x ? !!(L || g && b.trim() && le(b.trim()) > g) : !1;
    },
    get urlInputValue() {
      return b;
    },
    ...
    validateImageUrl: async (p, f) => {
      j(!0), U("");
      try {
        return await Mt(p, f, y), !0;
      } catch (E) {
        const G = E instanceof Error ? E : new Error(String(E));
        throw U(G.message || v("Image URL invalid")), G;
      } finally {
        j(!1);
      }
    },
    reset: () => {
      D.current.reset(), $.current = null, K(null), me(!1), ae(!1), ie(r || ""), ne(""), U(""), F(!1), M(0), Q(!1), d && q(!!r), I?.(null);
    },
    ensureUrlValidated: async () => x ? await D.current.ensureUrlValidatedWithErrorCheck(
      b,
      r || "",
      !!L,
      g
    ...
    uploadPendingFile: async () => {
      ...
      F(!0), M(0), Q(!1);
      try {
        const f = await Oe(p, t, M);
        return $.current = null, ne(f.provider || ""), Q(!1), f.url;
      } catch (f) {
        throw Q(!0), f;
      } finally {
        F(!1), M(0);
  ...
  }), [t, x, fe, L, b, O, r, g, e, v]), H(() => {
    ie(r), r && d && q(!0), w && ($.current = null, K(null), ae(!1), I?.(null));
  }, [r]), H(() => {
    d && r ? q(!0) : d && q(!1);
  }, [d]), H(() => {
    if (!R) return;
    let p = !1;
    (x || !d) && (L || g && b.trim() && le(b.trim()) > g) && (p = !0), R(p);
  }, [x, L, b, g, d, R]);
  const De = X(r);
  H(() => {
    r && O && De.current !== r && K(null), De.current = r;
  }, [r, O, K]), H(() => () => {
    D.current?.dispose();
  }, []), H(() => {
    !ve || !O || xe(O).catch((p) => {
      $e.error("ImageUpload", "SVGA preview load error:", p);
    });
  }, [ve, O, xe]);
  const ge = X(null), T = X(null);
  H(() => {
    if (!r || !Le(r) || !(x || !d) || !ge.current) {
      if (T.current) {
        try {
    ...
    const p = ge.current, f = new Ke.Player(p);
    f.loops = 0, f.setContentMode("AspectFit"), T.current = f;
    const E = zt();
    if (E)
      return E.load(
        r,
        (G) => {
          f.setVideoItem(G), f.startAnimation();
        },
        (G) => {
          $e.error("ImageUpload", "SVGA URL preview load error:", G);
        }
      ), () => {
        try {
          f.stopAnimation(), f.clear();
        } catch {
        }
        T.current = null;
      };
  }, [r, x, d]);
  const [Qe, ee] = S(!1), [te, ze] = S(""), [et, be] = S({ x: 0, y: 0 }), [tt, Me] = S(1), [Ae, Ie] = S(null), [ar, rt] = S(null), [Ne, Ue] = S(!1), ot = Ce((p, f) => {
    Ie(f);
  }, []), [nt, Te] = S(!1), re = X(null);
  H(() => () => {
  ...
  const we = Ce(async (p) => {
    ...
    if (!It(p, n)) {
      Y.error(v(W.FILE_SIZE_EXCEEDS_MB, { max: n }));
      return;
    }
    try {
      await Nt(p, m, y);
      ...
      const G = E instanceof Error ? E : new Error(String(E));
      Y.error(G.message || v("File load failed"));
      return;
    }
    if (o) {
      ze(""), rt(p), be({ x: 0, y: 0 }), Me(1), Ie(null), Ue(!0), Te(!1), ee(!0);
      try {
        const E = await St(p);
        ze(E);
      } catch {
        Y.error(v("Image load failed")), ee(!1);
      } finally {
      ...
      await We(p);
  }, [m, n, v, y, o, w]), We = async (p) => {
    if (w) {
      $.current = p, K(p);
      const f = p.type.startsWith("video/"), E = _t(p);
      me(f), ae(E), I?.(p);
      return;
    }
    F(!0), M(0);
    try {
      const f = await Oe(p, t, M);
      e(f.url), ne(f.provider || ""), Y.success(v("Upload Success"));
    } catch (f) {
      const E = f instanceof Error ? f : new Error(String(f));
      Y.error(v(W.UPLOAD_FAILED_WITH_ERROR, { error: E.message || v(W.NETWORK_ERROR) }));
    } finally {
      F(!1), M(0);
    }
  }, it = async () => {
    if (!(!Ae || !te))
      try {
        ...
        Y.error(v("Crop failed"));
      }
  }, at = Pt, st = Ce(Et((p) => {
    we(p);
  }), [we]), ct = () => {
    D.current.handleUrlFocus();
  }, lt = () => {
    D.current.handleUrlBlur(
      b,
      g
    );
  }, ut = () => {
    D.current.handleUrlEnter(
      b,
      g
    );
  }, pt = (p) => {
    p?.stopPropagation(), D.current.cancelValidation(), j(!1), U(""), e(""), ie(""), ne(""), F(!1), M(0), Q(!1), w && ($.current = null, K(null), me(!1), ae(!1), I?.(null));
  };
  return /* @__PURE__ */ A("div", { className: `image-upload-container ${P}`, children: [
    d && c && /* @__PURE__ */ A("div", { className: "image-upload-mode-switch", children: [
      /* @__PURE__ */ h(
        ce,
        {
          shape: "round",
          ...
          onClick: () => {
            D.current.cancelValidation(), j(!1), U(""), q(!1);
          },
          icon: /* @__PURE__ */ h(Fe, { size: "12" }),
          children: v("Upload Image")
        }
      ),
      /* @__PURE__ */ h(
        ce,
        {
          ...
          className: `mode-switch-btn ${x ? "active" : ""}`,
          onClick: () => {
            D.current.cancelValidation(), j(!1), U(""), q(!0);
          },
          children: v(W.ENTER_URL)
        }
      )
    ] }),
    (x || !d) && /* @__PURE__ */ h("div", { className: "image-upload-url-input", children: /* @__PURE__ */ h(
      Ct,
      {
        value: b,
        onChange: (p) => {
          ie(String(p)), U(""), D.current.cancelValidation(), j(!1);
        },
        onFocus: ct,
        onBlur: lt,
        onEnter: ut,
        placeholder: v(W.ENTER_IMAGE_URL),
        status: L ? "error" : void 0,
        suffix: g ? fe ? /* @__PURE__ */ h("span", { className: "input-suffix-validating", children: v("Validating") }) : /* @__PURE__ */ A("span", { className: `input-suffix-count${le(b) > g ? " byte-overflow" : ""}`, children: [
          le(b),
          "/",
          g
        ] }) : void 0
    ...
    L && (x || !d) && /* @__PURE__ */ h("div", { className: "image-upload-url-error", children: L }),
    d && !x && /* @__PURE__ */ A(se, { children: [
      O ? /* @__PURE__ */ A(
        "div",
        {
          ...
          children: [
            N ? (
              // 正在上传时显示进度条覆盖层
              /* @__PURE__ */ h("div", { className: "image-upload-uploading-overlay", children: /* @__PURE__ */ h("div", { className: "image-upload-progress-circle", children: /* @__PURE__ */ A("svg", { viewBox: "0 0 36 36", className: `progress-ring${z <= 0 ? " indeterminate" : ""}`, children: [
                /* @__PURE__ */ h(
                  "path",
                  {
                ...
                /* @__PURE__ */ h(
                  "path",
                  {
                    className: `progress-ring-fill${z <= 0 ? " indeterminate" : ""}`,
                    pathLength: "100",
                    strokeDasharray: z > 0 ? `${z}, 100` : "25, 100",
                    d: `M18 2.0845
                          a 15.9155 15.9155 0 0 1 0 31.831
                          a 15.9155 15.9155 0 0 1 0 -31.831`
                  }
            ...
            ) : /* @__PURE__ */ h(se, { children: ve ? /* @__PURE__ */ h("div", { ref: Je, className: "svga-preview-container" }) : Be ? /* @__PURE__ */ h("video", { src: O, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ h("img", { src: O, alt: "preview" }) }),
            !N && de && /* @__PURE__ */ h("span", { className: "image-upload-provider-badge", children: de.toUpperCase() }),
            !N && he ? /* @__PURE__ */ h("span", { className: "image-upload-provider-badge upload-failed-badge", children: v("Upload Failed") }) : !N && !de ? /* @__PURE__ */ h("span", { className: "image-upload-provider-badge", style: { background: "#ff9800" }, children: v("Pending Upload") }) : null,
            !N && /* @__PURE__ */ A("div", { className: "image-upload-preview-actions", children: [
              /* @__PURE__ */ h(
                "button",
                {
        ...
        /* @__PURE__ */ h(
          "div",
          {
            ...
            onDrop: st,
            style: { height: u || 120 },
            children: N ? /* @__PURE__ */ A("div", { className: "image-upload-progress", children: [
              /* @__PURE__ */ h("div", { className: "progress-bar", children: /* @__PURE__ */ h("div", { className: "progress-fill", style: { width: `${z}%` } }) }),
              /* @__PURE__ */ A("span", { className: "progress-text", children: [
                z,
                "%"
              ] })
              ...
              /* @__PURE__ */ h("span", { className: "upload-sub-hint", children: C || v(W.SUPPORTS_IMAGE_FORMATS_MAX_MB, { max: n }) })
            ] })
          }
        )
      ),
    ...
    r && (x || !d) && /* @__PURE__ */ h(
      "div",
      {
        ...
        children: Le(r) ? /* @__PURE__ */ h("div", { ref: ge, className: "svga-preview-container" }) : xt(r) ? /* @__PURE__ */ h("video", { src: r, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ h("img", { src: r, alt: "preview", onError: (p) => {
    ...
    /* @__PURE__ */ h(
      yt,
      {
        ...
        footer: /* @__PURE__ */ A(se, { children: [
          /* @__PURE__ */ h(ce, { shape: "round", variant: "outline", onClick: () => ee(!1), children: v(W.CANCEL) }),
          /* @__PURE__ */ h(ce, { shape: "round", theme: "primary", onClick: it, disabled: Ne || !te, icon: /* @__PURE__ */ h(wt, { size: "14" }), children: v(W.CONFIRM_CROP) })
        ] }),
        children: /* @__PURE__ */ h("div", { className: "image-crop-area", children: Ne || !nt ? /* @__PURE__ */ A("div", { className: "image-crop-loading", children: [
          /* @__PURE__ */ h("div", { className: "loading-spinner" }),
          /* @__PURE__ */ h("span", { children: v("Image Loading") })
        ] }) : te ? /* @__PURE__ */ h(
          nr,
          {
            image: te,
