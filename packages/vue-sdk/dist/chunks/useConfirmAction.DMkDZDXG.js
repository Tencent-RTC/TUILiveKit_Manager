...
import { I as _, r as o, a3 as R, a2 as A, am as F, g as E } from "./en-US.CklcmnrB.js";
import { d as q } from "./LiveMonitorCore.C5JUs2tc.js";
import { O as U, R as O, aF as W, aG as N, u as V, m as B } from "./main-layout.DI9Xn1Ek.js";
import { u as K } from "./useAsyncAction.BeTu7weS.js";
function Y(v) {
  ...
  const k = async () => {
    ...
    try {
      ...
      await A({ ids: e.ids, items: r, liveId: e.liveId ?? t }), o("moderation", "approve", !0, String(e.ids.length));
    } catch (r) {
      throw o("moderation", "approve", !1), console.error("[useRiskControlState] approveTextModerationItems failed:", r), r;
    }
  }, x = async (e) => {
    try {
      await R({ content: e.content, liveId: e.liveId ?? t }), o("moderation", "bypass", !0, String(e.content.length));
    } catch (r) {
  ...
  return {
    ...
    muteMember: async (e) => {
      ...
      try {
        await B(t, e.memberAccounts, e.muteTime), await y(), o("risk_control", "mute", !0, t);
      } catch (r) {
    ...
    unmuteMember: async (e) => {
      ...
      s.value = !0, n.value = null;
      try {
        await V(t, e.memberAccounts), await y(), o("risk_control", "unmute", !0, t);
      } catch (r) {
    ...
    banMember: async (e) => {
      ...
      s.value = !0, n.value = null;
      try {
        await N(t, e.memberAccounts, e.duration, e.reason), await M(), o("risk_control", "ban", !0, t);
      } catch (r) {
