import { aA as h, aB as s, aC as g, r as o } from "./en-US.DXdmRfHg.js";
...
async function E(a) {
  await g(s.delGift, { GiftId: a });
}
async function I(a, e) {
  const i = (await h(s.getGiftLanguage, { GiftId: a, Language: e }))?.Response?.Language;
  return {
    name: i?.Name || "",
    description: i?.Desc || ""
  };
...
async function p(a, e) {
  await g(s.delGiftLanguage, { GiftId: a, Language: e });
}
async function A(a) {
...
async function _(a) {
  await g(s.delGiftCategory, { CategoryId: a });
}
async function m(a, e) {
  const i = (await h(s.getGiftCategoryLanguage, { CategoryId: a, Language: e }))?.Response?.Language;
  return {
    name: i?.CategoryName || "",
...
async function N(a, e) {
  await g(s.delGiftCategoryLanguage, { CategoryId: a, Language: e });
}
async function v(a, e) {
  await g(s.addGiftCategoryRelations, { CategoryId: a, GiftIdList: e });
}
async function T(a, e) {
  await g(s.delGiftCategoryRelations, { CategoryId: a, GiftIdList: e });
}
class M {
  constructor(e = {}) {
  ...
  async createGift(e) {
    ...
    try {
      ...
      const i = t instanceof Error ? t : new Error(String(t));
      throw this.setLoading("giftAction", !1), this.setError(i), o("gift_manage", "create", !1), i;
    }
  }
  async updateGift(e) {
    this.setLoading("giftAction", !0), this.setError(null);
    try {
      await w(e), this.setLoading("giftAction", !1), o("gift_manage", "update", !0, e.giftId);
    } catch (t) {
      const i = t instanceof Error ? t : new Error(String(t));
      throw this.setLoading("giftAction", !1), this.setError(i), o("gift_manage", "update", !1, e.giftId), i;
    }
  }
  async deleteGift(e) {
    this.setLoading("giftAction", !0), this.setError(null);
    try {
      await E(e), this.giftList = this.giftList.filter((t) => t.id !== e), this.setLoading("giftAction", !1), this.notifyStateChange(), o("gift_manage", "delete", !0, e);
    } catch (t) {
      const i = t instanceof Error ? t : new Error(String(t));
      throw this.setLoading("giftAction", !1), this.setError(i), o("gift_manage", "delete", !1, e), i;
    }
  }
  // ========= 礼物分类操作 =========
  async createGiftCategory(e) {
    ...
    try {
      await A(e), this.setLoading("categoryAction", !1), o("gift_manage", "create_category", !0, e.categoryId);
    } catch (t) {
      const i = t instanceof Error ? t : new Error(String(t));
      throw this.setLoading("categoryAction", !1), this.setError(i), o("gift_manage", "create_category", !1), i;
    }
  }
  async updateGiftCategory(e) {
    ...
    try {
      ...
      const i = t instanceof Error ? t : new Error(String(t));
      throw this.setLoading("categoryAction", !1), this.setError(i), o("gift_manage", "update_category", !1, e.categoryId), i;
    }
  }
  async deleteGiftCategory(e) {
    this.setLoading("categoryAction", !0), this.setError(null);
    try {
      await _(e), this.giftCategoryList = this.giftCategoryList.filter((t) => t.id !== e), this.setLoading("categoryAction", !1), this.notifyStateChange(), o("gift_manage", "delete_category", !0, e);
    } catch (t) {
      const i = t instanceof Error ? t : new Error(String(t));
      throw this.setLoading("categoryAction", !1), this.setError(i), o("gift_manage", "delete_category", !1, e), i;
    }
  }
  // ========= 礼物-分类关联操作 =========
