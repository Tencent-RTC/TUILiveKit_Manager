import { aG as u, aH as r, aI as s } from "./layout.5hoGLPKE.js";
import { s as l } from "./main-layout.DZAH01ts.js";
import { r as g } from "./logger.DRLw23-l.js";
const L = 500;
function C(e, t, a = {}) {
  const i = a.ttl ?? L, n = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
  return async (...d) => {
    const c = t(...d), y = n.get(c);
    if (y)
      return y;
    if (i > 0) {
      const f = o.get(c);
      if (f && Date.now() - f.timestamp < i)
    ...
    try {
      const f = await h;
      return i > 0 && o.set(c, { result: f, timestamp: Date.now() }), f;
    } catch (f) {
      throw f;
    } finally {
      n.delete(c);
...
const G = () => "gift_" + Date.now() + "_" + Math.random().toString(36).substr(2, 9), w = (e, t, a) => {
  const i = e.Name || "", n = e.Desc || "", o = (e.LanguageList || []).map((c) => ({
    name: c.Name || "",
    description: c.Desc || "",
    language: c.Language || ""
  })), d = a.get(e.GiftId) || [];
...
async function D(e) {
  const t = await u(s.getGiftList, {});
  if (t && t.ErrorCode === 0 && t.Response) {
    const a = t.Response.GiftList || [], i = t.Response.CategoryList || [], { giftToCategories: n, giftToCategoryIds: o } = p(i), d = a.map((y) => w(y, n, o)), c = i.map((y) => I(y));
    return {
      gifts: d,
...
async function R(e) {
  await r(s.delGift, { GiftId: e });
}
async function T(e, t) {
  const i = (await u(s.getGiftLanguage, { GiftId: e, Language: t }))?.Response?.Language;
  return {
    name: i?.Name || "",
    description: i?.Desc || ""
  };
...
async function S(e, t) {
  await r(s.delGiftLanguage, { GiftId: e, Language: t });
}
async function N(e) {
  await r(s.addGiftCategory, {
...
async function E(e) {
  await r(s.delGiftCategory, { CategoryId: e });
}
async function A(e, t) {
  const i = (await u(s.getGiftCategoryLanguage, { CategoryId: e, Language: t }))?.Response?.Language;
  return {
    name: i?.CategoryName || "",
...
async function M(e, t, a, i) {
  await r(s.setGiftCategoryLanguage, {
    CategoryId: e,
    Language: t,
    CategoryName: a,
    CategoryDesc: i || ""
...
async function $(e, t) {
  await r(s.delGiftCategoryLanguage, { CategoryId: e, Language: t });
}
async function x(e, t) {
  await r(s.addGiftCategoryRelations, { CategoryId: e, GiftIdList: t });
}
async function F(e, t) {
  await r(s.delGiftCategoryRelations, { CategoryId: e, GiftIdList: t });
}
class k {
  constructor(t = {}) {
  ...
  async _fetchGiftListRaw(t) {
    ...
    return this.giftList = a.gifts || [], this.giftCategoryList = a.categories || [], this.notifyStateChange(), {
      giftList: a.gifts || [],
  ...
  async createGift(t) {
    try {
      ...
      return g("gift_manage", "create", !0, t.id), a;
    } catch (a) {
      throw g("gift_manage", "create", !1), a;
    }
  }
  async updateGift(t) {
    try {
      await this.withLoading(
        "giftAction",
        () => _(t)
      ), g("gift_manage", "update", !0, t.giftId);
    } catch (a) {
      throw g("gift_manage", "update", !1, t.giftId), a;
    }
  }
  async deleteGift(t) {
    try {
      await this.withLoading(
        "giftAction",
        () => R(t)
      ), this.giftList = this.giftList.filter((a) => a.id !== t), this.notifyStateChange(), g("gift_manage", "delete", !0, t);
    } catch (a) {
      throw g("gift_manage", "delete", !1, t), a;
    }
  }
  // ========= 礼物分类操作 =========
  async createGiftCategory(t) {
    try {
      await this.withLoading(
        "categoryAction",
        () => N(t)
      ), g("gift_manage", "create_category", !0, t.categoryId);
    } catch (a) {
      throw g("gift_manage", "create_category", !1), a;
    }
  }
  async updateGiftCategory(t) {
    try {
      await this.withLoading(
        "categoryAction",
        () => U(t)
      ), g("gift_manage", "update_category", !0, t.categoryId);
    } catch (a) {
      throw g("gift_manage", "update_category", !1, t.categoryId), a;
    }
  }
  async deleteGiftCategory(t) {
    try {
      await this.withLoading(
        "categoryAction",
        () => E(t)
      ), this.giftCategoryList = this.giftCategoryList.filter((a) => a.id !== t), this.notifyStateChange(), g("gift_manage", "delete_category", !0, t);
    } catch (a) {
      throw g("gift_manage", "delete_category", !1, t), a;
    }
  }
  // ========= 礼物-分类关联操作 =========
  ...
  async getGiftLanguage(t) {
    return this.withLoading(
      "giftLanguage",
      () => T(t.giftId, t.language)
    );
  }
  async setGiftLanguage(t) {
    await this.withLoading(
      "giftLanguage",
      () => v(t.giftId, t.language, t.name, t.description)
    );
  }
