import { aa as g, ab as d, ac as Ct, N as B, z as Xt, ad as et, L as C, a4 as St, a6 as vt, I as l, K as Y } from "./en-US.CSjM9toh.js";
function us(i, t = 0) {
  const e = Number(i);
...
function bt(i) {
  ...
  if ("RoomType" in i) {
    ...
    return {
      ...
      customInfo: r.CustomInfo ? Jt(r.CustomInfo) : {}
    };
  }
  return s;
}
...
async function re(i, t, e = 3600, s = "") {
...
class ps {
  constructor(t = {}) {
    this.currentLive = null, this.liveList = [], this.hasMore = !0, this.loading = {}, this.error = null, this.onStateChange = t.onStateChange, this.getActive = t.getActive, this.playerRegistry = new pe({
      playerFactory: t.playerFactory,
      debug: !1
    }), this.userProfileManager = new Le({
      onStateChange: (e) => {
  ...
  async createLive(t) {
    ...
    try {
      ...
      const r = (await te(t)).liveId || t.liveId, n = r ? await A(r) : null;
      if (!n)
        throw new Error("创建直播成功，但获取详情失败");
  ...
  async updateLive(t) {
    ...
    this.setLoading(s, !0), this.setError(null);
    try {
      await ee(e, t), this.currentLive && (this.currentLive = { ...this.currentLive, ...t }, this.notifyStateChange({ currentLive: this.currentLive })), this.setLoading(s, !1);
    } catch (n) {
  ...
  async endLive(t) {
    ...
    this.setLoading(s, !0), this.setError(null);
    try {
      await Qt(e), this.liveList = this.liveList.filter((n) => n.liveId !== e), this.currentLive && this.currentLive.liveId === e && (this.currentLive = null), this.notifyStateChange({
        liveList: this.liveList,
        currentLive: this.currentLive
      }), this.setLoading(s, !1);
    } catch (n) {
  ...
  async setAllMute(t, e) {
    if (t)
      try {
        await he(t, e), this.liveList = this.liveList.map((s) => s.liveId === t ? { ...s, isMuted: e } : s), this.currentLive && this.currentLive.liveId === t && (this.currentLive = { ...this.currentLive, isMuted: e }, this.notifyStateChange({ currentLive: this.currentLive })), this.notifyStateChange({ liveList: this.liveList });
      } catch (s) {
...
function at(i, t = 8e3, e = !1) {
  return new Promise((s, r) => {
    ...
    if (Ee(i)) {
      ...
      Ce(i, t > 8e3 ? t : 15e3).then(() => s(!0)).catch(r);
      return;
    }
...
async function ws(i, t, e = !1) {
  ...
  if (o)
    ...
    try {
      i.type.startsWith("video/") ? await be(c) : await ve(c);
    } finally {
...
const Gs = {
  field: "createTime",
  direction: "descend"
}, Ae = O.liveList, H = "liveList_currentPage", z = "liveList_pageCursors", Me = 1024;
...
async function Re(i) {
  const { page: t, pageCursors: e, pageSize: s = Ae } = i, r = e.get(t) || "", { list: n, next: o } = await Zt({ next: r, count: s, sortDirection: "descend" }), a = n, c = new Map(e);
...
const Ge = () => "gift_" + Date.now() + "_" + Math.random().toString(36).substr(2, 9), Fe = (i, t, e) => {
...
async function ke(i) {
  ...
  if (t && t.ErrorCode === 0 && t.Response) {
    const e = t.Response.GiftList || [], s = t.Response.CategoryList || [], { giftToCategories: r, giftToCategoryIds: n } = je(s), o = e.map((c) => Fe(c, r, n)), a = s.map((c) => Ve(c));
    return {
      gifts: o,
...
class Bs {
  ...
  async fetchGiftList(t) {
    ...
    try {
      const e = await ke(t == null ? void 0 : t.language);
  ...
  async updateGift(t) {
    this.setLoading("giftAction", !0), this.setError(null);
    try {
      await We(t), this.setLoading("giftAction", !1);
    } catch (e) {
      const s = e instanceof Error ? e : new Error(String(e));
      throw this.setLoading("giftAction", !1), this.setError(s), s;
    }
  ...
  async deleteGift(t) {
    this.setLoading("giftAction", !0), this.setError(null);
    try {
      await $e(t), this.giftList = this.giftList.filter((e) => e.id !== t), this.setLoading("giftAction", !1), this.notifyStateChange();
    } catch (e) {
      const s = e instanceof Error ? e : new Error(String(e));
      throw this.setLoading("giftAction", !1), this.setError(s), s;
    }
  ...
  async updateGiftCategory(t) {
    this.setLoading("categoryAction", !0), this.setError(null);
    try {
      await qe(t), this.setLoading("categoryAction", !1);
    } catch (e) {
      const s = e instanceof Error ? e : new Error(String(e));
      throw this.setLoading("categoryAction", !1), this.setError(s), s;
    }
  ...
  async deleteGiftCategory(t) {
    this.setLoading("categoryAction", !0), this.setError(null);
    try {
      await Xe(t), this.giftCategoryList = this.giftCategoryList.filter((e) => e.id !== t), this.setLoading("categoryAction", !1), this.notifyStateChange();
    } catch (e) {
      const s = e instanceof Error ? e : new Error(String(e));
      throw this.setLoading("categoryAction", !1), this.setError(s), s;
    }
  ...
  async getGiftLanguage(t) {
    ...
    try {
      const e = await Ke(t.giftId, t.language);
  ...
  async setGiftLanguage(t) {
    this.setLoading("giftLanguage", !0), this.setError(null);
    try {
      await Ye(t.giftId, t.language, t.name, t.description), this.setLoading("giftLanguage", !1);
    } catch (e) {
      const s = e instanceof Error ? e : new Error(String(e));
      throw this.setLoading("giftLanguage", !1), this.setError(s), s;
    }
  ...
  async deleteGiftLanguage(t) {
    this.setLoading("giftLanguage", !0), this.setError(null);
    try {
      await He(t.giftId, t.language), this.setLoading("giftLanguage", !1);
    } catch (e) {
      const s = e instanceof Error ? e : new Error(String(e));
      throw this.setLoading("giftLanguage", !1), this.setError(s), s;
    }
  ...
  async setGiftCategoryLanguage(t, e, s, r) {
    this.setLoading("giftCategoryLanguage", !0), this.setError(null);
    try {
      await Ze(t, e, s, r), this.setLoading("giftCategoryLanguage", !1);
    } catch (n) {
      const o = n instanceof Error ? n : new Error(String(n));
  ...
  async deleteGiftCategoryLanguage(t, e) {
    this.setLoading("giftCategoryLanguage", !0), this.setError(null);
    try {
      await Qe(t, e), this.setLoading("giftCategoryLanguage", !1);
    } catch (s) {
      const r = s instanceof Error ? s : new Error(String(s));
      throw this.setLoading("giftCategoryLanguage", !1), this.setError(r), r;
    }
...
const ii = 7, si = 1440 * 60 * 1e3, ri = "live-manager-moderation-local-deletions", ni = 1, M = "deletedModerationItems";
let V = {
  ttlDays: ii
}, x = null;
function At(i) {
...
async function Mt(i, t = {}) {
  ...
  const s = At(t.ttlDays ?? V.ttlDays), r = Date.now(), n = r + s * si;
  await li(r), await U("readwrite", (o) => {
    e.forEach((a) => {
...
function Dt(i) {
  ...
  if (t.length === 0)
    throw new C("ids 不能为空");
  if (t.length > j)
    throw new C(`ids 不能超过 ${j} 个`);
  return t;
}
function fi(i = 1, t = 20) {
  if (!Number.isInteger(i) || i < 1)
    throw new C("pageNum 必须大于等于 1");
  if (!Number.isInteger(t) || t < 1 || t > j)
    throw new C(`pageSize 必须在 1-${j} 之间`);
}
function hi() {
  return "1";
}
...
function yi(i) {
  ...
  return {
    ...
    type: di[i.type] || String(i.type) || "unknown",
    createdAtMs: t
  };
}
async function pi(i = {}) {
  ...
  if (!r || r.code !== 0)
    throw new C("getInteractionModerationList failed");
...
async function Ks(i) {
  const t = Dt(i.ids), e = i.items || [];
  if (!i.liveId)
    throw new C("liveId 必填");
...
async function Hs(i) {
  if (Dt(i.ids), !Array.isArray(i.items) || i.items.length !== i.ids.length)
    throw new C("items 必须与 ids 一一对应");
}
async function zs() {
  var t;
...
const Xs = O.mutedList, Js = O.bannedList, Ei = 600, Ci = 86400, Ut = (i) => Array.isArray(i) ? i.filter((t) => !!t && typeof t == "object") : [], q = (i, ...t) => {
...
async function Zs(i) {
  var s;
  const t = await oe(i);
  return Ut(((s = t.Response) == null ? void 0 : s.MutedAccountList) || t.MutedAccountList).map((r) => ({
    userId: q(r, "Member_Account", "userId", "UserID"),
    endTime: Ot(r, "MutedUntil", "endTime")
  })).filter((r) => r.userId);
}
function Qs(i, t) {
...
async function tr(i) {
  var s;
  const t = await ae(i);
  return Ut(((s = t.Response) == null ? void 0 : s.BannedAccountList) || t.BannedAccountList).map((r) => ({
    userId: q(r, "Member_Account", "userId", "UserID"),
    endTime: Ot(r, "BannedUntil", "endTime"),
...
}, vi = "https://web.sdk.qcloud.com/im/assets/emoji-plugin/", ur = (i) => {
  if (!i)
    return [];
  const t = [];
  let e = i;
...
const Gi = "live_", Mr = 43, Rr = 100, Fi = "VideoDynamicGrid9Seats", Vi = 8, G = 9 / 16, Gt = 16 / 9, E = {
  maxCount: 10,
  maxKeyBytes: 50,
...
function Or(i) {
  var t;
  return ((t = Wi(i)) == null ? void 0 : t.orientation) === "landscape" ? Gt : G;
}
function Nr(i) {
...
async function Vr(i) {
  const { liveId: t, anchorId: e, onStatusChange: s, messages: r = {} } = i, n = Ft(e), o = r.getStreamInfoFailed || "Get Stream Info Failed";
  let a = null, c = "";
  try {
...
async function zi(i) {
  const { liveId: t, anchorId: e, getStreamInfoFailedMessage: s = "Get Stream Info Failed" } = i, r = Ft(e);
  try {
...
function kt(i) {
  const t = i.roomIdText ?? i.liveIdText ?? "", {
    ...
    minVisibleTags: c = 2,
    maxVisibleTags: u = 99
  } = i, p = $("live-id-badge", t), h = r + p, _ = e - n, S = s.map(
    (m) => $("live-card-tag-overlay", m)
  ), N = $("live-card-tag-overlay live-card-tag-more", "...");
  let v = 0, I = 0;
  for (let m = 0; m < S.length; m++) {
    const y = S[m], st = S.length - m - 1, Ht = st > 0 ? N : 0, rt = I > 0 ? o : 0, zt = v + rt + y + (st > 0 ? o + Ht : 0), nt = _ - zt, qt = Math.max(60, nt - r - a);
    if (p > qt || nt < h + a)
      break;
    v += rt + y, I++;
  }
  if (S.length - I > 0 && (v += o + N), s.length >= c && I < c) {
    let m = 0;
    for (let y = 0; y < c; y++)
      m += (y > 0 ? o : 0) + S[y];
    s.length > c && (m += o + N), I = c, v = m;
  }
  if (I > u) {
    I = u;
    let m = 0;
    for (let y = 0; y < u; y++)
      m += (y > 0 ? o : 0) + S[y];
    s.length > u && (m += o + N), v = m;
  }
  const Kt = _ - v, Yt = Math.max(
    60,
    Kt - r - a
  );
  return {
    visibleCount: I,
    showMore: s.length > I,
    idMaxWidth: `${Math.round(Yt)}px`,
    tagsMaxWidth: `${Math.round(v)}px`
  };
}
...
const L = {
  ...
  "zh-Hant": "tc",
  en: "en"
}, Jr = ["sc", "tc", "en"], Zr = 20, Qr = 20, tn = 20, en = 100, dt = 20, sn = 45;
function Bt(i) {
  return new TextEncoder().encode(i).length;
}
function rn(i, t) {
...
const ln = 10, un = 20, gn = 20, dn = 60, tt = "gift_categories_cache";
function es(i) {
  return i.map((t) => {
...
class yn {
  ...
  setPreview(t) {
    ...
    const e = Te(this.currentUrl || void 0, t);
...
class In {
  ...
  isSearchInputTooLong() {
    return xe(this.state.searchInput, Me);
  }
  async search() {
