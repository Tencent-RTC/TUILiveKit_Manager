...
import { ao as j, aq as Q, bo as J, bF as X, bE as Y, u as Z, m as ee, O as te, bG as re, ap as ae, p as ne, a as oe, t as ie } from "./main-layout.7dM7GuCv.js";
import { c as $, r as l } from "./logger.pnqt7v8K.js";
import "./gift.D1aj6nK1.js";
import { I as se, o as le, m as ue, a8 as ce, ac as ve } from "./layout.BInVXJga.js";
import { C as de } from "./chat-state.CeLbmNpU.js";
const g = $("RiskControl");
function _e(i) {
...
function me() {
  if (!y) {
    ...
    ne(
      ...
      ie(r),
      oe((v) => {
        q.value = v.sending, O.value = v.error;
      })
    );
  }
  return y;
