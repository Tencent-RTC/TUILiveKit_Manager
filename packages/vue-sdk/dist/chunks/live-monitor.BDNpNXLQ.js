import { ref as C, onUnmounted as tt, defineComponent as Se, resolveComponent as ee, openBlock as y, createElementBlock as w, createElementVNode as c, toDisplayString as v, unref as t, createVNode as g, withCtx as E, createTextVNode as B, computed as F, watch as Le, normalizeClass as we, onMounted as At, onBeforeUnmount as Ei, normalizeStyle as Ge, Fragment as Ee, renderList as Ne, createCommentVNode as ue, createBlock as ne, withModifiers as gi, nextTick as Je, inject as Lo, renderSlot as ht, resolveDynamicComponent as ai, withDirectives as pi, vShow as Di, mergeProps as _n, createSlots as Ea, onErrorCaptured as xo, normalizeProps as No, shallowRef as Oi, h as Zt, vModelText as ko, Teleport as wn, reactive as Ui, isRef as Bn } from "vue";
import { useRouter as _i, useRoute as Do } from "vue-router";
import { SearchIcon as Cn, RefreshIcon as In, FullscreenIcon as _a, CloseIcon as Wi, SoundMuteIcon as Oo, SoundIcon as Uo, NotificationIcon as wa, StopCircleIcon as Ca, UploadIcon as Wn, ImageIcon as $o, CutIcon as Po, ChevronDownIcon as $i, ChevronRightIcon as Ia, AddIcon as An, CopyIcon as Dt, DeleteIcon as Fo, EditIcon as Pi, InfoCircleIcon as Nt, LoginIcon as Vo, CheckCircleIcon as Hi, ChatOffIcon as Aa, UserCheckedIcon as Ma, UserBlockedIcon as Sa, MoreIcon as zo, CloseCircleIcon as Go, AdjustmentIcon as Bo } from "tdesign-icons-vue-next";
...
const ul = { class: "monitor-header" }, dl = { class: "monitor-title-section" }, hl = { class: "monitor-title" }, vl = { class: "monitor-header-actions" }, ml = /* @__PURE__ */ Se({
      ...
      return y(), w("div", ul, [
        ...
        c("div", vl, [
          g(f, {
            ...
            clearable: "",
            status: t(Z)(e.searchInput) > t(bi) ? "error" : "default",
            tips: t(Z)(e.searchInput) > t(bi) ? t(s)(t(r).INPUT_EXCEEDS_LENGTH_LIMIT) : "",
  ...
  setup(e, { emit: n }) {
    ...
    const h = F(() => i.isFullscreen && i.fullscreenLiveId === i.card.liveId), m = F(() => i.card.tags.slice(0, i.adaptiveResult.visibleCount)), b = F(() => i.card.tags.slice(i.adaptiveResult.visibleCount)), R = F(() => {
    ...
    }), M = F(() => `live_monitor_view_${i.card.liveId}`), S = async () => {
      ...
      try {
        console.log("[LiveCard] Calling startPlay", { liveId: O, containerId: M.value }), await a({ liveId: O, containerId: M.value }), D === f && (p.value = O, console.log("[LiveCard] startPlay success", { liveId: O }));
      } catch (N) {
        console.error("[LiveCard] startPlay failed", { liveId: O, error: N }), D === f && s("playError", N, O);
      }
    }, Q = async (O = p.value || i.card.liveId) => {
      ...
      return y(), w("div", {
        ...
        c("div", {
          ...
          e.card.tags && e.card.tags.length > 0 ? (y(), w("div", {
            ...
            (y(!0), w(Ee, null, Ne(m.value, (L) => (y(), w("span", {
              key: L,
            ...
            e.adaptiveResult.showMore ? (y(), w("div", wl, [
              ...
              c("div", Cl, [
                (y(!0), w(Ee, null, Ne(b.value, (L) => (y(), w("span", {
                  key: L,
                  class: "live-card-tag-overlay"
                }, [
                  D[1] || (D[1] = c("svg", {
...
function $l(e, n) {
  ...
  const m = C(/* @__PURE__ */ new Set()), b = C(!1), R = () => {
    ...
    return U;
  }, S = (T) => String(T.liveId || T.id || T.RoomId || ""), Q = () => {
    ...
    if (!(k.length === 0 || d.value)) {
      R(), h = U;
      try {
        const { startTime: x, endTime: A } = Q(), ie = await Xs(k, 10, x, A);
  ...
  }, D = F(() => e.currentPage.value), N = F(() => e.hasMore.value), L = F(() => e.loading.value);
  return tt(() => {
    b.value = !0, R(), H();
  }), {
    // 分页状态（响应式 computed）
...
const Pl = { class: "live-monitor-page" }, Fl = { class: "live-monitor-grid" }, Vl = {
  ...
  setup(e) {
    ...
    const { init: s, liveList: o, endLive: a, stopPlay: l, paginatedList: d } = Pt(), u = Lo("sdkReady", null), p = C(!1), f = C(""), h = C(null), m = C(0), b = C({
      ...
      const Ve = me.tags || [], Te = he(Ve, W.value.get(me.liveId));
      return {
        ...me,
        tags: Te
      };
    ...
    const $ = (le, me) => {
      ...
      play: async (me, Ve) => {
        await Je();
        const Te = document.getElementById(Ve);
    ...
    return u && Le(() => u.value, (le) => {
      ...
      D.value = !0, document.removeEventListener("fullscreenchange", Xe), Q(), A();
    }), (le, me) => {
      ...
      return y(), w("div", Pl, [
        g(fl, {
          "search-input": t(fe),
          refreshing: t(de),
          "onUpdate:searchInput": me[0] || (me[0] = (Te) => fe.value = Te),
          onSearch: t(U),
          onClearSearch: t(k),
          onRefresh: t(x)
        ...
        c("div", Fl, [
          ...
          ])) : t(oe) ? (y(!0), w(Ee, { key: 2 }, Ne(ve.value, (Te) => {
            var mt, at;
            return y(), ne(xl, {
              key: `${m.value}:${Te.liveId}`,
              card: Te,
              "adaptive-result": t(M)(Te.liveId),
        ...
        g(Ve, {
          ...
          "onUpdate:visible": me[2] || (me[2] = (Te) => b.value.visible = Te),
        ...
        g(Fa, {
          ...
          "onUpdate:visible": me[3] || (me[3] = (Te) => R.value.visible = Te),
...
function rr(e) {
  ...
  u.factor && R && (u.factor < 1 ? (b = Math.max(u.factor, M.stencil.minimum)) > 1 && (b = 1) : u.factor > 1 && (b = Math.min(u.factor, Math.min(M.area.maximum, M.stencil.maximum))) < 1 && (b = 1)), b && (f = rt(f, b, u.center));
  var S = i.left - s.left, Q = s.width + s.left - (i.width + i.left), V = i.top - s.top, q = s.height + s.top - (i.height + i.top);
  return f = Ye(f = et(f, ri(f, { left: l.left !== void 0 ? l.left - S * b : void 0, top: l.top !== void 0 ? l.top - V * b : void 0, bottom: l.bottom !== void 0 ? l.bottom + q * b : void 0, right: l.right !== void 0 ? l.right + Q * b : void 0 })), a({ visibleArea: f, type: "move" })), h.width = h.width * b, h.height = h.height * b, h.left = f.left + S * b, h.top = f.top + V * b, h = Ye(h, qi(_t(f), l)), u.factor && R && d && (u.factor > 1 ? m = Math.min(M.area.maximum, u.factor) / b : u.factor < 1 && (m = Math.max(h.height / f.height, h.width / f.width, u.factor / b)), m !== 1 && (f = et(f = Ye(f = rt(f, m, u.factor > 1 ? u.center : He(h)), a({ visibleArea: f, type: "move" })), Xi(ri(h, _t(f)))))), { coordinates: h, visibleArea: f };
}
function cr(e) {
...
function va(e) {
  ...
  } else m.width !== 1 / 0 && Kl.forEach((function(M) {
    u[M] *= m.width;
  })), m.height !== 1 / 0 && ql.forEach((function(M) {
    u[M] *= m.height;
  }));
  return u;
}
...
var dr = vt("vue-simple-handler"), hr = vt("vue-simple-handler-wrapper"), Rn = { name: "SimpleHandler", components: { HandlerWrapper: Wa }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, horizontalPosition: { type: String }, verticalPosition: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  ...
  return { default: Fe(dr(n), this.defaultClass, this.hover && this.hoverClass), wrapper: Fe(hr(n), this.wrapperClass) };
...
var vr = vt("vue-simple-line"), mr = vt("vue-simple-line-wrapper"), Ln = { name: "SimpleLine", components: { LineWrapper: Ha }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, position: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  ...
  return { root: Fe(vr(lt({}, this.position, !0)), this.defaultClass, this.hover && this.hoverClass), wrapper: Fe(mr(lt({}, this.position, !0)), this.wrapperClass) };
} }, methods: { onDrag: function(e) {
  this.$emit("drag", e);
}, onEnter: function() {
  this.hover = !0;
...
function yr(e) {
  try {
    ...
    if (a && (s = a + 10, (function(b, R, M) {
      var S, Q = "";
      for (S = R, M += R; S < M; S++) Q += String.fromCharCode(b.getUint8(S));
      return Q;
    })(i, a + 4, 4) === "Exif")) {
      var p = i.getUint16(s);
...
var Ti = vt("vue-preview"), Ja = { props: { coordinates: { type: Object }, transitions: { type: Object }, image: { type: Object, default: function() {
  ...
  return { root: Ti({ fill: this.fill }), wrapper: Ti("wrapper"), imageWrapper: Ti("image-wrapper"), image: Fe(Ti("image"), this.imageClass) };
}, style: function() {
  if (this.fill) return {};
  var e = {};
...
var Er = ["transitions"], wt = vt("vue-advanced-cropper"), to = { name: "Cropper", components: { BackgroundWrapper: pn }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  ...
  if (m) {
    ...
    if (b || (b = l.width >= l.height || m === 1 ? "width" : "height"), b === "width") {
      ...
      if (p.top && p.bottom) {
        ...
        u.bottom = Si(R, S, M), u.top = Si(R, M, S);
      } else p.bottom ? u.bottom = R : p.top ? u.top = R : p.right ? u.right = 0 : p.left && (u.left = 0);
    } else if (b === "height") {
      var Q = l.width - h * m;
      if (p.left && p.right) {
        var V = u.left, q = u.right;
        u.left = -Si(Q, V, q), u.right = -Si(Q, q, V);
      } else p.left ? u.left = -Q : p.right ? u.right = -Q : p.top ? u.top = 0 : p.bottom && (u.bottom = 0);
    }
  ...
  if (this.$refs.canvas) {
    var e = this.$refs.canvas, n = this.$refs.image, i = this.imageTransforms.rotate !== 0 || this.imageTransforms.flip.horizontal || this.imageTransforms.flip.vertical ? (function(d, u, p) {
      ...
      return R.translate(-(M.left - b.width / 2), -(M.top - b.height / 2)), R.rotate(f * Math.PI / 180), R.translate(h.horizontal ? m.width : 0, h.vertical ? m.height : 0), R.scale(h.horizontal ? -1 : 1, h.vertical ? -1 : 1), R.drawImage(u, 0, 0, m.width, m.height), R.restore(), d;
    ...
    try {
      await new Promise((M, S) => {
        R.load(
          ...
          (Q) => {
            try {
              b.loops = n, b.setVideoItem(Q), i && (b.startAnimation(), o.value = !0), M();
            } catch (V) {
              S(V);
            }
          },
...
const Ar = { class: "image-upload-container" }, Mr = {
  ...
  viewBox: "0 0 36 36",
  class: "progress-ring"
}, kr = ["stroke-dasharray"], Dr = { class: "progress-percent" }, Or = { class: "upload-status-text" }, Ur = ["src"], $r = ["src"], Pr = {
  key: 2,
  ...
  setup(e, { expose: n, emit: i }) {
    const { t: s } = ke();
    qo(dn.Parser);
    const o = e, a = i, l = F(() => o.placeholder || s(r.CLICK_OR_DRAG_TO_UPLOAD_COVER_IMAGE)), d = F(() => o.acceptHint || s("Supports JPG/PNG/GIF/WebP max {max}MB", { max: o.maxSize })), u = C(null), p = C(null), f = C(!1), h = C(0), m = C(!1), b = C(""), R = C(!o.uploadEnabled), M = C(o.modelValue), S = C(null), { previewUrl: Q, setPreview: V } = Cr(), q = C(!1), H = C(!1), {
      containerRef: J,
      playUrl: oe
    ...
    Le(() => o.skipSvgaValidation, (P) => {
      ae.updateSkipSvgaValidation(!!P);
    });
    const $ = F(() => Z(M.value));
    Le(() => o.modelValue, (P) => {
      M.value = P, ve.value = "", P && o.uploadEnabled && (R.value = !0), o.deferUpload && (S.value = null, V(null), q.value = !1, H.value = !1, a("fileReady", null));
    }), Le(() => o.uploadEnabled, (P) => {
    ...
    function Ve(P) {
      typeof P == "string" && (M.value = P, ve.value = "", ae.cancelValidation(), he.value = !1);
    }
    function Te(P) {
    ...
    function mt(P) {
      P == null || P.stopPropagation(), ae.cancelValidation(), he.value = !1, ve.value = "", a("update:modelValue", ""), M.value = "", b.value = "", f.value = !1, h.value = 0, m.value = !1, W(), o.deferUpload && (S.value = null, V(null), q.value = !1, H.value = !1, a("fileReady", null));
    }
    function at(P) {
    ...
    return n({
      ...
      get hasUrlError() {
        return R.value ? !!(ve.value || o.maxBytes && M.value.trim() && $.value > o.maxBytes) : !1;
      },
      ...
      reset() {
        ae.reset(), S.value = null, V(null), q.value = !1, H.value = !1, W(), M.value = o.modelValue || "", b.value = "", ve.value = "", f.value = !1, h.value = 0, m.value = !1, o.uploadEnabled && (R.value = !!o.modelValue), a("fileReady", null);
      },
      /**
      ...
      return y(), w("div", Ar, [
        ...
        e.uploadEnabled && !R.value ? (y(), w(Ee, { key: 3 }, [
          t(Q) ? (y(), w("div", {
            ...
            !f.value && b.value ? (y(), w("span", Pr, v(b.value.toUpperCase()), 1)) : ue("", !0),
            !f.value && m.value ? (y(), w("span", Fr, v(t(s)(t(r).UPLOAD_FAILED)), 1)) : !f.value && !b.value ? (y(), w("span", Vr, v(t(s)(t(r).PENDING_UPLOAD)), 1)) : ue("", !0),
  ...
  setup(e, { emit: n }) {
    const { t: i } = ke(), s = e, { extraFieldsSlot: o } = s, { createLive: a } = Pt(), l = n, d = F({
      ...
      value: ae.value,
      label: i(ae.labelKey)
    })), p = (ae) => Z(ae), f = (ae) => Z(ae), h = (ae) => {
      m.value.maxSeatCount = Number(ae) || 1;
    }, m = C(jn()), b = C([]), R = C(!1), M = C(!1), S = C(!1), Q = C(!1), V = C(""), q = C(""), H = C(null), J = C(""), oe = C(null), de = C(!1), fe = F(() => Z(m.value.anchorId)), W = F(() => Z(m.value.liveName));
    F(() => b.value.filter((ae) => ae.key.trim()).length);
    const O = F(() => {
      var ae;
      return i(((ae = cs(m.value.seatTemplate)) == null ? void 0 : ae.descKey) || "");
    }), D = F(() => us(m.value.seatTemplate)), N = F(() => Q.value ? V.value === "error" ? `OBS 配置失败：${q.value}` : H.value ? "OBS 已配置完成，可直接复制下方推流信息。" : J.value ? `OBS 已配置完成，但推流信息生成失败：${J.value}` : "OBS 已配置完成。" : ""), L = F(() => V.value === "error" || !!J.value), T = (ae) => {
      de.value = !!ae;
    }, U = async (ae, $) => {
      try {
      ...
      var ae;
      m.value = jn(), b.value = [], R.value = !1, S.value = !1, Q.value = !1, V.value = "", q.value = "", H.value = null, J.value = "", de.value = !1, (ae = oe.value) == null || ae.reset();
    }, ie = () => {
      ...
      try {
        ...
        try {
          ...
          const je = xe instanceof Vi ? xe.message : `${i(r.COVER_PROCESSING_FAILED)}: ${xe instanceof Error ? xe.message : String(xe) || i(r.UNKNOWN_ERROR)}`;
          j.error(je), M.value = !1;
          return;
        }
        const _e = ds({
          formData: m.value,
        ...
        if (Q.value) {
          ...
          H.value = xe.streamInfo, J.value = xe.streamInfoError, q.value = xe.setupError, Ue = xe.configuredSuccessfully;
        }
        S.value = !0, j.success(Q.value && Ue ? i(r.LIVE_CREATED_SUCCESSFULLY_OBS) : i(r.LIVE_CREATED_SUCCESSFULLY));
      } catch (ce) {
    ...
    return (ae, $) => {
      const ce = ee("t-input"), _e = ee("t-form-item"), Ue = ee("t-select"), xe = ee("t-input-number"), je = ee("t-checkbox"), Xe = ee("t-button"), ct = ee("t-form"), pe = ee("t-dialog");
      return y(), ne(pe, {
        visible: d.value,
            ...
            c("div", yc, [
              S.value ? (y(), ne(Xe, {
                ...
                g(Xe, {
                  ...
                  default: E(() => [
                    B(v(M.value ? t(i)(t(r).CREATING) : t(i)(t(r).CREATE)), 1)
                  ]),
                  _: 1
                }, 8, ["loading", "disabled"])
              ], 64))
            ...
            default: E(() => [
              ...
              g(_e, {
                ...
                default: E(() => [
                  g(je, {
                    modelValue: Q.value,
                    "onUpdate:modelValue": $[4] || ($[4] = (ge) => Q.value = ge)
                  }, {
                    default: E(() => [
  ...
  setup(e, { emit: n }) {
    const { t: i } = ke(), { fetchLiveDetail: s, updateLive: o } = Pt(), a = e, l = F(() => a.room ? "RoomId" in a.room && a.room.RoomId ? a.room.RoomId : "id" in a.room && a.room.id ? a.room.id : "" : ""), d = n, u = F({
    ...
    }), p = (O) => Z(O), f = (O) => Z(O), h = C(Xn()), m = C([]), b = C(!1), R = C([]), M = C(Kn), S = C(null), Q = C(!1), { loading: V, execute: q } = io({
      action: async (O) => {
        var N, L;
      ...
      Q.value = !!O;
    }, J = F(() => Z(h.value.liveName));
    F(() => m.value.filter((O) => O.key.trim()).length), Le([() => {
      var O, D;
      ...
      if (N && D) {
        ...
        h.value = {
          liveName: L || "",
          coverUrl: T || ""
        }, T ? M.value = await hs(T) : M.value = Kn;
        try {
    ...
    const oe = () => {
      ...
      var O;
      m.value = [], b.value = !1, R.value = [], Q.value = !1, (O = S.value) == null || O.reset(), h.value = Xn(), d("update:visible", !1);
    }, W = async () => {
      if (a.room) {
          ...
          g(U, {
            ...
            default: E(() => [
              ...
              c("div", wc, [
                ...
                b.value ? (y(), w("div", Ic, [
                  (y(!0), w(Ee, null, Ne(m.value, (x, A) => (y(), w("div", {
                    key: A,
                    class: "custom-info-row"
                  }, [
                    c("div", Ac, [
  ...
  setup(e) {
    ...
    const R = (L) => L.fitContent || i.fitContent && L.width === void 0, M = (L) => typeof L == "number" ? `${L}px` : L, S = (L) => {
      if (R(L)) {
      ...
      const L = {};
      for (const T of i.columns) L[T.key] = { width: S(T) };
      return L;
    }), V = F(() => {
      const L = {};
      ...
      L.forEach(({ column: $, index: ce }) => {
        ...
        _e && (k.push(_e), x.push($.key)), U.forEach((Ue) => {
          const xe = Ue.children[ce];
          xe && (k.push(xe), x.push($.key));
        });
      });
      const A = ks(k), ie = {};
      A.forEach(($, ce) => {
    ...
    return At(() => {
      ...
      c("div", {
        ...
        c("table", {
          ...
          c("colgroup", null, [
            (y(!0), w(Ee, null, Ne(e.columns, (U) => (y(), w("col", {
              key: U.key,
              style: Ge(Q.value[U.key])
            }, null, 4))), 128))
          ]),
          c("thead", null, [
            c("tr", null, [
              (y(!0), w(Ee, null, Ne(e.columns, (U) => (y(), w("th", {
                key: U.key,
      ...
      c("div", {
        ...
        e.loading ? (y(), w("div", Lc, [
          ...
          c("tbody", null, [
            (y(!0), w(Ee, null, Ne(e.data, (U, k) => (y(), w("tr", {
              key: O(U, k),
              class: we(D(U, k))
            }, [
              (y(!0), w(Ee, null, Ne(e.columns, (x) => (y(), w("td", {
                key: x.key,
  ...
  setup(e) {
    ...
    return (m, b) => {
      var V, q, H;
      const R = ee("t-input"), M = ee("t-button"), S = ee("t-card"), Q = ee("t-dialog");
      return y(), w("div", Oc, [
        c("div", Uc, [
...
}), Uu = { class: "live-control-navbar" }, $u = { class: "nav-left" }, Pu = ["viewBox", "stroke-width", "stroke-linecap"], Fu = ["d"], Vu = { class: "nav-right" }, zu = /* @__PURE__ */ Se({
  __name: "NavBar",
  props: {
  ...
  setup(e) {
    const { t: n } = ke(), i = e, { loginUserInfo: s } = Ua(), { currentLive: o } = Pt(), { audienceList: a, disableSendMessage: l } = $a(), d = F(() => i.currentLive || o.value), u = (D) => new TextEncoder().encode(D).length, p = C(!1), f = C({ top: 0, left: 0 }), h = C(null), m = C(""), b = C(!1), R = C(null), M = C(null), S = C(null), Q = F(() => b.value || !i.liveId || !m.value.trim()), V = (D) => a.value.find((N) => N.userId === D), q = (D) => {
      const N = V(D);
      if (N)
      ...
      M.value && M.value.contains(D.target) || (p.value = !1, h.value = null);
    };
    return Le(p, (D) => {
  ...
  setup(e, { emit: n }) {
    const i = e, s = n, { login: o, loginUserInfo: a } = Ua(), { joinLive: l, leaveLive: d, subscribeEvent: u, unsubscribeEvent: p, LiveListEvent: f } = ol(), h = C(!1), m = C(""), b = C(!1), R = C(""), M = F(
      () => {
        var q;
    ...
    return Le(
      ...
      async () => {
        !i.liveId || !i.currentLive || (await Q(), await V());
      },
      { immediate: !0 }
    ), Le(
      () => i.liveId,
...
}), wd = { class: "sidebar-stats-card" }, Cd = { class: "stats-card-header" }, Id = { class: "stats-header-left" }, Ad = { class: "live-status-tag" }, Md = { class: "live-duration-text" }, Sd = { class: "update-time" }, Td = { class: "stat-bar-item" }, Rd = { class: "stat-label" }, Ld = { class: "stat-value" }, xd = { class: "stat-bar-item" }, Nd = { class: "stat-label" }, kd = { class: "stat-value" }, Dd = { class: "stat-bar-item" }, Od = { class: "stat-label" }, Ud = { class: "stat-value" }, $d = { class: "stat-bar-item" }, Pd = { class: "stat-label" }, Fd = { class: "stat-value" }, Vd = { class: "stat-bar-item" }, zd = { class: "stat-label" }, Gd = { class: "stat-value" }, Bd = { class: "stat-bar-item" }, Wd = { class: "stat-label" }, Hd = { class: "stat-value" }, Yd = { class: "stat-bar-item" }, jd = { class: "stat-label" }, Xd = { class: "stat-value" }, Kd = /* @__PURE__ */ Se({
  __name: "StatsCard",
  props: {
    stats: {},
    liveDuration: {},
  ...
  setup(e) {
    ...
    const l = (f, h, m) => {
      ...
      const h = d(f);
      if (!h.length) return;
      const m = parseFloat(getComputedStyle(f).columnGap) || 0, b = f.clientWidth, R = [7, 4, 3, 2, 1].find((M) => l(h, M, m) <= b + 1) || 1;
...
}), Fh = { class: "dropdown-header" }, Vh = /* @__PURE__ */ Se({
...
function zh() {
  ...
  return {
    ...
    showModerationDropdown: (M, S, Q, V) => {
      n.visible = !0, n.x = M, n.y = S, n.itemId = Q, n.content = V;
    },
    hideModerationDropdown: () => {
      n.visible = !1;
    },
    showAudienceDropdown: (M, S, Q, V) => {
      i.visible = !0, i.x = M, i.y = S, i.userId = Q, i.userName = V;
    },
...
const Gh = { class: "live-control-container" }, Bh = { class: "live-control-viewport" }, Wh = { class: "right-sidebar" }, Ri = 20, Hh = /* @__PURE__ */ Se({
  ...
  setup(e) {
    var Gn;
    const n = Do(), i = _i(), s = F(() => n.params.liveId), o = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__, { t: a } = ke(), { currentLive: l, fetchLiveDetail: d, fetchLiveStats: u, endLive: p, updateLive: f } = Pt(), { audienceList: h, audienceCount: m } = $a(), b = (Gn = Yi().components) == null ? void 0 : Gn.roomControl, {
      mutedList: R,
      bannedList: M,
      memberLoading: S,
      muteMember: Q,
      ...
      await Q({ memberAccounts: [_], muteTime: I });
    }, U = async (_) => {
    ...
    } = zh(), ae = F(() => Oa() || ""), $ = C(!0), ce = C(null), _e = C(!1), Ue = C("chat"), xe = C(0), je = C(null), Xe = C(/* @__PURE__ */ new Map()), ct = C(null), pe = Ui({
      onlineCount: 0,
      totalViewers: 0,
      totalMsgCount: 0,
    ...
    const Ve = C([]), Te = C(1), mt = O, at = C(0), P = C([]), se = F(
      ...
      if (!mt.value && s.value)
        try {
          ...
          Ve.value = Pe.map(it), at.value = Math.max(0, fe.value - Ci), Te.value = G, P.value = P.value.filter(
            (To) => Pe.some((Ro) => Ro.id === To)
          );
        } catch (G) {
          console.error("[moderation] load failed:", G), j.error(a(r.OPERATION_FAILED));
        }
    }, Qi = async () => {
      await Ft(Te.value), j.success(a(r.REFRESHED));
    }, wi = (_) => {
      ...
      const I = Math.max(0, at.value - _.length), G = Math.max(1, Math.ceil(I / Ri)), Y = Math.min(Te.value, G);
      await Ft(Y);
    }, z = (_) => {
    ...
    const en = F(
      ...
      di(), ve.value = !0;
    }, po = (_) => Array.isArray(R.value) && R.value.some((I) => I.userId === _), Fn = (_) => Array.isArray(M.value) && M.value.some((I) => I.userId === _), bo = (_) => {
    ...
    Le(
      ...
      { immediate: !0 }
    ), s.value && (Ao(), Vn(), Ft(1)), s.value && (Kt = window.setInterval(() => {
      if (je.value) {
    ...
    return Le(Ue, (_) => {
      ...
      return y(), w("div", Gh, [
        ...
        g(t(Vh), {
          ...
          "is-banned": Fn(((be = dt.value) == null ? void 0 : be.userId) || ""),
  ...
  setup(e) {
    ...
    const R = F(() => d.value.giftLangConfig), M = F(() => d.value.editingLang);
    F(() => d.value.editingGiftForLang);
    const S = F(() => d.value.langEditForm);
    F(() => d.value.editingCategoryGift);
    const Q = F(() => d.value.allCategories), V = F(() => d.value.giftCategoryIds);
    ...
    const q = F({
      ...
      () => Q.value.filter((z) => !V.value.includes(z.id))
      ...
      if (A.description && Z(A.description) > Qe) {
      ...
      const z = S.value;
      if (z.name && Z(z.name) > Ze) {
        j.error(o("Gift name max bytes", { max: Ze }));
        return;
      }
      if (z.description && Z(z.description) > Qe) {
        j.error(o("Gift desc max bytes", { max: Qe }));
        return;
      }
    ...
    return At(async () => {
      ...
      return y(), w("div", Yh, [
          ...
          default: E(() => [
            g(Zi, {
              ...
              "cell-languageList": E(({ row: X }) => [
                c("div", nv, [
                  X.languageList && X.languageList.length > 0 ? (y(!0), w(Ee, { key: 0 }, Ne(X.languageList, (ye) => (y(), w("span", {
                    key: t(ii)(ye),
                    class: "gift-lang-tag",
                  ...
                  m.value ? ue("", !0) : (y(), ne(Oe, {
                    ...
                    default: E(() => [
                      g(We, {
                        ...
                        status: t(Z)(A.id) > t(Ht) ? "error" : "default",
                        tips: t(Z)(A.id) > t(Ht) ? t(o)("Gift ID max bytes", { max: t(Ht) }) : ""
                      }, {
                        suffix: E(() => [
                          c("span", {
                            class: we(["input-suffix-count", { "byte-overflow": t(Z)(A.id) > t(Ht) }])
                          }, v(t(Z)(A.id)) + "/" + v(t(Ht)), 3)
                        ]),
                        _: 1
                      }, 8, ["modelValue", "placeholder", "status", "tips"])
                  ...
                  g(Oe, {
                    ...
                    default: E(() => [
                      g(We, {
                        ...
                        status: t(Z)(A.name) > t(Ze) ? "error" : "default",
                        tips: t(Z)(A.name) > t(Ze) ? t(o)("Gift name max bytes", { max: t(Ze) }) : ""
                      }, {
                        suffix: E(() => [
                          c("span", {
                            class: we(["input-suffix-count", { "byte-overflow": t(Z)(A.name) > t(Ze) }])
                          }, v(t(Z)(A.name)) + "/" + v(t(Ze)), 3)
                        ]),
                        _: 1
                      }, 8, ["modelValue", "placeholder", "status", "tips"])
                    ]),
                  ...
                  g(Oe, {
                    ...
                    default: E(() => [
                      g(We, {
                        ...
                        status: t(Z)(A.description) > t(Qe) ? "error" : "default",
                        tips: t(Z)(A.description) > t(Qe) ? t(o)("Gift desc max bytes", { max: t(Qe) }) : ""
                      }, {
                        suffix: E(() => [
                          c("span", {
                            class: we(["input-suffix-count", { "byte-overflow": t(Z)(A.description) > t(Qe) }])
                          }, v(t(Z)(A.description)) + "/" + v(t(Qe)), 3)
                        ]),
                        _: 1
                      }, 8, ["modelValue", "placeholder", "status", "tips"])
                    ]),
                    ...
                    default: E(() => [
                      c("div", uv, [
                        g(jt, {
                          ...
                          autosize: { minRows: 3 },
                          status: t(Z)(A.extensionInfo) > t(hi) ? "error" : "default"
                        }, null, 8, ["modelValue", "placeholder", "status"]),
                        c("span", {
                          class: we(["textarea-suffix-count", { "byte-overflow": t(Z)(A.extensionInfo) > t(hi) }])
                        }, v(t(Z)(A.extensionInfo)) + "/" + v(t(hi)), 3)
                      ]),
                      t(Z)(A.extensionInfo) > t(hi) ? (y(), w("div", dv, v(t(o)("Extension info max bytes", { max: t(hi) })), 1)) : ue("", !0)
                    ]),
                    _: 1
                  }, 8, ["label"])
                ];
          ...
          default: E(() => [
            c("div", hv, [
              ...
              c("table", fv, [
                ...
                c("tbody", null, [
                  (y(!0), w(Ee, null, Ne(t(ka), (X) => (y(), w("tr", { key: X }, [
                ...
                g(Oe, {
                  ...
                  default: E(() => [
                    g(We, {
                      ...
                      status: t(Z)(S.value.name) > t(Ze) ? "error" : "default",
                      tips: t(Z)(S.value.name) > t(Ze) ? t(o)(t(r).GIFT_NAME_MAX_BYTES, { max: t(Ze) }) : "",
                      "onUpdate:modelValue": ve
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Z)(S.value.name) > t(Ze) }])
                        }, v(t(Z)(S.value.name)) + "/" + v(t(Ze)), 3)
                      ]),
                      _: 1
                    }, 8, ["model-value", "placeholder", "status", "tips"])
                  ]),
                ...
                g(Oe, {
                  ...
                  default: E(() => [
                    g(We, {
                      ...
                      status: t(Z)(S.value.description) > t(Qe) ? "error" : "default",
                      tips: t(Z)(S.value.description) > t(Qe) ? t(o)(t(r).GIFT_DESC_MAX_BYTES, { max: t(Qe) }) : "",
                      "onUpdate:modelValue": ae
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Z)(S.value.description) > t(Qe) }])
                        }, v(t(Z)(S.value.description)) + "/" + v(t(Qe)), 3)
                      ]),
                      _: 1
                    }, 8, ["model-value", "placeholder", "status", "tips"])
                  ]),
        ...
        g(qe, {
          ...
          default: E(() => [
            c("div", Ev, [
              V.value.length > 0 ? (y(!0), w(Ee, { key: 0 }, Ne(V.value, (X) => (y(), w("span", {
                key: X,
          ...
          default: E(() => [
            c("div", Cv, [
              g(Ji, {
                ...
                default: E(() => [
                  (y(!0), w(Ee, null, Ne(D.value, (X) => (y(), ne(zt, {
                    key: X.id,
                    value: X.id,
                    label: X.name
...
}, kv = { class: "gift-category-table-wrapper" }, Dv = { class: "gift-id" }, Ov = { class: "gift-id-text" }, Uv = { class: "category-name" }, $v = { class: "category-desc" }, Pv = { class: "category-lang-tags" }, Fv = ["onClick"], Vv = {
  key: 1,
  ...
  setup(e) {
    const n = _i(), { t: i } = ke(), s = Pa(), o = new Ss({
      actions: {
      ...
      if (k.name && Z(k.name) > ot) {
        j.error(i("Category name max bytes", { max: ot }));
        return;
      }
      if (k.description && Z(k.description) > st) {
    ...
    return At(() => {
      ...
      return y(), w("div", Mv, [
        ...
        c("div", kv, [
          g(Zi, {
            ...
            "cell-languageList": E(({ row: $ }) => [
              c("div", Pv, [
                $.languageList && $.languageList.length > 0 ? (y(!0), w(Ee, { key: 0 }, Ne($.languageList, (ce) => (y(), w("span", {
                  key: t(ii)(ce),
                  class: "category-lang-tag",
                  onClick: (_e) => O($.id, ce)
                }, v(t(i)(t(Na)(t(ii)(ce)))), 9, Fv))), 128)) : (y(), w("span", Vv, "-")),
                g(t(Pi), {
                ...
                g(he, {
                  ...
                  default: E(() => [
                    g(ie, {
                      ...
                      disabled: p.value,
                      status: t(Z)(f.value.categoryId) > t(vi) ? "error" : "default",
                      tips: t(Z)(f.value.categoryId) > t(vi) ? t(i)("Category ID max bytes", { max: t(vi) }) : ""
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Z)(f.value.categoryId) > t(vi) }])
                        }, v(t(Z)(f.value.categoryId)) + "/" + v(t(vi)), 3)
                      ]),
                      _: 1
                ...
                g(he, {
                  ...
                  default: E(() => [
                    g(ie, {
                      ...
                      status: t(Z)(f.value.name) > t(ot) ? "error" : "default",
                      tips: t(Z)(f.value.name) > t(ot) ? t(i)("Category name max bytes", { max: t(ot) }) : ""
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Z)(f.value.name) > t(ot) }])
                        }, v(t(Z)(f.value.name)) + "/" + v(t(ot)), 3)
                      ]),
                      _: 1
                    }, 8, ["modelValue", "placeholder", "status", "tips"])
                  ]),
                ...
                g(he, {
                  ...
                  default: E(() => [
                    g(ie, {
                      ...
                      status: t(Z)(f.value.description) > t(st) ? "error" : "default",
                      tips: t(Z)(f.value.description) > t(st) ? t(i)("Category desc max bytes", { max: t(st) }) : ""
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Z)(f.value.description) > t(st) }])
                        }, v(t(Z)(f.value.description)) + "/" + v(t(st)), 3)
                      ]),
                      _: 1
                    }, 8, ["modelValue", "placeholder", "status", "tips"])
                  ]),
        ...
        g(ae, {
          visible: M.value,
          "onUpdate:visible": x[6] || (x[6] = ($) => M.value = $),
          ...
          default: E(() => [
            c("div", Yv, [
              ...
              c("table", Kv, [
                ...
                c("tbody", null, [
                  (y(!0), w(Ee, null, Ne(t(ka), ($) => (y(), w("tr", { key: $ }, [
                ...
                g(he, {
                  ...
                  default: E(() => [
                    g(ie, {
                      ...
                      status: t(Z)(b.value.name) > t(ot) ? "error" : "default",
                      tips: t(Z)(b.value.name) > t(ot) ? t(i)(t(r).CATEGORY_NAME_MAX_BYTES, { max: t(ot) }) : ""
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Z)(b.value.name) > t(ot) }])
                        }, v(t(Z)(b.value.name)) + "/" + v(t(ot)), 3)
                      ]),
                      _: 1
                    }, 8, ["modelValue", "placeholder", "status", "tips"])
                  ]),
                ...
                g(he, {
                  ...
                  default: E(() => [
                    g(ie, {
                      ...
                      status: t(Z)(b.value.description) > t(st) ? "error" : "default",
                      tips: t(Z)(b.value.description) > t(st) ? t(i)(t(r).CATEGORY_DESC_MAX_BYTES, { max: t(st) }) : ""
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Z)(b.value.description) > t(st) }])
                        }, v(t(Z)(b.value.description)) + "/" + v(t(st)), 3)
                      ]),
                      _: 1
                    }, 8, ["modelValue", "placeholder", "status", "tips"])
                  ]),
        ...
        g(ae, {
          visible: Q.value,
          "onUpdate:visible": x[11] || (x[11] = ($) => Q.value = $),
...
function Pt() {
  const e = () => {
    Re || (Re = new Ts({
      onStateChange: (S) => {
        S.liveList !== void 0 && (ga.value = S.liveList), S.hasMore !== void 0 && (pa.value = S.hasMore), S.currentLive !== void 0 && (ba.value = S.currentLive), S.loading !== void 0 && (tm.value = S.loading), S.error !== void 0 && (im.value = S.error);
      },
      getActive: () => em
  ...
  return tt(() => {
    ...
    if (e(), ya(), De) {
      const S = De.getSnapshot();
      ki.value = S.pageData, bn.value = S.currentPage, yn.value = S.hasMore, En.value = S.loading;
    }
  }), Re || e(), ya(), {
    init: (S) => {
      if (console.log("[useLiveMonitorState] init called", { hasCore: !!Re, configKeys: Object.keys(S) }), Re || (console.warn("[useLiveMonitorState] core is null, initializing..."), e(), console.log("[useLiveMonitorState] after initCore, hasCore:", !!Re)), !Re) {
    ...
    fetchLiveDetail: async (S) => Re ? Re.fetchLiveDetail(S) : (console.warn("[useLiveMonitorState] fetchLiveDetail: core is null, returning null"), null),
    fetchLiveStats: async (S) => Re ? Re.fetchLiveStats(S) : (console.warn("[useLiveMonitorState] fetchLiveStats: core is null, returning empty object"), {}),
    startPlay: async (S) => {
      if (!Re) {
        console.warn("[useLiveMonitorState] startPlay: core is null, skipping");
        return;
      }
      return Re.startPlay(S);
    },
    stopPlay: async (S) => {
      if (!Re) {
    ...
    paginatedList: {
      ...
      hasMore: yn,
      loading: En,
      nextPage: () => (De == null ? void 0 : De.nextPage()) ?? Promise.resolve(),
      prevPage: () => (De == null ? void 0 : De.prevPage()) ?? Promise.resolve(),
      goToFirstPage: () => (De == null ? void 0 : De.goToFirstPage()) ?? Promise.resolve(),
      refreshCurrentPage: () => (De == null ? void 0 : De.refreshCurrentPage()) ?? Promise.resolve()
    }
  };
}
export {
