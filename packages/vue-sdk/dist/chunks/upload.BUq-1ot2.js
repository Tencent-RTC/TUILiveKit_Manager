import { bh as g, bf as p, g as d } from "./main-layout.OEkSp6vd.js";
import { bh as w, bg as b, bb as m, L as v } from "./shared-state.Bf8CkvaR.js";
...
async function P(r, t, a = "image/jpeg", s = 0.92) {
  const e = new Image();
...
async function S(r, t = "image/jpeg", a = 0.92) {
  if (!r)
...
async function M(r, t = "cover", a) {
  ...
  if (e.code !== 0)
    throw new v(e.message || "", e.code, void 0, "uploadImage");
  return e.data;
}
export {
  u as I,
