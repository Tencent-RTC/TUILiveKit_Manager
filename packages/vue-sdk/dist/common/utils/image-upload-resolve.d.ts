...
/** 解析失败时抛出的带标签错误 */
export declare class ImageUploadResolveError extends Error {
    /** 错误来源标签，如 "封面" / "缩略图" */
    label: string;
    ...
    /** 原始错误 */
    cause: unknown;
    constructor(label: string, type: 'url-validation' | 'upload', originalError: unknown);
}
/**
 ...
 * ```
 */
export declare function resolveImageUploadUrl(options: ResolveImageUploadOptions): Promise<string>;
/**
 ...
 * ```
 */
export declare function resolveMultipleImageUploads(uploads: ResolveImageUploadOptions[]): Promise<string[]>;
/**
 ...
 */
export declare function getUploadErrorMessage(error: unknown, fallbackLabel?: string): string;
