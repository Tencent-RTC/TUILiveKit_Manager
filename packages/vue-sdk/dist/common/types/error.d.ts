 ...
 */
/** 通用错误码 */
export declare enum ClientCommonError {
    /** 操作成功 */
    SUCCESS = 0,
    /** 暂未归类的通用错误 */
    UNKNOWN = -1,
...
/** 直播管理相关错误码 */
export declare enum LiveError {
    /** 需要进房后才可使用此功能 */
    NOT_IN_ROOM = -2101,
    /** 房主不支持退房操作 */
    OWNER_EXIT_NOT_ALLOWED = -2102,
    /** 当前直播类型下不支持该操作 */
    LIVE_TYPE_NOT_SUPPORTED = -2103,
    /** 创建直播 ID 非法 */
    INVALID_LIVE_ID = -2105,
    /** 直播名称非法 */
    INVALID_LIVE_NAME = -2107,
    /** 当前用户已在别的直播内 */
    ALREADY_IN_ANOTHER_LIVE = -2108
}
/** 直播内用户信息错误码 */
export declare enum LiveUserError {
    /** 未找到该用户 */
    USER_NOT_FOUND = -2200
}
/** 权限与麦位管理错误码 */
export declare enum SeatPermissionError {
    /** 需要房主权限才能操作 */
...
/** 直播预加载错误码 */
export declare enum PreloadError {
    /** 当前直播不支持预加载 */
    PRELOAD_NOT_SUPPORTED = -4001
}
export declare enum RestApiError {
    /** HTTP 解析错误 */
...
export declare enum ServerError {
    ...
    /** 直播 ID 已被使用 */
    LIVE_ID_ALREADY_USED = 100003,
    /** 直播不存在 */
    LIVE_NOT_EXIST = 100004,
    /** 非直播成员 */
    NOT_LIVE_MEMBER = 100005,
    /** 操作权限不足 */
    PERMISSION_DENIED = 100006,
    /** 无付费信息 */
    NO_PAYMENT_INFO = 100007,
    /** 直播成员已满 */
    LIVE_MEMBERS_FULL = 100008,
    /** 标签数量超上限 */
    TAG_LIMIT_EXCEEDED = 100009,
    /** 直播 ID 已被使用，操作者为主播 */
    LIVE_ID_USED_BY_OWNER = 100010,
    /** 直播 ID 已被 IM 占用 */
    LIVE_ID_OCCUPIED_BY_IM = 100011,
    /** 频率超过限制 */
    RATE_LIMITED = 100012,
    /** 超过付费上限 */
    PAYMENT_LIMIT_EXCEEDED = 100013,
    /** 无效的直播类型 */
    INVALID_LIVE_TYPE = 100015,
    /** 该成员已经被封禁 */
    MEMBER_BANNED = 100016,
    /** 该成员已经被禁言 */
    MEMBER_MUTED = 100017,
    /** 当前直播需要密码才能进入 */
    LIVE_PASSWORD_REQUIRED = 100018,
    /** 进直播密码错误 */
    LIVE_PASSWORD_WRONG = 100019,
    /** 管理员数量超过上限 */
    ...
    /** 该直播已经在连线中 */
    LIVE_ALREADY_CONNECTED = 100401,
    /** 该直播存在待处理的连线请求 */
    PENDING_CONNECTION_REQUEST = 100402,
    /** 当前直播与其他直播连线中 */
    LIVE_CONNECTED_TO_OTHER = 100403,
    /** 超过连线和 battle 直播数量上限 */
    ...
    /** 发起的 battle 里没有一个有效的直播 */
    NO_VALID_BATTLE_LIVE = 100412,
    /** 短时间内频繁发起 battle */
    BATTLE_TOO_FREQUENT = 100413,
    /** 该直播已经不在 battle 中 */
    LIVE_NOT_IN_BATTLE = 100414,
    /** 该直播处于其他的 battle 场次中 */
    LIVE_IN_OTHER_BATTLE = 100415,
    /** 该直播存在待处理的 battle 请求 */
    PENDING_BATTLE_REQUEST = 100416,
    /** 该直播处于 battle 中 */
    LIVE_IN_BATTLE = 100419,
    /** 该 battle 场次还未开始 */
    BATTLE_NOT_STARTED = 100420,
    /** 该 battle 场次已经结束 */
    BATTLE_ALREADY_ENDED = 100421,
    /** 直播 meta 数据中的 key 数量超过上限 */
    META_KEY_LIMIT_EXCEEDED = 100500,
    /** 直播 meta 数据中单个 key 对应的 val 超过最大字节数限制 */
    META_VALUE_SIZE_EXCEEDED = 100501,
    /** 直播 meta 数据中所有 key 对应的 val 总和超过最大字节数限制 */
    META_TOTAL_SIZE_EXCEEDED = 100502,
    /** 删除直播 meta 数据时，被删除的 key 没有一个存在 */
    META_KEY_NOT_EXIST = 100503,
    /** 直播 meta 数据中的 key 大小超过了最大字节数限制 */
