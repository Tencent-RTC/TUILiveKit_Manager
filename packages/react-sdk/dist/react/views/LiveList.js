...
import { ChevronDownIcon as ye, ChevronRightIcon as Me, CloseIcon as be, AddIcon as Ce, FileCopyIcon as ae, SearchIcon as We, RefreshIcon as $e } from "tdesign-icons-react";
import { h as xe, d as je, I as e, ar as he, C as De, z as qe, L as Qe, B as Je, n as Ze, aR as er } from "../../chunks/shared-state.Bf8CkvaR.js";
import { a4 as rr, aq as Se, A as ee, g as N, S as R, aO as ar, b1 as Le, b5 as tr, C as F, b8 as Ee, ao as sr, aa as ir, bG as nr, ar as Oe, a1 as Ae, ay as or, bR as lr, ak as cr, aP as dr, V as mr, ad as ur, aI as vr, R as Ne, bb as fr } from "../../chunks/main-layout.OEkSp6vd.js";
import { r as Ue, I as Ve, b as hr } from "../../chunks/upload.BUq-1ot2.js";
import { g as Er } from "../../chunks/columns.CY8AmK1x.js";
import { M as Ir } from "../../chunks/MonitorPagination.DA0Y5Aae.js";
import { a as ge, M as me } from "../../chunks/useAsyncAction.R1AlIQqh.js";
import { I as we } from "../../chunks/ImageUpload.DB6Sd-EZ.js";
import { S as te } from "../../chunks/SlotRenderer.C2--beKA.js";
...
function gr({ visible: D, onClose: s, onSuccess: H, uploadEnabled: X = !1, extraFieldsSlot: q, onCreate: se }) {
  const { t } = _e(), { opSuccess: k, opFailed: a } = je(t), _ = rr.map((n) => ({
    ...
    try {
      ...
      Cr.error("handleCopy", `复制失败 (ErrorCode: ${qe(y).code || "N/A"})`, y);
    ...
    if (c > R) {
      $("error", t(e.MAX_BYTES_WITH_CURRENT, { field: t(e.LIVE_TITLE), max: R, current: c }));
      return;
    }
    if (h.some(Ee)) {
  ...
  return /* @__PURE__ */ r(
    fe,
    {
      ...
      footer: P ? /* @__PURE__ */ r(
        ...
        /* @__PURE__ */ r(S, { shape: "round", variant: "outline", onClick: A, children: t(e.CANCEL) }),
        /* @__PURE__ */ r(
          S,
          {
            shape: "round",
            ...
            /* @__PURE__ */ i("div", { className: "stream-info-items", children: [
              /* @__PURE__ */ i("div", { className: "stream-info-item", children: [
                /* @__PURE__ */ i("div", { className: "stream-info-label", children: [
                  ...
                  /* @__PURE__ */ r(S, { variant: "text", size: "small", icon: /* @__PURE__ */ r(ae, { size: "14" }), onClick: () => m(u.serverUrl, t(e.SERVER_URL)), children: t(e.COPY) })
                ] }),
              ...
              /* @__PURE__ */ i("div", { className: "stream-info-item", children: [
                /* @__PURE__ */ i("div", { className: "stream-info-label", children: [
                  ...
                  /* @__PURE__ */ r(S, { variant: "text", size: "small", icon: /* @__PURE__ */ r(ae, { size: 14 }), onClick: () => m(u.streamKey, t(e.STREAM_KEY)), children: t(e.COPY) })
                ] }),
          ...
          /* @__PURE__ */ r(Y, { label: t(e.LIVE_TITLE), children: /* @__PURE__ */ i("div", { className: "form-field__input-wrapper", children: [
            /* @__PURE__ */ r(
              G,
              {
                ...
                status: N(o.liveName) > R ? "error" : "default",
                suffix: /* @__PURE__ */ i("span", { className: `input-suffix-count${N(o.liveName) > R ? " byte-overflow" : ""}`, children: [
                  N(o.liveName),
                  "/",
                  R
                ] })
            ...
            N(o.liveName) > R && /* @__PURE__ */ r("div", { className: "form-field__error-tip", children: t(e.MAX_BYTES, { field: t(e.LIVE_TITLE), max: R }) })
          ] }) }),
          ...
          /* @__PURE__ */ i("div", { className: "custom-info-section", children: [
            /* @__PURE__ */ i(
              "div",
              {
                ...
                onClick: () => b(!M),
                children: [
                  M ? /* @__PURE__ */ r(ye, { size: "16" }) : /* @__PURE__ */ r(Me, { size: "16" }),
            ...
            M && /* @__PURE__ */ i("div", { className: "custom-info-container", children: [
              h.map((n, c) => {
                const y = N(n.key), j = N(n.value), oe = y > F.maxKeyBytes, w = j > F.maxValueBytes, Te = Ee(n);
              ...
              h.length < F.maxCount && /* @__PURE__ */ r(S, { variant: "text", className: "add-custom-info-btn", onClick: d, icon: /* @__PURE__ */ r(Ce, { size: "14" }), theme: "primary", children: t(e.ADD) })
            ] })
          ] })
        ] })
      )
...
function Tr({ visible: D, live: s, onClose: H, onSuccess: X, uploadEnabled: q = !1, extraFieldsSlot: se, onUpdate: t, onFetchDetail: k }) {
  ...
  const W = () => {
    ...
    if (m > R) {
      x("error", a(e.MAX_BYTES_WITH_CURRENT, { field: a(e.LIVE_TITLE), max: R, current: m }));
      return;
    }
    if (I.some(Ee)) {
    ...
    try {
      ...
      try {
        ...
        Re.error("EditLive", `Cover processing failed: ${A instanceof Error ? A.message : String(A)}`, A), x("error", A instanceof Ve ? A.message : a(e.COVER_PROCESSING_FAILED));
        return;
      }
      const v = lr(I);
      if (v) {
      ...
      Re.error("EditLiveModal", "Update failed:", d);
    }
  };
  return !D || !s ? null : /* @__PURE__ */ r(
    fe,
    {
      ...
      footer: /* @__PURE__ */ i(le, { children: [
        /* @__PURE__ */ r(S, { shape: "round", variant: "outline", onClick: Z, children: a(e.CANCEL) }),
        /* @__PURE__ */ r(
          S,
          {
            shape: "round",
        ...
        /* @__PURE__ */ r(Y, { label: a(e.LIVE_TITLE), requiredMark: !0, children: /* @__PURE__ */ i("div", { className: "form-field__input-wrapper", children: [
          /* @__PURE__ */ r(
            G,
            {
              ...
              status: N(_.liveName) > R ? "error" : "default",
              suffix: /* @__PURE__ */ i("span", { className: `input-suffix-count${N(_.liveName) > R ? " byte-overflow" : ""}`, children: [
                N(_.liveName),
                "/",
                R
              ] })
          ...
          N(_.liveName) > R && /* @__PURE__ */ r("div", { className: "form-field__error-tip", children: a(e.MAX_BYTES, { field: a(e.LIVE_TITLE), max: R }) })
        ] }) }),
        ...
        /* @__PURE__ */ i("div", { className: "custom-info-section", children: [
          /* @__PURE__ */ i(
            "div",
            {
              ...
              onClick: () => M(!U),
              children: [
                U ? /* @__PURE__ */ r(ye, { size: "16" }) : /* @__PURE__ */ r(Me, { size: "16" }),
          ...
          U && /* @__PURE__ */ i("div", { className: "custom-info-container", children: [
            ...
            I.length < F.maxCount && /* @__PURE__ */ r(S, { variant: "text", className: "add-custom-info-btn", onClick: W, icon: /* @__PURE__ */ r(Ce, { size: 14 }), theme: "primary", children: a(e.ADD) })
          ] })
        ] })
      ] })
    },
        ...
        return {
          ...
          render: (f) => {
            const W = ur({
              live: f,
              t: s,
              onEnter: (L) => a.enterLive(L),
              onDetail: (L) => {
                a.showDetail(L);
              },
              onEdit: (L) => a.openEditModal(L),
              onDelete: (L) => a.requestDelete(L)
            });
  ...
  return /* @__PURE__ */ i("div", { className: "live-list-page", children: [
    ...
    /* @__PURE__ */ r(
      fe,
      {
        ...
        width: he.CONFIRM,
        footer: /* @__PURE__ */ i(le, { children: [
          /* @__PURE__ */ r(S, { shape: "round", variant: "outline", disabled: o, onClick: () => a.cancelDelete(), children: s(e.CANCEL) }),
          /* @__PURE__ */ r(S, { shape: "round", theme: "primary", loading: o, onClick: () => I(), children: s(e.CONFIRM) })
        ] }),
    ...
    /* @__PURE__ */ r(
      fe,
      {
        ...
        footer: /* @__PURE__ */ r(S, { shape: "round", variant: "outline", onClick: () => a.closeDetail(), children: s(e.CLOSE) }),
