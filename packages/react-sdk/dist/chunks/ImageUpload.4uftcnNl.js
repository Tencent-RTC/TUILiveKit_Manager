...
import { forwardRef as pt, useRef as q, useState as S, useImperativeHandle as ht, useEffect as H, useCallback as Ce } from "react";
import { aF as dt, Y as W } from "./en-US.DXdmRfHg.js";
import { UploadIcon as Fe, CloseIcon as ft, ImageIcon as vt, CutIcon as mt } from "tdesign-icons-react";
import { Button as ce, Input as gt, Dialog as wt } from "tdesign-react";
import { useUIKit as Ct } from "@tencentcloud/uikit-base-component-react";
import { _ as le, af as Le, al as yt, ae as Rt, ah as St } from "./main-layout.Bx74vUBv.js";
import { i as _t, g as Et } from "./PreviewUrlController.CKpndgj3.js";
import { U as Pt, u as Oe, m as xt, k as Dt, j as zt, v as bt, a as Mt, p as At, g as It } from "./upload.fiNwxMP3.js";
import { s as Ke } from "./svga.min.oQNdj2nc.js";
import { M as Y } from "./useAsyncAction.3VDMHaQC.js";
import { u as Nt, a as Ut } from "./useSvgaPlayer.DhIecSed.js";
var Pe = function(a, r) {
...
function Ht(a, r, e, t, o, i, n) {
  i === void 0 && (i = 0), n === void 0 && (n = !0);
  var s = n ? Xt : qt, c = B(r.width, r.height, i), l = B(r.naturalWidth, r.naturalHeight, i), u = {
...
function $t(a, r, e, t, o, i) {
  e === void 0 && (e = 0);
  var n = B(r.naturalWidth, r.naturalHeight, e), s = pe(Kt(a, r, t), o, i), c = t.height > t.width ? t.height / a.height : t.width / a.width, l = {
  ...
  (function(a) {
    ...
    function r() {
      ...
      return e.cropperRef = V.createRef(), e.imageRef = V.createRef(), e.videoRef = V.createRef(), e.containerPosition = {
        ...
        if (e.props.initialCroppedAreaPercentages) {
          var o = Yt(e.props.initialCroppedAreaPercentages, e.mediaSize, e.props.rotation, t, e.props.minZoom, e.props.maxZoom), i = o.crop, n = o.zoom;
          e.props.onCropChange(i), e.props.onZoomChange && e.props.onZoomChange(n);
        } else if (e.props.initialCroppedAreaPixels) {
          var s = $t(e.props.initialCroppedAreaPixels, e.mediaSize, e.props.rotation, t, e.props.minZoom, e.props.maxZoom), i = s.crop, n = s.zoom;
          e.props.onCropChange(i), e.props.onZoomChange && e.props.onZoomChange(n);
        }
        ...
        if (l && e.containerRef) {
          ...
          var w = e.props.cropSize ? e.props.cropSize : jt(e.mediaSize.width, e.mediaSize.height, e.containerRect.width, e.containerRect.height, e.props.aspect, e.props.rotation);
        ...
        if (e.currentWindow && !(e.props.onWheelRequest && !e.props.onWheelRequest(t))) {
          t.preventDefault();
          var o = r.getMousePoint(t), i = kt(t).pixelY, n = e.props.zoom - i * e.props.zoomSpeed / 200;
          e.setNewZoom(n, o, {
            shouldUpdatePosition: !0
    ...
    return r.prototype.componentDidMount = function() {
      !this.currentDoc || !this.currentWindow || (this.containerRef && (this.containerRef.ownerDocument && (this.currentDoc = this.containerRef.ownerDocument), this.currentDoc.defaultView && (this.currentWindow = this.currentDoc.defaultView), this.initResizeObserver(), typeof window.ResizeObserver > "u" && this.currentWindow.addEventListener("resize", this.computeSizes), this.props.zoomWithScroll && this.containerRef.addEventListener("wheel", this.onWheel, {
        passive: !1
      }), this.containerRef.addEventListener("gesturestart", this.onGestureStart)), this.currentDoc.addEventListener("scroll", this.onScroll), this.props.disableAutomaticStylesInjection || (this.styleRef = this.currentDoc.createElement("style"), this.styleRef.setAttribute("type", "text/css"), this.props.nonce && this.styleRef.setAttribute("nonce", this.props.nonce), this.styleRef.innerHTML = Jt, this.currentDoc.head.appendChild(this.styleRef)), this.imageRef.current && this.imageRef.current.complete && this.onMediaLoad(), this.props.setImageRef && this.props.setImageRef(this.imageRef), this.props.setVideoRef && this.props.setVideoRef(this.videoRef), this.props.setCropperRef && this.props.setCropperRef(this.cropperRef));
      ...
      this.lastPinchDistance = Xe(t, o), this.lastPinchRotation = qe(t, o), this.onDragStart(Ye(t, o));
      ...
      if (!(!this.currentDoc || !this.currentWindow)) {
        ...
        this.onDrag(n), this.rafPinchTimeout && this.currentWindow.cancelAnimationFrame(this.rafPinchTimeout), this.rafPinchTimeout = this.currentWindow.requestAnimationFrame(function() {
          var s = Xe(o, i), c = t.props.zoom * (s / t.lastPinchDistance);
          t.setNewZoom(c, n, {
            shouldUpdatePosition: !1
          }), t.lastPinchDistance = s;
          var l = qe(o, i), u = t.props.rotation + (l - t.lastPinchRotation);
...
const gr = pt(function({
  ...
  const { t: f } = Ct(), k = s || f(W.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), J = q(null), [N, F] = S(!1), [I, M] = S(0), [he, Q] = S(!1), [de, ne] = S(""), [D, X] = S(!d), [b, ie] = S(r), [fe, j] = S(!1), [L, U] = S(""), z = q(null);
  z.current || (z.current = new Pt({
    setValidating: j,
    setError: U,
    onConfirm: e
  ...
  const K = q(null), { previewUrl: O, setPreview: $ } = Nt(), [$e, ve] = S(!1), [me, ae] = S(!1), {
    containerRef: Be,
    playUrl: xe,
    stopAnimation: or
  } = Ut({ loop: 1, autoPlay: !0 });
  ht(Z, () => ({
    get isUrlInputMode() {
      return D;
    },
    ...
    reset: () => {
      z.current.reset(), K.current = null, $(null), ve(!1), ae(!1), ie(r || ""), ne(""), U(""), F(!1), M(0), Q(!1), d && X(!!r), A?.(null);
    },
    ...
    uploadPendingFile: async () => {
      ...
      F(!0), M(0), Q(!1);
      try {
        const v = await Oe(p, t, M);
        return K.current = null, ne(v.provider || ""), Q(!1), v.url;
      } catch (v) {
        throw Q(!0), v;
      } finally {
        F(!1), M(0);
    ...
    ie(r), r && d && X(!0), w && (K.current = null, $(null), ae(!1), A?.(null));
  }, [r]), H(() => {
    d && r ? X(!0) : d && X(!1);
  }, [d]), H(() => {
    if (!R) return;
  ...
  const ge = q(null), T = q(null);
  H(() => {
    if (!r || !Le(r) || !(D || !d) || !ge.current) {
      if (T.current) {
        try {
    ...
    const p = ge.current, v = new Ke.Player(p);
  ...
  const [Je, ee] = S(!1), [te, ze] = S(""), [Qe, be] = S({ x: 0, y: 0 }), [et, Me] = S(1), [Ae, Ie] = S(null), [nr, tt] = S(null), [Ne, Ue] = S(!1), rt = Ce((p, v) => {
    Ie(v);
  }, []), [ot, Te] = S(!1), re = q(null);
  H(() => () => {
  ...
  const we = Ce(async (p) => {
    ...
    if (o) {
      ze(""), tt(p), be({ x: 0, y: 0 }), Me(1), Ie(null), Ue(!0), Te(!1), ee(!0);
      try {
        const E = await yt(p);
        ze(E);
      } catch {
      ...
      await We(p);
  }, [m, n, f, y, o, w]), We = async (p) => {
    if (w) {
      K.current = p, $(p);
      const v = p.type.startsWith("video/"), E = Rt(p);
      ve(v), ae(E), A?.(p);
      return;
    }
    F(!0), M(0);
    try {
      const v = await Oe(p, t, M);
      e(v.url), ne(v.provider || ""), Y.success(f("Upload Success"));
    } catch (v) {
    ...
    p?.stopPropagation(), z.current.cancelValidation(), j(!1), U(""), e(""), ie(""), ne(""), F(!1), M(0), Q(!1), w && (K.current = null, $(null), ve(!1), ae(!1), A?.(null));
  };
  return /* @__PURE__ */ P("div", { className: `image-upload-container ${x}`, children: [
      ...
      O ? /* @__PURE__ */ P(
        "div",
        {
          ...
          children: [
            ...
            ) : /* @__PURE__ */ h(se, { children: me ? /* @__PURE__ */ h("div", { ref: Be, className: "svga-preview-container" }) : $e ? /* @__PURE__ */ h("video", { src: O, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ h("img", { src: O, alt: "preview" }) }),
        ...
        /* @__PURE__ */ h(
          "div",
          {
            ...
            children: N ? /* @__PURE__ */ P("div", { className: "image-upload-progress", children: [
              ...
              /* @__PURE__ */ h(vt, { size: "32", strokeWidth: 1.2 }),
    ...
    r && (D || !d) && /* @__PURE__ */ h(
      "div",
      {
        ...
        children: Le(r) ? /* @__PURE__ */ h("div", { ref: ge, className: "svga-preview-container" }) : St(r) ? /* @__PURE__ */ h("video", { src: r, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ h("img", { src: r, alt: "preview", onError: (p) => {
    ...
    /* @__PURE__ */ h(
      wt,
      {
        ...
        footer: /* @__PURE__ */ P(se, { children: [
          ...
          /* @__PURE__ */ h(ce, { shape: "round", theme: "primary", onClick: nt, disabled: Ne || !te, icon: /* @__PURE__ */ h(mt, { size: "14" }), children: f(W.CONFIRM_CROP) })
        ] }),
        children: /* @__PURE__ */ h("div", { className: "image-crop-area", children: Ne || !ot ? /* @__PURE__ */ P("div", { className: "image-crop-loading", children: [
