...
import { MessagePlugin as At, Dialog as ge, Button as K, Input as fe, Select as sr, InputNumber as Qt, Checkbox as vn, Card as Wr, Tabs as Bt, Switch as En, Tooltip as xe, Loading as Nn, Textarea as Cn } from "tdesign-react";
import { s as yn, ax as _n, av as bn, aG as W, H as Nt, aM as In, bq as zr, br as Br, b as Ln, W as Sn, aZ as Hr, a$ as Tn, Z as wn, bL as An, be as fr, bJ as Rn, bI as Mn, bH as On, bm as Dn, bd as xn, am as Un, bl as kn, bg as Pn, aI as Fn, Y as Gn, aj as gr, A as je, J as ke, aH as Vn, aY as Wn, b1 as zn, b4 as Ut, g as Ue, ah as Bn, bs as Yr, t as cr, $ as Hn, ak as vr, V as Er, as as Yn, bG as Kn, ac as $n, aJ as qn, N as Xn, aT as jn, a1 as Zn, aC as Jn, X as Ht, b7 as Qn, bk as ea, aW as Ot, a3 as ta, a8 as ra, R as Rt, a6 as na, b0 as aa, aL as tt, i as ia, b9 as Nr, D as oa, a as Ye, n as Ze, o as Me, l as Oe, m as gt, bt as sa, v as Kr, w as Pe, aP as ca, u as $r, aF as la, r as da, b6 as Cr, p as yr, q as ua, P as Yt, d as vt, e as Ae, C as Re, O as ha, aw as ma } from "./main-layout.BU1yumQ_.js";
import { c as pa, g as fa, s as lr, a as ga, D as va, d as Ea, e as Na, m as Ca, b as ya, P as _a } from "./gift-category.qmtjx5qb.js";
import { aT as ba, a3 as Ia, b as La, e as Sa, ap as Ta, aM as wa, c as Aa, aL as Ra, b9 as Ma, aY as a, b8 as Oa, b2 as Kt, D as yt, b3 as dr, i as Da, h as xa, d as qr, b5 as Ua, aX as be, ax as ur, aR as _r, X as lt, aI as ka, W as Xr, aA as Pa } from "./upload.BFIaIzq9.js";
...
import { a as Va } from "./moderation-store.C64XetTn.js";
import { useLiveListState as Wa, useLoginState as jr, LiveListEvent as br, LiveView as za, useLiveAudienceState as Ba, BarrageList as Ha, LiveAudienceList as Ya } from "tuikit-atomicx-react";
...
function Jr(r) {
  ...
  const B = A(async () => {
    ...
    N(!0);
    try {
      const G = await Ia({ pageSize: t, liveId: n, ...b });
    ...
    try {
      ...
      return await La({ ids: b.ids, items: G, liveId: b.liveId ?? n });
    } catch (G) {
      throw console.error("[useRiskControlState] approveTextModerationItems failed:", G), G;
    }
  }, [n, p]), Z = A(async (b) => {
    try {
      return await Sa({ content: b.keywords.join(","), liveId: n });
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await Ta(n, b.memberAccounts, b.muteTime), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await wa(n, b.memberAccounts), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await Aa(n, b.memberAccounts, b.duration, b.reason), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    R(!0), I(null);
    try {
      await Ra(n, b.memberAccounts), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    if (!n) throw new Error("liveId is required");
    try {
      return await Ma(n, "default", "您的内容涉嫌违规");
    } catch (b) {
...
function Pt({
  ...
  return !o || p ? /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: In(n) }) : /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: /* @__PURE__ */ e(
    "img",
    {
      src: o,
      alt: d,
...
const Za = ({
  ...
  var H, D, Z, j, X;
  const { t: h } = ve(), { startPlay: N, stopPlay: m } = mt(), T = (H = yt().components) == null ? void 0 : H.liveMonitor, w = ((D = r.avatarUrl) == null ? void 0 : D.trim()) || "", E = (c == null ? void 0 : c.avatarUrl) || ((Z = r.anchor) == null ? void 0 : Z.avatarUrl) || w || zr(r), S = (c == null ? void 0 : c.nick) || ((j = r.anchor) == null ? void 0 : j.nick) || Br(r, h(a.UNKNOWN_HOST)), R = ((X = r.stats) == null ? void 0 : X.viewCount) ?? 0, C = _e(() => `live_monitor_view_${r.liveId}`, [r.liveId]), I = ee(""), P = ee(0), B = ee(null);
  return J(() => {
    const M = r.liveId;
    if (!M) return;
    const L = ++P.current;
    ...
    return (async () => {
      ...
      try {
        ...
        !y && P.current === L && ($ === kt.LOGIN_TIMEOUT || $ === kt.USER_SIG_ILLEGAL) && (Da(), xa(), localStorage.removeItem("tuiLiveMonitor-userInfo"), window.location.href = "/#/config-required");
      }
    })(), () => {
      y = !0, P.current += 1;
      const $ = I.current || M;
  ...
  const { pageSize: n, isSearchModeRef: t, isUnmountedRef: i, pageVersionRef: c } = r, [o, s] = _(/* @__PURE__ */ new Map()), p = ee(null), l = ee(""), d = A(() => {
    ...
    l.current = S;
    try {
      const { startTime: R, endTime: C } = f(), I = await Ua(E, 10, R, C);
  ...
  return J(() => {
    ...
    (async () => {
      try {
        const te = await ur();
        if (te && te.sdkAppId !== 0) {
          console.log("[LiveMonitor] Initializing SDK with account:", te.userId), Fa({
    ...
    /* @__PURE__ */ e(
      ge,
      {
        ...
        footer: /* @__PURE__ */ u(ue, { children: [
          /* @__PURE__ */ e(K, { shape: "round", variant: "outline", onClick: U, disabled: G.closing, children: r(a.CANCEL) }),
          /* @__PURE__ */ e(
            K,
            {
              shape: "round",
...
const Ft = on(function({
  ...
  const { t: C } = ve(), I = p || C(a.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), P = ee(null), [B, H] = _(!1), [D, Z] = _(0), [j, X] = _(!1), [M, L] = _(""), [y, x] = _(!g), [$, b] = _(n), [G, V] = _(!1), [O, U] = _(""), Y = ee(null);
  Y.current || (Y.current = new wn({
    setValidating: V,
    setError: U,
    onConfirm: t
  ...
  sn(R, () => ({
    ...
    reset: () => {
      Y.current.reset(), ne.current = null, le(null), Se(!1), se(!1), b(n || ""), L(""), U(""), H(!1), Z(0), X(!1), g && x(!!n), w == null || w(null);
    },
    ensureUrlValidated: async () => y ? await Y.current.ensureUrlValidatedWithErrorCheck(
      $,
      n || "",
      !!O,
      N
  ...
  const k = A(async (Q) => {
    ...
    if (T) {
      ne.current = Q, le(Q);
      const oe = Q.type.startsWith("video/"), Ee = xn(Q);
    ...
    Q == null || Q.stopPropagation(), Y.current.cancelValidation(), V(!1), U(""), t(""), b(""), L(""), H(!1), Z(0), X(!1), T && (ne.current = null, le(null), Se(!1), se(!1), w == null || w(null));
  };
  return /* @__PURE__ */ u("div", { className: `image-upload-container ${m}`, children: [
    g && l && /* @__PURE__ */ u("div", { className: "image-upload-mode-switch", children: [
      /* @__PURE__ */ e(
        K,
        {
          ...
          onClick: () => {
            Y.current.cancelValidation(), V(!1), U(""), x(!1);
          },
      ...
      /* @__PURE__ */ e(
        K,
        {
          ...
          className: `mode-switch-btn ${y ? "active" : ""}`,
          onClick: () => {
            Y.current.cancelValidation(), V(!1), U(""), x(!0);
          },
    ...
    (y || !g) && /* @__PURE__ */ e("div", { className: "image-upload-url-input", children: /* @__PURE__ */ e(
      fe,
      {
        value: $,
        onChange: (Q) => {
          b(String(Q)), U(""), Y.current.cancelValidation(), V(!1);
        },
        onFocus: qe,
        onBlur: Xe,
        onEnter: en,
    ...
    n && (y || !g) && /* @__PURE__ */ e(
      "div",
      {
        ...
        children: fr(n) ? /* @__PURE__ */ e("div", { ref: Ie, className: "svga-preview-container" }) : Pn(n) ? /* @__PURE__ */ e("video", { src: n, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ e("img", { src: n, alt: "preview", onError: (Q) => {
    ...
    /* @__PURE__ */ e(
      ge,
      {
        ...
        footer: /* @__PURE__ */ u(ue, { children: [
          /* @__PURE__ */ e(K, { shape: "round", variant: "outline", onClick: () => Te(!1), children: C(a.CANCEL) }),
          /* @__PURE__ */ e(K, { shape: "round", theme: "primary", onClick: ce, disabled: Lt || !ye, icon: /* @__PURE__ */ e(ln, { size: "14" }), children: C(a.CONFIRM_CROP) })
        ] }),
...
function Ai({ visible: r, onClose: n, onSuccess: t, uploadEnabled: i = !1, extraFieldsSlot: c, onCreate: o }) {
  var Se, ae, se;
  const { t: s } = ve(), p = Gn.map((F) => ({
    value: F.value,
    label: s(F.labelKey)
  })), [l, d] = _(gr()), [f, g] = _([]), [v, h] = _(!1), [N, m] = _(!1), [T, w] = _(""), [E, S] = _(""), [R, C] = _(!1), [I, P] = _(""), [B, H] = _(""), [D, Z] = _(null), [j, X] = _(""), M = ee(null), [L, y] = _(!1), x = (F, te) => {
    F === "success" ? q.success(te) : q.error(te);
  }, $ = async (F, te) => {
    try {
      await Bn(F), x("success", s(a.COPY_LABEL_COPIED, { label: te }));
    } catch (he) {
    ...
    var F;
    d(gr()), g([]), h(!1), m(!1), w(""), S(""), C(!1), P(""), H(""), Z(null), X(""), y(!1), (F = M.current) == null || F.reset();
  }, U = () => {
    O(), n();
    ...
    ge,
    {
      ...
      footer: N ? /* @__PURE__ */ e(
        ...
        /* @__PURE__ */ e(
          K,
          {
            ...
            onClick: z,
            loading: Y,
            disabled: Y || !l.anchorId.trim() || ((Se = M.current) == null ? void 0 : Se.isValidating) || ((ae = M.current) == null ? void 0 : ae.hasUrlError),
      ...
      children: N ? (
        ...
        /* @__PURE__ */ u(ut, { className: "create-live-form", labelWidth: lt(100), children: [
          ...
          /* @__PURE__ */ e(de, { label: s(a.LAYOUT_TEMPLATE), requiredMark: !0, help: s(((se = Wn(l.seatTemplate)) == null ? void 0 : se.descKey) || ""), children: /* @__PURE__ */ e(
            sr,
            {
              options: p,
          ...
          zn(l.seatTemplate) && /* @__PURE__ */ e(de, { label: s(a.MAX_SEATS), help: s(a.MAX_SEATS_HELP), children: /* @__PURE__ */ e(
            Qt,
            {
          ...
          /* @__PURE__ */ u("div", { className: "custom-info-section", children: [
            ...
            v && /* @__PURE__ */ u("div", { className: "custom-info-container", children: [
              ...
              f.length < Ue.maxCount && /* @__PURE__ */ e(K, { variant: "text", className: "add-custom-info-btn", onClick: b, icon: /* @__PURE__ */ e(or, { size: "14" }), theme: "primary", children: s(a.ADD) })
            ] })
          ] })
        ] })
      )
...
function Ri({ visible: r, live: n, onClose: t, onSuccess: i, uploadEnabled: c = !1, extraFieldsSlot: o, onUpdate: s, onFetchDetail: p }) {
  var b, G;
  const { t: l } = ve(), [d, f] = _(vr()), [g, v] = _([]), [h, N] = _(!1), m = ee([]), [T, w] = _(Er), [E, S] = _(!1), [R, C] = _(""), [I, P] = _(""), { loading: B, execute: H } = ht({
    action: async (V) => {
  ...
  J(() => {
    n != null && n.coverUrl ? Yn(n.coverUrl).then(w) : w(Er);
    ...
    if (n && r) {
      ...
      S(!0), p(V).then((O) => {
        ...
        if (U && typeof U == "object") {
          const Y = Object.entries(U).map(([ne, z]) => ({
            key: ne,
            value: String(z)
          }));
        ...
        if (n.customInfo && typeof n.customInfo == "object") {
          const O = Object.entries(n.customInfo).map(([U, Y]) => ({
            key: U,
            value: String(Y)
          }));
  ...
  const X = () => {
    ...
    var V;
    C(""), P(""), v([]), N(!1), m.current = [], j(!1), (V = D.current) == null || V.reset(), f(vr()), t();
  }, $ = async () => {
    if (!n) return;
    if (!d.liveName.trim()) {
      ...
      children: /* @__PURE__ */ u(ut, { className: "edit-live-form", labelWidth: lt(100), children: [
        ...
        /* @__PURE__ */ u("div", { className: "custom-info-section", children: [
          ...
          h && /* @__PURE__ */ u("div", { className: "custom-info-container", children: [
            g.map((V, O) => {
              const U = W(V.key), Y = W(V.value), ne = U > Ue.maxKeyBytes, z = Y > Ue.maxValueBytes, le = Ut(V);
              return /* @__PURE__ */ u("div", { className: "custom-info-row", children: [
                /* @__PURE__ */ e("div", { className: "custom-input-wrap", children: /* @__PURE__ */ e(
                  fe,
                  {
...
function Vt({
  ...
  mr(() => {
    ...
    const x = () => {
      var Ce, Se;
      const V = ((Ce = T.current) == null ? void 0 : Ce.querySelectorAll("thead th")) || [], O = Array.from(((Se = E.current) == null ? void 0 : Se.querySelectorAll("tbody tr")) || []).slice(0, h), U = [], Y = [];
      L.forEach(({ column: ae, index: se }) => {
        const F = V[se];
        F && (U.push(F), Y.push(ae.key)), O.forEach((te) => {
          const he = te.children[se];
          he && (U.push(he), Y.push(ae.key));
        });
      });
      const ne = Ca(U), z = {};
      ne.forEach((ae, se) => {
      ...
      for (const { column: ae } of L)
        z[ae.key] !== void 0 && (le[ae.key] = ya(z[ae.key], ae.minWidth, ae.maxWidth));
      C.current = le;
    }, $ = () => {
      var Y;
      const V = C.current;
      ...
      const O = ((Y = w.current) == null ? void 0 : Y.clientWidth) ?? 0, U = Ea(
        r,
        V,
        O,
        B
...
function Ao() {
  ...
  J(() => (l.init(), () => l.dispose()), []);
  const f = Ui(), g = _e(() => jn({ hasExtraColumn: !!(s != null && s.tableExtraColumns) }).map((y) => {
    switch (y.key) {
      case "liveId":
        return {
          ...y,
      ...
      case "createdAt":
        return {
          ...
          render: (x) => /* @__PURE__ */ e("span", { className: "live-list-text", children: Jn(x.createdAt) })
        };
      case "customer-extra":
        return {
          ...y,
      ...
      /* @__PURE__ */ u("div", { className: "header-actions", children: [
        /* @__PURE__ */ e(
          fe,
          {
            ...
            suffixIcon: /* @__PURE__ */ e(rr, { size: 16 }),
            style: { width: 220 },
            status: W(w) > Ht ? "error" : "default",
            tips: W(w) > Ht ? n(a.INPUT_EXCEEDS_LENGTH_LIMIT) : ""
          }
        ),
        /* @__PURE__ */ e(
          K,
...
const Gi = 12 * 1024, Vi = (r) => new TextEncoder().encode(r).length, ct = { current: {} }, Wi = st.memo(
  ({ message: r, style: n }) => {
    var l, d;
    const t = r.sender.userId, i = t === ct.current.anchorUserId, c = r.sender.nameCard || r.sender.userName || t, o = r.messageType === 0 ? r.textContent : r.data || "", s = ea(o);
    return /* @__PURE__ */ u(
      "div",
      {
...
function to(r, n) {
  ...
  } = Jr({ liveId: r || "", pageSize: Rt }), [o, s] = _([]), [p, l] = _(!1), [d, f] = _(1), [g, v] = _(0), [h, N] = _([]), [m, T] = _(null), [w, E] = _(null), S = _e(() => ra(g, Rt), [g]), R = A(
    async (b = 1) => {
      if (r) {
        l(!0);
        try {
          ...
          s(O), v(V.total || 0), f(G), N((U) => U.filter((Y) => O.some((ne) => ne.id === Y)));
        } catch (G) {
...
function ro(r, n, t) {
  ...
  const D = (O, U) => {
    ...
    onError: (O) => {
      const { code: U, info: Y } = rt(O), ne = U ? tt(U, Y) : O.message || n(a.UNKNOWN_HOST);
      D("error", n(a.OPERATION_FAILED, { error: ne }));
    }
  }), j = Ve({
    action: async () => {
      if (!E) throw new Error("No target");
      await l({ memberAccounts: [E.userId], muteTime: ia });
    },
    confirm: {
    ...
    r && (Nr(O, t) || (Y ? (C({ userId: O, userName: U }), Z.requestConfirm()) : (S({ userId: O, userName: U }), j.requestConfirm())));
  }, [r, t, Z, j]), M = Ve({
    action: async () => {
    ...
    action: async () => {
      ...
      await f({ memberAccounts: [I.userId], duration: oa });
    },
    confirm: {
    ...
    r && (Nr(O, t) || (Y ? (H({ userId: O, userName: U }), M.requestConfirm()) : (P({ userId: O, userName: U }), L.requestConfirm())));
  }, [r, t, M, L]), x = A((O) => {
...
function Ro() {
  ...
  const v = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__, [h, N] = _(v), [m, T] = _(null), [w, E] = _(!1), [S, R] = _("chat"), [C, I] = _(!0), { successMsg: P, errorMsg: B } = ki(), [H, D] = _(null), [Z, j] = _(!1), [X, M] = _(!1), L = Va(), y = Ve({
    action: async () => {
  ...
  }, V = ee(null), O = ee(null), [U, Y] = _(null), [ne, z] = _(0), [le, Ce] = _(null), Se = _e(
    () => {
      var k, re;
  ...
  return C ? /* @__PURE__ */ e("div", { className: "loading-container", children: /* @__PURE__ */ e(Nn, { loading: !0, text: c(a.LOADING) }) }) : /* @__PURE__ */ u("div", { className: "live-control-container", children: [
    ...
    /* @__PURE__ */ u("header", { className: "live-control-navbar", children: [
      ...
      /* @__PURE__ */ u("div", { className: "nav-right", children: [
        ...
        /* @__PURE__ */ e(K, { variant: "text", theme: "danger", onClick: () => y.requestConfirm(), icon: /* @__PURE__ */ e(Pr, {}), children: c(a.FORCE_STOP) })
      ] })
    ] }),
...
function no({
  ...
  return /* @__PURE__ */ e(
    ge,
    {
      ...
      footer: /* @__PURE__ */ u(ue, { children: [
        /* @__PURE__ */ e(K, { shape: "round", variant: "outline", onClick: C, children: d(a.CANCEL) }),
        /* @__PURE__ */ e(
          K,
          {
            shape: "round",
  ...
  return /* @__PURE__ */ u(ue, { children: [
    /* @__PURE__ */ e(
      ge,
      {
        ...
        footer: /* @__PURE__ */ e(K, { shape: "round", theme: "primary", onClick: N, children: T(a.CLOSE) }),
    ...
    /* @__PURE__ */ e(
      ge,
      {
        ...
        width: 360,
        placement: "center",
        footer: /* @__PURE__ */ e(K, { shape: "round", theme: "primary", disabled: !o, onClick: f, children: T(a.CONFIRM) }),
    ...
    /* @__PURE__ */ e(
      ge,
      {
        ...
        placement: "center",
        footer: /* @__PURE__ */ u(ue, { children: [
          /* @__PURE__ */ e(K, { shape: "round", variant: "outline", onClick: m, children: T(a.CANCEL) }),
          /* @__PURE__ */ e(K, { shape: "round", theme: "primary", onClick: h, children: T(a.CONFIRM) })
        ] }),
      ...
      },
      {
        ...
        render: (f) => /* @__PURE__ */ u("div", { className: "gift-lang-tags", children: [
          f.languageList && f.languageList.length > 0 ? f.languageList.map((g) => {
            const v = ca(g), h = $r[v], N = h ? Pe[h] : null;
            return /* @__PURE__ */ e(
              "span",
              {
  ...
  return /* @__PURE__ */ u("div", { className: "gift-config-container", children: [
    /* @__PURE__ */ u("div", { className: "gift-config-page-header", children: [
      ...
      /* @__PURE__ */ u("div", { className: "gift-config-actions", children: [
        ...
        /* @__PURE__ */ e(K, { shape: "round", theme: "primary", onClick: () => o.goToCategoryManagement(), variant: "outline", icon: /* @__PURE__ */ e(gn, {}), children: r(a.CATEGORY_MANAGEMENT) }),
        /* @__PURE__ */ u(K, { shape: "round", onClick: O, theme: "primary", children: [
          "＋ ",
          r(a.ADD_GIFT)
        ] })
      ] })
          ...
          },
          {
            ...
            render: (h) => /* @__PURE__ */ u("div", { className: "category-lang-tags", children: [
              h.languageList && h.languageList.length > 0 ? h.languageList.map((N) => {
                const m = typeof N == "string" ? N : N.language || "", T = $r[m], w = T ? Pe[T] : null;
                return /* @__PURE__ */ e(
                  "span",
                  {
