...
const he = {
  ...
  setup(n) {
    ...
    let F = {}, p = null, T = null, x = 0, S = null;
    ...
    return se(() => {
      ...
      cancelAnimationFrame(x), p?.disconnect(), p = null, T?.disconnect(), T = null, d.value && S && (d.value.removeEventListener("scroll", S), S = null);
    }), (e, t) => (s(), o("div", {
      ref_key: "rootRef",
      ref: y,
      ...
      f("div", {
        ...
        f("table", {
          ...
          f("colgroup", null, [
            (s(!0), o(N, null, W(n.columns, (l) => (s(), o("col", {
              key: l.key,
          ...
          f("thead", null, [
            f("tr", null, [
              (s(!0), o(N, null, W(n.columns, (l) => (s(), o("th", {
                key: l.key,
                class: u(l.className),
      ...
      f("div", {
        ...
        n.loading ? (s(), o("div", he, [
          ...
          f("tbody", null, [
            (s(!0), o(N, null, W(n.data, (l, b) => (s(), o("tr", {
              key: ee(l, b),
              class: u(te(l, b))
            }, [
              (s(!0), o(N, null, W(n.columns, (c) => (s(), o("td", {
                key: c.key,
                class: u(c.className),
  ...
  setup(n) {
    ...
    return (y, h) => (s(), o("div", {
      ...
      (s(!0), o(N, null, W(n.actions, (i) => (s(), o("button", {
        key: i.key,
        type: "button",
