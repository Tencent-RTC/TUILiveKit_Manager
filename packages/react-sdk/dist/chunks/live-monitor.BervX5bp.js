...
import { SearchIcon as Mn, RefreshIcon as Tn, FullscreenIcon as wa, CloseIcon as Wi, SoundMuteIcon as Oo, SoundIcon as Uo, NotificationIcon as Ca, StopCircleIcon as Ia, UploadIcon as Kn, ImageIcon as $o, CutIcon as Po, ChevronDownIcon as $i, ChevronRightIcon as Aa, AddIcon as Sn, CopyIcon as Dt, DeleteIcon as Fo, EditIcon as Pi, InfoCircleIcon as Nt, LoginIcon as Vo, CheckCircleIcon as Hi, ChatOffIcon as Ma, UserCheckedIcon as Ta, UserBlockedIcon as Sa, MoreIcon as zo, CloseCircleIcon as Go, AdjustmentIcon as Bo } from "tdesign-icons-vue-next";
...
import { w as Wo, aD as Ho, aF as Yo, b$ as jo, cn as Ko, co as Xo, u as qo, m as Zo, a9 as Qo, a2 as Jo, b0 as es, bb as ts, aS as te, N as bi, aZ as is, b_ as ns, b as as, b7 as os, bP as dn, bQ as hn, _ as ss, bi as Ra, bl as ls, a1 as rs, bA as Xn, ci as cs, cc as qn, bJ as Zn, bC as us, cg as ds, cf as hs, ce as vs, bK as ms, ax as fs, bz as gs, bB as ps, aC as bs, a0 as ys, ar as Qn, bh as Es, aT as _s, A as Wt, O as bt, i as Xe, bq as ti, ap as La, bR as xa, x as Vi, a4 as ws, c2 as Cs, as as Jn, Z as ea, aA as Is, ay as ta, cd as As, aj as Ms, aV as Ts, R as Ss, aW as Na, b5 as Rs, bt as ia, aL as Ls, a6 as xs, a as Ot, bI as Ns, bf as xi, bZ as ks, a8 as Ds, aG as Os, aP as Us, bL as na, bv as aa, aY as gt, k as $s, D as Ps, v as Fs, bs as oa, s as sa, aO as Vs, b3 as ka, b1 as ii, b4 as Da, q as Ht, r as Je, o as et, p as hi, z as Oa, F as Ut, bS as zs, t as Gs, T as nn, d as vi, f as st, C as lt, S as Bs, aE as Ws } from "./main-layout.DUWbMPfj.js";
import { c as Hs, s as vn, D as Ys, a as js, m as Ks, b as Xs, d as qs, e as Zs, i as Qs, P as Js } from "./gift-category.DaeXtH9F.js";
import { I as r, N as an, O as Rn, F as el, J as tl, H as il, g as Yi, ae as nl, k as oi, W as Ua, t as al } from "./en-US.rgXKsoPj.js";
...
function Fa() {
  ...
  return e.value = i.getGiftList(), n.value = i.getGiftCategoryList(), nt(() => {
    ...
    getGiftCategoryLanguage: async (G, X) => i.getGiftCategoryLanguage(G, X),
    setGiftCategoryLanguage: async (G, X, q, Q) => i.setGiftCategoryLanguage(G, X, q, Q),
    deleteGiftCategoryLanguage: async (G, X) => i.deleteGiftCategoryLanguage(G, X)
  };
}
function ul(e) {
  ...
  return {
    ...
    banMember: async (W) => {
      ...
      h.value = !0, p.value = null;
      try {
        await Xo(n, W.memberAccounts, W.duration, W.reason), await X();
      } catch (O) {
    ...
    unbanMember: async (W) => {
      ...
      h.value = !0, p.value = null;
      try {
        await Ko(n, W.memberAccounts), await X();
      } catch (O) {
...
const Fl = { class: "live-monitor-page" }, Vl = { class: "live-monitor-grid" }, zl = {
  ...
  setup(e) {
    ...
    return m && Me(() => m.value, (ne) => {
      ...
      F.value = !0, document.removeEventListener("fullscreenchange", ut), X(), de();
    }), (ne, ve) => {
...
}), fm = /* @__PURE__ */ ci(Hl, [["__scopeId", "data-v-6b683c0f"]]);
function la(e, n) {
  var i = Object.keys(e);
...
function nr(e) {
  ...
  var R = Xi(p = ct(p, h.width * i.width / (p.width * b.width)), n({ visibleArea: p, type: "resize" }));
...
function ar(e) {
  ...
  if (o && a && n.type !== "manipulateImage") {
    ...
    var m = Xi(u = ct(u, d.width * s.width / (u.width * g.width)), i({ visibleArea: u, type: "resize" }));
...
function or(e) {
  ...
  if (n.type === "setCoordinates") {
    ...
    d > u ? a = ct(a, Math.min(l.width / a.width, li(a, o({ visibleArea: a, type: "resize" })))) : u > d && (a = ct(a, Math.min(l.height / a.height, li(a, o({ visibleArea: a, type: "resize" }))))), a = je(a = it(a, Ki(ri(l, _t(a)))), o({ visibleArea: a, type: "move" }));
  }
...
function ur(e) {
  ...
  var T = i.left - s.left, ie = s.width + s.left - (i.width + i.left), G = i.top - s.top, X = s.height + s.top - (i.height + i.top);
  return m = je(m = it(m, ri(m, { left: l.left !== void 0 ? l.left - T * b : void 0, top: l.top !== void 0 ? l.top - G * b : void 0, bottom: l.bottom !== void 0 ? l.bottom + X * b : void 0, right: l.right !== void 0 ? l.right + ie * b : void 0 })), a({ visibleArea: m, type: "move" })), h.width = h.width * b, h.height = h.height * b, h.left = m.left + T * b, h.top = m.top + G * b, h = je(h, qi(_t(m), l)), u.factor && R && d && (u.factor > 1 ? p = Math.min(M.area.maximum, u.factor) / b : u.factor < 1 && (p = Math.max(h.height / m.height, h.width / m.width, u.factor / b)), p !== 1 && (m = it(m = je(m = ct(m, p, u.factor > 1 ? u.center : Ye(h)), a({ visibleArea: m, type: "move" })), Ki(ri(h, _t(m)))))), { coordinates: h, visibleArea: m };
}
function dr(e) {
  ...
  return (m = re(re({}, It({ sizeRestrictions: a, aspectRatio: n, width: m.width, height: m.height })), kt(Ye(m), g))).left -= p.left - d.width / 2 + m.width / 2, m.top -= p.top - d.height / 2 + m.height / 2, h = ct(h, Xi(h, i({ visibleArea: h, type: "resize" }))), { coordinates: m = je(m, l), visibleArea: h = je(h = it(h, si(Ye(m), Ye(s))), i({ visibleArea: h, type: "move" })) };
}
function hr(e) {
...
var rn = mt("vue-bounding-box"), pr = ["east", "west", null], br = ["south", "north", null], qa = { name: "BoundingBox", props: { width: { type: Number }, height: { type: Number }, transitions: { type: Object }, handlers: { type: Object, default: function() {
  ...
  n === "west" ? d.left -= a : n === "east" && (d.right += a), i === "north" ? d.top -= l : i === "south" && (d.bottom += l), !i && n ? s = "width" : i && !n && (s = "height"), this.resizable && this.$emit("resize", new Kl(d, { allowedDirections: { left: n === "west" || !n, right: n === "east" || !n, bottom: i === "south" || !i, top: i === "north" || !i }, preserveAspectRatio: e.nativeEvent && e.nativeEvent.shiftKey, respectDirection: s }));
...
var Si = mt("vue-preview"), eo = { props: { coordinates: { type: Object }, transitions: { type: Object }, image: { type: Object, default: function() {
  ...
  if (this.coordinates && this.image) {
    var e = this.coordinates.width / this.size.width, n = Ce(Ce({ rotate: 0, flip: { horizontal: !1, vertical: !1 } }, this.image.transforms), {}, { scaleX: 1 / e, scaleY: 1 / e }), i = this.imageSize.width, s = this.imageSize.height, o = Ka({ width: i, height: s }, n.rotate), a = { width: "".concat(i, "px"), height: "".concat(s, "px"), left: "0px", top: "0px" }, l = { rotate: { left: (i - o.width) * n.scaleX / 2, top: (s - o.height) * n.scaleY / 2 }, scale: { left: (1 - n.scaleX) * i / 2, top: (1 - n.scaleY) * s / 2 } };
...
var wr = ["transitions"], wt = mt("vue-advanced-cropper"), io = { name: "Cropper", components: { BackgroundWrapper: yn }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  ...
  if (p) {
    ...
    if (b || (b = l.width >= l.height || p === 1 ? "width" : "height"), b === "width") {
      ...
      var ie = l.width - h * p;
      if (g.left && g.right) {
        var G = u.left, X = u.right;
        u.left = -Ti(ie, G, X), u.right = -Ti(ie, X, G);
  ...
  var l = Ki(ri(o, _t(a = ct(a, Xi(a, s({ visibleArea: a, type: "resize" }))))));
  ...
  if (this.$refs.canvas) {
    var e = this.$refs.canvas, n = this.$refs.image, i = this.imageTransforms.rotate !== 0 || this.imageTransforms.flip.horizontal || this.imageTransforms.flip.vertical ? (function(d, u, g) {
      var m = g.rotate, h = g.flip, p = { width: u.naturalWidth, height: u.naturalHeight }, b = Ka(p, m), R = d.getContext("2d");
...
const Tr = { class: "image-upload-container" }, Sr = {
...
}, jr = { class: "progress-bar" }, Kr = { class: "progress-text" }, Xr = { class: "upload-hint" }, qr = { class: "upload-sub-hint" }, Zr = ["accept"], Qr = ["src"], Jr = ["src"], ec = { class: "image-crop-body" }, tc = {
  key: 0,
  ...
  setup(e, { expose: n, emit: i }) {
    const { t: s } = ke();
    ls(vn.Parser);
    const o = e, a = i, l = P(() => o.placeholder || s(r.CLICK_OR_DRAG_TO_UPLOAD_COVER_IMAGE)), d = P(() => o.acceptHint || s("Supports JPG/PNG/GIF/WebP max {max}MB", { max: o.maxSize })), u = I(null), g = I(null), m = I(!1), h = I(0), p = I(!1), b = I(""), R = I(!o.uploadEnabled), M = I(o.modelValue), T = I(null), { previewUrl: ie, setPreview: G } = Ar(), X = I(!1), q = I(!1), {
      containerRef: Q,
      playUrl: le
    ...
    const $ = P(() => te(M.value));
    Me(() => o.modelValue, (x) => {
      M.value = x, de.value = "", x && o.uploadEnabled && (R.value = !0), o.deferUpload && (T.value = null, G(null), X.value = !1, q.value = !1, a("fileReady", null));
    ...
    async function qe(x) {
      if (o.deferUpload) {
        ...
        X.value = Ae, q.value = J, a("fileReady", x), J && O(previewUrl);
        return;
      }
      m.value = !0, h.value = 0;
      try {
    ...
    function ve(x) {
      x == null || x.stopPropagation(), _e.cancelValidation(), ce.value = !1, de.value = "", a("update:modelValue", ""), M.value = "", b.value = "", m.value = !1, h.value = 0, p.value = !1, W(), o.deferUpload && (T.value = null, G(null), X.value = !1, q.value = !1, a("fileReady", null));
    }
    function Oe(x) {
    ...
    return n({
      ...
      reset() {
        _e.reset(), T.value = null, G(null), X.value = !1, q.value = !1, W(), M.value = o.modelValue || "", b.value = "", de.value = "", m.value = !1, h.value = 0, p.value = !1, o.uploadEnabled && (R.value = !!o.modelValue), a("fileReady", null);
      },
      /**
  ...
  setup(e, { emit: n }) {
    ...
    }, p = I(Qn()), b = I([]), R = I(!1), M = I(!1), T = I(!1), ie = I(""), G = I(""), X = I(null), q = I(""), Q = I(null), le = I(!1), { loading: he, execute: Ee } = On({
      action: async () => {
        let $ = "";
        try {
          $ = await xa({
        ...
        await a(j), X.value = null, q.value = "";
        let $e = !T.value;
        if (T.value) {
          const De = await Cs({
            liveId: Se,
          ...
          X.value = De.streamInfo, q.value = De.streamInfoError, G.value = De.setupError, $e = De.configuredSuccessfully;
        }
    ...
    const U = P(() => {
    ...
    }), D = P(() => _s(p.value.seatTemplate)), L = P(() => T.value ? ie.value === "error" ? `OBS 配置失败：${G.value}` : X.value ? "OBS 已配置完成，可直接复制下方推流信息。" : q.value ? `OBS 已配置完成，但推流信息生成失败：${q.value}` : "OBS 已配置完成。" : ""), F = P(() => ie.value === "error" || !!q.value), N = ($) => {
      le.value = !!$;
    }, S = async ($, j) => {
      try {
      ...
      if (b.value.length >= Xe.maxCount) {
        Y.error(i("Custom info max count exceeded", { max: Xe.maxCount }));
        return;
      }
      ...
      var $;
      p.value = Qn(), b.value = [], R.value = !1, M.value = !1, T.value = !1, ie.value = "", G.value = "", X.value = null, q.value = "", le.value = !1, ($ = Q.value) == null || $.reset();
    }, ce = () => {
    ...
    return ($, j) => {
      const Se = ae("t-input"), Re = ae("t-form-item"), $e = ae("t-select"), De = ae("t-input-number"), qe = ae("t-checkbox"), Ke = ae("t-button"), me = ae("t-form"), ut = ae("t-dialog");
      return y(), se(ut, {
        visible: d.value,
              ...
              c("div", mc, [
                c("div", fc, [
                  c("div", gc, [
                    ...
                    c("button", {
                      class: "action-link",
                      onClick: j[6] || (j[6] = (fe) => S(X.value.serverUrl, t(i)(t(r).SERVER_URL)))
                    }, [
                      f(t(Dt)),
                      B(" " + v(t(i)(t(r).COPY)), 1)
                    ])
                  ]),
                  c("code", pc, v(X.value.serverUrl), 1)
                ]),
                c("div", bc, [
                  c("div", yc, [
                    ...
                    c("button", {
                      class: "action-link",
                      onClick: j[7] || (j[7] = (fe) => S(X.value.streamKey, t(i)(t(r).STREAM_KEY)))
                    }, [
                      f(t(Dt)),
                      B(" " + v(t(i)(t(r).COPY)), 1)
                    ])
                  ]),
                  c("code", Ec, v(X.value.streamKey), 1)
                ])
              ])
            ])) : ue("", !0)
          ])) : (y(), se(me, {
            ...
            default: E(() => [
              ...
              c("div", oc, [
                ...
                R.value ? (y(), C("div", lc, [
                  (y(!0), C(pe, null, Ne(b.value, (fe, Ze) => (y(), C("div", {
                    ...
                    c("div", rc, [
                      f(Se, {
                        ...
                        status: g(fe.key) > t(Xe).maxKeyBytes || t(ti)(fe) ? "error" : "default",
                        tips: g(fe.key) > t(Xe).maxKeyBytes ? t(i)("Key exceeds byte limit", { max: t(Xe).maxKeyBytes }) : t(ti)(fe) ? t(i)(t(r).CUSTOM_INFO_KEY_REQUIRED) : ""
                    ...
                    c("div", cc, [
                      f(Se, {
                        ...
                        status: m(fe.value) > t(Xe).maxValueBytes ? "error" : "default",
                        tips: m(fe.value) > t(Xe).maxValueBytes ? t(i)(t(r).VALUE_EXCEEDS_2KB_LIMIT) : ""
                      }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder", "status", "tips"])
                    ]),
                    f(Ke, {
                      variant: "text",
                  ...
                  b.value.length < t(Xe).maxCount ? (y(), se(Ke, {
                    key: 0,
                    style: { width: "80px" },
                    variant: "text",
                    shape: "round",
  ...
  setup(e, { emit: n }) {
    ...
    }), g = (O) => te(O), m = (O) => te(O), h = I(Jn()), p = I([]), b = I(!1), R = I([]), M = I(ea), T = I(null), ie = I(!1), { loading: G, execute: X } = On({
      action: async (O) => {
        var D, L;
            ...
            default: E(() => [
              ...
              c("div", Ic, [
                ...
                b.value ? (y(), C("div", Mc, [
                  (y(!0), C(pe, null, Ne(p.value, (k, w) => (y(), C("div", {
                    ...
                    c("div", Tc, [
                      f(D, {
                        ...
                        placeholder: t(i)(t(r).ENTER_KEY),
                        status: g(k.key) > t(Xe).maxKeyBytes || t(ti)(k) ? "error" : "default",
                        tips: g(k.key) > t(Xe).maxKeyBytes ? t(i)("Key exceeds byte limit", { max: t(Xe).maxKeyBytes }) : t(ti)(k) ? t(i)(t(r).CUSTOM_INFO_KEY_REQUIRED) : ""
                      }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder", "status", "tips"])
                    ]),
                    c("div", Sc, [
                      f(D, {
                        ...
                        placeholder: t(i)(t(r).ENTER_VALUE),
                        status: m(k.value) > t(Xe).maxValueBytes ? "error" : "default",
                        tips: m(k.value) > t(Xe).maxValueBytes ? t(i)(t(r).VALUE_EXCEEDS_2KB_LIMIT) : ""
                      }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder", "status", "tips"])
                    ]),
                    f(F, {
                      variant: "text",
                  ...
                  p.value.length < t(Xe).maxCount ? (y(), se(F, {
                    key: 0,
                    style: { width: "80px" },
                    variant: "text",
                    shape: "round",
    ...
    return (p, b) => {
      ...
      return y(), C("div", $c, [
        c("div", Pc, [
          ...
          f(Et, {
            "slot-component": (X = t(o)) == null ? void 0 : X.afterToolbar,
            "slot-props": { lives: l.value.lives, loading: l.value.loading }
          }, null, 8, ["slot-component", "slot-props"])
        ]),
...
}), Wu = { class: "video-monitor-area" }, Hu = { class: "live-header-external" }, Yu = { class: "live-title-text" }, ju = { class: "video-stage" }, Ku = {
  key: 1,
  class: "video-blur-bg-placeholder"
}, Xu = { class: "player-container" }, qu = {
  key: 0,
  ...
  setup(e) {
    const { t: n } = ke(), i = e, { loginUserInfo: s } = $a(), { currentLive: o } = Pt(), { audienceList: a, disableSendMessage: l } = Pa(), d = P(() => i.currentLive || o.value), u = (U) => new TextEncoder().encode(U).length, g = I(!1), m = I({ top: 0, left: 0 }), h = I(null), p = I(""), b = I(!1), R = I(null), M = I(null), T = I(null), ie = P(() => b.value || !i.liveId || !p.value.trim()), G = (U) => a.value.find((D) => D.userId === U), X = (U) => {
      const D = G(U);
      if (D)
      ...
      const D = h.value.sender.userName || h.value.sender.nameCard || h.value.sender.userId, L = X(U);
      try {
      ...
      (y(), se(An, { to: "body" }, [
        g.value && h.value ? (y(), C("div", {
          ...
          c("button", {
            ...
            X(h.value.sender.userId) ? (y(), se(t(Hi), { key: 0 })) : (y(), se(t(Ma), { key: 1 })),
            c("span", null, v(X(h.value.sender.userId) ? t(n)(t(r).UNMUTE) : t(n)(t(r).MUTE)), 1)
          ]),
          c("button", {
  ...
  setup(e, { emit: n }) {
    const i = e, s = n, { login: o, loginUserInfo: a } = $a(), { joinLive: l, leaveLive: d, subscribeEvent: u, unsubscribeEvent: g, LiveListEvent: m } = ll(), h = I(!1), p = I(""), b = I(!1), R = I(""), M = P(
      () => {
        var X;
        return i.currentUserId || R.value || Ua() || ((X = a.value) == null ? void 0 : X.userId) || "";
      }
    ), T = () => {
      s("live-ended");
    }, ie = async () => {
      ...
      if (!h.value)
        try {
          ...
          if ((q == null ? void 0 : q.code) === 2025 || (X = q == null ? void 0 : q.message) != null && X.includes("重复登录")) {
            h.value = !0;
            return;
          }
      ...
      if (!(!i.liveId || !i.currentLive || !h.value || p.value === i.liveId))
        try {
          ...
          console.error("[LiveControlLeftPanel] joinLive failed:", X);
        }
    };
    return Me(
      ...
      var X, q;
      b.value && g && (m != null && m.onLiveEnded) && (g(m.onLiveEnded, T), b.value = !1), p.value && ((q = d == null ? void 0 : (X = d()).catch) == null || q.call(X, (Q) => {
...
const Wh = { class: "live-control-container" }, Hh = { class: "live-control-viewport" }, Yh = { class: "right-sidebar" }, Ri = 20, jh = /* @__PURE__ */ Te({
  ...
  setup(e) {
    ...
    const n = Do(), i = _i(), s = P(() => n.params.liveId), o = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__, { t: a } = ke(), { currentLive: l, fetchLiveDetail: d, fetchLiveStats: u, endLive: g, updateLive: m } = Pt(), { audienceList: h, audienceCount: p } = Pa(), b = (Yn = Yi().components) == null ? void 0 : Yn.roomControl, {
      ...
      await X({ memberAccounts: [_], duration: A, reason: z });
    }, k = async (_) => {
    ...
    } = Bh(), _e = P(() => Ua() || ""), $ = I(!0), j = I(null), Se = I(!1), Re = I("chat"), $e = I(0), De = I(null), qe = I(/* @__PURE__ */ new Map()), Ke = I(null), me = Ui({
      onlineCount: 0,
      totalViewers: 0,
      totalMsgCount: 0,
    ...
    const en = P(
      ...
      () => {
        var _, A, z;
        return ((_ = Ke.value) == null ? void 0 : _.nick) || hn(
      ...
      () => {
        var _, A, z;
        return ((_ = Ke.value) == null ? void 0 : _.avatarUrl) || dn((A = l.value) == null ? void 0 : A.liveOwner) || ((z = j.value) == null ? void 0 : z.anchor.avatar);
      }
    ), $n = P(() => {
      var _;
      ...
      Xt && (clearInterval(Xt), Xt = null), Se.value = !0;
    }, Hn = () => {
      s.value && (ui(), di());
    }, To = () => {
      Hn();
    ...
    Me(
      ...
      { immediate: !0 }
    ), s.value && (Ao(), Wn(), Ft(1)), s.value && (Xt = window.setInterval(() => {
      if (De.value) {
    ...
    return Me(Re, (_) => {
      ...
      })), Xt && clearInterval(Xt), qt && clearInterval(qt), ot == null || ot.disconnect(), ot = null;
    }), (_, A) => {
      var z, H, Z, ge;
      return y(), C("div", Wh, [
        f(t($u), {
...
}), pm = /* @__PURE__ */ ci(jh, [["__scopeId", "data-v-06a99f87"]]), Kh = { class: "gift-config-container" }, Xh = { class: "gift-config-page-header" }, qh = { class: "gift-config-title" }, Zh = { class: "gift-config-actions" }, Qh = { class: "gift-search-input" }, Jh = { class: "gift-id" }, ev = { class: "gift-id-text" }, tv = { class: "gift-thumbnail" }, iv = ["src", "alt"], nv = { key: 1 }, av = ["onClick"], ov = { class: "gift-lang-tags" }, sv = ["onClick"], lv = {
  key: 1,
  ...
  setup(e) {
    ...
    return At(async () => {
      ...
      return y(), C("div", Kh, [
          ...
          default: E(() => [
            f(Zi, {
              ...
              "cell-categories": E(({ row: K }) => {
                ...
                return [
                  c("div", {
                    ...
                    c("span", null, v(((be = K.categories) == null ? void 0 : be.join(", ")) || "-"), 1),
                    f(t(Pi), {
              ...
              "cell-languageList": E(({ row: K }) => [
                c("div", ov, [
                  K.languageList && K.languageList.length > 0 ? (y(!0), C(pe, { key: 0 }, Ne(K.languageList, (be) => (y(), C("span", {
                    key: t(ii)(be),
                    class: "gift-lang-tag",
                    onClick: (Kt) => Oe(K.id, t(ka)(t(ii)(be)))
        ...
        f(Qe, {
          visible: X.value,
          "onUpdate:visible": oe[9] || (oe[9] = (K) => X.value = K),
          ...
          footer: E(() => {
            ...
            return [
              ...
              f(dt, {
                theme: "primary",
                shape: "round",
                disabled: D.value || !p.value && !w.id || !w.name.trim() || ((K = F.value) == null ? void 0 : K.isValidating) || ((be = N.value) == null ? void 0 : be.isValidating) || ((Kt = F.value) == null ? void 0 : Kt.hasUrlError) || ((Rt = N.value) == null ? void 0 : Rt.hasUrlError),
                loading: D.value,
                onClick: ze
              }, {
                default: E(() => [
        ...
        f(Qe, {
          visible: q.value,
          "onUpdate:visible": oe[10] || (oe[10] = (K) => q.value = K),
          ...
          default: E(() => [
            c("div", mv, [
              ...
              c("table", pv, [
                ...
                c("tbody", null, [
                  (y(!0), C(pe, null, Ne(t(Oa), (K) => (y(), C("tr", { key: K }, [
                    c("td", null, v(t(o)(t(Ut)[K].label)), 1),
                    c("td", bv, [
                      R.value[K].name ? (y(), C(pe, { key: 0 }, [
                        B(v(R.value[K].name), 1)
                      ], 64)) : (y(), C("span", yv, v(t(o)(t(r).NOT_CONFIGURED)), 1))
                    ]),
                    c("td", Ev, [
                      R.value[K].description ? (y(), C(pe, { key: 0 }, [
                        B(v(R.value[K].description), 1)
        ...
        f(Qe, {
          visible: Q.value,
          "onUpdate:visible": oe[11] || (oe[11] = (K) => Q.value = K),
        ...
        f(Qe, {
          visible: le.value,
          "onUpdate:visible": oe[12] || (oe[12] = (K) => le.value = K),
          ...
          "confirm-btn": { content: t(o)(t(r).CLOSE), shape: "round" },
          "cancel-btn": null,
          onConfirm: oe[13] || (oe[13] = (K) => le.value = !1)
        }, {
          default: E(() => [
            c("div", wv, [
              G.value.length > 0 ? (y(!0), C(pe, { key: 0 }, Ne(G.value, (K) => (y(), C("span", {
                key: K,
        ...
        f(Qe, {
          visible: W.value,
          "onUpdate:visible": oe[14] || (oe[14] = (K) => W.value = K),
        ...
        f(Qe, {
          visible: Ee.value,
          "onUpdate:visible": oe[15] || (oe[15] = (K) => Ee.value = K),
        ...
        f(Qe, {
          visible: he.value,
          "onUpdate:visible": oe[17] || (oe[17] = (K) => he.value = K),
          ...
          default: E(() => [
            c("div", Av, [
              f(Ji, {
                modelValue: O.value,
                "onUpdate:modelValue": oe[16] || (oe[16] = (K) => O.value = K),
                placeholder: t(o)(t(r).SELECT_CATEGORY_LOWERCASE),
                style: { width: "100%" }
              }, {
                default: E(() => [
                  (y(!0), C(pe, null, Ne(U.value, (K) => (y(), se(zt, {
                    key: K.id,
                    value: K.id,
                    label: K.name
...
}, Bv = { class: "category-count" }, Wv = { class: "category-loading-container" }, Hv = { class: "category-loading-text" }, Yv = { class: "category-empty-container" }, jv = { class: "category-empty-text" }, Kv = { class: "category-lang-config-container" }, Xv = { class: "category-lang-config-info-banner" }, qv = {
  width: "16",
  height: "16",
  viewBox: "0 0 16 16",
  fill: "none",
              ...
              default: E(() => [
                ...
                f(ce, {
                  ...
                  default: E(() => [
                    f(ee, {
                      modelValue: X.value,
                      "onUpdate:modelValue": k[3] || (k[3] = ($) => X.value = $),
