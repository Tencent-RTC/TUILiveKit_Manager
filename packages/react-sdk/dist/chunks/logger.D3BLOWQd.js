...
var en = { exports: {} }, To = en.exports, mi;
function Oo() {
  return mi || (mi = 1, (function(E, O) {
    ((T, q) => {
      E.exports = q();
    })(To, function() {
      var T, q;
      ...
      Array.prototype.find || Object.defineProperty(Array.prototype, "find", { configurable: !0, writable: !0, value: function(e) {
        ...
        return !!e[this.name];
      }, q = G, Object.defineProperty(window, "WeakSet", { value: function(e) {
        return new q(e);
      ...
      var R, A, ie, Ii = /_?t(\d)?(imestamp)?=\d+&?/g, $n = ["aegis.qq.com", "tamaegis.com", "/aegis-sdk", "rumt-", "/flog.core.min.js", "pingfore.qq.com", "pingfore.tencent.com", "zhiyan.tencent-cloud.net", "h.trace.qq.com", "btrace.qq.com", "beacon.qq.com", "dmplog.qq.com", "qq.com/report", "svibeacon.onezapp.com", "cube.weixinbridge.com", "doubleclick.net", "pcmgrmonitor.3g.qq.com", "tdm.qq.com", "report.qqweb.qq.com", "tpstelemetry.tencent.com", "galileotelemetry.tencent.com", "insight.cloud.tencent.com", "facebook.com", "facebook.net", "google", "yahoo.com", "twitter.com", "ga-audiences", "report.idqqimg.com", "arms-retcode.aliyuncs.com", "px.effirst.com", "sentry", "baidu.com", "hot-update.json", "u.c.b.r.o.w.s.e.r", "report.url.cn", "sockjs-node", "m3u8", "flv"], Mi = ["ResizeObserver loop limit exceeded", "ResizeObserver loop completed", "Failed to execute 'transaction'", "window.indexedDB.deleteDatabase is not a function"], Jn = ["ext1", "ext2", "ext3", "ext4", "ext5", "ext6", "ext7", "ext8", "ext9", "ext10", "level", "trace", "tag", "seq", "code"], Ni = ["static", "fetch"], Z = "unknown";
      (S = R = R || {}).INFO_ALL = "-1", S.API_RESPONSE = "1", S.INFO = "2", S.ERROR = "4", S.PROMISE_ERROR = "8", S.AJAX_ERROR = "16", S.SCRIPT_ERROR = "32", S.IMAGE_ERROR = "64", S.CSS_ERROR = "128", S.CONSOLE_ERROR = "256", S.MEDIA_ERROR = "512", S.RET_ERROR = "1024", S.PAGE_LOAD = "1025", S.SLOW_PAGE_LOAD = "1026", S.SLOW_NET_REQUEST = "1027", S.ASSERT_REQUEST = "1028", S.SLOW_ASSET_REQUEST = "1029", S.CLICK_EVENT = "1030", S.CONSOLE_LOG = "1031", S.BLANK_SCREEN = "1032", S.MEMORY_OOM = "1033", S.LAG_MONITOR = "1034", S.NORESPONSE_LOG = "1035", S.REPORT = "2048", S.PV = "4096", S.EVENT = "8192", S.SPEED_EVENT = "8193", S.PAGE_NOT_FOUND_ERROR = "16384", S.WEBSOCKET_ERROR = "32768", S.BRIDGE_ERROR = "65536", S.LAZY_LOAD_ERROR = "131072", S.CRASH_ERROR = "262144", (S = A = A || {}).LOG = "log", S.SPEED = "speed", S.PERFORMANCE = "performance", S.OFFLINE = "offline", S.WHITE_LIST = "whiteList", S.VITALS = "vitals", S.PV = "pv", S.CUSTOM_PV = "customPV", S.EVENT = "event", S.CUSTOM = "custom", S.SDK_ERROR = "sdkError", S.SET_DATA = "setData", S.LOAD_PACKAGE = "loadPackage", S.MEMORY = "memory", (S = ie = ie || {}).production = "production", S.development = "development", S.gray = "gray", S.pre = "pre", S.daily = "daily", S.local = "local", S.test = "test", S.others = "others";
      function rn(e, t) {
        var n;
      ...
      (S = rt = rt || {})[S.number = -1] = "number", S.string = "";
      function St(e, t) {
      ...
      function Kn(e, t) {
        return t === void 0 && (t = 2048), String(e).replace(Ii, "").slice(0, t);
      }
      function Et(e) {
      ...
      function qe(e, t) {
        return typeof e != "string" || !e || t && -1 < e.indexOf(t) || Wi.test(e) || $n.some(function(n) {
      ...
      function Zn(e, t, n, r) {
        ...
        i ? r === A.LOG && Array.isArray(t) ? (e = t.filter(function(o) {
          return o = ir(r, o.level), or(i[o]);
        })).length && n(e) : (e = ir(r), or(i[e]) && n(t)) : n(t);
      }
      function Rt(e, t) {
        var n, r = [], i = e.config;
        return e.lifeCycle.on("destroy", function() {
          ...
          Array.isArray(o) ? r = r.concat(o) : r.push(o), t && r.length >= t || e.sendNow && 0 < r.length ? (r = ar(r), 0 < (r = Array.isArray(r) ? r : []).length && a(r.splice(0, r.length)), n && clearTimeout(n)) : (n && clearTimeout(n), n = setTimeout(function() {
            n = null, r = ar(r), 0 < (r = Array.isArray(r) ? r : []).length && a(r.splice(0, r.length));
          }, i.delay));
        };
      }
      function Fi(e, t) {
        return Array.isArray(e) ? t(e.map(function(n) {
          return r = x(x({}, n), { msg: typeof n.msg == "string" ? n.msg : [].concat(n.msg).map(we).join(" ") }), Jn.forEach(function(i) {
            r[i] || delete r[i];
          }), r;
          var r;
        ...
        return function(n, r) {
          ...
          n != null && n.log && n != null && n.type ? (i = function(l, c, f) {
            switch (c) {
              ...
              case A.SPEED:
                var p = l, d = f;
                return d = d && d !== "undefined" ? x(x({}, e.bean), { from: d }) : x({}, e.bean), de(Yn(p, d));
              case A.EVENT:
      ...
      function Ui(e, t) {
        return function(n, r) {
          ...
          (u = typeof l == "function" ? u.map(function(c) {
            ...
            return c !== !1;
          }) : u).length && (i = u, n = Jn, !Array.isArray(i) || i.length <= 1 || (o = [], a = [], !(a = typeof n == "string" ? [n] : n)) || a.length <= 0 || (a.forEach(function(c) {
      ...
      var Di = ["application/xhtml+xml", "application/xml", "application/pdf", "application/pkcs12", "application/javascript", "application/x-javascript", "application/ecmascript", "application/vnd.mspowerpoint", "application/vnd.apple.mpegurl", "application/ogg", "text/css", "text/javascript", "image", "audio", "video", "video/mp2t"], Hi = /\.(json|js|css|jpg|jpeg|png|svg|apng|webp|gif|bmp|mp4|mp3|ts|mpeg|wav|webm|ogg|flv|m3u8|ttf|woff2|otf|eot|woff|html|htm|shtml|shtm|)$/i, Tt = ["ret", "retcode", "code", "errcode"], on = function() {
  ...
  Error.stack: ` + n.stack;
        ...
        try {
          return e instanceof Error ? (JSON.stringify(e, on(), 2) || "undefined").replace(/"/gim, "") : JSON.stringify(e, on(), 2) || "undefined";
        } catch (t) {
 ...
 ` + t.stack;
        ...
        if (typeof e == "string") return e;
        try {
          return JSON.stringify(e, on()) || "undefined";
        } catch (t) {
          return `error happen when aegis stringify: 
 ` + t.message + ` 
 ` + t.stack;
        ...
        return Array.isArray(e) ? (o += "[", n = e.length, e.forEach(function(a, s) {
          o = (o += typeof a == "object" && 1 < t ? an(a, t - 1) : qi(a)) + (s === n - 1 ? "" : ",");
        }), o += "]") : e instanceof Object || typeof e == "object" ? (o = "{", r = Object.keys(e), i = r.length, r.forEach(function(a, s) {
          typeof e[a] == "object" && 1 < t ? o += '"' + a + '":' + an(e[a], t - 1) : o += ji(a, e[a]), o += s === i - 1 || s < i - 1 && e[r[s + 1]] === void 0 ? "" : ",";
        }), o += "}") : o += e, o;
      }, ji = function(e, t) {
        var n = typeof t, r = "";
      ...
      }, Wi = /data:(image|text|application|font)\/.*;base64/, Bi = ((S = {})[A.LOG] = "log", S[A.MEMORY] = "log", S[A.SPEED] = "speed", S[A.PERFORMANCE] = "performance", S[A.VITALS] = "webvitals", S[A.PV] = "pv", S[A.EVENT] = "event", S[A.CUSTOM] = "custom", S[A.SET_DATA] = "miniProgramData", S[A.LOAD_PACKAGE] = "miniProgramData", S), rr = ((S = {})[R.ERROR] = "jsError", S[R.PROMISE_ERROR] = "jsError", S[R.BLANK_SCREEN] = "whiteScreen", S[R.SCRIPT_ERROR] = "assetsException", S[R.IMAGE_ERROR] = "assetsException", S[R.CSS_ERROR] = "assetsException", S[R.MEDIA_ERROR] = "assetsException", S), ir = function(e, t) {
        return e === A.LOG && t && rr[t] ? rr[t] : Bi[e] || "";
      }, or = function(e) {
        ...
        return function(t) {
          return e.sendPipeline([function(n, r) {
            return r({ url: e.config.url || "", data: Xn(lr(n)), method: "post", contentType: "application/json", type: A.LOG, log: n, requestConfig: { timeout: 5e3 }, success: function() {
      ...
      }, Ot = { generateTraceId: cr(16), generateSpanId: cr(8) }, xt = Array(32);
      function cr(e) {
        return function() {
      ...
      function Gi(e) {
        if (e = String(e).replace(/[\t\n\f\r ]+/g, ""), !Vi.test(e)) throw new TypeError("Failed to execute 'atob': The string to be decoded is not correctly encoded.");
        var t;
      ...
      function Be(e) {
        if (e && e.reduce && e.length) return e.length === 1 ? function(t, n) {
          ...
          return function(r, i) {
            return i === void 0 && (i = dr), t(r, function(o) {
              return n?.(o, i);
            });
          };
        });
      ...
      var Te = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", Vi = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/, $i = (be.prototype.generate = function(e, t, n) {
        ...
        var t = typeof btoa == "function" ? btoa : zi, r = r || {}, n = r.host, n = n === void 0 ? "" : n, r = r.pathname, r = r === void 0 ? "" : r, i = un(), o = un();
        ...
        var e = ln().substring(16);
        return ln() + "-" + e + "-" + this.traceFlag;
      ...
      }, be), fr = { sw8: function(n) {
        var t = typeof atob == "function" ? atob : Gi, n = n.split("-")[1];
        return n ? t(n) : "";
      ...
      C.use = function(e) {
            ...
            m({ url: "" + h, type: A.WHITE_LIST, success: function(b) {
              try {
                ...
                v === 0 && Array.isArray(L) ? (y = {}, L.forEach(function(k) {
                  ...
                  Zn(n, k.logs, k.resolve, k.sendType);
                }), 0 < N && c(N)) : u();
              } catch {
                u();
              }
        ...
        if (this.lifeCycle.emit("destroy"), this.lifeCycle.clear(), e) t = this, n = Object.getOwnPropertyDescriptors(t), Object.keys(n).forEach(function(a) {
          ...
          for (var o = this; o.constructor !== Object && fn(o, this), o = Object.getPrototypeOf(o); ) ;
          C.instances.length === 0 && (r = Object.getPrototypeOf(this).constructor, fn(r), fn(C));
        }
        ...
        })() ? u : ie.others, l && this.extendBean("from", encodeURIComponent(l.slice(0, 2048))), i && this.extendBean("ext1", encodeURIComponent(i)), o && this.extendBean("ext2", encodeURIComponent(o)), a && this.extendBean("ext3", encodeURIComponent(a)), c && this.lifeCycle.emit("onConfigChange", this.config), this.config;
        ...
        var r = this;
        return Be([tr(this), er(this, e?.type), function(i, o) {
        ...
        return Be(Q([function(a, s) {
          ...
          if (i !== A.SDK_ERROR && i !== A.WHITE_LIST) return r.rateLimitReady ? void Zn(r, a, s, i) : (r.rateLimitPool || (r.rateLimitPool = []), void (r.rateLimitPool.length < 200 && r.rateLimitPool.push({ logs: a, resolve: s, sendType: i })));
          s(a);
        }, Ui(r = n = this, i = t)], e, [er(this, t), tr(this), function(a, s) {
          var u;
      ...
      }, C.version = "1.41.13", C.instances = [], C.logType = R, C.environment = ie, C.installedPlugins = [];
      var S = C, _ = (le.prototype.patch = function(e) {
      ...
      }, le), Ji = new _({ name: "aid", aid: "", init: function(e) {
        try {
          var t = e !== !0 && e || window.localStorage.getItem("AEGIS_ID");
          t || (t = un(), window.localStorage.setItem("AEGIS_ID", t)), this.aid = t;
        } catch {
        }
      }, onNewAegis: function(e) {
        e.bean.aid = this.aid, e.config.aid = this.aid;
      } }), Pt = new _({ name: "reportAssetSpeed" }), Xi = Pt = new _({ name: "reportAssetSpeed", collectCur: 0, collectEntryType: "resource", ASSETS_INITIATOR_TYPE: ["img", "css", "script", "link", "audio", "video"], getFromParam: function(e) {
...
`), a = e.isWhiteList && e.config.assetLog, s = e.config.slowAssetLog && i, u = { level: i ? e.LogType.SLOW_ASSET_REQUEST : e.LogType.ASSERT_REQUEST, msg: o, ext1: n.toString() || "", errorMsg: "", originFrom: e.getOriginFrom() };
        ...
        function t(i) {
          ...
          i && (i = i.target || i.srcElement, !(o = i?.src || i?.href) || typeof o != "string" || -1 < window.location.href.indexOf(o) || (i = typeof ((i = r.api) == null ? void 0 : i.resourceTypeHandler) == "function" ? (i = r.api) == null ? void 0 : i.resourceTypeHandler(o) : "", a = performance.getEntriesByType(n.collectEntryType).find(function(l) {
            return l.name === o;
          }), qe(o, r.hostUrl)) || (s = n.getFromParam(e), u = Number((u = a) == null ? void 0 : u.responseStatus), u = Number.isFinite(u) && 0 < u ? u : 400, u = { url: Kn(o), status: u, duration: Number((a?.duration || 0).toFixed(2)), method: "get", type: i || "static", isHttps: Et(o), urlQuery: je(o, !0), nextHopProtocol: "", domainLookup: 0, connectTime: 0, from: s }, n.publish(u, e)));
        }
        ...
        return { url: Kn(e.name), method: "get", duration: Number(e.duration.toFixed(2)), status: o, type: r || "static", isHttps: Et(e.name), nextHopProtocol: e.nextHopProtocol || "", urlQuery: je(e.name, !0), domainLookup: St(e.domainLookupEnd - e.domainLookupStart), connectTime: St(e.connectEnd - e.connectStart), transferSize: 0 < i ? i : -1, from: n };
      ...
      } }), Ki = window.navigator.userAgent.toLowerCase(), P = {};
      function le(e) {
      ...
      function C(e) {
        ...
        this.isGetSample = !1, this.isHidden = !1, this.config = { version: 0, delay: 1e3, onError: !0, repeat: 60, random: 1, aid: !0, device: !0, pagePerformance: !0, webVitals: !0, speedSample: !0, onClose: !0, reportLoadPackageSpeed: !0, hostUrl: "https://rumt-zh.com", env: "production", url: "", offlineUrl: "", whiteListUrl: "", rateLimitUrl: "", pvUrl: "", speedUrl: "", customTimeUrl: "", performanceUrl: "", performanceUrlForHippy: "", webVitalsUrl: "", eventUrl: "", setDataReportUrl: "", memoryUrl: "", reportImmediately: !0, gzip: !0 }, this.isWhiteList = !1, this.whitelistUseGzip = !0, this.whitelistUseGzipReady = !1, this.lifeCycle = new _i(), this.bean = {}, this.rateLimitConfigs = null, this.rateLimitReady = !1, this.rateLimitSampled = !1, this.rateLimitPool = [], this.normalLogPipeline = Be([Rt(this, 5), Fi, function(g, m) {
          var b = t.config;
          ...
          m(g.filter(function(v) {
            if (v.level === R.ERROR || v.level === R.PROMISE_ERROR || v.level === R.AJAX_ERROR || v.level === R.SCRIPT_ERROR || v.level === R.IMAGE_ERROR || v.level === R.CSS_ERROR || v.level === R.MEDIA_ERROR || v.level === R.RET_ERROR || v.level === R.BRIDGE_ERROR || v.level === R.PAGE_NOT_FOUND_ERROR || v.level === R.WEBSOCKET_ERROR || v.level === R.LAZY_LOAD_ERROR) {
              if (v = v.msg.slice(0, 200), w[v] > b) return Ne[y] || sn(y), !1;
              w[v] = 1 + ~~w[v], We[y] = w;
            }
            return !0;
          }));
          ...
          o && clearTimeout(o), o = setTimeout(function() {
            ...
            !u && i.config && (u = !0, g = i.config.whiteListUrl, (m = g === void 0 ? "" : g) && i.sendPipeline([function(b, y) {
              y({ url: m, type: A.WHITE_LIST, success: function(w) {
                s = !0;
                try {
                  var v = w.data || JSON.parse(w), L = v.retcode, N = v.result, k = N === void 0 ? {} : N, I = (L === 0 ? (a = k.is_in_white_list, i.isWhiteList = a, i.updateWhitelistGzipState(k.use_gzip), 0 <= k.rate && k.rate <= 1 && (i.config.random = k.rate, i.isGetSample = !1)) : i.disableWhitelistGzipState(), i.isWhiteList && l.length ? ur(i)(l.splice(0), function() {
          ...
          a || (b = (b = i.config) == null ? void 0 : b.api) != null && b.reportRequest ? m(g.concat(l.splice(0)).map(function(y) {
            ...
            return y.level !== R.INFO && y.level !== R.API_RESPONSE ? (sr(y), !0) : (s || (l.push(y), 200 <= l.length && (l.length = 200)), !1);
          })).length && m(b);
        }), function(g, m) {
          try {
        ...
        }, ur(this)]), this.eventPipeline = Be([Rt(this, 10), (r = this, function(g) {
        ...
        })]), this.customTimePipeline = Be([Rt(this, 10), (n = this, function(g) {
...
`) + n + " header " + i + ": " + o : r;
      ...
      function pn(o, t, n) {
        ...
        return Ni.indexOf(o) === -1 && (r = t === void 0 ? "" : t, i = (n === void 0 ? "" : n).split("?")[0], o = Hi.test(i) || Di.some(function(a) {
      ...
      function Qi(e) {
        return (e = ((t) => {
          ...
          if (r === 1 || r === 9 || r === 11) {
            ...
            for (var i = t.firstChild; i; i = i.nextSibling) n += kr(t);
          } else if (r === 3 || r === 4) return t.nodeValue;
          return n;
        })(e)) ? e.replace(/^\s+|\s+$/g, "") : "";
      }
      var yr, wr, hn, gn, oe, kt, At, Oe, st, br, It, ze, Sr, mn, vn, Er, yn, wn, Rr = !(P.isIE = function() {
        return "ActiveXObject" in window;
      }), xe = [], Tr = /^\/[^/]/, Or = !1, pe = [], Ge = { maxRetryCount: 10, retryInterval: function(e) {
        return 1e3 * (2 << e);
      }, whenRetryEndStillFail: "discard", maxStorageCount: 50 }, Yi = (new _({ name: "reportApiSpeed" }), new _({ name: "reportApiSpeed", override: !1, onNewAegis: function(e) {
        var t, n;
        this.override || (this.override = !0, (n = e.config.api) != null && n.injectTraceHeader && (this.traceRequestHeader = new $i(n.injectTraceHeader, (t = n?.injectTraceIgnoreUrls) != null ? t : [], n?.injectTraceUrls, n?.traceFlag)), this.overrideFetch(e.config, e), this.overrideXhr(e.config, e));
        ...
        var n = this, r = e.api, r = { name: this.name, traceRequestHeader: r != null && r.injectTraceHeader ? this.traceRequestHeader : null, getCurrentFrom: function() {
          ...
          var d, h;
          qe(u, e.hostUrl) || (d = a.headers ? a.headers.get("content-type") : "", (h = pn(e, d || "", u)) === "fetch" ? a.clone().text().then(function(g) {
            var m, b = a.status <= 0 || 400 <= a.status, k = ((k = e.api) == null ? void 0 : k.reqHeaders) || [], y = at(l?.headers, k, "req"), k = ((k = e.api) == null ? void 0 : k.resHeaders) || [], w = at(a.headers, k, "res"), v = cn(l?.headers), k = Qn(g, e.api, { url: u, ctx: a, payload: l?.body }), L = k.code, N = k.isErr, k = (k = e.api) == null ? void 0 : k.apiDetail, I = k ? it(l?.body, (m = e.api) == null ? void 0 : m.reqParamHandler, { url: u }) : "", F = k ? it(g, (m = e.api) == null ? void 0 : m.resBodyHandler, { url: u, ctx: a }) : "";
            setTimeout(function() {
              var W = Ct(e, { url: u, duration: s, type: h, status: a.status || 0, method: l?.method || "get" }), Y = [b ? "FETCH_ERROR: " + g : "", "fetch req url: " + u, "res status: " + (W.status || 0), "res duration: " + W.duration + "ms", "res startTime: " + c, y, w, "req method: " + (W.method || "GET"), "res retcode: " + L, Lt(I, "req param"), Lt(F, "res data")].filter(function(D) {
                return D;
              }).join(`

`), Y = (W.payload = l?.body, W.ret = L, W.isErr = +N, W.from = f || n.getFromParam(t), { msg: Y, code: L, trace: v, errorMsg: "", from: f || n.getFromParam(t), originFrom: p, level: R.API_RESPONSE }), U = e.slowApiLog && mr(W?.duration, e, W);
              Y.level = U ? R.SLOW_NET_REQUEST : gr(b, N), (U || Y.level !== R.API_RESPONSE || t.isWhiteList || (U = (U = t.config) == null ? void 0 : U.api) != null && U.reportRequest) && n.publishNormalLog(Y, t), n.publishSpeed(W, t);
            }, 0);
          }).catch(function(g) {
          ...
          var d, h, g, m, b;
          throw qe(u, e.hostUrl) || (d = pn(e, "", u), h = ((h = e.api) == null ? void 0 : h.reqHeaders) || [], g = at(l?.headers, h, "req"), m = cn(l?.headers), b = (h = e.api) != null && h.apiDetail ? it(l?.body, (h = e.api) == null ? void 0 : h.reqParamHandler, { url: u }) : "", setTimeout(function() {
...
` + g);
        ...
        pe.push(i), !Or && window.fetch && (Or = !0, gn = window.fetch, window.fetch = function(a, s) {
          s === void 0 && (s = {});
          var u = typeof a == "string" ? a : a?.url;
          if ((p = o?.test) != null && p.call(o, u)) return gn(u, s);
          Tr.test(u) && (u = "" + location.origin + u);
          var l, c, f, p = (i || {}).traceRequestHeader;
          p && (l = (l = (s || {}).headers) === void 0 ? {} : l, c = (f = hr()).host, c = (p = p.generate(u, l, { host: c, pathname: f.pathname }) || {}).name, f = p.value) && c && (s.headers = Object.assign(l, ((p = {})[c] = f, p)));
        ...
        var n, r = this, i = { name: this.name, ignoreHackReg: (i = e.api) == null ? void 0 : i.ignoreHackReg, traceRequestHeader: (i = e.api) != null && i.injectTraceHeader ? this.traceRequestHeader : null, getCurrentFrom: function() {
          ...
          var l, c, f = Date.now(), p = ((e?.api || {}).injectTraceHeader && (c = (l = hr()).host, l = (c = r.traceRequestHeader.generate(o.aegisUrl, {}, { host: c, pathname: l.pathname }) || {}).name, c = c.value, l) && c && o.setRequestHeader(l, c), o.addEventListener("loadend", function() {
            var g, m, b, y, w = o.aegisUrl || "";
            qe(w, e.hostUrl) || o.failType === "abort" || (g = "", (o.failType || !o.status || 400 <= o.status) && (g = o.failType || "failed"), m = Date.now() - f, b = o.getResponseHeader("content-type") || "", y = pn(e, b, w), setTimeout(function() {
...
`).reduce(function(U, D) {
                ...
                }, {}), k = at(N, F, "res"), I = cn(o.aegisXhrReqHeader), F = (N = e.api) == null ? void 0 : N.apiDetail, W = F ? it(a, (N = e.api) == null ? void 0 : N.reqParamHandler, { url: w }) : "", Y = F ? it(o.response, (N = e.api) == null ? void 0 : N.resBodyHandler, { url: w }) : "";
                try {
                  ((U, D, j, J) => {
                    var Ce, Ye, ee;
                    try {
                    ...
                    var D = j.code, j = j.isErr, J = [g ? "AJAX_ERROR: request " + g : "", "fetch req url: " + w, "res status: " + (v.status || 0), "res duration: " + v.duration + "ms", "res startTime: " + f, L, k, "req method: " + (v.method || "GET"), "res retcode: " + D, Lt(W, "req param"), Lt(Y, "res data")].filter(function(Ce) {
                      return Ce;
                    }).join(`

`);
                    v.ret = D, v.isErr = +j, v.payload = a, e.slowApiLog && mr(v?.duration, e, v) ? r.publishNormalLog({ msg: J, level: R.SLOW_NET_REQUEST, code: D, trace: I, errorMsg: "", from: s || r.getFromParam(t), originFrom: u }, t) : r.publishNormalLog({ msg: J, level: gr(!!g, j), code: D, trace: I, errorMsg: "", from: s || r.getFromParam(t), originFrom: u }, t), r.publishSpeed(v, t);
                  });
                } catch {
        ...
        this.hackXHROptions = i, n = this.hackXHROptions, xe.find(function(o) {
        ...
        }) || (xe.push(n), !Rr && window.XMLHttpRequest && (yr = window.XMLHttpRequest.prototype.send, wr = window.XMLHttpRequest.prototype.open, hn = window.XMLHttpRequest.prototype.setRequestHeader, Rr = !0, window.XMLHttpRequest.prototype.open = function() {
          this.aegisMethod = arguments[0];
          var o, a = arguments[1];
          if (Tr.test(a) && (a = "" + location.origin + a), this.aegisUrl = a, (a = (o = n.ignoreHackReg) == null ? void 0 : o.test) == null || !a.call(o, this.aegisUrl)) if (this.aegisXhrStartTime = Date.now(), this.sendByAegis) P.isIE() || (this.timeout = 5e3);
          ...
          var o, a, s;
          return (a = (s = n.ignoreHackReg) == null ? void 0 : s.test) != null && a.call(s, this.aegisUrl) ? hn.apply(this, arguments) : (a = arguments[0], s = arguments[1], this.aegisXhrReqHeader = (o = this.aegisXhrReqHeader) != null ? o : {}, n != null && n.traceRequestHeader && -1 < ["traceparent", "b3", "sw8", "sentry-trace"].indexOf(a) && (this.aegisXhrReqHeader[a] || (arguments[1] = s), this.aegisXhrReqHeader[a]) ? void 0 : (this.aegisXhrReqHeader[a] = arguments[1], hn.apply(this, arguments)));
        ...
        this.$walk(function(n) {
          var r = t.$getConfig(n);
          e.type !== "fetch" || typeof r?.urlHandler != "function" ? (e.url = je(e.url), n.speedLogPipeline(e)) : n.speedLogPipeline(x(x({}, e), { url: je(r.urlHandler(e.url, e.payload)) }));
        });
      ...
      } })), lt = {}, Zi = new _({ name: "reportBridgeSpeed", override: !1, onNewAegis: function(e) {
        ...
        n.reportBridgeSpeed && n.h5Bridge && n.h5BridgeFunc.length && n.h5BridgeFunc.forEach(function(r) {
          ...
          lt[r] = i, n.h5Bridge[r] = function() {
            ...
            i(s, u, l, function(d) {
              var h = Qn(d, n.api), g = h.code, h = h.isErr, g = { url: s + "-" + u, name: s + "-" + u, duration: Date.now() - f, type: "bridge", ret: g, isErr: +h, from: p };
        ...
        var t = this, n = e.config;
        n && (typeof n.getNetworkType == "function" ? n.getNetworkType : xr)(function(r) {
          oe[r] || (r = oe.unknown), e.extendBean("netType", r), t.NetworkRefreshTimer = setTimeout(function() {
        ...
        n ? t = n[1] : navigator.connection && (t = navigator.connection.effectiveType || navigator.connection.type), e((n = t = t || Z, 0 <= (n = String(n).toLowerCase()).indexOf("4g") ? oe.net4g : 0 <= n.indexOf("wifi") ? oe.wifi : 0 <= n.indexOf("5g") ? oe.net5g : 0 <= n.indexOf("6g") ? oe.net6g : 0 <= n.indexOf("3g") ? oe.net3g : 0 <= n.indexOf("2g") ? oe.net2g : oe.unknown));
      }, eo = window.WebSocket, Se = [], to = { construct: function(e, t) {
        var n = new e(t[0], t[1]);
      ...
      } }, Pr = new _({ name: "onError" }), no = Pr = new _({ name: "onError", onNewAegis: function(e) {
        this.startListen(e);
      }, getFromParam: function(e) {
        return e.getCurrentPageUrl();
...
error msg: ` + ((c = l?.error) == null ? void 0 : c.message) : "") : ""), level: R.INFO, from: s.getFromParam(e), originFrom: e.getOriginFrom() };
        ...
        window.onerror = function() {
          ...
          var f, p = we(l[0]);
          typeof (f = p) != "string" || !f || Mi.some(function(d) {
...
` + we(l[4] || ""), level: R.ERROR, from: s.getFromParam(e), originFrom: e.getOriginFrom() }, e), u?.call.apply(u, Q([window], l));
          ...
          Pr.countInstance() === 0 && (window.document.removeEventListener("unhandledrejection", t), window.document.removeEventListener("error", n, !0));
          ...
          var c;
          (c = s.publishWsErrorLog) != null && c.call(s, l, e);
        } }, this.hackWebsocketConfig = r, r = this.hackWebsocketConfig, window.Proxy) && window.WebSocket && (i = window.WebSocket, window && !i.isHack && (o = new Proxy(WebSocket, to), i.isHack = !0, window.WebSocket = o), a = r, Se.find(function(l) {
          return l.key === a.key;
        }) || a && Se.push(a));
        ...
        }, this.option.hackWebsocketConfig && (e = this.option.hackWebsocketConfig, window.WebSocket = eo, (t = Se.findIndex(function(n) {
          return n.key === e.key;
        })) !== -1) && Se.splice(t, 1);
      } }), Lr = (new _({ name: "clickElementLog" }), function(e) {
        ...
        if (e.parentNode) for (var n = e.parentNode.childNodes, r = 0; r < n.length; r += 1) {
          var i = n[r];
          if (i === e) return Lr(e.parentNode) + "/" + e.tagName + "[" + (t + 1) + "]";
        ...
        for (var t = "", n = e.firstChild; n; n = n.nextSibling) t += kr(n);
        return t;
      }, ro = new _({ name: "clickElementLog", listeners: [], onNewAegis: function(e) {
        this.startListen(e);
      }, startListen: function(e) {
        for (var t = function(o) {
          n.listeners.push(((a, s, u, l) => {
            ...
            var u, l, c;
            s && !((f, p) => {
              d = Cr(((d = (f = f).ignoreElements) == null ? void 0 : d.ignoreClasses) || []) || /* @__PURE__ */ new Map();
              for (var d, h = (f = { ignoreIds: Cr(((f = f.ignoreElements) == null ? void 0 : f.ignoreIds) || []) || /* @__PURE__ */ new Map(), ignoreClasses: d }).ignoreClasses, g = f.ignoreIds, m = !(g.size === 0 && h.size === 0), b = p, y = (Mt(p.getAttribute("id") || "", " "), Mt(p.getAttribute("class") || "", ""), 0), w = !1; b && m && b.getAttribute; ) {
                if (w) return !0;
                if (10 <= y) break;
              ...
              return !1;
            })(e.config, s) && (u = Lr(s), l = Qi(s), c = s.getBoundingClientRect && s.getBoundingClientRect(), s = { op: o, view_type: s?.nodeName || "", view_text: l.slice(0, 127), view_tag: u, page: vr(), page_id: vr(), view_pos: { p0: (parseInt(String(c.left), 10) || -1) + "," + (parseInt(String(c.top), 10) || -1), p1: (parseInt(String(c.left + window.scrollX), 10) || -1) + "," + (parseInt(String(c.top + window.scrollY), 10) || -1) } }, e.normalLogPipeline({ msg: s, level: R.CLICK_EVENT, errorMsg: "", originFrom: e.getOriginFrom() }));
          }, !0));
      ...
      } }), Nt = (new _({ name: "consoleLog" }), { log: console.log, error: console.error, warn: console.warn, info: console.info, debug: console.debug, trace: console.trace }), io = new _({ name: "consoleLog", onNewAegis: function(e) {
        this.startListen(e);
      }, startListen: function(e) {
        var t;
...
message: ` + i, level: R.CONSOLE_LOG, errorMsg: "", originFrom: t.getOriginFrom() }));
      ...
      function Ar() {
        It = [], st = -1, Oe = null, yn(addEventListener);
      }
      ze = { passive: !0, capture: !0 }, Sr = /* @__PURE__ */ new Date(), mn = function(e, t) {
        Oe || (Oe = t, st = e, br = /* @__PURE__ */ new Date(), yn(removeEventListener), vn());
      }, vn = function() {
        var e;
        0 <= st && st < br - Sr && (e = { entryType: "first-input", name: Oe.type, target: Oe.target, cancelable: Oe.cancelable, startTime: Oe.timeStamp, processingStart: Oe.timeStamp + st }, It.forEach(function(t) {
          t(e);
        }), It = []);
      }, Er = function(e) {
        var t, n, r, i, o, a;
        ...
        }, addEventListener("pointerup", i, ze), addEventListener("pointercancel", o, ze)) : mn(t, e));
      }, yn = function(e) {
        ["mousedown", "keydown", "touchstart", "pointerdown"].forEach(function(t) {
          return e(t, Er, ze);
        });
      }, wn = document.visibilityState === "hidden" ? 0 : 1 / 0, addEventListener("visibilitychange", function e(t) {
        document.visibilityState === "hidden" && (wn = t.timeStamp, removeEventListener("visibilitychange", e, !0));
      }, !0), Ar(), self.webVitals = { firstInputPolyfill: function(e) {
        It.push(e), vn();
      }, resetFirstInputPolyfill: Ar, get firstHiddenTime() {
        return wn;
      } };
      function he(e, t) {
        var n = Ur(), r = "navigate";
        return 0 <= Fr ? r = "back-forward-cache" : n && (document.prerendering || 0 < On() ? r = "prerender" : document.wasDiscarded ? r = "restore" : n.type && (r = n.type.replace(/_/g, "-"))), { name: e, value: t === void 0 ? -1 : t, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12), navigationType: r };
      }
      function Ve(e, t, n) {
        try {
          var r;
      ...
      function En() {
        return Xe < 0 && (Xe = Dr(), Hr(), Je(function() {
          setTimeout(function() {
            Xe = Dr(), Hr();
          }, 0);
        })), { get firstHiddenTime() {
      ...
      function Ir(e, t) {
        t = t || {}, Ft(function() {
          var n, r = En(), i = he("FCP"), o = Ve("paint", function(a) {
            a.forEach(function(s) {
              s.name === "first-contentful-paint" && (o.disconnect(), s.startTime < r.firstHiddenTime) && (i.value = Math.max(s.startTime - On(), 0), i.entries.push(s), n(!0));
            });
          });
          o && (n = ge(e, i, jr, t.reportAllChanges), Je(function(a) {
            i = he("FCP"), n = ge(e, i, jr, t.reportAllChanges), bn(function() {
      ...
      function oo(e) {
        ...
        }, addEventListener("pointerup", i, ct), addEventListener("pointercancel", o, ct)) : Wr(t, e));
      }
      function ao(e) {
        e.forEach(function(t) {
          t.interactionId && (xn = Math.min(xn, t.interactionId), qt = Math.max(qt, t.interactionId), Vr = qt ? (qt - xn) / 7 + 1 : 0);
        });
      }
      function Mr() {
        return $r() - Xr;
      ...
      function Nr(e) {
        var t = ve[ve.length - 1], n = Pn[e.interactionId];
        (n || ve.length < 10 || e.duration > t.latency) && (n ? (n.entries.push(e), n.latency = Math.max(n.latency, e.duration)) : (t = { id: e.interactionId, latency: e.duration, entries: [e] }, Pn[t.id] = t, ve.push(t)), ve.sort(function(r, i) {
      ...
      var Pe, ut, _r, Ht, Tn, _e, Fr = -1, Je = function(e) {
        ...
        document.visibilityState === "hidden" && -1 < Xe && (Xe = e.type === "visibilitychange" ? e.timeStamp : 0, so());
      }, Hr = function() {
      ...
      }, jr = [1800, 3e3], qr = [0.1, 0.25], ct = { passive: !0, capture: !0 }, lo = /* @__PURE__ */ new Date(), Wr = function(e, t) {
        Pe || (Pe = t, ut = e, _r = /* @__PURE__ */ new Date(), zr(removeEventListener), Br());
      }, Br = function() {
        var e;
        0 <= ut && ut < _r - lo && (e = { entryType: "first-input", name: Pe.type, target: Pe.target, cancelable: Pe.cancelable, startTime: Pe.timeStamp, processingStart: Pe.timeStamp + ut }, Ht.forEach(function(t) {
          t(e);
        }), Ht = []);
      }, zr = function(e) {
        ["mousedown", "keydown", "touchstart", "pointerdown"].forEach(function(t) {
      ...
      }, Gr = [100, 300], Vr = 0, xn = 1 / 0, qt = 0, $r = function() {
        return Tn ? Vr : performance.interactionCount || 0;
      }, Jr = [200, 500], Xr = 0, ve = [], Pn = {}, Kr = [2500, 4e3], Ln = {}, uo = (Fe.prototype.start = function() {
      ...
      }, Fe), Le = (new _({ name: "webVitals" }), { FCP: -1, LCP: -1, FID: -1, CLS: -1, INP: -1, TTI: -1, from: void 0 }), Cn = /* @__PURE__ */ new Map(), co = new _({ name: "webVitals", onNewAegis: function(e) {
        ...
        if (ot() && typeof window.PerformanceObserver == "function" && typeof performance.getEntriesByName == "function") try {
          Cn.set(e, { isWebVitalsReported: !1, hasFirstEntry: !1, custom: null }), Ir($e), l = $e, c = {}, Ft(function() {
            function p(y) {
              (y = y[y.length - 1]) && y.startTime < g.firstHiddenTime && (m.value = Math.max(y.startTime - On(), 0), m.entries = [y], d());
            }
            var d, h, g = En(), m = he("LCP"), b = Ve("largest-contentful-paint", p);
            b && (d = ge(l, m, Kr, c.reportAllChanges), h = Sn(function() {
              Ln[m.id] || (p(b.takeRecords()), b.disconnect(), Ln[m.id] = !0, d(!0));
            }), ["keydown", "click"].forEach(function(y) {
              addEventListener(y, function() {
                return setTimeout(h, 0);
              }, !0);
            }), _t(h), Je(function(y) {
              m = he("LCP"), d = ge(l, m, Kr, c.reportAllChanges), bn(function() {
                m.value = performance.now() - y.timeStamp, Ln[m.id] = !0, d(!0);
              });
            }));
          }), s = $e, u = {}, Ft(function() {
            function p(y) {
            ...
            var h = En(), g = he("FID"), m = Ve("first-input", d), b = ge(s, g, Gr, u.reportAllChanges);
            m && _t(Sn(function() {
              d(m.takeRecords()), m.disconnect();
            })), m && Je(function() {
              g = he("FID"), b = ge(s, g, Gr, u.reportAllChanges), Ht = [], ut = -1, Pe = null, zr(addEventListener), Ht.push(p), Br();
            });
          }), o = $e, a = {}, Ir(Sn(function() {
            function p(y) {
            ...
            var d, h = he("CLS", 0), g = 0, m = [], b = Ve("layout-shift", p);
            b && (d = ge(o, h, qr, a.reportAllChanges), _t(function() {
              p(b.takeRecords()), d(!0);
            }), Je(function() {
              h = he("CLS", g = 0), d = ge(o, h, qr, a.reportAllChanges), bn(function() {
                return d();
              });
            }), setTimeout(d, 0));
          })), r = $e, i = {}, Ft(function() {
            var p;
            "interactionCount" in performance || (Tn = Tn || Ve("event", ao, { type: "event", buffered: !0, durationThreshold: 0 }));
            function d(b) {
              b.forEach(function(y) {
                y.interactionId && Nr(y), y.entryType !== "first-input" || ve.some(function(w) {
                  return w.entries.some(function(v) {
                    return y.duration === v.duration && y.startTime === v.startTime;
                  });
                }) || Nr(y);
              }), b = Math.min(ve.length - 1, Math.floor(Mr() / 50)), (b = ve[b]) && b.latency !== h.value && (h.value = b.latency, h.entries = b.entries, m());
            }
            var h = he("INP"), g = Ve("event", d, { durationThreshold: (p = i.durationThreshold) != null ? p : 40 }), m = ge(r, h, Jr, i.reportAllChanges);
            g && ("PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && g.observe({ type: "first-input", buffered: !0 }), _t(function() {
              d(g.takeRecords()), h.value < 0 && 0 < Mr() && (h.value = 0, h.entries = []), m(!0);
            }), Je(function() {
              ve = [], Xr = $r(), h = he("INP"), m = ge(r, h, Jr, i.reportAllChanges);
            }));
          }), n = function(p) {
            $e({ name: "TTI", value: p });
          }, ot() && new uo(n).start(), Rn(function() {
        ...
        n === void 0 && (n = "manual"), this.$walk(function(i) {
          i === e && (typeof (i = r.$getConfig(e)) == "object" && i.manualReport === !0 || n !== "onHidden" ? (i = Cn.get(e)) && !i.hasFirstEntry ? (i.hasFirstEntry = !0, n === "manual" && t && (i.custom = t)) : r.doReport(e, i?.custom || t) : r.doReport(e, null));
        });
      ...
      } }), Qr = (new _({ name: "pagePerformance" }), 3), ft = /* @__PURE__ */ new Map(), fo = new _({ name: "pagePerformance", performanceMap: {}, onNewAegis: function(e) {
        var t;
        ot() && (ft.set(e, { isPagePerformanceReported: !1 }), _e ? this.publish(_e, e) : this.startCalcPerformance(e), t = this.publishWhenObHidden.bind(this, e), Rn(t, { once: !0 }), e.lifeCycle.on("destroy", function() {
          var n = ft.get(e);
...
`), u = r.$getConfig(i), s = !1;
        ...
        var r, i = this, o = ["script", "style", "link", "br"], a = [], s = {}, u = (pr("paint") && (r = new PerformanceObserver(function(f) {
          ...
          c = null;
          for (var b = 0, y = [g, h.loadEventStart - h.domInteractive, m]; b < y.length; b++) if (y[b] <= 0 && 0 < Qr) {
            c = setTimeout(function() {
              return l(m);
            }, 3e3);
            break;
          }
          c ? --Qr : (u.disconnect(), r?.disconnect(), t?.(f));
        }), c = setTimeout(function() {
          return l();
        }, 3e3);
        ...
        return !1;
      } }), po = (new _({ name: "spa" }), ["replaceState", "pushState", "popstate", "hashchange"]), ho = new _({ name: "spa", originFireUrl: "", onNewAegis: function(e) {
        var t = this;
        history.pushState = this.wr("pushState") || history.pushState, history.replaceState = this.wr("replaceState") || history.replaceState, this.sendPv = this.sendPv.bind(this), e.config.spa && this.sendPv(e), po.forEach(function(n) {
      ...
      var Ee = null, kn = !1, go = 0, Re = /* @__PURE__ */ new Map(), An = "__MONITOR_SESSION_V1__";
      function In(e) {
        try {
      ...
      function mo(e, t) {
        var n;
        return typeof window > "u" ? { sessionId: t(), createdAt: Date.now(), lastActivity: Date.now(), source: e, version: 1 } : (n = window[An]) != null && n.sessionId ? (n.lastActivity = Date.now(), In(n), n) : (n = (() => {
          try {
        ...
        })()) ? (In(window[An] = n), n) : (n = { sessionId: t(), createdAt: Date.now(), lastActivity: Date.now(), source: e, version: 1 }, In(window[An] = n), n);
      }
      re(Mn = H, S = Zr = S), Mn.prototype = S === null ? Object.create(S) : (ei.prototype = S.prototype, new ei()), H.resolveGzipConfig = function(e) {
        ...
        r && (t = this.getOriginFrom(), n = typeof e == "string" && e ? e.slice(0, 2048) : "", this.sendPipeline([function(i, o) {
          var a = t ? rn(r, { originFrom: t }) : r;
          o({ url: n ? rn(a, { from: n }) : a, type: A.PV, beanFilter: n ? ["from"] : void 0 });
        }], A.PV)(null));
        ...
        this.config.reportImmediately || this.isReportReady ? this.$request(e, r = function(a) {
          ...
          var s = typeof o.config.reportRetry == "boolean" ? Ge : x(x({}, Ge), o.config.reportRetry), l = s.maxRetryCount, u = l === void 0 ? Ge.maxRetryCount : l, l = s.retryInterval, l = l === void 0 ? Ge.retryInterval : l, f = s.whenRetryEndStillFail, c = f === void 0 ? Ge.whenRetryEndStillFail : f, f = s.maxStorageCount, p = Math.min(100, Math.max(20, f === void 0 ? Ge.maxStorageCount : f)), d = (e.extraRetryOptions || (e.extraRetryOptions = { requestId: "", retriedCount: 0, success: "", fail: "" }), e.extraRetryOptions), h = (d.requestId = d.requestId || e.url + "-" + Date.now() + "-" + Math.random(), d.requestId), g = (d.retriedCount = d.retriedCount || 0, d.success = d.success || h + "_successCallback", d.fail = d.fail || h + "_failCallback", Ut("aegis-web-retry-report-requests"));
...
self.onmessage=async function(e){
  try{
    ...
    self.postMessage({id:id,error:err.message||"compress error"});
                  ...
                  y ? (g = go += 1, m = setTimeout(function() {
                    var w = Re.get(g);
              ...
              case 7:
                u = l.sent(), l.label = 8;
              case 8:
                return this.resolvedGzipConfig.debug && console.info("[Aegis gzip] before=" + (c = o.byteLength) + "B after=" + (f = u.byteLength) + "B saved=" + (c - f) + "B ratio=" + (0 < c ? (f / c * 100).toFixed(1) : "0.0") + "%"), this.sendXhr(e, t, u, dn(n, !0), r, i), [3, 10];
              case 9:
                return l.sent(), this.sendXhr(e, t, e.data, dn(n, !1), r, i), [3, 10];
              case 10:
                return [2];
            }
            var c, f, p;
        ...
        }), t.toLocaleLowerCase() === "get" ? (a.open("get", rn(e.url, e.data)), a.send()) : (a.open("post", e.url), e.contentType && a.setRequestHeader("Content-Type", e.contentType), r && a.setRequestHeader("Content-Encoding", r), a.send(n));
      ...
      }, H.sessionID = mo("aegis", ln).sessionId, H.compressionSupported = null;
      var Zr, Mn, S = H;
      function H(e) {
        var t, n, r, i, o, a, s = Zr.call(this, e) || this;
        s.sendNow = !1, s.isReportReady = !1, s.reportRequestQueue = [], s.speedLogPipeline = Be([Rt(s), (i = s.config, function(f, p) {
          ...
          !i.speedSample || m <= 0 ? p(f) : (d = i?.id || "0", h = We[d] || {}, Array.isArray(f) ? (g = f.filter(function(b) {
            ...
            return y ? (h[b.url] = 1 + ~~h[b.url], We[d] = h) : Ne[d] || sn(d), y;
          })).length && p(g) : !h[f.url] || h[f.url] < m ? (h[f.url] = 1 + ~~h[f.url], We[d] = h, p(f)) : Ne[d] || sn(d));
        }), (r = s, function(f, p) {
          xr(function(d) {
          ...
          return s.sendPipeline([function(p, d) {
            d({ type: A.SPEED, url: "" + s.config.speedUrl, method: "post", contentType: "application/json", data: Yn(p, x(x({}, s.bean), { from: s.getCurrentPageUrl() })), log: p });
          }], A.SPEED)(f);
        }]), e.asyncPlugin = !0;
        try {
...
It is recommended that you contact us for feedback and thank you for your support.`, "color: red"), s.sendSDKError(f);
      ...
      var Ke, Qe = { containers: ["body", "html", "#app", "#root"], ignoreContainers: [], containerMatchers: { tagName: ["body", "html"], id: ["app", "root"], className: [] }, ignoreMatchers: { tagName: [], id: [], className: [] }, detectStartPosition: { x: 0, y: 0 }, emptyElementsPercent: 70, sameElementsPercent: 70, debounceDuration: 2e3, everySideSampleNumber: 9, disableSameElementsCheck: !0, ignoreElesWhenDomChange: [], reDetectInterval: 2e3, samePointDepth: 5, customBlankScreenDector: null, enableScreenshot: !1, needScreenShotMeta: !1, screenshotQuality: 0.1, screenshotFormat: "image/webp", onBlankScreenCapture: null, clientScreenshotTimeout: 1e4 }, yo = ["canvas", "img", "svg", "iframe"], wo = ((Ue = Ke = Ke || {})[Ue.UNKNOWN = 0] = "UNKNOWN", Ue[Ue.ERROR = 1] = "ERROR", Ue[Ue.DOM_CHANGE = 2] = "DOM_CHANGE", /* @__PURE__ */ new Set(["SCRIPT", "STYLE", "NOSCRIPT", "TEMPLATE", "HEAD", "META", "LINK", "BR", "WBR"])), bo = ($.prototype.capture = function() {
        ...
        if (t === void 0 && (t = 0), n === void 0 && (n = []), (r = r === void 0 ? 0 : r) > this.maxDepthReached && (this.maxDepthReached = r), 100 < r) this.depthLimitHitCount++;
          ...
          if (e.nodeType !== 3) {
            ...
            } else if (e.childNodes) for (var W = 0, Y = Array.from(e.childNodes); W < Y.length; W++) {
              var U = Y[W];
      ...
      }, $), ti = { THRESHOLDS: { SMALL: 3e5 }, LEVELS: [{ maxArea: 1e5, scale: 1, defaultQuality: 0.7 }, { maxArea: 3e5, scale: 1, defaultQuality: 0.6 }, { maxArea: 8e5, scale: 0.7, defaultQuality: 0.6 }, { maxArea: 15e5, scale: 0.5, defaultQuality: 0.65 }, { maxArea: 25e5, scale: 0.45, defaultQuality: 0.65 }, { maxArea: 1 / 0, scale: 0.45, defaultQuality: 0.65 }] };
      function $(n) {
      ...
      function Nn(e) {
        return ti.LEVELS.find(function(t) {
          return e <= t.maxArea;
        });
      }
      function ni(e) {
      ...
      function Wt(e, t, n, r, i) {
        ...
        return (e = e[0]) ? (a = o = !1, a = ui(r) ? (o = si(e, r), si(e, i)) : (o = li(e, t), li(e, n)), { isWhitePoint: o && !a, selectorPointers: s }) : { isWhitePoint: !1, selectorPointers: s };
      }
      function ii(e) {
        try {
          var t, n, r, i, o, a, s = e.config.blankScreen;
          return s === !0 ? x({}, Qe) : (n = "containerMatchers" in (t = s) || "ignoreMatchers" in t, r = "containers" in t || "ignoreContainers" in t, i = _n(x({}, Qe), t), n ? (ui(i.containerMatchers) || (i.containerMatchers = ni(Qe.containerMatchers)), typeof i.ignoreMatchers == "object" && i.ignoreMatchers !== null || (i.ignoreMatchers = ni(Qe.ignoreMatchers)), i.containers = [], i.ignoreContainers = []) : r && (o = ri(i.containers), a = ri(i.ignoreContainers), i.containers = o.length ? o : Q(Qe.containers), i.ignoreContainers = a, i.containerMatchers = { tagName: [], id: [], className: [] }, i.ignoreMatchers = { tagName: [], id: [], className: [] }), i);
        } catch {
          return x({}, Qe);
        }
      }
      ...
      function oi(e, t, n, r) {
        return t === void 0 && (t = "image/webp"), n === void 0 && (n = 1920), r === void 0 && (r = 1080), K(void 0, void 0, void 0, function() {
          ...
          return se(this, function(a) {
            switch (a.label) {
              case 0:
                return a.trys.push([0, 2, , 3]), i = Math.min(window.innerWidth, n), o = Math.min(window.innerHeight, r), i = Nn(i * o), o = i.scale, i = i.defaultQuality, [4, new bo(s = (s = { scale: o, quality: e ?? i, format: { "image/webp": "webp", "image/jpeg": "jpeg", "image/png": "png" }[t] || "webp", maxWidth: n, maxHeight: r, useCORS: !0, viewportOnly: !0, debug: !1 }) === void 0 ? {} : s).capture()];
              case 1:
                return [2, a.sent()];
              case 2:
      ...
      var ai = function(r) {
        ...
        if (r) for (var i in r) {
          var o = r[i];
          Array.isArray(o) ? e[i] = Q(o) : typeof o == "object" && o !== null && Object.prototype.hasOwnProperty.call(e, i) && typeof e[i] == "object" && e[i] !== null && !Array.isArray(e[i]) ? _n(e[i], o) : e[i] = o;
        }
        return _n.apply(void 0, Q([e], t));
        ...
        var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, m, b, y, w, v, L, N, k, I, F, W, Y, U, D, j, J, Ce, Ye, ee, pt, te, ke, Ze, Dn, zt = this;
        document.elementFromPoint && (this.pendingTimeouts.forEach(function(B) {
          clearTimeout(B);
        }), this.pendingTimeouts = [], this.isDestroyed = !1, this.isAwaitingClientScreenshot = !1, r = ii(e), i = r.everySideSampleNumber, o = r.sameElementsPercent, a = r.containers, s = r.ignoreContainers, u = r.containerMatchers, l = r.ignoreMatchers, c = r.detectStartPosition, f = r.ignoreElesWhenDomChange, p = r.reDetectInterval, d = r.disableSameElementsCheck, h = r.samePointDepth, g = r.enableScreenshot, m = r.needScreenShotMeta, b = r.onBlankScreenCapture, y = r.clientScreenshotTimeout, w = 4 * i - 3, v = Math.floor(w * r.emptyElementsPercent / 100), L = Math.floor(w * o / 100), N = Ke.UNKNOWN, I = null, F = k = !1, W = function() {
          return K(zt, void 0, void 0, function() {
            var B, X, Ae, ye, ci, fi, Gt, ht, De, Hn, et, gt, Vt, ue, $t, ce, jn, di, ae, qn, Wn, Jt, Xt, pi, Ie, mt, vt, yt, wt, Kt, Bn, tt, Eo = this;
            return se(this, function(bt) {
              switch (bt.label) {
                case 0:
                  if (B = window.innerHeight, X = window.innerWidth, Ae = c.x, ye = c.y, X <= Ae || B <= ye) return [2];
                  for (ci = Ae + (X - Ae) / 2, fi = ye + (B - ye) / 2, Gt = [], ht = i + 1, Hn = De = 0, et = 1; et < ht; et++) ue = ye + (B - ye) * et / ht, ce = Bt(gt = Ae + (X - Ae) * et / ht, fi), Vt = Bt(ci, ue), $t = Bt(gt, ue), gt = Bt(gt, B - ue), ue = Wt(ce, a, s, u, l), ue.isWhitePoint && (De += 1), Gt.push(ue.selectorPointers), et !== ht / 2 && (ce = Wt(Vt, a, s, u, l), ue = ce.isWhitePoint, Vt = ce.selectorPointers, ue && (De += 1), ce = Wt($t, a, s, u, l), ue = ce.isWhitePoint, $t = ce.selectorPointers, ue && (De += 1), ce = Wt(gt, a, s, u, l), ce.isWhitePoint && (De += 1), Gt.push(Vt, $t, ce.selectorPointers));
                  return vt = v <= De, yt = !1, jn = { samePointerMap: {}, maximumSamePointer: {} }, d || (ae = Gt.map(function(z) {
                    return z.slice(0, h);
                  }), Qt = ae.map(function(z) {
                    return z.join(" < ");
                  }).reduce(function(z, ne) {
                    return z[ne] = z[ne] ? z[ne] + 1 : 1, z;
                  }, {}), zn = Object.keys(Qt).map(function(z) {
                    return [z, Qt[z]];
                  }).sort(function(z, ne) {
                    return ne[1] - z[1];
                  })[0], hi = zn[0], ae = { samePointerMap: Qt, maximumSamePointerClass: hi, maximumSamePointerCounter: zn[1] }, jn = { samePointerMap: ae.samePointerMap, maximumSamePointer: ((tt = {})[di = ae.maximumSamePointerClass] = ae = ae.maximumSamePointerCounter, tt) }, Hn = ae, tt = yo.some(function(z) {
                    return di.startsWith(z);
                  }), yt = L <= ae && !tt), vt || yt ? [3, 1] : (k = !1, I = null, [3, 8]);
                case 1:
                  return k ? (ae = I?.whitePointCount >= v, tt = I?.samePointCount >= L, qn = ae && tt ? "both" : ae ? "whitePoint" : "sameElement", Wn = t ? "error" : "domChange", Jt = window.innerWidth, Xt = window.innerHeight, pi = Math.round(I?.samePointCount / w * 100), Ie = { whitePointCount: I?.whitePointCount, samePointCount: I?.samePointCount, maximumSamePointer: I?.maximumSamePointer, linkMsg: I?.linkMsg }, mt = function(z, ne) {
                    ne = { msg: "decect blankscreen triggerReason: " + qn + " triggerType: " + Wn + `

whitePointCount: ` + Ie.whitePointCount + " whitePointerThreshold: " + v + (d ? "" : `

sameElementsCount: ` + Ie.samePointCount + " samePointerThreshold: " + L + " sameElementPercent: " + pi + "%") + `
...
linkError: ` + Ie.linkMsg : ""), level: R.BLANK_SCREEN, errorMsg: z || null, originFrom: e.getOriginFrom() }, e.normalLogPipeline(ne);
                  }, g ? b ? (vt = Nn(Jt * Xt), yt = { triggerReason: qn, triggerType: Wn, whitePointCount: Ie.whitePointCount || 0, samePointCount: Ie.samePointCount || 0, viewportWidth: Jt, viewportHeight: Xt, url: window.location.href, timestamp: Date.now(), recommendedScale: vt.scale, recommendedQuality: vt.defaultQuality, maxSizeKB: 30 }, this.notifyClientScreenshot(b, yt, y, function(z, ne) {
                    if (z && typeof z == "string") {
                      var gi = z.length / 1024;
                      if (30 < gi) return void mt(null, x(x({}, ne), { success: !1, reason: "size_exceeded", size: Math.round(gi), maxSize: 30 }));
                    }
                    mt(z, ne);
                  }), [3, 4]) : [3, 2] : [3, 5]) : [3, 7];
                case 2:
                ...
                case 3:
                  wt = bt.sent(), Bn = Kt = null, Bn = typeof wt == "string" ? (Kt = wt, { success: !0, source: "sdk" }) : (Kt = null, { success: !1, source: "sdk", error: wt.error, details: wt.details }), mt(Kt, Bn), bt.label = 4;
                case 4:
                  return [3, 6];
                case 5:
                ...
                case 7:
                  I = x(x({ msg: "blank_screen", level: R.BLANK_SCREEN, whitePointCount: De, samePointCount: Hn }, jn), t ? { linkLogType: t?.type, linkLogLevel: t?.level, linkErrorMsg: t?.errorMsg, linkMsg: t?.msg } : {}), k = !0, n = setTimeout(function() {
                    return K(Eo, void 0, void 0, function() {
                  ...
                  return "requestIdleCallback" in window ? (window.requestIdleCallback(function(Ae) {
                    return K(B, void 0, void 0, function() {
                      return se(this, function(ye) {
                        switch (ye.label) {
                          case 0:
                            return 0 < Ae.timeRemaining() ? [4, W()] : [3, 2];
                          case 1:
                            ye.sent(), ye.label = 2;
                          case 2:
                            return [2];
          ...
          var B;
          k || zt.isAwaitingClientScreenshot || N === Ke.ERROR && !t || (N = t ? Ke.ERROR : Ke.DOM_CHANGE, clearTimeout(n), B = ii(e).debounceDuration, n = setTimeout(function() {
            return K(zt, void 0, void 0, function() {
              return se(this, function(X) {
                switch (X.label) {
                  case 0:
        ...
        }, e.lifeCycle.on("errorOccurred", D = function(B) {
          B = B.filter(function(X) {
            return X.level !== R.BLANK_SCREEN;
          }), 0 < B.length && (t = B[B.length - 1], U());
        }), j = null, window.MutationObserver && (te = ke = null, J = window.cancelAnimationFrame || function(B) {
          clearTimeout(B);
        }, Ce = window.requestAnimationFrame || function(B) {
          return setTimeout(B, 1e3 / 60);
        }, Ye = function() {
          (j = new MutationObserver(function(B) {
            var X = ai(B[0].target), X = f.includes(X.selector);
            B.length === 1 && X || U();
          })).observe(document.body, { childList: !0, subtree: !0 });
        }, ee = function() {
          ke && (clearTimeout(ke), ke = null), te && (J(te), te = null);
        }, document.body ? Ye() : (te = Ce(pt = function() {
          document.body ? (ee(), Ye()) : te = Ce(pt);
        }), ke = setTimeout(function() {
          ee();
        }, 1e4))), Ze = function() {
          F && (F = !0, k) && (clearTimeout(n), W());
        }, Dn = function() {
          document.visibilityState === "visible" && (F = !1), document.visibilityState === "hidden" && Ze();
        }, window.addEventListener("pagehide", Ze), window.addEventListener("beforeunload", Ze), window.addEventListener("visibilitychange", Dn), this.destroyBlanckScreenDetect = function() {
          window.removeEventListener("pagehide", Ze), window.removeEventListener("beforeunload", Ze), window.removeEventListener("visibilitychange", Dn), e.lifeCycle.remove("errorOccurred", D), j?.disconnect();
        });
      }, destroy: function() {
      ...
      } }), So = (new _({ name: "lagMonitor" }), new _({ name: "lagMonitor", observer: null, lagRecords: [], onNewAegis: function(e) {
      ...
      function Un() {
        try {
          var e, t, n;
          return Fn() ? (t = (e = window.performance.memory).usedJSHeapSize || 0, n = e.jsHeapSizeLimit || 0, { usedJSHeapSize: t, totalJSHeapSize: e.totalJSHeapSize || 0, jsHeapSizeLimit: n, usageRatio: 0 < n ? Math.round(t / n * 1e4) / 100 : 0, timestamp: Date.now() }) : null;
        } catch {
          return null;
        }
      }
      ...
      return new _({ name: "memoryMonitor" }), _ = new _({ name: "memoryMonitor", memoryReportTimer: null, oomCheckTimer: null, lastOOMTime: 0, memoryRecords: [], onNewAegis: function(e) {
        ...
        r && r.enabled && Fn() && (t = r.sampleRate || 1, Math.random() < t) && (!(t = r.monitorPages) || t.length === 0 || (n = typeof window < "u" ? window.location.href : "", t.some(function(i) {
        ...
        var n, r = this, i = t.enableMemoryReport !== !1, o = t.enableOOMReport !== !1, a = t.memoryReportInterval || 6e4, s = t.oomCheckInterval || 1e4, u = t.oomThreshold || (() => {
          try {
            var l, c;
            return Fn() && 0 < (l = window.performance.memory.jsHeapSizeLimit || 0) ? (c = dt(l), Math.round(0.9 * c)) : 100;
          } catch {
            return 100;
          }
        })();
      ...
      }, getCurrentMemoryStatus: Un, clearMemoryRecords: function() {
      ...
      } }), S.use(no), S.use(Yi), S.use(Xi), S.use(fo), S.use(co), S.use(Ji), S.use(M), S.use(ho), S.use(vo), S.use(ro), S.use(io), S.use(So), S.use(_), S.use(Zi), S.use(Ue), S;
    });
  })(en)), en.exports;
}
var xo = Oo();
const Si = /* @__PURE__ */ Ro(xo);
function Ei() {
  return {
    // 凭证（基础设施层使用）
    sdkAppId: 0,
...
function Ri(E) {
  return {
    ...E,
    credentials: E.credentials ? { ...E.credentials } : null
  };
}
function Po(E, O) {
  const T = Ri({
    ...E,
    ...O,
    credentials: O.credentials === void 0 ? E.credentials : O.credentials ? { ...O.credentials } : null
  });
  if (O.credentials !== void 0) {
    const q = T.credentials;
    T.sdkAppId = q?.sdkAppId ?? 0, T.userId = q?.userId ?? "", T.userSig = q?.userSig ?? "", T.secretKey = q?.secretKey ?? "";
  }
  return T;
}
let Yt = Ei();
...
function Ho(E) {
  const O = Me.getState();
  Me = E ?? Ti, Me.reset(), Me.setState(O);
}
function Oi() {
  return Me.getState();
}
function jo(E) {
  return Me.setState(E), Me.getState();
}
function qo() {
  Me.reset();
}
let fe = null, tn = null;
function Gn() {
  const E = Oi().credentials?.sdkAppId;
  return E ? String(E) : void 0;
}
function xi(E, O) {
  if (!O)
    return !1;
...
function Wo(E) {
  ...
  return fe = new Si({
    ...
    uin: O,
    ...E
  }), (E.autoUpdateUin || !E.uin && Gn()) && Pi(), fe;
}
function Bo(E) {
  if (!tn || !tn.id || !E) return;
  ...
  if (String(O) !== String(E)) {
    ...
    fe = new Si({
      ...
      ...tn,
      uin: E
    }), console.log("[Aegis] instance reinitialized with uin:", E);
  }
}
function Lo() {
  return fe;
...
function nt(E, O, T, q) {
  ...
  const re = nn();
  if (!re) return;
  const x = { name: E, ext1: O, ext2: T, ext3: q, ext4: re };
  try {
    G.reportEvent?.(x);
  } catch {
  }
...
function Ci(E, O) {
  ...
  if (T)
    try {
      T.reportTime?.({ name: E, duration: O });
    } catch {
    }
}
function ki(E, O, T, q) {
  nt(E, O, T ? "success" : "fail", q);
}
function ko(E, O) {
  const T = Date.now();
  return O().finally(() => {
...
function Ao(E = Co) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  vi.has(T) || (vi.add(T), nt("app_init", "live_manager", E));
}
...
function Io(E) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  yi.has(T) || (yi.add(T), nt("capability", E, "on"));
}
...
function Mo(E) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  wi.has(T) || (wi.add(T), nt("feature_use", E));
}
let bi = null;
function No(E) {
  if (E === bi) return;
...
function _o(E) {
  return E.split("/").filter(Boolean)[0] || "home";
}
...
function Uo(E) {
  ...
  if (E instanceof Error) {
    const O = [];
    if (E.message && O.push(E.message), E.stack) {
...
class Ai {
   ...
   */
  error(O, ...T) {
    const q = T[0], G = T.length > 1 ? T.slice(1) : void 0;
    if (this.log("error", O, q, G), this.config.enableReport && G) {
      const re = G.find((x) => x instanceof Error) ?? G[G.length - 1];
      re && this.reportToRum(O, q, re);
    }
  }
  /**
   * 统一日志输出
   */
  log(O, T, q, G) {
    if (Zt[O] < Zt[Vn] || this.config.minLevel && Zt[O] < Zt[this.config.minLevel] || !this.config.enableConsole) return;
    const re = this.formatTimestamp(), x = this.config.prefix ? `[${this.config.prefix}]` : "", K = `${re}${x}[${T}] ${q}`;
    switch (O) {
      case "debug":
        console.debug(K, G ?? "");
        break;
   ...
   */
  formatTimestamp() {
    const O = /* @__PURE__ */ new Date(), T = String(O.getHours()).padStart(2, "0"), q = String(O.getMinutes()).padStart(2, "0"), G = String(O.getSeconds()).padStart(2, "0"), re = String(O.getMilliseconds()).padStart(3, "0");
    return `[${T}:${q}:${G}.${re}]`;
  }
  /**
   * 上报错误到 RUM (Aegis)
...
const Qo = new Ai({ prefix: "LiveKit" }), Yo = (E) => new Ai({ prefix: E });
export {
  Si as A,
  qo as B,
  Jo as C,
