...
function me({
  ...
  const _ = h(null), O = h(null), T = h(null), R = h(null), A = h(null), [g, E] = H({}), S = h({}), [U, X] = H(0);
  ae(() => X((e) => e + 1));
  const d = re((e) => e.fitContent || N && e.width === void 0, [N]), J = C(() => {
    const e = {};
    for (const t of r) {
      let n;
      if (d(t)) {
    ...
    for (const t of r) {
      ...
      t.ellipsis ? (n.whiteSpace = "nowrap", n.overflow = "hidden", n.textOverflow = "ellipsis") : d(t) && !t.flexible && (n.whiteSpace = "nowrap"), e[t.key] = n;
    }
    return e;
  }, [r, d]), j = C(() => ne(r, g, d) ?? {}, [r, g, d]);
  I(() => {
    const e = r.map((o, p) => ({ column: o, index: p })).filter(({ column: o }) => d(o));
    ...
    let t = 0;
    const n = () => {
      const o = T.current?.querySelectorAll("thead th") || [], p = Array.from(A.current?.querySelectorAll("tbody tr") || []).slice(0, F), b = [], f = [];
      e.forEach(({ column: c, index: w }) => {
        const y = o[w];
        y && (b.push(y), f.push(c.key)), p.forEach((te) => {
          const D = te.children[w];
          D && (b.push(D), f.push(c.key));
        });
      });
      const ee = oe(b), v = {};
      ee.forEach((c, w) => {
      ...
      for (const { column: c } of e)
        v[c.key] !== void 0 && (B[c.key] = ce(v[c.key], c.minWidth));
      S.current = B;
    }, m = () => {
      const o = S.current;
      if (Object.keys(o).length === 0) {
        E((f) => Object.keys(f).length === 0 ? f : {});
        return;
      }
      const p = R.current?.clientWidth ?? 0, b = ie(
        r,
        o,
        p,
        d
  ...
  }, []), /* @__PURE__ */ x("div", { ref: _, className: `fixed-header-table ${i}`.trim(), children: [
    /* @__PURE__ */ s("div", { ref: O, className: `fixed-header-table__header ${k}`.trim(), children: /* @__PURE__ */ x(
      "table",
      {
        ref: T,
        ...
        children: [
          q,
          /* @__PURE__ */ s("thead", { children: /* @__PURE__ */ s("tr", { children: r.map((e) => /* @__PURE__ */ s("th", { className: e.className, style: L[e.key], children: e.headerRender ? e.headerRender() : e.title }, e.key)) }) })
        ]
      }
    ) }),
    /* @__PURE__ */ s("div", { ref: R, className: `fixed-header-table__body ${z}`.trim(), style: P, children: $ ? /* @__PURE__ */ s("div", { className: "fixed-header-table__loading", children: G }) : l.length === 0 ? /* @__PURE__ */ s("div", { className: "fixed-header-table__empty", children: K }) : /* @__PURE__ */ x(
      "table",
      {
        ref: A,
        className: `fixed-header-table__table ${u}`.trim(),
        ...
        children: [
          q,
          /* @__PURE__ */ s("tbody", { children: l.map((e, t) => /* @__PURE__ */ s("tr", { className: Y(e, t), children: r.map((n) => /* @__PURE__ */ s("td", { className: n.className, style: L[n.key], children: n.render ? n.render(e, t) : he(e, n.key) }, n.key)) }, Q(e, t))) })
        ]
      }
    ) })
  ] });
...
function pe({ actions: r, className: l = "", disabled: a = !1 }) {
  return /* @__PURE__ */ s("div", { className: `list-action-buttons ${l}`.trim(), children: r.map((i) => /* @__PURE__ */ x(
    "button",
    {
      type: "button",
