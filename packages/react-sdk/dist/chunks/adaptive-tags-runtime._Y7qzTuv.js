import { c3 as D, c4 as $, s as T, p as C, d as P, t as R, f as g, e as _, b3 as j, c5 as F, c6 as G } from "./main-layout.D1ZA8pmk.js";
import { aV as q, a5 as k, I as H } from "./layout.CKxcF5ct.js";
class K extends $ {
  constructor(e, t, s) {
      ...
      z((t) => {
        ...
        return t.forEach((n) => {
          ...
          z(() => {
            ...
            return g(
              j(s, 10, n, r, i).then((l) => (k("av_moderation"), k("moderation"), l))
            );
          }),
...
function A(o) {
  const e = o.roomIdText ?? o.liveIdText ?? "", {
    ...
    minVisibleTags: d = 2,
    maxVisibleTags: m = 99
  } = o, M = x("live-id-badge", e), V = i + M, y = t - n, u = s.map(
