...
import { at as j, av as Q, br as J, bI as X, bH as Y, u as Z, m as ee, R as te, Q as re, p as ne } from "./main-layout.Bwa83IG1.js";
import { c as z, r as s } from "./logger.pnqt7v8K.js";
import "./gift.Y5SLDKcE.js";
import { R as ae, ad as oe, ac as ie, av as se, U as le } from "./layout.xMYH3d3a.js";
import { s as ue, t as ce } from "./utils.CPJqv6Oy.js";
import { C as ve } from "./chat-state.D1lR_iRt.js";
...
function me() {
  if (!y) {
    ...
    ne(
      ...
      ce(n),
      ue((f) => {
        q.value = f.sending, H.value = f.error;
      })
    );
  }
  return y;
