...
import { av as Y, at as Z, m as ee, u as te, bH as re, bI as ne, br as ae, R as oe, Q as se } from "./main-layout.Bwa83IG1.js";
import { c as F, r as s } from "./logger.pnqt7v8K.js";
import { U as ie, av as ce, R as ue, ac as le, ad as de } from "./layout.xMYH3d3a.js";
import "tdesign-react";
const b = F("RiskControl");
function ye(i) {
  const { liveId: t, pageSize: w } = i, [y, M] = l(!1), [L, h] = l(0), [v, p] = l([]), [S, I] = l(1), [_, R] = l(0), [E, T] = l(!1), [x, A] = l([]), [r, c] = l([]), [g, d] = l(!1), [K, f] = l(null), P = B(!0);
  N(() => (P.current = !0, () => {
    P.current = !1;
  }), []);
  const O = n(async () => {
