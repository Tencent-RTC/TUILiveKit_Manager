import { useState as h, useRef as w, useCallback as a, useEffect as g } from "react";
import { P as V } from "./PreviewUrlController.D1r9dOPU.js";
import { s as b } from "./svga.min.Zof6g_Kl.js";
import { h as d, b4 as G, bj as L } from "./shared-state.Bf8CkvaR.js";
...
function z(c = {}) {
  const { loop: s = 1, autoPlay: i = !0 } = c, e = w(null), r = w(null), n = w(!1), o = a(() => {
    ...
    o();
    const f = e.current, p = new b.Player(f);
    r.current = p;
    const P = G();
    if (!P) {
