import { openBlock as b, createBlock as x, renderSlot as he, resolveComponent as _, createVNode as S, withCtx as j, Fragment as ve, renderList as ht, resolveDynamicComponent as Ie, withDirectives as xt, vShow as Et, mergeProps as Ct, withModifiers as ri, createCommentVNode as X, defineComponent as ai, computed as Ue, ref as C, watch as ce, nextTick as lt, onMounted as hi, onUnmounted as li, createElementBlock as A, createElementVNode as E, normalizeClass as Ae, unref as y, createTextVNode as ct, toDisplayString as P, createSlots as ci, normalizeStyle as Se } from "vue";
...
import { I as W } from "./en-US.BT81VsgK.js";
import { _ as pi, af as ft, ah as gi, al as vi, ae as bi, ag as wi } from "./main-layout.qKCc3UXK.js";
import { i as yi, g as zi } from "./PreviewUrlController.CKpndgj3.js";
import { U as Ri, m as Ai, u as mt, p as pt, k as Si, j as Mi, v as xi, b as Ei, e as Ci } from "./upload.dlm3R5om.js";
import { u as Ti, a as Wi } from "./useSvgaPlayer.CGodJgdV.js";
...
} }, Me.exports), Me.exports), Y = function(e) {
  return function(t, i) {
    if (!t) return e;
    var o;
...
function Xe(e, t, i) {
  ...
  return We(e) ? (Object.keys(t).forEach((function(s) {
    D(e[s]) ? o[s] = t[s] : We(t[s]) ? We(e[s]) ? o[s] = Xe(e[s], t[s], i[s]) : o[s] = e[s] ? t[s] : i[s] : t[s] === !0 || t[s] === !1 ? o[s] = !!e[s] : o[s] = e[s];
  })), o) : e ? t : i;
}
function xe(e) {
  var t = Number(e);
...
var $e = Y("vue-handler-wrapper"), Pt = { name: "HandlerWrapper", components: { DraggableElement: Ke }, props: { horizontalPosition: { type: String }, verticalPosition: { type: String }, disabled: { type: Boolean, default: !1 } }, computed: { classes: function() {
  var e;
...
var Hi = Y("vue-line-wrapper"), Lt = { name: "LineWrapper", components: { DraggableElement: Ke }, props: { position: { type: String, required: !0 }, disabled: { type: Boolean, default: !1 } }, computed: { classname: function() {
  var e;
...
function Zi(e) {
  ...
  if (i) {
    var n = { height: Math.max(i.height, o.height), width: Math.max(i.width, o.width) }, a = Ot({ width: R(n) > s ? n.width : n.height * s, height: R(n) > s ? n.width / s : n.height }, Ye(t())), h = { left: i.left + i.width / 2 - a.width / 2, top: i.top + i.height / 2 - a.height / 2, width: a.width, height: a.height }, r = we(i, Q(p({ left: 0, top: 0 }, o))), l = {};
...
var Ji = Y("vue-simple-handler"), en = Y("vue-simple-handler-wrapper"), Qe = { name: "SimpleHandler", components: { HandlerWrapper: Pt }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, horizontalPosition: { type: String }, verticalPosition: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  return { hover: !1 };
...
var tn = Y("vue-simple-line"), nn = Y("vue-simple-line-wrapper"), Je = { name: "SimpleLine", components: { LineWrapper: Lt }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, position: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  return { hover: !1 };
}, computed: { classes: function() {
...
var Be = Y("vue-bounding-box"), on = ["east", "west", null], sn = ["south", "north", null], kt = { name: "BoundingBox", props: { width: { type: Number }, height: { type: Number }, transitions: { type: Object }, handlers: { type: Object, default: function() {
...
var rn = Y("vue-draggable-area"), $t = { name: "DraggableArea", props: { movable: { type: Boolean, default: !0 }, activationDistance: { type: Number, default: 20 } }, computed: { classnames: function() {
  return { default: rn() };
} }, beforeMount: function() {
  window.addEventListener("mouseup", this.onMouseUp, { passive: !1 }), window.addEventListener("mousemove", this.onMouseMove, { passive: !1 }), window.addEventListener("touchmove", this.onTouchMove, { passive: !1 }), window.addEventListener("touchend", this.onTouchEnd, { passive: !1 });
}, beforeUnmount: function() {
...
var Te = Y("vue-preview"), _t = { props: { coordinates: { type: Object }, transitions: { type: Object }, image: { type: Object, default: function() {
  return {};
...
var Fe = Y("vue-rectangle-stencil"), et = { name: "RectangleStencil", components: { StencilPreview: Ft, BoundingBox: kt, DraggableArea: $t }, props: { image: { type: Object }, coordinates: { type: Object }, stencilCoordinates: { type: Object }, handlers: { type: Object }, handlersComponent: { type: [Object, String], default: function() {
  return Qe;
...
var ln = ["transitions"], ee = Y("vue-advanced-cropper"), Vt = { name: "Cropper", components: { BackgroundWrapper: Ze }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  return et;
  ...
  var e = Xe(this.resizeImage, { touch: !0, wheel: { ratio: 0.1 }, adjustStencil: !0 }, { touch: !1, wheel: !1, adjustStencil: !1 });
  return { moveImage: Xe(this.moveImage, { touch: !0, mouse: !0 }, { touch: !1, mouse: !1 }), resizeImage: e };
  ...
  if (this.boundaries.width && this.boundaries.height && this.imageSize.width && this.imageSize.height) {
    ...
    if (e = (function(o) {
      ...
      var t = this.getStencilSize(), i = Ye(this.getAreaRestrictions({ visibleArea: this.visibleArea, type: "resize" }));
  ...
  if (this.$refs.image) {
    ...
    t || (t = this.stencilSize ? Gi : Yi);
    var i = this.sizeRestrictions;
    i.minWidth, i.minHeight, i.maxWidth, i.maxHeight;
    var o = ue(t) ? t({ boundaries: this.boundaries, imageSize: this.imageSize, aspectRatio: this.getAspectRatio(), sizeRestrictions: this.sizeRestrictions, stencilSize: this.getStencilSize(), visibleArea: this.visibleArea }) : t, s = this.defaultPosition || Xi, n = [o, function(a) {
      var h = a.coordinates;
  ...
  setup(e, { expose: t, emit: i }) {
    ...
    async function rt(f) {
      if (s.deferUpload) {
        T.value = f, G(f);
        const v = bi(f), M = wi(f);
        Z.value = M, V.value = v, n("fileReady", f), v && Yt(previewUrl);
        return;
      }
      c.value = !0, u.value = 0;
      try {
    ...
    return t({
      ...
      return b(), A("div", dn, [
        ...
        H.value && (g.value || !e.uploadEnabled) ? (b(), A("div", gn, P(H.value), 1)) : X("", !0),
        e.uploadEnabled && !g.value ? (b(), A(ve, { key: 3 }, [
          y(k) ? (b(), A("div", {
            ...
            !c.value && m.value ? (b(), A("span", Mn, P(m.value.toUpperCase()), 1)) : X("", !0),
            !c.value && d.value ? (b(), A("span", xn, P(y(o)(y(W).UPLOAD_FAILED)), 1)) : !c.value && !m.value ? (b(), A("span", En, P(y(o)(y(W).PENDING_UPLOAD)), 1)) : X("", !0),
            c.value ? X("", !0) : (b(), A("div", Cn, [
              E("button", {
