import { c as p, r as f, f as g, j as d, g as u, b as I } from "./utils.CEZ6gpqU.js";
import { f as c, d as L } from "./constants.BKgq3oBR.js";
import { c as y } from "./utils.Cdo9eusG.js";
import { Y as s } from "./en-US.DXdmRfHg.js";
import { c as C } from "./index.B5lyUA6W.js";
...
class F {
  ...
  goToCategoryManagement() {
    y(this.state.categoryList), this.opts.onNavigateToCategoryManagement();
  }
  async copyGiftId(t) {
  ...
  async openGiftLangConfigDialog(t) {
    const e = this.state.giftList.find((a) => a.id === t), { config: i, langsToFetch: o } = u(e?.languageList);
    if (this.setState({
      editingId: t,
      giftLangConfig: i,
      langConfigVisible: !0
  ...
  async openLangEditDialog(t, e) {
    const i = this.state.giftList.find((r) => r.id === t), o = I(i?.languageList, e);
    let a = o.form;
    if (o.needsFetch)
      try {
