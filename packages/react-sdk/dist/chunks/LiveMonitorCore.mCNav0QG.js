import { g as f, aH as d, aI as L, aJ as p, e as S } from "./main-layout.Bx74vUBv.js";
import { aD as y, aA as c, ac as v, aB as u, Y as l, d as C, az as I } from "./en-US.DXdmRfHg.js";
...
class k {
  ...
  async updateLive(t) {
    ...
    try {
      await p(e, t);
      const { liveId: r, ...s } = t;
      this.currentLive && (this.currentLive = { ...this.currentLive, ...s, liveId: this.currentLive.liveId }), this.liveList = this.liveList.map(
        (a) => a.liveId === e ? { ...a, ...s, liveId: a.liveId } : a
      ), this.notifyStateChange({
        currentLive: this.currentLive,
        liveList: this.liveList
      }), this.setLoading(i, !1);
