...
import { aX as gt, g as wt, I as m, c as Ct } from "./layout.C3iw4hOH.js";
import { UploadIcon as Ve, CloseIcon as yt, ImageIcon as Rt, CutIcon as _t } from "tdesign-icons-react";
import { Button as ue, Input as Et, Dialog as St } from "tdesign-react";
import { useUIKit as Pt } from "@tencentcloud/uikit-base-component-react";
import { g as pe, bo as Ge, by as Dt, bn as xt, ax as At, bx as bt, bq as Mt } from "./main-layout.Df5XdcMa.js";
import { i as zt, g as It } from "./PreviewUrlController.AaXbIEwh.js";
import { U as Nt, u as Ze, k as Ut, i as Ot, h as Lt, v as Tt, g as Wt } from "./upload.B0hABtwm.js";
import { s as Je } from "./svga.min.Zof6g_Kl.js";
import { M as $ } from "./useAsyncAction.BqnpftqB.js";
import { u as Ft, a as Vt } from "./useT.DURiU63F.js";
var Ae = function(a, r) {
...
const Er = vt(function({
  ...
  const { t: f } = Pt(), { opSuccess: ve, opFailed: G } = Ct(f), ie = s || f(m.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), U = Y(null), [M, Z] = S(!1), [K, k] = S(0), [Qe, ee] = S(!1), [me, ae] = S(""), [x, q] = S(!h), [b, se] = S(r), [ge, j] = S(!1), [W, O] = S(""), A = Y(null);
  ...
  mt(X, () => ({
    ...
    reset: () => {
      A.current.reset(), B.current = null, J(null), we(!1), ce(!1), se(r || ""), ae(""), O(""), Z(!1), k(0), ee(!1), h && q(!!r), _?.(null);
    },
    ...
    h && l && /* @__PURE__ */ z("div", { className: "image-upload-mode-switch", children: [
      /* @__PURE__ */ d(
        ue,
        {
          ...
          onClick: () => {
            A.current.cancelValidation(), j(!1), O(""), q(!1);
          },
      ...
      /* @__PURE__ */ d(
        ue,
        {
          ...
          className: `mode-switch-btn ${x ? "active" : ""}`,
          onClick: () => {
            A.current.cancelValidation(), j(!1), O(""), q(!0);
          },
        ...
        /* @__PURE__ */ d(
          "div",
          {
            ...
            children: M ? /* @__PURE__ */ z("div", { className: "image-upload-progress", children: [
              ...
              /* @__PURE__ */ d(Rt, { size: "32", strokeWidth: 1.2 }),
    ...
    /* @__PURE__ */ d(
      St,
      {
        ...
        footer: /* @__PURE__ */ z(le, { children: [
          ...
          /* @__PURE__ */ d(ue, { shape: "round", theme: "primary", onClick: ct, disabled: Le || !re, icon: /* @__PURE__ */ d(_t, { size: "14" }), children: f(m.CONFIRM_CROP) })
        ] }),
