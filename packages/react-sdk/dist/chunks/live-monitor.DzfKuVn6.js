...
import { c0 as B, aZ as V, c1 as K, c2 as ae, aH as se, aF as ie, m as ce, u as le, c3 as ue, c4 as de, bL as fe, c5 as ge, a7 as me, c6 as he, ae as be, c7 as ve, bz as Me, V as we, U as ye } from "./main-layout.BqLTYqar.js";
import { c as z, n as pe, j as O, h as s } from "./logger.DCFRj533.js";
...
function xe(i) {
  ...
  const j = n(async (e = {}) => {
    ...
    if (!t) throw new Error("liveId is required");
    try {
      const e = await fe(t, "default", Le.VIOLATION_SUGGESTION_DEFAULT);
