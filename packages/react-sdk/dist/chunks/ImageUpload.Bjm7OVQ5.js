import { openBlock as v, createBlock as E, renderSlot as he, resolveComponent as F, createVNode as M, withCtx as B, Fragment as we, renderList as lt, resolveDynamicComponent as De, withDirectives as Et, vShow as Ct, mergeProps as Tt, withModifiers as ri, createCommentVNode as X, defineComponent as hi, computed as ke, ref as C, watch as ce, nextTick as ct, onMounted as li, onUnmounted as ci, createElementBlock as A, createElementVNode as T, normalizeClass as ue, unref as y, createTextVNode as ut, toDisplayString as H, createSlots as ui, normalizeStyle as Me } from "vue";
...
import { P as I } from "./en-US.Cyn41QJd.js";
import { as as vi, a_ as mt, b6 as pt, b0 as bi, b7 as wi, aZ as yi, a$ as zi, af as Ri } from "./main-layout.0SrlHtaV.js";
import { i as Ai, g as Si } from "./svga.DC02l1-t.js";
import { U as Mi, k as xi, u as gt, i as Ei, h as Ci, v as Ti, a as Wi } from "./upload.DD4N09Kq.js";
import { u as Ii } from "./usePreviewUrl.BJkYcvDu.js";
import { a as Di } from "./useAsyncAction.CeUdmKXy.js";
...
Lt.render = function(e, t, i, o, s, n) {
  var r = F("DraggableElement");
  return v(), E("div", { class: n.classes.root }, [M(r, { class: n.classes.draggable, onDrag: t[1] || (t[1] = function(h) {
...
var Z = ["left", "right", "top", "bottom"], $i = ["left", "right"], Bi = ["top", "bottom"], ji = ["left", "top"], Fi = ["fill-area", "fit-area", "stencil", "none"], zt = { left: 0, top: 0, width: 0, height: 0 };
function Rt(e, t, i) {
...
function _i(e) {
  ...
  return (Array.isArray(i) ? i : [i]).forEach((function(u) {
    ...
    D((c = typeof u == "function" ? u({ coordinates: l, imageSize: o, visibleArea: h }) : u).width) && D(c.height) || (l = (function(d, m) {
      var w = p(p(p({}, d), te({ width: m.width, height: m.height, sizeRestrictions: s, aspectRatio: r })), { left: 0, top: 0 });
...
function Ni(e) {
  ...
  e.stencilReference;
  var a, l, u, c = p({}, o), d = p({}, s), m = p({}, n);
  a = R(m), l = R(c), u === void 0 && (u = 1e-3), (a === 0 || l === 0 ? Math.abs(l - a) < u : Math.abs(l / a) < 1 + u && Math.abs(l / a) > 1 - u) || (c = p(p({}, c), te({ sizeRestrictions: r, width: c.width, height: c.height, aspectRatio: { minimum: R(m), maximum: R(m) } })));
  var w = Le(d = V(d, c.width * i.width / (d.width * m.width)), t({ visibleArea: d, type: "resize" }));
  return w !== 1 && (d = V(d, w), c = V(c, w)), d = L(d = k(d, fe(P(c), P(d))), t({ visibleArea: d, type: "move" })), { coordinates: c = L(c, Oe(q(d), h)), visibleArea: d };
}
function Xi(e) {
  ...
  if (s && n && t.type !== "manipulateImage") {
    ...
    var u = Le(a = V(a, h.width * o.width / (a.width * l.width)), i({ visibleArea: a, type: "resize" }));
    a = V(a, u), u !== 1 && (l.height /= u, l.width /= u), a = L(a = k(a, fe(P(h), P(a))), i({ visibleArea: a, type: "move" })), h = L(h, Oe(q(a), r));
  }
...
function Yi(e) {
  ...
  if (t.type === "setCoordinates") {
    ...
    h > a ? n = V(n, Math.min(r.width / n.width, me(n, s({ visibleArea: n, type: "resize" })))) : a > h && (n = V(n, Math.min(r.height / n.height, me(n, s({ visibleArea: n, type: "resize" }))))), n = L(n = k(n, Pe(pe(r, q(n)))), s({ visibleArea: n, type: "move" }));
  }
...
function Ki(e) {
  ...
  if (i) {
    ...
    return !a.left && !a.right && h.width <= o.width && (l.left = 0, l.right = o.width), !a.top && !a.bottom && h.height <= o.height && (l.top = 0, l.bottom = o.height), L(h, l);
  }
  var u = R(o);
...
function Qi(e) {
  var t = e.event, i = e.coordinates, o = e.visibleArea, s = e.sizeRestrictions, n = e.getAreaRestrictions, r = e.positionRestrictions, h = e.adjustStencil, a = t.scale, l = t.move, u = p({}, o), c = p({}, i), d = 1, m = 1, w = a.factor && Math.abs(a.factor - 1) > 1e-3;
  u = k(u, { left: l.left || 0, top: l.top || 0 });
  var b = { stencil: { minimum: Math.max(s.minWidth ? s.minWidth / c.width : 0, s.minHeight ? s.minHeight / c.height : 0), maximum: Math.min(s.maxWidth ? s.maxWidth / c.width : 1 / 0, s.maxHeight ? s.maxHeight / c.height : 1 / 0, me(c, r)) }, area: { maximum: me(u, n({ visibleArea: u, type: "resize" })) } };
  a.factor && w && (a.factor < 1 ? (m = Math.max(a.factor, b.stencil.minimum)) > 1 && (m = 1) : a.factor > 1 && (m = Math.min(a.factor, Math.min(b.area.maximum, b.stencil.maximum))) < 1 && (m = 1)), m && (u = V(u, m, a.center));
  var S = i.left - o.left, O = o.width + o.left - (i.width + i.left), K = i.top - o.top, Q = o.height + o.top - (i.height + i.top);
  return u = L(u = k(u, pe(u, { left: r.left !== void 0 ? r.left - S * m : void 0, top: r.top !== void 0 ? r.top - K * m : void 0, bottom: r.bottom !== void 0 ? r.bottom + Q * m : void 0, right: r.right !== void 0 ? r.right + O * m : void 0 })), n({ visibleArea: u, type: "move" })), c.width = c.width * m, c.height = c.height * m, c.left = u.left + S * m, c.top = u.top + K * m, c = L(c, Oe(q(u), r)), a.factor && w && h && (a.factor > 1 ? d = Math.min(b.area.maximum, a.factor) / m : a.factor < 1 && (d = Math.max(c.height / u.height, c.width / u.width, a.factor / m)), d !== 1 && (u = k(u = L(u = V(u, d, a.factor > 1 ? a.center : P(c)), n({ visibleArea: u, type: "move" })), Pe(pe(c, q(u)))))), { coordinates: c, visibleArea: u };
}
function Ji(e) {
  var t = e.aspectRatio, i = e.getAreaRestrictions, o = e.coordinates, s = e.visibleArea, n = e.sizeRestrictions, r = e.positionRestrictions, h = e.imageSize, a = e.previousImageSize, l = e.angle, u = p({}, o), c = p({}, s), d = ne(P(p({ left: 0, top: 0 }, a)), l);
  return (u = p(p({}, te({ sizeRestrictions: n, aspectRatio: t, width: u.width, height: u.height })), ne(P(u), l))).left -= d.left - h.width / 2 + u.width / 2, u.top -= d.top - h.height / 2 + u.height / 2, c = V(c, Le(c, i({ visibleArea: c, type: "resize" }))), { coordinates: u = L(u, r), visibleArea: c = L(c = k(c, fe(P(u), P(o))), i({ visibleArea: c, type: "move" })) };
}
function en(e) {
  ...
  if (u || c) {
    var d = ne({ left: h.width / 2, top: h.height / 2 }, -o), m = ne(P(a), -o), w = ne({ left: u ? d.left - (m.left - d.left) : m.left, top: c ? d.top - (m.top - d.top) : m.top }, o);
    a = k(a, fe(w, P(a))), m = ne(P(l), -o), l = L(l = k(l, fe(w = ne({ left: u ? d.left - (m.left - d.left) : m.left, top: c ? d.top - (m.top - d.top) : m.top }, o), P(l))), s({ visibleArea: l, type: "move" }));
  }
...
Je.render = function(e, t, i, o, s, n) {
  var r = F("HandlerWrapper");
  return v(), E(r, { class: n.classes.wrapper, "vertical-position": i.verticalPosition, "horizontal-position": i.horizontalPosition, disabled: i.disabled, onDrag: n.onDrag, onDragEnd: n.onDragEnd, onEnter: n.onEnter, onLeave: n.onLeave }, { default: B((function() {
...
et.render = function(e, t, i, o, s, n) {
  var r = F("LineWrapper");
  return v(), E(r, { class: n.classes.wrapper, position: i.position, disabled: i.disabled, onDrag: n.onDrag, onDragEnd: n.onDragEnd, onEnter: n.onEnter, onLeave: n.onLeave }, { default: B((function() {
    return [M("div", { class: n.classes.root }, null, 2)];
  })), _: 1 }, 8, ["class", "position", "disabled", "onDrag", "onDragEnd", "onEnter", "onLeave"]);
};
var Fe = Y("vue-bounding-box"), an = ["east", "west", null], rn = ["south", "north", null], $t = { name: "BoundingBox", props: { width: { type: Number }, height: { type: Number }, transitions: { type: Object }, handlers: { type: Object, default: function() {
  ...
  return this.points.forEach((function(s) {
    if (e.handlers[s.name]) {
      ...
      if (i && o) {
        ...
        n.wrapperClass = Fe("handler"), n.wrapperStyle = { transform: "translate(".concat(a, "px, ").concat(l, "px)") }, e.transitions && e.transitions.enabled && (n.wrapperStyle.transition = "".concat(e.transitions.time, "ms ").concat(e.transitions.timingFunction));
      } else n.wrapperClass = Fe("handler", j({}, s.classname, !0));
      t.push(n);
    }
  })), t;
...
$t.render = function(e, t, i, o, s, n) {
  return v(), E("div", { ref: "box", class: n.classes.root, style: n.style }, [he(e.$slots, "default"), M("div", null, [(v(!0), E(we, null, lt(n.lineNodes, (function(r) {
    return v(), E(De(r.component), { key: r.name, "default-class": r.class, "hover-class": r.hoverClass, "wrapper-class": r.wrapperClass, position: r.name, disabled: r.disabled, onDrag: function(h) {
  ...
  })), 128))]), (v(!0), E(we, null, lt(n.handlerNodes, (function(r) {
    return v(), E("div", { key: r.name, style: r.wrapperStyle, class: r.wrapperClass }, [(v(), E(De(r.component), { "default-class": r.class, "hover-class": r.hoverClass, "wrapper-class": r.wrapperClass, "horizontal-position": r.horizontalDirection, "vertical-position": r.verticalDirection, disabled: r.disabled, onDrag: function(h) {
      return n.onHandlerDrag(h, r.horizontalDirection, r.verticalDirection);
    }, onDragEnd: t[2] || (t[2] = function(h) {
      return n.onEnd();
  ...
  return new Promise((function(t, i) {
    try {
      if (e) if (/^data:/i.test(e)) t((function(a) {
        ...
        for (var l = atob(a), u = l.length, c = new ArrayBuffer(u), d = new Uint8Array(c), m = 0; m < u; m++) d[m] = l.charCodeAt(m);
        return c;
      })(e));
...
function cn(e) {
  try {
    ...
    if (n && (o = n + 10, (function(m, w, b) {
      var S, O = "";
      for (S = w, b += w; S < b; S++) O += String.fromCharCode(m.getUint8(S));
      return O;
    })(i, n + 4, 4) === "Exif")) {
      var l = i.getUint16(o);
...
function xt(e, t) {
  ...
  return e.forEach((function(h) {
    ...
    r += Pt({ x: n.left, y: n.top }, { x: h.clientX - o, y: h.clientY - s });
...
var qe = { components: { TransformableImage: Ft }, props: { touchMove: { type: Boolean, required: !0 }, mouseMove: { type: Boolean, required: !0 }, touchResize: { type: Boolean, required: !0 }, wheelResize: { type: [Boolean, Object], required: !0 } }, emits: ["resize", "move"] };
qe.render = function(e, t, i, o, s, n) {
  var r = F("transformable-image");
...
var We = Y("vue-preview"), Vt = { props: { coordinates: { type: Object }, transitions: { type: Object }, image: { type: Object, default: function() {
  return {};
  ...
  return { root: We({ fill: this.fill }), wrapper: We("wrapper"), imageWrapper: We("image-wrapper"), image: W(We("image"), this.imageClass) };
}, style: function() {
  if (this.fill) return {};
  var e = {};
...
var _t = { components: { Preview: Vt }, inheritAttrs: !1 };
_t.render = function(e, t, i, o, s, n) {
  var r = F("preview");
  return v(), E(r, Tt(e.$attrs, { fill: !0 }), null, 16);
};
var _e = Y("vue-rectangle-stencil"), tt = { name: "RectangleStencil", components: { StencilPreview: _t, BoundingBox: $t, DraggableArea: Bt }, props: { image: { type: Object }, coordinates: { type: Object }, stencilCoordinates: { type: Object }, handlers: { type: Object }, handlersComponent: { type: [Object, String], default: function() {
  return Je;
  ...
  return { stencil: W(_e({ movable: this.movable, moving: this.moving, resizing: this.resizing }), this.moving && this.movingClass, this.resizing && this.resizingClass), preview: W(_e("preview"), this.previewClass), boundingBox: W(_e("bounding-box"), this.boundingBoxClass) };
}, style: function() {
...
tt.render = function(e, t, i, o, s, n) {
  var r = F("stencil-preview"), h = F("draggable-area"), a = F("bounding-box");
  return v(), E("div", { class: n.classes.stencil, style: n.style }, [M(a, { width: i.stencilCoordinates.width, height: i.stencilCoordinates.height, transitions: i.transitions, class: n.classes.boundingBox, handlers: i.handlers, "handlers-component": i.handlersComponent, "handlers-classes": i.handlersClasses, "handlers-wrappers-classes": i.handlersWrappersClasses, lines: i.lines, "lines-component": i.linesComponent, "lines-classes": i.linesClasses, "lines-wrappers-classes": i.linesWrappersClasses, resizable: i.resizable, onResize: n.onResize, onResizeEnd: n.onResizeEnd }, { default: B((function() {
    return [M(h, { movable: i.movable, onMove: n.onMove, onMoveEnd: n.onMoveEnd }, { default: B((function() {
      return [M(r, { image: i.image, coordinates: i.coordinates, width: i.stencilCoordinates.width, height: i.stencilCoordinates.height, class: n.classes.preview, transitions: i.transitions }, null, 8, ["image", "coordinates", "width", "height", "class", "transitions"])];
...
var un = ["transitions"], ee = Y("vue-advanced-cropper"), Nt = { name: "Cropper", components: { BackgroundWrapper: qe }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  ...
  n.widthFrozen && (a.left = 0, a.right = 0), n.heightFrozen && (a.top = 0, a.bottom = 0), Z.forEach((function(_) {
    l[_] || (a[_] = 0);
  }));
  ...
  return u = G(r, a).width, c = G(r, a).height, (d = h.preserveRatio ? R(r) : je(u / c, o)) && Math.abs(d - u / c) > 1e-3 && Z.forEach((function(_) {
    l[_] || (a[_] = 0);
  ...
  return r = L(r = k(r, fe(P(i), P(r))), Oe(q(t), n));
  ...
  var r = Pe(pe(s, q(n = V(n, Le(n, o({ visibleArea: n, type: "resize" }))))));
  return n.width < s.width && (r.left = 0), n.height < s.height && (r.top = 0), n = L(n = k(n, r), o({ visibleArea: n, type: "move" }));
  ...
  return this.roundResult ? (function(t) {
    ...
    return n.width > o.maxWidth ? n.width = Math.floor(i.width) : n.width < o.minWidth && (n.width = Math.ceil(i.width)), n.height > o.maxHeight ? n.height = Math.floor(i.height) : n.height < o.minHeight && (n.height = Math.ceil(i.height)), L(n, s);
  ...
  var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i = t.transitions, o = i !== void 0 && i, s = Li(t, un), n = this.processAutoZoom(e, this.visibleArea, this.coordinates, s), r = n.visibleArea, h = n.coordinates, a = n.changed;
  ...
  if (this.$refs.canvas) {
    var e = this.$refs.canvas, t = this.$refs.image, i = this.imageTransforms.rotate !== 0 || this.imageTransforms.flip.horizontal || this.imageTransforms.flip.vertical ? (function(h, a, l) {
      var u = l.rotate, c = l.flip, d = { width: a.naturalWidth, height: a.naturalHeight }, m = Ut(d, u), w = h.getContext("2d");
      h.height = m.height, h.width = m.width, w.save();
      var b = ne(P(p({ left: 0, top: 0 }, d)), u);
      return w.translate(-(b.left - m.width / 2), -(b.top - m.height / 2)), w.rotate(u * Math.PI / 180), w.translate(c.horizontal ? d.width : 0, c.vertical ? d.height : 0), w.scale(c.horizontal ? -1 : 1, c.vertical ? -1 : 1), w.drawImage(a, 0, 0, d.width, d.height), w.restore(), h;
    ...
    return (function(h, a, l, u, c) {
      ...
      d.drawImage(a, l.left + m, l.top + w, l.width, l.height, m * (h.width / l.width), w * (h.height / l.height), h.width, h.height);
    })(e, i, this.coordinates, n, o), e;
  }
}, update: function() {
  this.$emit("change", this.getResult());
}, applyTransform: function(e) {
  var t = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], i = this.visibleArea && t ? Vi(this.sizeRestrictions, this.visibleArea) : this.sizeRestrictions, o = this.visibleArea && t ? Ce(this.positionRestrictions, this.visibleArea) : this.positionRestrictions;
  ...
  })(o) : this.imageAttributes.src = i, de(this.defaultTransforms) ? this.appliedImageTransforms = Ve(this.defaultTransforms()) : Ie(this.defaultTransforms) ? this.appliedImageTransforms = Ve(this.defaultTransforms) : this.appliedImageTransforms = (function(n) {
    var r = Ve({});
    if (n) switch (n) {
      case 2:
        r.flip.horizontal = !0;
...
Nt.render = function(e, t, i, o, s, n) {
  return v(), E("div", { ref: "cropper", class: n.classes.cropper }, [M("div", { ref: "stretcher", class: n.classes.stretcher }, null, 2), M("div", { class: n.classes.boundaries, style: n.boundariesStyle }, [(v(), E(De(i.backgroundWrapperComponent), { class: n.classes.cropperWrapper, "wheel-resize": n.settings.resizeImage.wheel, "touch-resize": n.settings.resizeImage.touch, "touch-move": n.settings.moveImage.touch, "mouse-move": n.settings.moveImage.mouse, onMove: n.onManipulateImage, onResize: n.onManipulateImage }, { default: B((function() {
    return [M("div", { class: n.classes.background, style: n.boundariesStyle }, null, 6), M("div", { class: n.classes.imageWrapper }, [M("img", { ref: "image", crossorigin: s.imageAttributes.crossOrigin, src: s.imageAttributes.src, class: n.classes.image, style: n.imageStyle, onMousedown: t[1] || (t[1] = ri((function() {
...
const mn = { class: "image-upload-container" }, pn = {
...
}, Cn = ["title"], Tn = ["title"], Wn = {
  key: 0,
  class: "image-upload-progress"
}, In = { class: "progress-bar" }, Dn = { class: "progress-text" }, Pn = { class: "upload-hint" }, Ln = { class: "upload-sub-hint" }, On = ["accept"], Hn = ["src"], Un = ["src"], kn = { class: "image-crop-body" }, $n = {
  key: 0,
  class: "image-crop-loading"
}, Bn = { class: "image-crop-footer" }, jn = { class: "btn-content" }, Fn = /* @__PURE__ */ hi({
  __name: "ImageUpload",
  props: {
    modelValue: { default: "" },
    type: { default: "cover" },
  ...
  setup(e, { expose: t, emit: i }) {
    ...
    Ai(ft.Parser);
    const n = e, r = i, h = ke(() => n.placeholder || s(I.CLICK_OR_DRAG_TO_UPLOAD_COVER_IMAGE)), a = ke(() => n.acceptHint || s("Supports JPG/PNG/GIF/WebP max {max}MB", { max: n.maxSize })), l = C(null), u = C(null), c = C(!1), d = C(0), m = C(!1), w = C(""), b = C(!n.uploadEnabled), S = C(n.modelValue), O = C(null), { previewUrl: K, setPreview: Q } = Ii(), _ = C(!1), ge = C(!1), {
      containerRef: Xt,
      playUrl: Yt
    } = Di({ loop: 1, autoPlay: !0 }), He = C(null);
    let ve = null;
    function be() {
      if (ve) {
        try {
    ...
    const ie = C(!1), oe = C(""), qt = C(1), it = C(1), Re = C(!1), Ae = C(null), nt = C({ width: 300, height: 300 });
    function Se() {
      if (!Ae.value) return;
      const f = Ae.value.clientWidth, g = Ae.value.clientHeight || 320, x = f / g, $ = n.aspectRatio || 16 / 9;
      let le, J;
      $ > x ? (le = Math.min(f, 500), J = le / $) : (J = Math.min(g, 320), le = J * $), nt.value = { width: Math.round(le), height: Math.round(J) };
    }
    ce(ie, async (f) => {
      f && (await ct(), setTimeout(Se, 100));
    }), ce(() => n.aspectRatio, () => {
      ie.value && Se();
    }), li(() => {
      window.addEventListener("resize", Se);
    });
    const se = C(!1), U = C(""), N = new Mi({
      setValidating: (f) => {
        se.value = f;
      },
      setError: (f) => {
    ...
    ce(() => n.modelValue, (f) => {
      S.value = f, U.value = "", f && n.uploadEnabled && (b.value = !0), n.deferUpload && (O.value = null, Q(null), _.value = !1, ge.value = !1, r("fileReady", null));
      ...
      N.dispose(), be(), window.removeEventListener("resize", Se);
    });
    function ot() {
      l.value?.click();
    }
    ...
    async function st(f) {
      ...
      if (!Ci(f, n.maxSize)) {
        ae.error(s("File size exceeds {max}MB", { max: n.maxSize }));
        return;
      }
      try {
        ...
        ae.error($.message || s(I.FILE_LOAD_FAILED));
        return;
      }
      if (n.cropEnabled) {
        ...
        try {
          ...
          ae.error(s(I.IMAGE_LOAD_FAILED)), ie.value = !1;
        } finally {
          Re.value = !1;
        }
      } else
    ...
    async function rt(f) {
      if (n.deferUpload) {
        O.value = f, Q(f);
        const g = yi(f), x = zi(f);
        _.value = x, ge.value = g, r("fileReady", f), g && Gt(previewUrl);
        return;
      }
      c.value = !0, d.value = 0;
      try {
        ...
        r("update:modelValue", g.url), w.value = g.provider || "", ae.success(s(I.UPLOAD_SUCCESS));
      } catch (g) {
        const x = g instanceof Error ? g : new Error(String(g));
        ae.error(`${s("Upload Failed With Error", { error: x.message || s(I.NETWORK_ERROR) })}`);
      } finally {
        c.value = !1, d.value = 0;
      }
    }
    ...
    function si(f) {
      f?.stopPropagation(), N.cancelValidation(), se.value = !1, U.value = "", r("update:modelValue", ""), S.value = "", w.value = "", c.value = !1, d.value = 0, m.value = !1, be(), n.deferUpload && (O.value = null, Q(null), _.value = !1, ge.value = !1, r("fileReady", null));
    }
    function ai(f) {
    ...
    return t({
      ...
      reset() {
        N.reset(), O.value = null, Q(null), _.value = !1, ge.value = !1, be(), S.value = n.modelValue || "", w.value = "", U.value = "", c.value = !1, d.value = 0, m.value = !1, n.uploadEnabled && (b.value = !!n.modelValue), r("fileReady", null);
      },
      /**
      ...
      async uploadPendingFile() {
        ...
        try {
          ...
          return O.value = null, w.value = g.provider || "", m.value = !1, g.url;
        } catch (g) {
          throw m.value = !0, g;
        } finally {
          c.value = !1, d.value = 0;
      ...
      const x = F("t-input"), $ = F("t-button"), le = F("t-dialog");
      return v(), A("div", mn, [
        e.uploadEnabled && e.showUrlInput ? (v(), A("div", pn, [
          T("button", {
            ...
            M(y(dt)),
            ut(" " + H(y(s)(y(I).UPLOAD_IMAGE)), 1)
          ], 2),
          T("button", {
            class: ue(["mode-switch-btn", { active: b.value }]),
            onClick: ht
          }, H(y(s)(y(I).ENTER_URL)), 3)
        ])) : X("", !0),
        b.value || !e.uploadEnabled ? (v(), A("div", gn, [
          M(x, {
            ...
            onBlur: ii,
            onEnter: oi,
            placeholder: y(s)(y(I).ENTER_IMAGE_URL),
            status: U.value ? "error" : "default"
          }, ui({ _: 2 }, [
            e.maxBytes ? {
              name: "suffix",
              fn: B(() => [
                se.value ? (v(), A("span", vn, H(y(s)(y(I).VALIDATING)), 1)) : (v(), A("span", {
                  key: 1,
                  class: ue(["input-suffix-count", { "byte-overflow": Ue.value > e.maxBytes }])
                }, H(Ue.value) + "/" + H(e.maxBytes), 3))
              ]),
              key: "0"
            } : void 0
          ]), 1032, ["model-value", "placeholder", "status"])
        ])) : X("", !0),
        U.value && (b.value || !e.uploadEnabled) ? (v(), A("div", bn, H(U.value), 1)) : X("", !0),
        e.uploadEnabled && !b.value ? (v(), A(we, { key: 3 }, [
          y(K) ? (v(), A("div", {
            ...
            !c.value && w.value ? (v(), A("span", Sn, H(w.value.toUpperCase()), 1)) : X("", !0),
            !c.value && m.value ? (v(), A("span", Mn, H(y(s)(y(I).UPLOAD_FAILED)), 1)) : !c.value && !w.value ? (v(), A("span", xn, H(y(s)(y(I).PENDING_UPLOAD)), 1)) : X("", !0),
            c.value ? X("", !0) : (v(), A("div", En, [
              T("button", {
                class: "preview-action-btn",
                onClick: ot,
                title: y(s)(y(I).RE_UPLOAD)
              }, [
                M(y(dt))
              ], 8, Cn),
              T("button", {
            ...
            c.value ? (v(), A("div", Wn, [
              ...
              T("span", Dn, H(d.value) + "%", 1)
            ])) : (v(), A(we, { key: 1 }, [
              M(y(fi), {
                size: "32",
                "stroke-width": 1.2
              }),
              T("span", Pn, H(h.value), 1),
              T("span", Ln, H(a.value), 1)
            ], 64))
          ], 38)),
          T("input", {
          ...
          default: B(() => [
            T("div", kn, [
              T("div", {
                ...
                Re.value ? (v(), A("div", $n, [
                  g[4] || (g[4] = T("div", { class: "loading-spinner" }, null, -1)),
                  T("span", null, H(y(s)(y(I).IMAGE_LOADING)), 1)
                ])) : oe.value ? (v(), E(y(Nt), {
                  key: 1,
                  ref_key: "cropperRef",
                  ref: u,
            ...
            T("div", Bn, [
              ...
              M($, {
                ...
                default: B(() => [
                  T("span", jn, [
                    M(y(mi)),
                    T("span", null, H(y(s)(y(I).CONFIRM_CROP)), 1)
                  ])
                ]),
                _: 1
              }, 8, ["disabled"])
...
}), io = /* @__PURE__ */ Pi(Fn, [["__scopeId", "data-v-a2489a76"]]);
export {
  io as I
};
