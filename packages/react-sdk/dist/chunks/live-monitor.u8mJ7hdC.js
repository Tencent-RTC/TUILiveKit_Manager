...
import { w as yn, aB as _n, az as bn, m as In, u as Ln, cc as Sn, cb as Tn, bP as wn, bO as An, aL as W, N as Nt, aS as Rn, bD as zr, bE as Br, b as Mn, _ as On, b7 as Hr, ba as Dn, a1 as xn, c0 as fr, c6 as Un, bp as gr, c4 as kn, c3 as Pn, c2 as Fn, bz as Gn, bo as Vn, aq as Wn, by as zn, br as Bn, aN as Hn, a0 as Yn, an as vr, A as je, O as ke, aM as Kn, b6 as $n, bc as qn, bf as Ut, i as Ue, al as Xn, bF as Yr, x as cr, a3 as jn, bS as Zn, ao as Er, Z as Nr, aw as Jn, c1 as Qn, ag as ea, aO as ta, R as ra, aZ as na, a5 as aa, aG as ia, $ as Ht, bi as oa, aP as Kr, bx as sa, b4 as Ot, bN as ca, a7 as la, ac as da, V as Rt, aa as ua, bb as ha, aR as tt, k as ma, bk as Cr, D as pa, a as Ye, q as Ze, r as Me, o as Oe, p as gt, bG as fa, z as $r, F as Pe, aV as ga, y as qr, aJ as va, v as Ea, bh as yr, s as _r, t as Na, T as Yt, d as vt, f as Ae, C as Re, S as Ca, aA as ya } from "./main-layout.YhXyesg5.js";
import { c as _a, g as ba, s as lr, a as Ia, D as La, d as Sa, e as Ta, m as wa, b as Aa, P as Ra } from "./gift-category.qmtjx5qb.js";
import { D as Ma, a9 as Oa, O as Da, R as xa, J as a, X as Kt, g as yt, Y as dr, U as Ua, T as ka, Q as Xr, aa as Pa, I as be, x as ur, l as lt } from "./en-US.DVkRUkOo.js";
...
import { a as Va } from "./moderation-store.DMk54_Cz.js";
...
function Jr(r) {
  ...
  const B = A(async () => {
    ...
    N(!0);
    try {
      const G = await Oa({ pageSize: t, liveId: n, ...b });
    ...
    try {
      ...
      return await Da({ ids: b.ids, items: G, liveId: b.liveId ?? n });
    } catch (G) {
      throw console.error("[useRiskControlState] approveTextModerationItems failed:", G), G;
    }
  }, [n, p]), Z = A(async (b) => {
    try {
      return await xa({ content: b.keywords.join(","), liveId: n });
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await In(n, b.memberAccounts, b.muteTime), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await Ln(n, b.memberAccounts), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await Sn(n, b.memberAccounts, b.duration, b.reason), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    R(!0), I(null);
    try {
      await Tn(n, b.memberAccounts), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    if (!n) throw new Error("liveId is required");
    try {
      return await wn(n, "default", "您的内容涉嫌违规");
    } catch (b) {
...
function Pt({
  ...
  return !o || p ? /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: Rn(n) }) : /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: /* @__PURE__ */ e(
    "img",
    {
      src: o,
      alt: d,
...
const Za = ({
  ...
  return J(() => {
    ...
    return (async () => {
      ...
      try {
        ...
        !y && P.current === L && ($ === kt.LOGIN_TIMEOUT || $ === kt.USER_SIG_ILLEGAL) && (Ua(), ka(), localStorage.removeItem("tuiLiveMonitor-userInfo"), window.location.href = "/#/config-required");
      }
    })(), () => {
      y = !0, P.current += 1;
      const $ = I.current || M;
  ...
  const { pageSize: n, isSearchModeRef: t, isUnmountedRef: i, pageVersionRef: c } = r, [o, s] = _(/* @__PURE__ */ new Map()), p = ee(null), l = ee(""), d = A(() => {
    ...
    l.current = S;
    try {
      const { startTime: R, endTime: C } = f(), I = await Pa(E, 10, R, C);
...
const Ft = on(function({
  ...
  const k = A(async (Q) => {
    ...
    if (T) {
      ne.current = Q, le(Q);
      const oe = Q.type.startsWith("video/"), Ee = Vn(Q);
  ...
  return /* @__PURE__ */ u("div", { className: `image-upload-container ${m}`, children: [
    ...
    n && (y || !g) && /* @__PURE__ */ e(
      "div",
      {
        ...
        children: gr(n) ? /* @__PURE__ */ e("div", { ref: Ie, className: "svga-preview-container" }) : Bn(n) ? /* @__PURE__ */ e("video", { src: n, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ e("img", { src: n, alt: "preview", onError: (Q) => {
...
function Ai({ visible: r, onClose: n, onSuccess: t, uploadEnabled: i = !1, extraFieldsSlot: c, onCreate: o }) {
  ...
  const { t: s } = ve(), p = Yn.map((F) => ({
    ...
    try {
      await Xn(F), x("success", s(a.COPY_LABEL_COPIED, { label: te }));
    } catch (he) {
    ...
    ge,
    {
      ...
      children: N ? (
        ...
        /* @__PURE__ */ u(ut, { className: "create-live-form", labelWidth: lt(100), children: [
          ...
          /* @__PURE__ */ e(de, { label: s(a.LAYOUT_TEMPLATE), requiredMark: !0, help: s(((se = $n(l.seatTemplate)) == null ? void 0 : se.descKey) || ""), children: /* @__PURE__ */ e(
            sr,
            {
              options: p,
...
function Ri({ visible: r, live: n, onClose: t, onSuccess: i, uploadEnabled: c = !1, extraFieldsSlot: o, onUpdate: s, onFetchDetail: p }) {
  ...
  J(() => {
    n != null && n.coverUrl ? Jn(n.coverUrl).then(w) : w(Nr);
  ...
  const X = () => {
    ...
    try {
      ...
      const Y = ea(g), ne = ta(m.current, Y);
      await H({
  ...
  mr(() => {
    ...
    const x = () => {
      ...
      for (const { column: ae } of L)
        z[ae.key] !== void 0 && (le[ae.key] = Aa(z[ae.key], ae.minWidth, ae.maxWidth));
      C.current = le;
    }, $ = () => {
      var Y;
      const V = C.current;
      ...
      const O = ((Y = w.current) == null ? void 0 : Y.clientWidth) ?? 0, U = Sa(
        r,
        V,
        O,
        B
...
function Ao() {
  ...
  J(() => (l.init(), () => l.dispose()), []);
  const f = Ui(), g = _e(() => na({ hasExtraColumn: !!(s != null && s.tableExtraColumns) }).map((y) => {
    switch (y.key) {
      case "liveId":
        return {
          ...y,
      ...
      case "createdAt":
        return {
          ...
          render: (x) => /* @__PURE__ */ e("span", { className: "live-list-text", children: ia(x.createdAt) })
        };
      case "customer-extra":
        return {
          ...y,
...
const Gi = 12 * 1024, Vi = (r) => new TextEncoder().encode(r).length, ct = { current: {} }, Wi = st.memo(
  ({ message: r, style: n }) => {
    var l, d;
    const t = r.sender.userId, i = t === ct.current.anchorUserId, c = r.sender.nameCard || r.sender.userName || t, o = r.messageType === 0 ? r.textContent : r.data || "", s = sa(o);
    return /* @__PURE__ */ u(
      "div",
      {
...
function to(r, n) {
  ...
  } = Jr({ liveId: r || "", pageSize: Rt }), [o, s] = _([]), [p, l] = _(!1), [d, f] = _(1), [g, v] = _(0), [h, N] = _([]), [m, T] = _(null), [w, E] = _(null), S = _e(() => da(g, Rt), [g]), R = A(
    async (b = 1) => {
      if (r) {
        l(!0);
        try {
...
function ro(r, n, t) {
  ...
  const D = (O, U) => {
    ...
    action: async () => {
      ...
      await l({ memberAccounts: [E.userId], muteTime: ma });
    },
    confirm: {
    ...
    r && (Cr(O, t) || (Y ? (C({ userId: O, userName: U }), Z.requestConfirm()) : (S({ userId: O, userName: U }), j.requestConfirm())));
  }, [r, t, Z, j]), M = Ve({
    action: async () => {
    ...
    action: async () => {
      ...
      await f({ memberAccounts: [I.userId], duration: pa });
    },
    confirm: {
    ...
    r && (Cr(O, t) || (Y ? (H({ userId: O, userName: U }), M.requestConfirm()) : (P({ userId: O, userName: U }), L.requestConfirm())));
  }, [r, t, M, L]), x = A((O) => {
  ...
  return (i) => {
    const {
      ...
      },
      {
        ...
        render: (f) => /* @__PURE__ */ u("div", { className: "gift-lang-tags", children: [
          f.languageList && f.languageList.length > 0 ? f.languageList.map((g) => {
            const v = ga(g), h = qr[v], N = h ? Pe[h] : null;
            return /* @__PURE__ */ e(
              "span",
              {
      ...
      },
      {
        ...
        render: (f) => /* @__PURE__ */ e("span", { className: "gift-create-time", children: va(f.createdAt) })
      }
    ];
          ...
          },
          {
            ...
            render: (h) => /* @__PURE__ */ u("div", { className: "category-lang-tags", children: [
              h.languageList && h.languageList.length > 0 ? h.languageList.map((N) => {
                const m = typeof N == "string" ? N : N.language || "", T = qr[m], w = T ? Pe[T] : null;
                return /* @__PURE__ */ e(
                  "span",
                  {
