import { d as Dt, a4 as D, a6 as z, be as Mt, n as Ut, aQ as Rt, y as Ot, aG as Pt, b6 as xt, a5 as Nt, a1 as Ft, l as Gt, aO as jt, t as Vt, m as kt, aP as Bt, u as Wt, a as $t, r as Kt, a0 as Yt, aF as Ht, s as Xt, _ as zt, aE as qt, q as Jt, c as Zt, J as Qt, aa as te, ap as ee, aL as ie, aM as se, aY as o, au as re, a3 as ae, z as ne, E as oe, A as N, ab as ce } from "./upload.HR7xdC-w.js";
class le {
  constructor(t = {}) {
...
class mi {
  constructor(t = {}) {
    this.currentLive = null, this.liveList = [], this.hasMore = !0, this.loading = {}, this.error = null, this.onStateChange = t.onStateChange, this.getActive = t.getActive, this.playerRegistry = new le({
  ...
  async fetchLiveDetail(t) {
    ...
    try {
      const [n, c, l] = await Promise.allSettled([
        D(e),
        z(e),
      ...
      if (n.status === "fulfilled")
        ...
        throw n.reason;
      const f = c.status === "fulfilled" ? (a = c.value) == null ? void 0 : a.Response : null;
      return g && l.status === "fulfilled" && l.value && (g.streamInfo = l.value), g && f && (g.stats = this.mergeStatisticData(g, f)), g && (this.liveList.some((C) => C.liveId === g.liveId) ? this.liveList = this.liveList.map(
        (C) => C.liveId === g.liveId ? g : C
      ) : this.liveList = [g, ...this.liveList], this.currentLive = g), this.setLoading(i, !1), this.notifyStateChange({
        liveList: this.liveList,
        currentLive: this.currentLive
      }), g;
    } catch (n) {
      const c = n instanceof Error ? n : new Error(String(n));
      throw this.setError(c), this.setLoading(i, !1), console.error("[LiveMonitorCore] fetchLiveDetail failed:", c), c;
    }
  }
  ...
  async createLive(t) {
    ...
    try {
      ...
      const r = (await Ut(t)).liveId || t.liveId, a = r ? await D(r) : null;
      if (!a)
  ...
  async updateLive(t) {
    ...
    this.setLoading(i, !0), this.setError(null);
    try {
      await Rt(e, t), this.currentLive && (this.currentLive = { ...this.currentLive, ...t }, this.notifyStateChange({ currentLive: this.currentLive })), this.setLoading(i, !1);
    } catch (a) {
  ...
  async endLive(t) {
    ...
    this.setLoading(i, !0), this.setError(null);
    try {
      await Ot(e), this.liveList = this.liveList.filter((a) => a.liveId !== e), this.currentLive && this.currentLive.liveId === e && (this.currentLive = null), this.notifyStateChange({
        liveList: this.liveList,
        currentLive: this.currentLive
      }), this.setLoading(i, !1);
    } catch (a) {
  ...
  mergeStatisticData(t, e) {
    ...
    return e ? {
      ...
      giftAmount: e.TotalGiftCoins || ((c = t.stats) == null ? void 0 : c.giftAmount) || 0,
      giftUserCount: e.TotalUniqueGiftSenders || ((l = t.stats) == null ? void 0 : l.giftUserCount),
      commentCount: e.TotalMsgCount || ((g = t.stats) == null ? void 0 : g.commentCount) || 0,
      totalUniqueCommenters: e.TotalUniqueCommenters || ((f = t.stats) == null ? void 0 : f.totalUniqueCommenters),
      duration: ((I = t.stats) == null ? void 0 : I.duration) || 0
    } : t.stats || {
      liveId: t.liveId,
  ...
  async fetchLiveStats(t) {
    ...
    this.setLoading(r, !0);
    try {
      const n = await z(e), c = n == null ? void 0 : n.Response, l = c ? this.mergeStatisticData(i, c) : i.stats || {
        liveId: e,
        onlineCount: 0,
        viewCount: 0,
        likeCount: 0,
  ...
  async setAllMute(t, e) {
    if (t)
      try {
        await Pt(t, e), this.liveList = this.liveList.map((i) => i.liveId === t ? { ...i, isMuted: e } : i), this.currentLive && this.currentLive.liveId === t && (this.currentLive = { ...this.currentLive, isMuted: e }, this.notifyStateChange({ currentLive: this.currentLive })), this.notifyStateChange({ liveList: this.liveList });
      } catch (i) {
...
function de(s, t = 15e3) {
  return new Promise((e, i) => {
    ...
    a = setTimeout(() => {
      ...
      () => {
        n || (n = !0, c(), i(new Error("SVGA 资源加载失败，请检查 URL 是否正确")));
      }
    );
  });
}
function fe(s, t = 15e3) {
  return new Promise((e, i) => {
    let r = null, a = !1;
    const n = () => {
    ...
    gt().load(
      c,
      () => {
        a || (a = !0, n(), URL.revokeObjectURL(c), e(!0));
      },
      () => {
        a || (a = !0, n(), URL.revokeObjectURL(c), i(new Error("SVGA 文件无效或已损坏")));
      }
    );
  });
}
function q(s, t = 8e3, e = !1) {
  return new Promise((i, r) => {
    ...
    if (ue(s)) {
      ...
      de(s, t > 8e3 ? t : 15e3).then(() => i(!0)).catch(r);
      return;
    }
    ...
    a.onload = () => {
      ...
      c(), r(new Error("图片加载失败，请检查 URL 是否正确"));
    }, n = setTimeout(() => {
      c(), r(new Error("图片加载超时，请检查 URL 是否可访问"));
...
function me(s, t = 1e4) {
  return new Promise((e, i) => {
    ...
    }, t), r.style.display = "none", (c = document.body) == null || c.appendChild(r), r.src = s;
  });
}
function pe(s, t = 15e3) {
  return new Promise((e, i) => {
    var c;
    ...
    }, t), r.style.display = "none", r.muted = !0, (c = document.body) == null || c.appendChild(r), r.src = s, r.load();
  });
}
function Ci(s, t) {
  ...
  return i.includes(s.type) || a && s.type.startsWith("video/") || r.includes(n) ? { valid: !0 } : { valid: !1, errorHint: `只允许上传 ${e.map((g) => g === "image/svg+xml" ? "SVG" : g === "video/mp4" ? "MP4" : g.startsWith(".") ? g.slice(1).toUpperCase() : g.startsWith("image/") ? g.replace("image/", "").toUpperCase() : g).join("/")} 格式的文件` };
}
function vi(s, t) {
  return s.size <= t * 1024 * 1024;
}
async function Si(s, t, e = !1) {
  const r = (t ? t.split(",").map((l) => l.trim()) : ["image/jpeg", "image/png", "image/gif", "image/webp"]).filter((l) => l.startsWith(".")).map((l) => l.toLowerCase()), a = "." + (s.name.split(".").pop() || "").toLowerCase(), n = a === ".svga", c = !n && r.includes(a) && !s.type.startsWith("image/") && !s.type.startsWith("video/");
  if (n)
    e || await fe(s);
  else if (!c) {
    const l = URL.createObjectURL(s);
    try {
      s.type.startsWith("video/") ? await pe(l) : await me(l);
    } finally {
...
class _i {
  ...
  async doUrlConfirm(t, e) {
    ...
    if (i) {
      ...
      const a = (async () => {
        try {
          if (await q(i, 8e3, this.skipSvgaValidation), r) return;
  ...
  async _doValidateForSubmit(t) {
    ...
    try {
      return await q(t, 8e3, this.skipSvgaValidation), e || (this.callbacks.onConfirm(t), this.callbacks.setValidating(!1)), t;
    } catch (i) {
...
function ht(s, t = "image/jpeg", e = 0.92) {
  return new Promise((i, r) => {
    s.toBlob(
      (a) => {
...
async function Ti(s, t, e = "image/jpeg", i = 0.92) {
  const r = new Image();
  r.crossOrigin = "anonymous", await new Promise((c, l) => {
    r.onload = () => c(), r.onerror = l, r.src = s;
  });
...
async function bi(s, t = "image/jpeg", e = 0.92) {
  if (!s)
...
const xi = {
  field: "createTime",
  direction: "descend"
}, Ie = b.liveList, F = "liveList_currentPage", G = "liveList_pageCursors", Ce = 1024;
...
async function ve(s) {
  const { page: t, pageCursors: e, pageSize: i = Ie } = s, r = e.get(t) || "", { list: a, next: n } = await Nt({ next: r, count: i, sortDirection: "descend" }), c = a, l = new Map(e);
...
function Te(s) {
  ...
  try {
    t.setItem(F, String(s.currentPage)), t.setItem(G, JSON.stringify(Array.from(s.pageCursors.entries())));
  } catch {
  }
}
function be(s = sessionStorage) {
  let t = 1, e = U();
  try {
    const i = s.getItem(F), r = s.getItem(G);
    if (s.removeItem(F), s.removeItem(G), i && r) {
      const a = Number(i);
      if (a > 0) {
  ...
  return r.sort((n, c) => {
    ...
    switch (e) {
      ...
      case "viewerCount":
        ...
        break;
      case "duration": {
        const g = n.endedAt ? n.endedAt - n.createdAt : Date.now() / 1e3 - n.createdAt, f = c.endedAt ? c.endedAt - c.createdAt : Date.now() / 1e3 - c.createdAt;
        l = g - f;
        break;
      }
      case "status": {
        const g = n.endedAt ? 1 : 0, f = c.endedAt ? 1 : 0;
        l = g - f;
        break;
      }
      default:
...
class ji {
  ...
  set(t, e, i) {
    ...
    if (this.cache.size >= this.maxPages) {
      const a = (r = Array.from(this.cache.entries()).sort((n, c) => n[1].timestamp - c[1].timestamp)[0]) == null ? void 0 : r[0];
...
class Vi {
  ...
  async fetchGiftList(t) {
    ...
    try {
      const e = await Ft(t == null ? void 0 : t.language);
  ...
  async deleteGiftLanguage(t) {
    this.setLoading("giftLanguage", !0), this.setError(null);
    try {
      await Xt(t.giftId, t.language), this.setLoading("giftLanguage", !1);
    } catch (e) {
      const i = e instanceof Error ? e : new Error(String(e));
      throw this.setLoading("giftLanguage", !1), this.setError(i), i;
    }
  ...
  async setGiftCategoryLanguage(t, e, i, r) {
    this.setLoading("giftCategoryLanguage", !0), this.setError(null);
    try {
      await qt(t, e, i, r), this.setLoading("giftCategoryLanguage", !1);
    } catch (a) {
      const n = a instanceof Error ? a : new Error(String(a));
...
const ki = b.mutedList, Bi = b.bannedList, De = 600, Me = 86400, dt = (s) => Array.isArray(s) ? s.filter((t) => !!t && typeof t == "object") : [], j = (s, ...t) => {
...
async function Wi(s) {
  var i;
  const t = await te(s);
  return dt(((i = t.Response) == null ? void 0 : i.MutedAccountList) || t.MutedAccountList).map((r) => ({
    userId: j(r, "Member_Account", "userId", "UserID"),
    endTime: ft(r, "MutedUntil", "endTime")
  })).filter((r) => r.userId);
}
function $i(s, t) {
...
async function Ki(s) {
  var i;
  const t = await Qt(s);
  return dt(((i = t.Response) == null ? void 0 : i.BannedAccountList) || t.BannedAccountList).map((r) => ({
    userId: j(r, "Member_Account", "userId", "UserID"),
    endTime: ft(r, "BannedUntil", "endTime"),
...
async function Hi(s) {
  const { liveId: t } = s, e = O(s), i = s.muteTime ?? s.duration ?? De;
  await ee(t, e, i);
}
async function Xi(s) {
...
async function zi(s) {
  const { liveId: t, reason: e = "" } = s, i = O(s), r = s.banTime ?? s.duration ?? Me;
  await Zt(t, i, r, e);
}
async function qi(s) {
  const { liveId: t } = s, e = O(s);
...
}, Re = "https://web.sdk.qcloud.com/im/assets/emoji-plugin/", es = (s) => {
  if (!s)
    return [];
  const t = [];
  let e = s;
...
function is(s, t) {
  ...
  if (e <= 7)
    return Array.from({ length: e }, (n, c) => c + 1);
  const r = [], a = (n) => {
...
async function Pe(s) {
  ...
  if ((t == null ? void 0 : t.isUrlInputMode) ?? !0)
    try {
      ...
      throw new V(r, "url-validation", n);
    }
  else if (e && t)
    try {
      return await t.uploadPendingFile() || "";
    } catch (n) {
      throw new V(r, "upload", n);
    }
  else
    return i.trim();
}
async function cs(s) {
  return Promise.all(s.map(Pe));
}
function ls(s, t = "图片") {
  if (s instanceof V)
    return s.message;
...
const Ke = "live_", ys = 43, Es = 100, Ye = "VideoDynamicGrid9Seats", He = 8, M = 9 / 16, yt = 16 / 9, p = {
  maxCount: 10,
  maxKeyBytes: 50,
...
function vs(s) {
  var t;
  return ((t = Je(s)) == null ? void 0 : t.orientation) === "landscape" ? yt : M;
}
function Ss(s) {
...
function _s(s) {
  ...
  for (const r of s) {
    ...
    const n = S(a);
    if (n > p.maxKeyBytes)
      return { type: "key-too-long", key: a, max: p.maxKeyBytes, current: n };
    const c = S(r.value);
    if (c > p.maxValueBytes)
      return { type: "value-too-long", key: a, max: p.maxValueBytes, current: c };
    e += c, t[a] = r.value;
  }
  const i = Object.keys(t).length;
  return i > p.maxCount ? { type: "max-count", max: p.maxCount, current: i } : e > p.maxTotalValueBytes ? { type: "total-value-too-long", max: p.maxTotalValueBytes, current: e } : null;
}
function Ts(s, t) {
...
function bs(s) {
  const { formData: t, coverUrl: e, customInfos: i, useObsStreaming: r } = s, a = Ze(i), n = {
    liveId: ze(t.anchorId),
    anchorId: t.anchorId,
    title: t.liveName,
    seatTemplate: t.seatTemplate
  };
  return e && (n.coverUrl = e), qe(t.seatTemplate) && (n.maxSeatCount = t.maxSeatCount), Object.keys(a).length > 0 && (n.customInfo = a), r && (n.useObsStreaming = !0), n;
}
function Qe(s) {
  if (!s) return [];
  if (typeof s == "string")
    try {
      return Qe(JSON.parse(s));
    } catch {
      return [];
    }
...
function It(s) {
  const t = s.roomIdText ?? s.liveIdText ?? "", {
    ...
    minVisibleTags: l = 2,
    maxVisibleTags: g = 99
  } = s, I = P("live-id-badge", t), C = r + I, K = e - a, v = i.map(
    (h) => P("live-card-tag-overlay", h)
  ), w = P("live-card-tag-overlay live-card-tag-more", "...");
  let L = 0, m = 0;
  for (let h = 0; h < v.length; h++) {
    const u = v[h], Y = v.length - h - 1, bt = Y > 0 ? w : 0, H = m > 0 ? n : 0, wt = L + H + u + (Y > 0 ? n + bt : 0), X = K - wt, At = Math.max(60, X - r - c);
    if (I > At || X < C + c)
      break;
    L += H + u, m++;
  }
  if (v.length - m > 0 && (L += n + w), i.length >= l && m < l) {
    let h = 0;
    for (let u = 0; u < l; u++)
      h += (u > 0 ? n : 0) + v[u];
    i.length > l && (h += n + w), m = l, L = h;
  }
  if (m > g) {
    m = g;
    let h = 0;
    for (let u = 0; u < g; u++)
      h += (u > 0 ? n : 0) + v[u];
    i.length > g && (h += n + w), L = h;
  }
  const _t = K - L, Tt = Math.max(
    60,
    _t - r - c
  );
  return {
...
function vt(s) {
  const t = Object.entries(d).find(([e, i]) => i.code === s);
  return t ? t[0] : void 0;
}
function Xs(s) {
  const t = vt(s);
  return t ? d[t].label : s;
}
function zs(s) {
...
function st(s) {
  ...
  return t.forEach((r) => {
    ...
    const a = N(r.languageList, "name", "description"), n = (r.categoryIds || []).map((c) => e.get(String(c)) || c);
    return {
      ...r,
      name: (a == null ? void 0 : a.name) || r.defaultName || r.name,
      description: (a == null ? void 0 : a.description) || r.defaultDescription || r.description,
...
const qs = 10, Js = 20, Zs = 20, Qs = 60, W = "gift_categories_cache";
function ni(s) {
  return s.map((t) => {
...
class sr {
  ...
  setPreview(t) {
    ...
    const e = ye(this.currentUrl || void 0, t);
   ...
   */
  clearPreview() {
    this.currentUrl && (ut(this.currentUrl), this.currentUrl = "");
  }
  /**
...
function rr(s) {
  const t = [
    { key: "liveId", i18nKey: o.LIVE_ID, className: "col-id", minWidth: 80, maxWidth: y.LIVE_ID_MAX_WIDTH, fitContent: !0, flexible: !0 },
    { key: "liveName", i18nKey: o.LIVE_TITLE, className: "col-title", minWidth: 120, maxWidth: y.LIVE_TITLE_MAX_WIDTH, fitContent: !0, flexible: !0, ellipsis: !0 },
    { key: "coverUrl", i18nKey: o.COVER_IMAGE, className: "col-cover", width: y.COVER_WIDTH },
    { key: "anchor", i18nKey: o.ANCHOR_ID, className: "col-anchor", minWidth: 80, maxWidth: y.ANCHOR_ID_MAX_WIDTH, fitContent: !0, flexible: !0 },
    { key: "createdAt", i18nKey: o.CREATE_TIME, className: "live-list-col-time", width: y.CREATED_AT_WIDTH }
  ];
  return s.hasExtraColumn && t.push({ key: "customer-extra", className: "live-list-col-customer-extra", width: y.EXTRA_COLUMN_WIDTH }), t.push({ key: "actions", i18nKey: o.ACTIONS, className: "live-list-col-action", maxWidth: y.ACTIONS_MAX_WIDTH, fitContent: !0 }), t;
}
function ar(s) {
  const { live: t, icons: e, t: i, onEnter: r, onDetail: a, onEdit: n, onDelete: c } = s;
  return [
    { key: "enter", label: i(o.ENTER_LIVE), title: i(o.ENTER_LIVE), icon: e.enter, onClick: () => r(t.liveId) },
    { key: "detail", label: i(o.LIVE_DETAILS), title: i(o.LIVE_DETAILS), icon: e.detail, onClick: () => a(t) },
    { key: "edit", label: i(o.EDIT), title: i(o.EDIT), icon: e.edit, onClick: () => n(t) },
    { key: "delete", label: i(o.DISSOLVE), title: i(o.DISSOLVE), icon: e.delete, danger: !0, onClick: () => c(t) }
  ];
}
...
class nr {
  constructor(t) {
    this.opts = t, this.state = {
      ...
      editingLive: null
    }, this.listeners = /* @__PURE__ */ new Set(), this.pageCursors = U(), this.destroyed = !1, this.getState = () => this.state, this.subscribe = (e) => (this.listeners.add(e), () => {
  ...
  async loadPage(t) {
    ...
    try {
      ...
      e instanceof J ? this.opts.toast.error(Z(e.errorCode, e.errorInfo, i)) : this.opts.toast.error(i);
    } finally {
  ...
  isSearchInputTooLong() {
    return we(this.state.searchInput, Ce);
  }
  async search() {
    ...
    if (t) {
      ...
      try {
        ...
        e ? (this.setState({
          ...
          currentPage: 1,
          hasMoreData: !1
        }), this.opts.toast.success(this.opts.t(o.SEARCH_SUCCESS))) : this.opts.toast.error(this.opts.t(o.LIVE_NOT_FOUND));
      } catch (e) {
        if (console.error("搜索直播失败:", e), e instanceof J)
          this.opts.toast.error(Z(
            e.errorCode,
            e.errorInfo,
            this.opts.t(o.LIVE_NOT_FOUND)
          ));
        else {
          const i = (e == null ? void 0 : e.message) || this.opts.t(o.NETWORK_ERROR);
  ...
  async clearSearch() {
    this.pageCursors = U(), this.setState({
      searchInput: "",
      currentPage: 1,
      hasMoreData: !0
  ...
  async showDetail(t) {
    ...
    const { snapshot: e, toastError: i } = await gi(t, this.opts.t);
  ...
  async confirmDelete() {
    ...
    if (t)
      try {
        await this.opts.endLive(t), this.opts.toast.success(this.opts.t(o.DISSOLVE_SUCCESS));
        const e = _e({
          currentPage: this.state.currentPage,
          hasMoreData: this.state.hasMoreData,
        ...
        console.error("解散直播失败:", e), this.opts.toast.error(this.opts.t(o.DISSOLVE_FAILED));
      } finally {
...
class or {
  ...
  async fetchGiftList() {
    ...
    try {
      ...
      console.error(this.opts.t(o.GET_GIFT_LIST_FAILED), t);
  ...
  async copyGiftId(t) {
    await $(String(t || "")), this.opts.toast.success(this.opts.t(o.COPY_LABEL_COPIED, { label: this.opts.t(o.GIFT_ID) }));
  }
      ...
      try {
        ...
        for (const c of a)
          if (c.status === "fulfilled") {
            const { langKey: l, result: g } = c.value;
            n[l] = { name: g.name || "", description: g.description || "" };
          }
  ...
  async clearLang(t, e) {
    try {
      await this.opts.actions.deleteGiftLanguage({ giftId: t, language: d[e].code }), this.opts.toast.success(this.opts.t(o.LANGUAGE_CONFIG_CLEARED)), this.setState({
        giftLangConfig: {
          ...this.state.giftLangConfig,
          [e]: { name: "", description: "" }
        }
  ...
  extractErrorInfo(t) {
    const e = t;
    return (e == null ? void 0 : e.ErrorInfo) || (e == null ? void 0 : e.message) || this.opts.t(o.UNKNOWN_HOST);
  }
  formatError(t, e) {
    const i = t;
...
class cr {
  ...
  async openLangEditDialog(t, e) {
    var c;
    const i = this.state.categoryList.find((l) => l.id === t), r = d[e].code, a = (c = i == null ? void 0 : i.languageList) == null ? void 0 : c.find((l) => x(l).langCode === r);
    let n = { ...ct };
    if (a) {
      const l = x(a);
      if (l.name || l.description)
        ...
        try {
          const g = await this.opts.actions.getGiftCategoryLanguage(t, r);
          n = { name: g.name || "", description: g.description || "" };
        } catch {
        }
    }
    this.setState({
  ...
  async clearLang(t, e) {
    try {
      await this.opts.actions.deleteGiftCategoryLanguage(t, d[e].code), this.opts.toast.success(this.opts.t(o.LANGUAGE_CONFIG_CLEARED)), this.setState({
        categoryLangConfig: {
          ...this.state.categoryLangConfig,
          [e]: { name: "", description: "" }
        }
