...
import { w as Wo, aE as Ho, aG as Yo, c2 as jo, cq as Xo, cr as Ko, u as qo, m as Zo, a9 as Qo, a2 as Jo, b1 as es, bc as ts, aT as te, N as bi, a_ as is, c1 as ns, b as as, b8 as os, bS as dn, bT as hn, _ as ss, bj as Ra, bn as ls, a1 as rs, bD as Kn, cl as cs, cf as qn, bM as Zn, bF as us, cj as ds, ci as hs, ch as vs, bN as ms, ax as fs, bC as gs, bE as ps, aD as bs, a0 as ys, ar as Qn, bi as Es, aU as _s, A as Wt, O as bt, i as Ke, bs as ti, ap as La, bU as xa, x as Vi, a4 as ws, c5 as Cs, as as Jn, Z as ea, aB as Is, ay as ta, cg as As, aj as Ms, aW as Ts, R as Ss, aX as Na, b6 as Rs, bv as ia, aM as Ls, a6 as xs, a as Ot, bL as Ns, bg as xi, c0 as ks, a8 as Ds, bw as Os, aH as Us, aQ as $s, bO as na, by as aa, aZ as gt, k as Ps, D as Fs, v as Vs, bu as oa, s as sa, aP as zs, b4 as ka, b2 as ii, b5 as Da, q as Ht, r as Je, o as et, p as hi, z as Oa, F as Ut, bV as Gs, t as Bs, T as nn, d as vi, f as st, C as lt, S as Ws, aF as Hs } from "./main-layout.WBxy2WWr.js";
import { c as Ys, s as vn, D as js, a as Xs, m as Ks, b as qs, d as Zs, e as Qs, P as Js } from "./gift-category.qmtjx5qb.js";
import { I as r, G as an, H as Rn, z as el, E as tl, B as il, g as Yi, ae as nl, W as oi, T as Ua, n as al } from "./en-US.CSjM9toh.js";
...
const Tr = { class: "image-upload-container" }, Sr = {
  ...
  props: {
    ...
    fitContentMaxRows: { type: Number, default: js }
  },
  setup(e) {
    function n() {
    ...
    const R = (L) => L.fitContent || i.fitContent && L.width === void 0, M = (L) => typeof L == "number" ? `${L}px` : L, T = (L) => {
      ...
      const F = ((S = l.value) == null ? void 0 : S.clientWidth) ?? 0, N = Zs(
        i.columns,
        L,
        F,
        R
      );
      Qs(u.value, N) || (u.value = N);
    }, le = () => {
      q(), Q();
    }, he = () => {
...
const Wh = { class: "live-control-container" }, Hh = { class: "live-control-viewport" }, Yh = { class: "right-sidebar" }, Ri = 20, jh = /* @__PURE__ */ Te({
  ...
  setup(e) {
    ...
    const ze = I([]), ne = I(1), ve = O, Oe = I(0), x = I([]), J = P(
      ...
      if (!ve.value && s.value)
        try {
          ...
          const Fe = await Us(he.value), Ci = await $s();
    ...
    const en = P(
      ...
      s.value && (aa(_, en.value) || (z ? (confirmDialogTitle.value = a(r.CONFIRM_UNMUTE_USER), confirmDialogContent.value = a("Unmute Confirm", { name: A }), confirmAction.value = async () => {
        ...
        try {
          await F(_, Ps), Pe("success", a("Muted Success", { name: A })), ui();
        } catch (H) {
          const { code: Z, info: ge } = xt(H), we = H instanceof Error ? H : new Error(String(H)), Fe = Z ? gt(Z, ge) : we.message || a(r.UNKNOWN_HOST);
      ...
      s.value && (aa(_, en.value) || (z ? (confirmDialogTitle.value = a(r.CONFIRM_UNBAN_USER), confirmDialogContent.value = a("Unban Confirm", { name: A }), confirmAction.value = async () => {
        ...
        try {
          await S(_, Fs), Pe("success", a("Banned Success", { name: A })), di();
        } catch (H) {
          const { code: Z, info: ge } = xt(H), we = H instanceof Error ? H : new Error(String(H)), Fe = Z ? gt(Z, ge) : we.message || a(r.UNKNOWN_HOST);
  ...
  setup(e) {
    const n = _i(), { t: i } = ke(), s = Fa(), o = new Bs({
      actions: {
