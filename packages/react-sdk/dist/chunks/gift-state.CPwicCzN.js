import { ar as h, as as f, at as g } from "./layout.BIfRE2CE.js";
import { s as l } from "./main-layout.mc55E2SN.js";
import { n as L, h as c } from "./logger.h-0kjLdM.js";
const C = 500;
function G(e, t, a = {}) {
  const i = a.ttl ?? C, n = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
  return async (...d) => {
...
const w = () => "gift_" + Date.now() + "_" + Math.random().toString(36).substr(2, 9), I = (e, t, a) => {
...
async function D(e) {
  ...
  if (t && t.ErrorCode === 0 && t.Response) {
    const a = t.Response.GiftList || [], i = t.Response.CategoryList || [], { giftToCategories: n, giftToCategoryIds: o } = m(i), d = a.map((r) => I(r, n, o)), s = i.map((r) => p(r));
    return {
      gifts: d,
...
class B {
  constructor(t = {}) {
    this.giftList = [], this.giftCategoryList = [], this.loading = {}, this.error = null, this.destroyed = !1, this.state$ = l(), this.destroy$ = l(), this.onStateChange = t.onStateChange, this.deduplicatedFetchGiftList = G(
  ...
  async _fetchGiftListRaw(t) {
    ...
    return this.giftList = i, this.giftCategoryList = a.categories || [], L("gift_manage"), this.notifyStateChange(), {
      giftList: i,
  ...
  async deleteGift(t) {
    try {
      ...
      throw c("gift_manage", "delete", !1), a;
    }
  }
  // ========= 礼物分类操作 =========
  ...
  async deleteGiftCategory(t) {
    try {
      ...
      throw c("gift_manage", "delete_category", !1), a;
    }
  }
  // ========= 礼物-分类关联操作 =========
  ...
  async setGiftLanguage(t) {
    await this.withLoading(
      "giftLanguage",
      () => S(t.giftId, t.language, t.name, t.description)
    );
  }
  async deleteGiftLanguage(t) {
    await this.withLoading(
      "giftLanguage",
      () => v(t.giftId, t.language)
    );
  }
  // ========= 礼物分类多语言操作 =========
