...
import { forwardRef as dt, useRef as X, useState as S, useImperativeHandle as ft, useEffect as j, useCallback as ye } from "react";
import { v as vt, c as mt } from "./logger.DCFRj533.js";
...
import { I as y } from "./layout.DppKPdLU.js";
import { g as le, bo as We, by as Et, bn as St, ax as Dt, bx as Pt, bq as xt } from "./main-layout.BqLTYqar.js";
import { i as At, g as bt } from "./svga.DC02l1-t.js";
import { U as zt, u as Ve, k as It, i as Mt, h as Nt, v as Ut, g as Lt } from "./upload.Ne4Xd5tE.js";
import { s as Ke } from "./svga.min.Zof6g_Kl.js";
import { M as Y } from "./useAsyncAction.Ce9HnFRp.js";
import { u as Ot } from "./usePreviewUrl.BmEz0uTc.js";
import { u as Tt } from "./useSvgaPlayer.xaOB2im4.js";
var Pe = function(a, r) {
...
function Wt() {
  if (Ze) return Re;
  Ze = 1;
  var a = !1, r, e, t, o, i, n, s, c, l, p, m, h, g, P, w;
  function C() {
    if (!a) {
      a = !0;
      ...
      if (h = /\b(iPhone|iP[ao]d)/.exec(_), g = /\b(iP[ao]d)/.exec(_), p = /Android/i.exec(_), P = /FBAN\/\w+;/i.exec(_), w = /Mobile/i.exec(_), m = !!/Win64/.exec(_), R) {
...
function oe(a, r, e, t, o) {
  ...
  return {
    x: qe(a.x, n, e.width, t),
    y: qe(a.y, s, e.height, t)
  };
}
function qe(a, r, e, t) {
...
function Yt(a, r, e, t, o, i, n) {
  ...
  }, m = Math.round(s(l.width, p.width * l.width / 100)), h = Math.round(s(l.height, p.height * l.height / 100)), g = l.width >= l.height * t, P = g ? {
    width: Math.round(h * t),
    height: h
  } : {
    width: m,
    height: Math.round(m / t)
  }, w = D(D({}, P), {
  ...
  (function(a) {
    ...
    function r() {
      ...
      return e.cropperRef = k.createRef(), e.imageRef = k.createRef(), e.videoRef = k.createRef(), e.containerPosition = {
        ...
        if (l && e.containerRef) {
          ...
          var p = e.containerRect.width / e.containerRect.height, m = ((t = e.imageRef.current) === null || t === void 0 ? void 0 : t.naturalWidth) || ((o = e.videoRef.current) === null || o === void 0 ? void 0 : o.videoWidth) || 0, h = ((i = e.imageRef.current) === null || i === void 0 ? void 0 : i.naturalHeight) || ((n = e.videoRef.current) === null || n === void 0 ? void 0 : n.videoHeight) || 0, g = l.offsetWidth < m || l.offsetHeight < h, P = m / h, w = void 0;
          if (g)
          ...
          var C = e.props.cropSize ? e.props.cropSize : qt(e.mediaSize.width, e.mediaSize.height, e.containerRect.width, e.containerRect.height, e.props.aspect, e.props.rotation);
        ...
        if (!(!e.state.cropSize || !e.props.onZoomChange)) {
          ...
          if (c) {
            var p = e.getPointOnContainer(o, e.containerPosition), m = e.getPointOnMedia(p), h = {
              x: m.x * l - p.x,
              y: m.y * l - p.y
        ...
        var o, i, n = e.props, s = n.crop, c = n.onCropChange, l = n.keyboardStep, p = n.zoom, m = n.rotation, h = l;
        if (e.state.cropSize) {
          t.shiftKey && (h *= 0.2);
          var g = D({}, s);
          switch (t.key) {
          ...
          e.props.restrictPosition && (g = oe(g, e.mediaSize, e.state.cropSize, p, m)), t.repeat || (i = (o = e.props).onInteractionStart) === null || i === void 0 || i.call(o), c(g);
        }
    ...
    return r.prototype.componentDidMount = function() {
      ...
      e.rotation !== this.props.rotation ? (this.computeSizes(), this.recomputeCropPosition()) : e.aspect !== this.props.aspect ? this.computeSizes() : e.objectFit !== this.props.objectFit ? this.computeSizes() : e.zoom !== this.props.zoom ? this.recomputeCropPosition() : ((t = e.cropSize) === null || t === void 0 ? void 0 : t.height) !== ((o = this.props.cropSize) === null || o === void 0 ? void 0 : o.height) || ((i = e.cropSize) === null || i === void 0 ? void 0 : i.width) !== ((n = this.props.cropSize) === null || n === void 0 ? void 0 : n.width) ? this.computeSizes() : (((s = e.crop) === null || s === void 0 ? void 0 : s.x) !== ((c = this.props.crop) === null || c === void 0 ? void 0 : c.x) || ((l = e.crop) === null || l === void 0 ? void 0 : l.y) !== ((p = this.props.crop) === null || p === void 0 ? void 0 : p.y)) && this.emitCropAreaChange(), e.zoomWithScroll !== this.props.zoomWithScroll && this.containerRef && (this.props.zoomWithScroll ? this.containerRef.addEventListener("wheel", this.onWheel, {
        passive: !1
      }) : this.clearScrollEvent()), e.video !== this.props.video && ((m = this.videoRef.current) === null || m === void 0 || m.load());
      ...
      this.lastPinchDistance = Xe(t, o), this.lastPinchRotation = Ye(t, o), this.onDragStart($e(t, o));
      ...
      return k.createElement("div", {
        ...
        ref: this.imageRef,
        style: D(D({}, H), {
          transform: l || "translate(".concat(m, "px, ").concat(h, "px) rotate(").concat(g, "deg) scale(").concat(P, ")")
        }),
...
const _r = dt(function({
  ...
  const { t: f } = _t(), de = s || f(y.CLICK_OR_DRAG_TO_UPLOAD_IMAGE), J = X(null), [N, b] = S(!1), [L, O] = S(0), [Be, Q] = S(!1), [fe, ne] = S(""), [x, q] = S(!h), [z, ie] = S(r), [ve, G] = S(!1), [V, T] = S(""), A = X(null);
  ...
  const $ = X(null), { previewUrl: Z, setPreview: K } = Ot(), [Je, me] = S(!1), [ge, ae] = S(!1), {
    containerRef: Qe,
    playUrl: xe,
    stopAnimation: ar
  ...
  ft(H, () => ({
    ...
    reset: () => {
      A.current.reset(), $.current = null, K(null), me(!1), ae(!1), ie(r || ""), ne(""), T(""), b(!1), O(0), Q(!1), h && q(!!r), _?.(null);
    },
    ...
    uploadPendingFile: async () => {
      ...
      b(!0), O(0), Q(!1);
      try {
        const v = await Ve(u, t, O);
        return $.current = null, ne(v.provider || ""), Q(!1), v.url;
      } catch (v) {
        throw Q(!0), v;
      } finally {
        b(!1), O(0);
  ...
  }), [t, x, ve, V, z, Z, r, w, e, f]), j(() => {
    ie(r), r && h && q(!0), M && ($.current = null, K(null), ae(!1), _?.(null));
  }, [r]), j(() => {
    h && r ? q(!0) : h && q(!1);
  }, [h]), j(() => {
    if (!U) return;
  ...
  j(() => {
    ...
    const u = we.current, v = new Ke.Player(u);
    v.loops = 0, v.setContentMode("AspectFit"), F.current = v;
    const E = bt();
    if (E)
      return E.load(
        r,
        (W) => {
          v.setVideoItem(W), v.startAnimation();
        },
        (W) => {
  ...
  const [et, ee] = S(!1), [te, be] = S(""), [tt, ze] = S({ x: 0, y: 0 }), [rt, Ie] = S(1), [Me, Ne] = S(null), [sr, ot] = S(null), [Ue, Le] = S(!1), nt = ye((u, v) => {
    Ne(v);
  }, []), [it, Oe] = S(!1), re = X(null);
  j(() => () => {
  ...
  const Ce = ye(async (u) => {
    ...
    if (M) {
      $.current = u, K(u);
      const v = u.type.startsWith("video/"), E = St(u);
      me(v), ae(E), _?.(u);
      return;
    }
    b(!0), O(0);
    try {
      const v = await Ve(u, t, O);
      e(v.url), ne(v.provider || ""), Y.success(f(y.UPLOAD_SUCCESS));
    } catch (v) {
    ...
    u?.stopPropagation(), A.current.cancelValidation(), G(!1), T(""), e(""), ie(""), ne(""), b(!1), O(0), Q(!1), M && ($.current = null, K(null), me(!1), ae(!1), _?.(null));
  };
  return /* @__PURE__ */ I("div", { className: `image-upload-container ${C}`, children: [
    h && l && /* @__PURE__ */ I("div", { className: "image-upload-mode-switch", children: [
      /* @__PURE__ */ d(
        ce,
        {
          ...
          onClick: () => {
            A.current.cancelValidation(), G(!1), T(""), q(!1);
          },
      ...
      /* @__PURE__ */ d(
        ce,
        {
          ...
          className: `mode-switch-btn ${x ? "active" : ""}`,
          onClick: () => {
            A.current.cancelValidation(), G(!1), T(""), q(!0);
          },
    ...
    (x || !h) && /* @__PURE__ */ d("div", { className: "image-upload-url-input", children: /* @__PURE__ */ d(
      yt,
      {
        ...
        suffix: w ? ve ? /* @__PURE__ */ d("span", { className: "input-suffix-validating", children: f(y.VALIDATING) }) : /* @__PURE__ */ I("span", { className: `input-suffix-count${le(z) > w ? " byte-overflow" : ""}`, children: [
          le(z),
          "/",
          w
        ] }) : void 0
