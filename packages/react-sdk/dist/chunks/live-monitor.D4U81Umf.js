import { ref as C, onUnmounted as tt, defineComponent as Se, resolveComponent as ee, openBlock as y, createElementBlock as w, createElementVNode as c, toDisplayString as v, unref as t, createVNode as g, withCtx as E, createTextVNode as B, computed as P, watch as xe, normalizeClass as we, onMounted as At, onBeforeUnmount as Ei, normalizeStyle as Ge, Fragment as Ee, renderList as ke, createCommentVNode as ue, createBlock as ne, withModifiers as gi, nextTick as Je, inject as Lo, renderSlot as ht, resolveDynamicComponent as ai, withDirectives as pi, vShow as Di, mergeProps as _n, createSlots as Ea, onErrorCaptured as xo, normalizeProps as No, shallowRef as Oi, h as Zt, vModelText as ko, Teleport as wn, reactive as Ui, isRef as Bn } from "vue";
import { useRouter as _i, useRoute as Do } from "vue-router";
import { SearchIcon as Cn, RefreshIcon as In, FullscreenIcon as _a, CloseIcon as Wi, SoundMuteIcon as Oo, SoundIcon as Uo, NotificationIcon as wa, StopCircleIcon as Ca, UploadIcon as Wn, ImageIcon as $o, CutIcon as Fo, ChevronDownIcon as $i, ChevronRightIcon as Ia, AddIcon as An, CopyIcon as Dt, DeleteIcon as Po, EditIcon as Fi, InfoCircleIcon as Nt, LoginIcon as Vo, CheckCircleIcon as Hi, ChatOffIcon as Aa, UserCheckedIcon as Ma, UserBlockedIcon as Sa, MoreIcon as zo, CloseCircleIcon as Go, AdjustmentIcon as Bo } from "tdesign-icons-vue-next";
import { MessagePlugin as j, Tooltip as Ct } from "tdesign-vue-next";
import { useUIKit as De, i18next as Pi } from "@tencentcloud/uikit-base-component-vue3";
import { s as Wo, av as Ho, ax as Yo, aG as Q, H as bi, aM as jo, b as Xo, W as Ko, aZ as Ta, a$ as qo, Z as Zo, be as Hn, bL as Qo, bl as Yn, bg as Jo, bJ as es, bI as ts, bH as is, bm as ns, ap as as, bd as os, bf as ss, au as ls, Y as rs, aj as jn, aY as cs, aH as us, A as Wt, J as bt, g as Ke, b4 as ti, ah as Ra, bs as La, t as Vi, $ as ds, ak as Xn, V as Kn, as as hs, aq as qn, bG as vs, ac as ms, aJ as fs, N as gs, aT as ps, b7 as Zn, aC as bs, a1 as ys, a as Ot, bk as Es, aW as xi, a3 as _s, br as Qn, bq as Jn, b9 as ea, aL as gt, i as ws, D as Cs, r as Is, b6 as ta, p as ia, aF as As, aR as xa, aP as ii, aS as Na, n as Ht, o as Ze, l as Qe, m as hi, v as ka, w as Ut, bt as Ms, q as Ss, P as nn, d as vi, e as ot, C as st, O as Ts, aw as Rs } from "./main-layout.Dw3RNEcP.js";
import { c as Ls, s as dn, D as xs, a as Ns, m as ks, b as Ds, d as Os, e as Us, P as $s } from "./gift-category.zxl1tGwe.js";
import { b9 as Fs, aL as Ps, c as Vs, aM as zs, ap as Gs, e as Bs, b as Ws, a3 as Hs, aT as Ys, aY as r, b2 as an, b3 as Mn, b8 as js, b5 as Xs, i as Ks, h as qs, D as Yi, k as Zs, aR as na, X as oi, aI as Qs, W as Da, aA as Js, Q as Oa, ax as el, z as tl, E as il, au as aa } from "./upload.HR7xdC-w.js";
...
function cl(e) {
  ...
  return {
    ...
    unbanMember: async (W) => {
      ...
      h.value = !0, m.value = null;
      try {
        await Ps(n, W.memberAccounts), await q();
      } catch (O) {
    ...
    sendViolationWarning: async () => {
      if (!n) throw new Error("liveId is required");
      try {
        return await Fs(n, "default", "您的内容涉嫌违规");
      } catch (W) {
...
const ul = { class: "monitor-header" }, dl = { class: "monitor-title-section" }, hl = { class: "monitor-title" }, vl = { class: "monitor-header-actions" }, ml = /* @__PURE__ */ Se({
...
}, Cl = { class: "live-card-tag-dropdown" }, Il = { class: "overlay-btn primary" }, Al = { class: "live-card-info" }, Ml = ["title"], Sl = { class: "live-card-meta" }, Tl = { class: "live-card-anchor" }, Rl = ["title"], Ll = ["title"], xl = /* @__PURE__ */ Se({
  __name: "LiveCard",
  props: {
    card: {},
    adaptiveResult: {},
  ...
  setup(e, { emit: n }) {
    const i = e, s = n, { t: o } = De(), { startPlay: a, stopPlay: l } = Ft(), d = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__, u = C(!1), p = C("");
    let f = 0;
    const h = P(() => i.isFullscreen && i.fullscreenLiveId === i.card.liveId), m = P(() => i.card.tags.slice(0, i.adaptiveResult.visibleCount)), b = P(() => i.card.tags.slice(i.adaptiveResult.visibleCount)), R = P(() => {
      var O;
      return ((O = i.card.stats) == null ? void 0 : O.viewCount) ?? 0;
    }), S = P(() => `live_monitor_view_${i.card.liveId}`), M = async () => {
      ...
      try {
        console.log("[LiveCard] Calling startPlay", { liveId: O, containerId: S.value }), await a({ liveId: O, containerId: S.value }), D === f && (p.value = O, console.log("[LiveCard] startPlay success", { liveId: O }));
      } catch (N) {
      ...
      return y(), w("div", {
        ...
        c("div", {
          ...
          e.card.tags && e.card.tags.length > 0 ? (y(), w("div", {
            ...
            (y(!0), w(Ee, null, ke(m.value, (L) => (y(), w("span", {
              key: L,
            ...
            e.adaptiveResult.showMore ? (y(), w("div", wl, [
              ...
              c("div", Cl, [
                (y(!0), w(Ee, null, ke(b.value, (L) => (y(), w("span", {
                  key: L,
                  class: "live-card-tag-overlay"
                }, [
                  D[1] || (D[1] = c("svg", {
...
}), Nl = { class: "live-monitor-pagination" }, kl = { class: "page-info" }, Dl = /* @__PURE__ */ Se({
  ...
  setup(e, { emit: n }) {
    const i = e, s = n, { t: o } = De(), a = P(() => o(r.PAGE, { page: i.currentPage })), l = () => s("goToFirstPage"), d = () => s("prevPage"), u = () => s("nextPage");
    return (p, f) => {
      const h = ee("t-button");
      return y(), w("div", Nl, [
        g(h, {
...
function $l(e, n) {
  ...
  const m = C(/* @__PURE__ */ new Set()), b = C(!1), R = () => {
    ...
    return U;
  }, M = (T) => String(T.liveId || T.id || T.RoomId || ""), Z = () => {
    const T = /* @__PURE__ */ new Date(), U = new Date(T.getTime() - 3600 * 1e3), k = (x) => {
      const A = x.getFullYear(), ie = String(x.getMonth() + 1).padStart(2, "0"), he = String(x.getDate()).padStart(2, "0"), ve = String(x.getHours()).padStart(2, "0"), ae = String(x.getMinutes()).padStart(2, "0"), $ = String(x.getSeconds()).padStart(2, "0");
      return `${A}-${ie}-${he} ${ve}:${ae}:${$}`;
    };
    return {
      startTime: k(U),
      endTime: k(T)
    ...
    const k = Array.from(new Set(T.slice(0, 8).map((x) => x.liveId).filter(Boolean)));
  ...
  xe(
    () => [...e.pageData.value || []].map((T) => [T.liveId, T.liveName, T.activityStatus].join(":")).join("|"),
    (T, U) => {
      if (!T || b.value || d.value) return;
      const k = e.pageData.value || [];
      if (k.length === 0) return;
      const x = `${e.currentPage.value}:${T}`;
      V(k, x);
    }
  ), xe(
    () => {
      var T;
      return [e.loading.value, (T = e.pageData.value) == null ? void 0 : T.length];
    },
    ([T, U]) => {
      T || (o.value = (U || 0) > 0);
    },
  ...
  const q = async (T, U, k) => {
    !U && k <= 1 && T > 1 ? await e.prevPage() : await e.refreshCurrentPage();
  }, H = async () => {
    const T = Array.from(m.value);
    m.value.clear(), T.length > 0 && await Promise.all(
      T.map(
        (U) => s(U).catch((k) => {
    ...
    const T = e.pageData.value || [];
    m.value = new Set(T.map((U) => U.liveId));
  }, oe = async () => {
    ...
    R(), a.value = !0;
    try {
      const { fetchLiveDetail: A } = Ft(), ie = await A(k);
      if (b.value) return;
      if (!ie) {
    ...
    if (!(l.value || e.loading.value)) {
      ...
      try {
        ...
        console.error("刷新失败:", T);
        const U = T, k = U.ErrorInfo || U.errorInfo || "";
        j.error(`${i(r.REFRESH_FAILED)}${k ? ` (${k})` : ""}`);
      } finally {
        b.value || (l.value = !1);
      }
    }
  }, D = P(() => e.currentPage.value), N = P(() => e.hasMore.value), L = P(() => e.loading.value);
  return tt(() => {
    b.value = !0, R(), H();
  }), {
    // 分页状态（响应式 computed）
...
const Fl = { class: "live-monitor-page" }, Pl = { class: "live-monitor-grid" }, Vl = {
  key: 0,
  class: "monitor-loading"
}, zl = {
  key: 1,
  class: "monitor-empty"
}, Gl = { class: "empty-icon" }, Bl = /* @__PURE__ */ Se({
  __name: "live-monitor",
  setup(e) {
    var ge;
    const n = _i(), { t: i } = De();
    ...
    return u && xe(() => u.value, (le) => {
      le && d.goToFirstPage();
    }), At(() => {
      document.addEventListener("fullscreenchange", Xe), M(), V(ve.value || []), pe();
    }), tt(() => {
      ...
      return y(), w("div", Fl, [
        ...
        c("div", Pl, [
          ...
          ])) : t(oe) ? (y(!0), w(Ee, { key: 2 }, ke(ve.value, (Re) => {
            var mt, at;
            return y(), ne(xl, {
              key: `${m.value}:${Re.liveId}`,
              card: Re,
              "adaptive-result": t(S)(Re.liveId),
...
}), mm = /* @__PURE__ */ ci(Bl, [["__scopeId", "data-v-b18dc1d7"]]);
function oa(e, n) {
  var i = Object.keys(e);
...
}, sa(Ii = { path: Hl, exports: {}, require: function(e, n) {
  return (function() {
...
var fi = function(e, n) {
  ...
  if (this.touches.length) {
    if (this.touches.length === 1 && i.length === 1) {
      ...
      this.$emit("drag", new jl(e, s, { left: i[0].clientX, top: i[0].clientY }, { left: this.touches[0].clientX, top: this.touches[0].clientY }, this.anchor));
    }
    this.touches = i;
  }
}, processEnd: function() {
...
var sn = vt("vue-handler-wrapper"), Wa = { name: "HandlerWrapper", components: { DraggableElement: Tn }, props: { horizontalPosition: { type: String }, verticalPosition: { type: String }, disabled: { type: Boolean, default: !1 } }, computed: { classes: function() {
  var e;
...
var Xl = vt("vue-line-wrapper"), Ha = { name: "LineWrapper", components: { DraggableElement: Tn }, props: { position: { type: String, required: !0 }, disabled: { type: Boolean, default: !1 } }, computed: { classname: function() {
  var e;
  return Xl((lt(e = {}, this.position, !0), lt(e, "disabled", this.disabled), e));
} }, emits: ["leave", "enter", "drag", "drag-end"] };
...
var yt = ["left", "right", "top", "bottom"], Kl = ["left", "right"], ql = ["top", "bottom"], Zl = ["left", "top"], Ql = ["fill-area", "fit-area", "stencil", "none"], ca = { left: 0, top: 0, width: 0, height: 0 };
function ua(e, n, i) {
...
function rr(e) {
  ...
  var S = { stencil: { minimum: Math.max(o.minWidth ? o.minWidth / h.width : 0, o.minHeight ? o.minHeight / h.height : 0), maximum: Math.min(o.maxWidth ? o.maxWidth / h.width : 1 / 0, o.maxHeight ? o.maxHeight / h.height : 1 / 0, li(h, l)) }, area: { maximum: li(f, a({ visibleArea: f, type: "resize" })) } };
  u.factor && R && (u.factor < 1 ? (b = Math.max(u.factor, S.stencil.minimum)) > 1 && (b = 1) : u.factor > 1 && (b = Math.min(u.factor, Math.min(S.area.maximum, S.stencil.maximum))) < 1 && (b = 1)), b && (f = rt(f, b, u.center));
  var M = i.left - s.left, Z = s.width + s.left - (i.width + i.left), V = i.top - s.top, q = s.height + s.top - (i.height + i.top);
  return f = Ye(f = et(f, ri(f, { left: l.left !== void 0 ? l.left - M * b : void 0, top: l.top !== void 0 ? l.top - V * b : void 0, bottom: l.bottom !== void 0 ? l.bottom + q * b : void 0, right: l.right !== void 0 ? l.right + Z * b : void 0 })), a({ visibleArea: f, type: "move" })), h.width = h.width * b, h.height = h.height * b, h.left = f.left + M * b, h.top = f.top + V * b, h = Ye(h, qi(_t(f), l)), u.factor && R && d && (u.factor > 1 ? m = Math.min(S.area.maximum, u.factor) / b : u.factor < 1 && (m = Math.max(h.height / f.height, h.width / f.width, u.factor / b)), m !== 1 && (f = et(f = Ye(f = rt(f, m, u.factor > 1 ? u.center : He(h)), a({ visibleArea: f, type: "move" })), Xi(ri(h, _t(f)))))), { coordinates: h, visibleArea: f };
}
function cr(e) {
...
function va(e) {
  ...
  if (p = pt(i, u).width, f = pt(i, u).height, u.right + u.left && (p > a.maxWidth ? m.width = (a.maxWidth - i.width) / (u.right + u.left) : p < a.minWidth && (m.width = (a.minWidth - i.width) / (u.right + u.left))), u.bottom + u.top && (f > a.maxHeight ? m.height = (a.maxHeight - i.height) / (u.bottom + u.top) : f < a.minHeight && (m.height = (a.minHeight - i.height) / (u.bottom + u.top))), l) {
    ...
    R !== 1 / 0 && yt.forEach((function(S) {
      u[S] *= R;
    }));
  } else m.width !== 1 / 0 && Kl.forEach((function(S) {
    u[S] *= m.width;
  })), m.height !== 1 / 0 && ql.forEach((function(S) {
    u[S] *= m.height;
  }));
  return u;
}
...
var dr = vt("vue-simple-handler"), hr = vt("vue-simple-handler-wrapper"), Rn = { name: "SimpleHandler", components: { HandlerWrapper: Wa }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, horizontalPosition: { type: String }, verticalPosition: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  return { hover: !1 };
  ...
  return { default: Pe(dr(n), this.defaultClass, this.hover && this.hoverClass), wrapper: Pe(hr(n), this.wrapperClass) };
...
var vr = vt("vue-simple-line"), mr = vt("vue-simple-line-wrapper"), Ln = { name: "SimpleLine", components: { LineWrapper: Ha }, props: { defaultClass: { type: String }, hoverClass: { type: String }, wrapperClass: { type: String }, position: { type: String }, disabled: { type: Boolean, default: !1 } }, data: function() {
  return { hover: !1 };
}, computed: { classes: function() {
  return { root: Pe(vr(lt({}, this.position, !0)), this.defaultClass, this.hover && this.hoverClass), wrapper: Pe(mr(lt({}, this.position, !0)), this.wrapperClass) };
} }, methods: { onDrag: function(e) {
  this.$emit("drag", e);
}, onEnter: function() {
  this.hover = !0;
...
var rn = vt("vue-bounding-box"), fr = ["east", "west", null], gr = ["south", "north", null], Ka = { name: "BoundingBox", props: { width: { type: Number }, height: { type: Number }, transitions: { type: Object }, handlers: { type: Object, default: function() {
  ...
  n === "west" ? d.left -= a : n === "east" && (d.right += a), i === "north" ? d.top -= l : i === "south" && (d.bottom += l), !i && n ? s = "width" : i && !n && (s = "height"), this.resizable && this.$emit("resize", new Yl(d, { allowedDirections: { left: n === "west" || !n, right: n === "east" || !n, bottom: i === "south" || !i, top: i === "north" || !i }, preserveAspectRatio: e.nativeEvent && e.nativeEvent.shiftKey, respectDirection: s }));
} }, emits: ["resize", "resize-end"] };
Ka.render = function(e, n, i, s, o, a) {
  return y(), ne("div", { ref: "box", class: a.classes.root, style: a.style }, [ht(e.$slots, "default"), g("div", null, [(y(!0), ne(Ee, null, ke(a.lineNodes, (function(l) {
  ...
  })), 128))]), (y(!0), ne(Ee, null, ke(a.handlerNodes, (function(l) {
...
var pr = vt("vue-draggable-area"), qa = { name: "DraggableArea", props: { movable: { type: Boolean, default: !0 }, activationDistance: { type: Number, default: 20 } }, computed: { classnames: function() {
  return { default: pr() };
} }, beforeMount: function() {
  window.addEventListener("mouseup", this.onMouseUp, { passive: !1 }), window.addEventListener("mousemove", this.onMouseMove, { passive: !1 }), window.addEventListener("touchmove", this.onTouchMove, { passive: !1 }), window.addEventListener("touchend", this.onTouchEnd, { passive: !1 });
}, beforeUnmount: function() {
...
function yr(e) {
  try {
    ...
    if (a && (s = a + 10, (function(b, R, S) {
      var M, Z = "";
      for (M = R, S += R; M < S; M++) Z += String.fromCharCode(b.getUint8(M));
      return Z;
    })(i, a + 4, 4) === "Exif")) {
      var p = i.getUint16(s);
...
var un = vt("vue-rectangle-stencil"), xn = { name: "RectangleStencil", components: { StencilPreview: eo, BoundingBox: Ka, DraggableArea: qa }, props: { image: { type: Object }, coordinates: { type: Object }, stencilCoordinates: { type: Object }, handlers: { type: Object }, handlersComponent: { type: [Object, String], default: function() {
  return Rn;
  ...
  return { stencil: Pe(un({ movable: this.movable, moving: this.moving, resizing: this.resizing }), this.moving && this.movingClass, this.resizing && this.resizingClass), preview: Pe(un("preview"), this.previewClass), boundingBox: Pe(un("bounding-box"), this.boundingBoxClass) };
}, style: function() {
...
var Er = ["transitions"], wt = vt("vue-advanced-cropper"), to = { name: "Cropper", components: { BackgroundWrapper: pn }, props: { src: { type: String, default: null }, stencilComponent: { type: [Object, String], default: function() {
  return xn;
  ...
  var f = pt(l, u = va({ coordinates: l, directions: u, sizeRestrictions: a, positionRestrictions: o })).width, h = pt(l, u).height, m = d.preserveRatio ? Ae(l) : ln(f / h, s);
  if (m) {
    var b = d.respectDirection;
    if (b || (b = l.width >= l.height || m === 1 ? "width" : "height"), b === "width") {
      var R = f / m - l.height;
      if (p.top && p.bottom) {
        var S = u.top, M = u.bottom;
        u.bottom = Si(R, M, S), u.top = Si(R, S, M);
      } else p.bottom ? u.bottom = R : p.top ? u.top = R : p.right ? u.right = 0 : p.left && (u.left = 0);
    } else if (b === "height") {
      var Z = l.width - h * m;
      if (p.left && p.right) {
        var V = u.left, q = u.right;
        u.left = -Si(Z, V, q), u.right = -Si(Z, q, V);
  ...
  o || (o = this.stencilSize ? tr : this.autoZoom ? ir : nr);
  ...
  var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, i = n.transitions, s = i !== void 0 && i, o = Wl(n, Er), a = this.processAutoZoom(e, this.visibleArea, this.coordinates, o), l = a.visibleArea, d = a.coordinates, u = a.changed;
  ...
  if (this.$refs.canvas) {
    var e = this.$refs.canvas, n = this.$refs.image, i = this.imageTransforms.rotate !== 0 || this.imageTransforms.flip.horizontal || this.imageTransforms.flip.vertical ? (function(d, u, p) {
      ...
      var S = kt(He(re({ left: 0, top: 0 }, m)), f);
      return R.translate(-(S.left - b.width / 2), -(S.top - b.height / 2)), R.rotate(f * Math.PI / 180), R.translate(h.horizontal ? m.width : 0, h.vertical ? m.height : 0), R.scale(h.horizontal ? -1 : 1, h.vertical ? -1 : 1), R.drawImage(u, 0, 0, m.width, m.height), R.restore(), d;
  ...
  var n = arguments.length > 1 && arguments[1] !== void 0 && arguments[1], i = this.visibleArea && n ? Jl(this.sizeRestrictions, this.visibleArea) : this.sizeRestrictions, s = this.visibleArea && n ? Mi(this.positionRestrictions, this.visibleArea) : this.positionRestrictions;
  return er({ transform: e, coordinates: this.coordinates, imageSize: this.imageSize, sizeRestrictions: i, positionRestrictions: s, aspectRatio: this.getAspectRatio(), visibleArea: this.visibleArea });
}, resetCoordinates: function() {
  var e = this;
  if (this.$refs.image) {
    this.$refs.cropper, this.$refs.image;
    var n = this.defaultSize;
    n || (n = this.stencilSize ? sr : or);
    var i = this.sizeRestrictions;
    i.minWidth, i.minHeight, i.maxWidth, i.maxHeight;
    var s = Qt(n) ? n({ boundaries: this.boundaries, imageSize: this.imageSize, aspectRatio: this.getAspectRatio(), sizeRestrictions: this.sizeRestrictions, stencilSize: this.getStencilSize(), visibleArea: this.visibleArea }) : n, o = this.defaultPosition || ar, a = [s, function(l) {
      var d = l.coordinates;
  ...
  return this.appliedImageTransforms = Ie(Ie({}, this.defaultImageTransforms), {}, { flip: Ie({}, this.defaultImageTransforms.flip) }), this.updateBoundaries().then((function() {
    ...
    var n, i, s, o, a, l, d = e.defaultVisibleArea || lr;
  ...
  if (!this.transitionsOptions.enabled) {
    ...
    var l = rr(Ie(Ie({}, this.getPublicProperties()), {}, { event: a ? this.normalizeEvent(e) : e, getAreaRestrictions: this.getAreaRestrictions, imageRestriction: this.imageRestriction, adjustStencil: !this.stencilSize && this.settings.resizeImage.adjustStencil })), d = l.visibleArea, u = l.coordinates;
  ...
  if (!this.transitionsActive) {
    ...
    var a = cr({ visibleArea: this.visibleArea, coordinates: this.coordinates, previousImageSize: o, imageSize: this.imageSize, angle: e, positionRestrictions: this.positionRestrictions, sizeRestrictions: this.sizeRestrictions, getAreaRestrictions: this.getAreaRestrictions, aspectRatio: this.getAspectRatio() }), l = a.visibleArea, d = a.coordinates, u = this.processAutoZoom("rotateImage", l, d);
    l = u.visibleArea, d = u.coordinates, this.visibleArea = l, this.coordinates = d, this.onChange(), s && this.debouncedDisableTransitions();
  }
} }, emits: ["change", "error", "ready"] }, _r = { key: 0, ref: "canvas", style: { display: "none" } }, wr = { key: 1, ref: "sourceCanvas", style: { display: "none" } };
...
function Ir(e = {}) {
  ...
  async function d(h) {
    ...
    try {
      await new Promise((S, M) => {
        R.load(
          h,
          (Z) => {
            try {
              b.loops = n, b.setVideoItem(Z), i && (b.startAnimation(), o.value = !0), S();
            } catch (V) {
              M(V);
            }
          },
...
const Ar = { class: "image-upload-container" }, Mr = {
  key: 0,
...
}, xr = { class: "image-upload-progress-circle" }, Nr = {
  viewBox: "0 0 36 36",
  class: "progress-ring"
}, kr = ["stroke-dasharray"], Dr = { class: "progress-percent" }, Or = { class: "upload-status-text" }, Ur = ["src"], $r = ["src"], Fr = {
  key: 2,
...
}, Gr = ["title"], Br = ["title"], Wr = {
  key: 0,
  class: "image-upload-progress"
}, Hr = { class: "progress-bar" }, Yr = { class: "progress-text" }, jr = { class: "upload-hint" }, Xr = { class: "upload-sub-hint" }, Kr = ["accept"], qr = ["src"], Zr = ["src"], Qr = { class: "image-crop-body" }, Jr = {
  key: 0,
  class: "image-crop-loading"
}, ec = { class: "image-crop-footer" }, tc = { class: "btn-content" }, ic = /* @__PURE__ */ Se({
  __name: "ImageUpload",
  props: {
    modelValue: { default: "" },
    type: { default: "cover" },
  ...
  setup(e, { expose: n, emit: i }) {
    const { t: s } = De();
    qo(dn.Parser);
    const o = e, a = i, l = P(() => o.placeholder || s(r.CLICK_OR_DRAG_TO_UPLOAD_COVER_IMAGE)), d = P(() => o.acceptHint || s("Supports JPG/PNG/GIF/WebP max {max}MB", { max: o.maxSize })), u = C(null), p = C(null), f = C(!1), h = C(0), m = C(!1), b = C(""), R = C(!o.uploadEnabled), S = C(o.modelValue), M = C(null), { previewUrl: Z, setPreview: V } = Cr(), q = C(!1), H = C(!1), {
      containerRef: J,
      playUrl: oe
    } = Ir({ loop: 1, autoPlay: !0 }), de = C(null);
    let fe = null;
    function W() {
      if (fe) {
        try {
    ...
    const N = C(!1), L = C(""), T = C(1), U = C(1), k = C(!1), x = C(null), A = C({ width: 300, height: 300 });
    function ie() {
      if (!x.value) return;
      const F = x.value.clientWidth, se = x.value.clientHeight || 320, Me = F / se, Be = o.aspectRatio || 16 / 9;
      let ft, it;
    ...
    xe(() => o.skipSvgaValidation, (F) => {
      ae.updateSkipSvgaValidation(!!F);
    });
    const $ = P(() => Q(S.value));
    xe(() => o.modelValue, (F) => {
      S.value = F, ve.value = "", F && o.uploadEnabled && (R.value = !0), o.deferUpload && (M.value = null, V(null), q.value = !1, H.value = !1, a("fileReady", null));
    }), xe(() => o.uploadEnabled, (F) => {
      F && !o.modelValue && (R.value = !1);
    }), xe(
      ...
      ae.dispose(), W(), window.removeEventListener("resize", ie);
    });
    function ce() {
      var F;
    ...
    async function Ue(F) {
      ...
      if (o.cropEnabled) {
        T.value = 1, U.value = 1, L.value = "", k.value = !0, N.value = !0;
        try {
          const Me = await ns(F);
          L.value = Me;
        } catch {
    ...
    async function Xe(F) {
      if (o.deferUpload) {
        ...
        q.value = Me, H.value = se, a("fileReady", F), se && O(previewUrl);
        return;
      }
      f.value = !0, h.value = 0;
      try {
    ...
    function pe() {
      ae.cancelValidation(), he.value = !1, ve.value = "", R.value = !1;
    }
    function ge() {
      ae.cancelValidation(), he.value = !1, ve.value = "", R.value = !0;
    }
    function le() {
      ae.handleUrlFocus();
    }
    ...
    function Ve(F) {
      typeof F == "string" && (S.value = F, ve.value = "", ae.cancelValidation(), he.value = !1);
    }
    function Re(F) {
    ...
    function mt(F) {
      F == null || F.stopPropagation(), ae.cancelValidation(), he.value = !1, ve.value = "", a("update:modelValue", ""), S.value = "", b.value = "", f.value = !1, h.value = 0, m.value = !1, W(), o.deferUpload && (M.value = null, V(null), q.value = !1, H.value = !1, a("fileReady", null));
    }
    function at(F) {
    ...
    return n({
      ...
      get hasUrlError() {
        return R.value ? !!(ve.value || o.maxBytes && S.value.trim() && $.value > o.maxBytes) : !1;
      },
      ...
      reset() {
        ae.reset(), M.value = null, V(null), q.value = !1, H.value = !1, W(), S.value = o.modelValue || "", b.value = "", ve.value = "", f.value = !1, h.value = 0, m.value = !1, o.uploadEnabled && (R.value = !!o.modelValue), a("fileReady", null);
      },
      /**
      ...
      async ensureUrlValidated() {
        return R.value ? await ae.ensureUrlValidatedWithErrorCheck(
          S.value,
          o.modelValue || "",
          !!ve.value,
          o.maxBytes
      ...
      async uploadPendingFile() {
        ...
        try {
          ...
          return M.value = null, b.value = se.provider || "", m.value = !1, se.url;
        } catch (se) {
          throw m.value = !0, se;
        } finally {
          f.value = !1, h.value = 0;
      ...
      return y(), w("div", Ar, [
        e.uploadEnabled && e.showUrlInput ? (y(), w("div", Mr, [
          c("button", {
        ...
        R.value || !e.uploadEnabled ? (y(), w("div", Sr, [
          g(Me, {
            ...
            e.maxBytes ? {
              name: "suffix",
              fn: E(() => [
                he.value ? (y(), w("span", Tr, v(t(s)(t(r).VALIDATING)), 1)) : (y(), w("span", {
                  key: 1,
        ...
        ve.value && (R.value || !e.uploadEnabled) ? (y(), w("div", Rr, v(ve.value), 1)) : ue("", !0),
        e.uploadEnabled && !R.value ? (y(), w(Ee, { key: 3 }, [
          t(Z) ? (y(), w("div", {
            key: 0,
            ...
            f.value ? (y(), w("div", Lr, [
              c("div", xr, [
                ...
                c("span", Dr, v(h.value) + "%", 1)
              ]),
              c("span", Or, v(t(s)(t(r).UPLOADING)), 1)
            ])) : (y(), w(Ee, { key: 1 }, [
              H.value ? (y(), w("div", {
                key: 0,
            ...
            !f.value && m.value ? (y(), w("span", Pr, v(t(s)(t(r).UPLOAD_FAILED)), 1)) : !f.value && !b.value ? (y(), w("span", Vr, v(t(s)(t(r).PENDING_UPLOAD)), 1)) : ue("", !0),
            f.value ? ue("", !0) : (y(), w("div", zr, [
              c("button", {
            ...
            f.value ? (y(), w("div", Wr, [
              ...
              c("span", Yr, v(h.value) + "%", 1)
            ])) : (y(), w(Ee, { key: 1 }, [
              g(t($o), {
                size: "32",
                "stroke-width": 1.2
              }),
              c("span", jr, v(l.value), 1),
              c("span", Xr, v(d.value), 1)
            ], 64))
          ], 38)),
          c("input", {
...
}), Bi = /* @__PURE__ */ ci(ic, [["__scopeId", "data-v-8b84b2f0"]]), nc = { class: "custom-info-section" }, ac = {
  key: 2,
  class: "custom-info-count"
}, oc = {
  key: 0,
  class: "custom-info-container"
}, sc = { class: "custom-input-wrap" }, lc = { class: "custom-input-wrap custom-value-wrap" }, rc = {
  key: 1,
  class: "create-success-content"
}, cc = { class: "create-success-summary" }, uc = {
  key: 0,
  class: "create-success-section"
}, dc = { class: "create-success-section-title" }, hc = { class: "stream-info-items" }, vc = { class: "stream-info-item" }, mc = { class: "stream-info-label" }, fc = { class: "stream-info-value" }, gc = { class: "stream-info-item" }, pc = { class: "stream-info-label" }, bc = { class: "stream-info-value" }, yc = { class: "dialog-footer" }, Ec = /* @__PURE__ */ Se({
  ...
  setup(e, { emit: n }) {
    const { t: i } = De(), s = e, { extraFieldsSlot: o } = s, { createLive: a } = Ft(), l = n, d = P({
      get: () => s.visible,
    ...
    }, m = C(jn()), b = C([]), R = C(!1), S = C(!1), M = C(!1), Z = C(!1), V = C(""), q = C(""), H = C(null), J = C(""), oe = C(null), de = C(!1), fe = P(() => Q(m.value.anchorId)), W = P(() => Q(m.value.liveName));
    P(() => b.value.filter((ae) => ae.key.trim()).length);
    const O = P(() => {
      var ae;
      return i(((ae = cs(m.value.seatTemplate)) == null ? void 0 : ae.descKey) || "");
    }), D = P(() => us(m.value.seatTemplate)), N = P(() => Z.value ? V.value === "error" ? `OBS 配置失败：${q.value}` : H.value ? "OBS 已配置完成，可直接复制下方推流信息。" : J.value ? `OBS 已配置完成，但推流信息生成失败：${J.value}` : "OBS 已配置完成。" : ""), L = P(() => V.value === "error" || !!J.value), T = (ae) => {
      de.value = !!ae;
    }, U = async (ae, $) => {
      try {
        await Ra(ae), j.success(i("Copy Label Copied", { label: $ }));
      } catch (ce) {
      ...
      var ae;
      m.value = jn(), b.value = [], R.value = !1, M.value = !1, Z.value = !1, V.value = "", q.value = "", H.value = null, J.value = "", de.value = !1, (ae = oe.value) == null || ae.reset();
    }, ie = () => {
      ...
      try {
        ...
        ae = _e.liveId, $ = _e.anchorId, await a(_e), H.value = null, J.value = "";
        let Ue = !Z.value;
        if (Z.value) {
          const Ne = await Qs({
            liveId: ae,
        ...
        M.value = !0, j.success(Z.value && Ue ? i(r.LIVE_CREATED_SUCCESSFULLY_OBS) : i(r.LIVE_CREATED_SUCCESSFULLY));
      } catch (ce) {
      ...
      return y(), ne(pe, {
            ...
            c("div", yc, [
              M.value ? (y(), ne(Xe, {
                ...
                g(Xe, {
                  ...
                  shape: "round",
                  loading: S.value,
                  disabled: S.value || !m.value.anchorId.trim() || ((ge = oe.value) == null ? void 0 : ge.isValidating) || ((le = oe.value) == null ? void 0 : le.hasUrlError),
                  onClick: he
                }, {
                  default: E(() => [
                    B(v(S.value ? t(i)(t(r).CREATING) : t(i)(t(r).CREATE)), 1)
                  ]),
                  _: 1
                }, 8, ["loading", "disabled"])
              ], 64))
        ...
        default: E(() => [
          M.value ? (y(), w("div", rc, [
            ...
            H.value ? (y(), w("div", uc, [
              c("div", dc, v(t(i)(t(r).STREAM_INFO)), 1),
              c("div", hc, [
                c("div", vc, [
                  c("div", mc, [
                  ...
                  c("code", fc, v(H.value.serverUrl), 1)
                ]),
                c("div", gc, [
                  c("div", pc, [
                  ...
                  c("code", bc, v(H.value.streamKey), 1)
                ])
              ])
            ])) : ue("", !0)
          ])) : (y(), ne(ct, {
            ...
            default: E(() => [
              ...
              c("div", nc, [
                c("div", {
                  ...
                  b.value.length > 0 ? (y(), w("span", ac, v(b.value.length), 1)) : ue("", !0)
                ]),
                R.value ? (y(), w("div", oc, [
                  (y(!0), w(Ee, null, ke(b.value, (ge, le) => (y(), w("div", {
                    key: le,
...
}), _c = /* @__PURE__ */ ci(Ec, [["__scopeId", "data-v-0795ae94"]]), Et = /* @__PURE__ */ Se({
  __name: "SlotRenderer",
  props: {
    slotComponent: {
...
}), wc = { class: "custom-info-section" }, Cc = {
  key: 2,
  class: "custom-info-count"
}, Ic = {
  key: 0,
  class: "custom-info-container"
}, Ac = { class: "custom-input-wrap" }, Mc = { class: "custom-input-wrap custom-value-wrap" }, Sc = { class: "dialog-footer" }, Tc = /* @__PURE__ */ Se({
  ...
  emits: ["update:visible", "success"],
  setup(e, { emit: n }) {
    const { t: i } = De(), { fetchLiveDetail: s, updateLive: o } = Ft(), a = e, l = P(() => a.room ? "RoomId" in a.room && a.room.RoomId ? a.room.RoomId : "id" in a.room && a.room.id ? a.room.id : "" : ""), d = n, u = P({
      get: () => a.visible,
      set: (O) => d("update:visible", O)
    }), p = (O) => Q(O), f = (O) => Q(O), h = C(Xn()), m = C([]), b = C(!1), R = C([]), S = C(Kn), M = C(null), Z = C(!1), { loading: V, execute: q } = io({
      action: async (O) => {
        var N, L;
    ...
    P(() => m.value.filter((O) => O.key.trim()).length), xe([() => {
      var O, D;
      return ((O = a.room) == null ? void 0 : O.RoomId) || ((D = a.room) == null ? void 0 : D.id);
    }, () => a.visible], async ([O, D]) => {
      const N = a.room;
      if (N && D) {
        const L = "RoomName" in N ? N.RoomName : N.liveName || "", T = "CoverURL" in N ? N.CoverURL : N.coverUrl || "", U = "RoomId" in N ? N.RoomId : N.id;
        h.value = {
          liveName: L || "",
          coverUrl: T || ""
        }, T ? S.value = await hs(T) : S.value = Kn;
        try {
          const k = await s(U), x = qn(k == null ? void 0 : k.customInfo);
          m.value = x, b.value = x.length > 0, R.value = x.map((A) => A.key);
        } catch {
          const k = "CustomInfo" in N ? N.CustomInfo : N.customInfo, x = qn(k);
          m.value = x, b.value = x.length > 0, R.value = x.map((A) => A.key);
        }
      }
    }, { immediate: !0 });
    const oe = () => {
      ...
      var O;
      m.value = [], b.value = !1, R.value = [], Z.value = !1, (O = M.value) == null || O.reset(), h.value = Xn(), d("update:visible", !1);
    }, W = async () => {
      if (a.room) {
        ...
        try {
          ...
          try {
            ...
            const U = T instanceof Vi ? T.message : `${i(r.COVER_PROCESSING_FAILED)}: ${T instanceof Error ? T.message : String(T) || i(r.UNKNOWN_ERROR)}`;
            j.error(U);
            return;
          }
          const D = vs(m.value);
    ...
    return (O, D) => {
      const N = ee("t-input"), L = ee("t-form-item"), T = ee("t-button"), U = ee("t-form"), k = ee("t-dialog");
      return y(), ne(k, {
        visible: u.value,
          ...
          return [
            c("div", Sc, [
              ...
              g(T, {
                ...
                shape: "round",
                loading: t(V),
                disabled: t(V) || !h.value.liveName.trim() || ((x = M.value) == null ? void 0 : x.isValidating) || ((A = M.value) == null ? void 0 : A.hasUrlError),
                onClick: W
              }, {
                default: E(() => [
            ...
            default: E(() => [
              ...
              c("div", wc, [
                c("div", {
                  ...
                  c("span", null, v(t(i)(t(r).CUSTOM_INFORMATION)), 1),
                  m.value.length > 0 ? (y(), w("span", Cc, v(m.value.length), 1)) : ue("", !0)
                ]),
                b.value ? (y(), w("div", Ic, [
                  (y(!0), w(Ee, null, ke(m.value, (x, A) => (y(), w("div", {
                    key: A,
                    class: "custom-info-row"
                  }, [
                    c("div", Ac, [
                  ...
                  m.value.length < t(Ke).maxCount ? (y(), ne(T, {
                    key: 0,
                    style: { width: "80px" },
                    variant: "text",
                    shape: "round",
...
}), Rc = /* @__PURE__ */ ci(Tc, [["__scopeId", "data-v-0a1ae480"]]), Lc = {
  key: 0,
  ...
  setup(e) {
    function n() {
      ...
      const T = L.offsetWidth - L.clientWidth;
      return document.body.removeChild(L), T;
    }
    const i = e, s = C(null), o = C(null), a = C(null), l = C(null), d = C(null), u = C({});
    let p = {}, f = null, h = null, m = 0, b = null;
    const R = (L) => L.fitContent || i.fitContent && L.width === void 0, S = (L) => typeof L == "number" ? `${L}px` : L, M = (L) => {
      if (R(L)) {
        const T = u.value[L.key];
      ...
      const L = {};
      for (const T of i.columns) L[T.key] = { width: M(T) };
      return L;
    }), V = P(() => {
      const L = {};
      for (const T of i.columns) {
        const U = { textAlign: T.align };
        T.ellipsis ? (U.whiteSpace = "nowrap", U.overflow = "hidden", U.textOverflow = "ellipsis") : R(T) && !T.flexible && (U.whiteSpace = "nowrap"), L[T.key] = U;
      }
      return L;
    }), q = P(() => Ns(i.columns, u.value, R) ?? {}), H = () => {
      var ve, ae;
      ...
      const T = ((ve = a.value) == null ? void 0 : ve.querySelectorAll("thead th")) || [], U = Array.from(((ae = d.value) == null ? void 0 : ae.querySelectorAll("tbody tr")) || []).slice(0, i.fitContentMaxRows), k = [], x = [];
      ...
      const T = ((k = l.value) == null ? void 0 : k.clientWidth) ?? 0, U = Os(
        i.columns,
        L,
        T,
        R
    ...
    }, O = (L, T) => typeof i.rowKey == "function" ? i.rowKey(L, T) : L[i.rowKey] ?? T, D = (L, T) => typeof i.rowClassName == "function" ? i.rowClassName(L, T) : i.rowClassName, N = () => {
      var k;
      const L = s.value, T = (k = d.value) == null ? void 0 : k.parentElement;
      if (!L || !T) return;
      const U = T.scrollHeight > T.clientHeight ? n() : 0;
    ...
    return At(() => {
      ...
      c("div", {
        ...
        c("table", {
          ...
          c("colgroup", null, [
            (y(!0), w(Ee, null, ke(e.columns, (U) => (y(), w("col", {
              key: U.key,
          ...
          c("thead", null, [
            c("tr", null, [
              (y(!0), w(Ee, null, ke(e.columns, (U) => (y(), w("th", {
                key: U.key,
      ...
      c("div", {
        ...
        e.loading ? (y(), w("div", Lc, [
          ht(L.$slots, "loading")
        ])) : e.data.length === 0 ? (y(), w("div", xc, [
          ht(L.$slots, "empty")
        ])) : (y(), w("table", {
          key: 2,
          ...
          c("tbody", null, [
            (y(!0), w(Ee, null, ke(e.data, (U, k) => (y(), w("tr", {
              key: O(U, k),
              class: we(D(U, k))
            }, [
              (y(!0), w(Ee, null, ke(e.columns, (x) => (y(), w("td", {
                key: x.key,
...
}), Nc = ["title", "disabled", "onClick"], kc = { class: "list-action-button__text" }, Dc = {
  key: 1,
  ...
  setup(e) {
    ...
    return (i, s) => (y(), w("div", {
      ...
      (y(!0), w(Ee, null, ke(e.actions, (o) => (y(), w("button", {
        key: o.key,
        type: "button",
        ...
        c("span", kc, v(o.label), 1),
        o.suffixCaret ? (y(), w("span", Dc)) : ue("", !0)
      ], 10, Nc))), 128))
    ], 2));
  }
}), Oc = { class: "live-list-page" }, Uc = { class: "live-list-header" }, $c = { class: "live-list-title" }, Fc = { class: "header-actions" }, Pc = { class: "live-list-id-cell" }, Vc = { class: "live-list-id-text" }, zc = ["title"], Gc = { class: "live-list-cover-cell" }, Bc = ["src", "alt"], Wc = { class: "live-list-text" }, Hc = { class: "live-list-text" }, Yc = { class: "live-list-loading-container" }, jc = { class: "live-list-loading-text" }, Xc = { class: "live-list-empty-container" }, Kc = { class: "live-list-empty-text" }, qc = { class: "live-list-pagination" }, Zc = { class: "page-info" }, Qc = { class: "live-info-form" }, Jc = { class: "live-info-section" }, eu = { class: "live-info-section-title" }, tu = { class: "live-info-card" }, iu = { class: "live-info-row" }, nu = { class: "live-info-label" }, au = { class: "live-info-value-area" }, ou = { class: "live-info-value" }, su = { class: "live-info-row" }, lu = { class: "live-info-label" }, ru = { class: "live-info-value-area" }, cu = { class: "live-info-value" }, uu = { class: "live-info-row" }, du = { class: "live-info-label" }, hu = { class: "live-info-value-area" }, vu = { class: "live-info-value" }, mu = { class: "live-info-row" }, fu = { class: "live-info-label" }, gu = { class: "live-info-value-area" }, pu = { class: "live-info-value live-info-value-url" }, bu = {
  key: 0,
  class: "live-info-section"
}, yu = { class: "live-info-section-title" }, Eu = { class: "live-info-card" }, _u = { class: "live-info-row" }, wu = { class: "live-info-label" }, Cu = { class: "live-info-value-area" }, Iu = { class: "live-info-value live-info-value-url" }, Au = { class: "live-info-row" }, Mu = { class: "live-info-label" }, Su = { class: "live-info-value-area" }, Tu = { class: "live-info-value live-info-value-url" }, Ru = {
  key: 1,
  class: "live-info-row"
}, Lu = {
  class: "live-info-label",
  style: { width: "auto" }
}, xu = { class: "dialog-footer" }, fm = /* @__PURE__ */ Se({
  __name: "live-list",
  setup(e) {
    var h;
    const { t: n } = De(), i = _i(), { endLive: s } = Ft(), o = (h = Yi().components) == null ? void 0 : h.roomList, a = new gs({
      endLive: s,
      onEnterLive: (m) => {
    ...
    return (m, b) => {
      var V, q, H;
      const R = ee("t-input"), S = ee("t-button"), M = ee("t-card"), Z = ee("t-dialog");
      return y(), w("div", Oc, [
        c("div", Uc, [
          c("h1", $c, v(t(n)(t(r).LIVE_LIST)), 1),
          g(Et, {
            ...
            return [
              g(Zi, {
                ...
                "cell-anchor": E(({ row: oe }) => {
                  var de;
                  return [
                    c("span", Wc, v(((de = oe.anchor) == null ? void 0 : de.userId) || "-"), 1)
                  ];
                }),
                "cell-createdAt": E(({ row: oe }) => [
                  c("span", Hc, v(t(bs)(oe.createdAt)), 1)
                ]),
                ...
                loading: E(() => [
                  c("div", Yc, [
                    ...
                    c("span", jc, v(t(n)(t(r).LOADING)), 1)
                  ])
                ]),
                empty: E(() => [
                  c("div", Xc, [
                    c("span", Kc, v(t(n)(t(r).NO_LIVE_DATA)), 1)
                  ])
                ]),
                _: 2
              }, [
        ...
        c("div", qc, [
          ...
          c("span", Zc, v(t(n)(t(r).PAGE, { page: l.value.currentPage })), 1),
          g(S, {
            variant: "outline",
            size: "small",
        ...
        g(Z, {
          ...
          default: E(() => {
            var J, oe, de, fe, W, O, D;
            return [
              c("div", Qc, [
                c("div", Jc, [
                  c("div", eu, v(t(n)(t(r).BASIC_INFORMATION)), 1),
                  c("div", tu, [
                    c("div", iu, [
                      c("span", nu, v(t(n)(t(r).ANCHOR_ID)), 1),
                      c("div", au, [
                        c("span", ou, v(((oe = (J = l.value.obsModal.live) == null ? void 0 : J.anchor) == null ? void 0 : oe.userId) || "-"), 1),
                    ...
                    c("div", su, [
                      c("span", lu, v(t(n)(t(r).LIVE_ID)), 1),
                      c("div", ru, [
                        c("span", cu, v(((W = l.value.obsModal.live) == null ? void 0 : W.liveId) || "-"), 1)
                      ])
                    ]),
                    c("div", uu, [
                      c("span", du, v(t(n)(t(r).LIVE_TITLE)), 1),
                      c("div", hu, [
                        c("span", vu, v(((O = l.value.obsModal.live) == null ? void 0 : O.liveName) || "-"), 1)
                      ])
                    ]),
                    c("div", mu, [
                      c("span", fu, v(t(n)(t(r).LIVE_COVER)), 1),
                      c("div", gu, [
                        c("span", pu, v(((D = l.value.obsModal.live) == null ? void 0 : D.coverUrl) || "-"), 1)
                      ])
                    ])
                  ])
                ]),
                l.value.obsModal.streamInfo || l.value.obsModal.actionLoading === "stream" ? (y(), w("div", bu, [
                  c("div", yu, v(t(n)(t(r).PUSH_STREAM_INFO)), 1),
                  c("div", Eu, [
                    l.value.obsModal.streamInfo ? (y(), w(Ee, { key: 0 }, [
                      c("div", _u, [
                        c("span", wu, v(t(n)(t(r).SERVER_URL)), 1),
                        c("div", Cu, [
                          c("span", Iu, v(l.value.obsModal.streamInfo.serverUrl), 1),
                          c("button", {
                            class: "live-info-copy-btn",
                      ...
                      c("div", Au, [
                        c("span", Mu, v(t(n)(t(r).STREAM_KEY)), 1),
                        c("div", Su, [
                          c("span", Tu, v(l.value.obsModal.streamInfo.streamKey), 1),
                          c("button", {
                            class: "live-info-copy-btn",
                      ...
                      c("span", Lu, v(t(n)(t(r).GETTING_STREAM_INFO)), 1)
                    ]))
                  ])
                ])) : ue("", !0)
              ])
  ...
  setup(e) {
    return (n, i) => (y(), w("div", Nu, [
      e.successMsg ? (y(), w("div", ku, v(e.successMsg), 1)) : ue("", !0),
      e.errorMsg ? (y(), w("div", Du, v(e.errorMsg), 1)) : ue("", !0)
    ]));
  }
}), Uu = { class: "live-control-navbar" }, $u = { class: "nav-left" }, Fu = ["viewBox", "stroke-width", "stroke-linecap"], Pu = ["d"], Vu = { class: "nav-right" }, zu = /* @__PURE__ */ Se({
  __name: "NavBar",
  props: {
...
}), Gu = { class: "video-monitor-area" }, Bu = { class: "live-header-external" }, Wu = { class: "live-title-text" }, Hu = { class: "video-stage" }, Yu = {
  key: 1,
  class: "video-blur-bg-placeholder"
}, ju = { class: "player-container" }, Xu = {
  key: 0,
  class: "mock-cover-preview"
}, Ku = ["src"], qu = {
  key: 2,
  class: "live-state-overlay live-state-overlay--ended"
}, Zu = { class: "live-state-overlay-content" }, Qu = { class: "live-state-overlay-title" }, Ju = /* @__PURE__ */ Se({
  __name: "VideoMonitor",
  props: {
    liveInfo: {},
    liveAnchorAvatar: {},
    ...
    return (i, s) => {
      ...
      return y(), w("section", Gu, [
        ...
        c("div", Bu, [
          ...
          c("span", Wu, v(e.liveEndedOverlayVisible ? t(n)(t(r).LIVE_ENDED) : ((a = e.currentLive) == null ? void 0 : a.liveName) || ((l = e.liveInfo) == null ? void 0 : l.liveName) || t(n)(t(r).LOADING)), 1)
        ]),
        c("div", Hu, [
          ...
          c("div", ju, [
            e.isMockMode ? (y(), w(Ee, { key: 0 }, [
              (u = e.liveInfo) != null && u.coverUrl ? (y(), w("div", Xu, [
                c("img", {
            ...
            e.liveEndedOverlayVisible ? (y(), w("div", qu, [
              c("div", Zu, [
                c("div", Qu, v(t(n)(t(r).LIVE_ENDED)), 1),
                c("button", {
...
}), ed = { class: "message-list-scroll-area" }, td = ["placeholder", "disabled"], id = ["disabled"], nd = 12 * 1024, ad = /* @__PURE__ */ Se({
  __name: "MessageList",
  props: {
    liveId: { default: "" },
    onMuteUser: {},
  ...
  setup(e) {
    const { t: n } = De(), i = e, { loginUserInfo: s } = Ua(), { currentLive: o } = Ft(), { audienceList: a, disableSendMessage: l } = $a(), d = P(() => i.currentLive || o.value), u = (D) => new TextEncoder().encode(D).length, p = C(!1), f = C({ top: 0, left: 0 }), h = C(null), m = C(""), b = C(!1), R = C(null), S = C(null), M = C(null), Z = P(() => b.value || !i.liveId || !m.value.trim()), V = (D) => a.value.find((N) => N.userId === D), q = (D) => {
      const N = V(D);
      if (N)
        return N.isMessageDisabled === !0;
      const L = i.mutedList.find((T) => T.userId === D);
      ...
      if (!L) return;
      const T = L.getBoundingClientRect(), U = T.bottom + 4, k = Math.min(
        T.left,
      ...
      if (h.value && i.onBanUser) {
        ...
        if (L !== xi(((N = (D = d.value) == null ? void 0 : D.liveOwner) == null ? void 0 : N.userId) || "")) {
          const T = h.value.sender.userName || h.value.sender.nameCard || h.value.sender.userId, U = H(L);
          i.onBanUser(L, T, U);
        }
      }
      ...
      if (D === xi(((U = (T = d.value) == null ? void 0 : T.liveOwner) == null ? void 0 : U.userId) || "")) {
        p.value = !1, h.value = null;
        return;
      }
      ...
      setup(D) {
        var x, A;
        const N = D.message.sender.nameCard || D.message.sender.userName || D.message.sender.userId, L = D.message.sender.userId === ((A = (x = d.value) == null ? void 0 : x.liveOwner) == null ? void 0 : A.userId), T = D.message.messageType === 0 ? D.message.textContent : D.message.data || "", U = Es(T), k = () => U.map((ie, he) => ie.type === "emoji" ? Zt("img", {
          key: he,
          class: "message-emoji",
          src: ie.src,
          alt: ie.key
      ...
      S.value && S.value.contains(D.target) || (p.value = !1, h.value = null);
    };
    return xe(p, (D) => {
      ...
      c("form", {
        ...
        c("button", {
          ...
          disabled: Z.value
        }, v(b.value ? t(n)(t(r).SENDING) : t(n)(t(r).SEND_MESSAGE)), 9, id)
      ], 32),
      (y(), ne(wn, { to: "body" }, [
        p.value && h.value ? (y(), w("div", {
          ...
          c("button", {
            ...
            H(h.value.sender.userId) ? (y(), ne(t(Ma), { key: 0 })) : (y(), ne(t(Sa), { key: 1 })),
...
}), od = { class: "left-interaction-card" }, sd = { class: "interaction-tabs-header" }, ld = { class: "all-mute-control-row" }, rd = { class: "all-mute-label" }, cd = { class: "interaction-body" }, ud = { class: "chat-stream-sidebar" }, dd = {
  key: 0,
  class: "all-mute-banner"
}, hd = { class: "audience-tab-wrapper" }, vd = { class: "audience-list-area" }, md = {
  key: 0,
...
}, pd = ["title", "onClick"], bd = { class: "audience-bottom-actions" }, yd = /* @__PURE__ */ Se({
      ...
      return y(), w("div", od, [
        c("div", sd, [
          ...
          c("div", ld, [
            ...
            c("span", rd, v(t(i)(t(r).ALL_MEMBER_MUTE)), 1)
          ])
        ]),
        c("div", cd, [
          pi(c("div", ud, [
            e.isAllMuted ? (y(), w("div", dd, [
            ...
            c("div", vd, [
              g(t(al), { height: "99%" }, {
                "audience-mark": E(({ audience: h }) => [
                  h.userId === e.currentUserId ? (y(), w("span", md, v(t(i)(t(r).ME)), 1)) : h.userRole !== 0 && h.userId !== t(xi)(e.anchorUserId) ? (y(), w("div", fd, [
                    e.isUserMuted(h.userId) ? (y(), w("span", gd, v(t(i)(t(r).MUTED)), 1)) : ue("", !0),
                    c("button", {
...
}), Ed = { class: "left-content-area" }, _d = /* @__PURE__ */ Se({
  ...
  setup(e, { emit: n }) {
    const i = e, s = n, { login: o, loginUserInfo: a } = Ua(), { joinLive: l, leaveLive: d, subscribeEvent: u, unsubscribeEvent: p, LiveListEvent: f } = ol(), h = C(!1), m = C(""), b = C(!1), R = C(""), S = P(
      () => {
        var q;
      ...
      if (!(!i.liveId || !i.currentLive || !h.value || m.value === i.liveId))
        try {
          await l({ liveId: i.liveId }), m.value = i.liveId, !b.value && u && (f != null && f.onLiveEnded) && (u(f.onLiveEnded, M), b.value = !0), s("joined-live");
        } catch (q) {
    ...
    return xe(
      ...
      var q, H;
      b.value && p && (f != null && f.onLiveEnded) && (p(f.onLiveEnded, M), b.value = !1), m.value && ((H = d == null ? void 0 : (q = d()).catch) == null || H.call(q, (J) => {
...
}), wd = { class: "sidebar-stats-card" }, Cd = { class: "stats-card-header" }, Id = { class: "stats-header-left" }, Ad = { class: "live-status-tag" }, Md = { class: "live-duration-text" }, Sd = { class: "update-time" }, Td = { class: "stat-bar-item" }, Rd = { class: "stat-label" }, Ld = { class: "stat-value" }, xd = { class: "stat-bar-item" }, Nd = { class: "stat-label" }, kd = { class: "stat-value" }, Dd = { class: "stat-bar-item" }, Od = { class: "stat-label" }, Ud = { class: "stat-value" }, $d = { class: "stat-bar-item" }, Fd = { class: "stat-label" }, Pd = { class: "stat-value" }, Vd = { class: "stat-bar-item" }, zd = { class: "stat-label" }, Gd = { class: "stat-value" }, Bd = { class: "stat-bar-item" }, Wd = { class: "stat-label" }, Hd = { class: "stat-value" }, Yd = { class: "stat-bar-item" }, jd = { class: "stat-label" }, Xd = { class: "stat-value" }, Kd = /* @__PURE__ */ Se({
  __name: "StatsCard",
  props: {
    stats: {},
    liveDuration: {},
  ...
  setup(e) {
    ...
    const l = (f, h, m) => {
      ...
      const b = h.map((R) => {
        ...
        return S.style.width = "max-content", S.style.maxWidth = "none", m.appendChild(S), Math.ceil(S.getBoundingClientRect().width);
      });
      return m.remove(), b;
    }, u = () => {
      const f = i.value;
      ...
      const h = d(f);
      if (!h.length) return;
      const m = parseFloat(getComputedStyle(f).columnGap) || 0, b = f.clientWidth, R = [7, 4, 3, 2, 1].find((S) => l(h, S, m) <= b + 1) || 1;
    ...
    return At(() => {
      ...
      c("div", Cd, [
        c("div", Id, [
          ...
          c("span", Ad, [
            ...
            c("span", Md, v(e.formatDuration(e.liveDuration)), 1)
          ])
        ]),
      ...
      c("div", {
        ...
        c("div", Td, [
          ...
          c("div", Ld, v(e.formatNumber(e.stats.onlineCount)), 1)
        ]),
        c("div", xd, [
          c("div", Nd, [
          ...
          c("div", kd, v(e.stats.totalMsgCount.toLocaleString()), 1)
        ]),
        c("div", Dd, [
          c("div", Od, [
          ...
          c("div", Ud, v(e.stats.totalUniqueCommenters || 0), 1)
        ]),
        c("div", $d, [
          c("div", Fd, [
          ...
          c("div", Pd, v(e.interactionRate), 1)
        ]),
        c("div", Vd, [
          c("div", zd, [
          ...
          c("div", Gd, v(e.stats.totalGiftCoins.toFixed(2)), 1)
        ]),
        c("div", Bd, [
          c("div", Wd, [
          ...
          c("div", Hd, v(e.stats.totalGiftsSent), 1)
        ]),
        c("div", Yd, [
          c("div", jd, [
          ...
          c("div", Xd, v(e.stats.totalUniqueGiftSenders), 1)
        ])
      ], 512)
    ]));
  }
}), qd = { class: "moderation-card" }, Zd = { class: "moderation-card-header" }, Qd = { class: "moderation-header-left" }, Jd = { class: "moderation-toolbar" }, eh = { class: "update-time" }, th = { class: "moderation-table-wrapper" }, ih = ["checked"], nh = ["checked", "onChange"], ah = { class: "moderation-user-cell" }, oh = { class: "moderation-user-id" }, sh = ["title"], lh = { class: "moderation-type-text" }, rh = { key: 0 }, ch = { class: "moderation-empty" }, uh = {
  key: 0,
  class: "moderation-pagination"
}, dh = { class: "pagination-pages" }, hh = ["disabled"], vh = {
  key: 0,
  class: "page-ellipsis"
}, mh = ["onClick"], fh = ["disabled"], gh = /* @__PURE__ */ Se({
    ...
    return (i, s) => {
      ...
      return y(), w("div", qd, [
        c("div", Zd, [
          ...
          c("div", Jd, [
            c("span", eh, v(t(n)(t(r).UPDATED_AT, { time: e.updateTimeText })), 1),
            g(o, {
              theme: "primary",
              variant: "outline",
              shape: "round",
        ...
        c("div", th, [
          g(Zi, {
            ...
            "cell-type": E(({ row: l }) => [
              g(a, {
                ...
                default: E(() => [
                  c("span", lh, [
                    (y(!0), w(Ee, null, ke(l.type.split(/[,\\s;|]+/).map((d) => String(d).trim()).filter(Boolean), (d, u) => (y(), w(Ee, { key: u }, [
                      u > 0 ? (y(), w("span", rh)) : ue("", !0),
          ...
          e.moderationList.length > 0 ? (y(), w("div", uh, [
            ...
            c("div", dh, [
              ...
              (y(!0), w(Ee, null, ke(e.moderationPageNumbers, (l, d) => (y(), w(Ee, {
                key: l === "..." ? `ellipsis-${d}` : l
              }, [
                l === "..." ? (y(), w("span", vh, "...")) : (y(), w("button", {
                  key: 1,
...
}), ph = { class: "member-list-panel-modal" }, bh = {
  key: 0,
...
}, _h = { class: "member-table-user" }, wh = { class: "member-table-user-cell" }, Ch = { class: "member-table-user-name" }, Ih = { class: "member-table-time" }, Ah = { class: "member-table-action" }, Mh = /* @__PURE__ */ Se({
  __name: "MutedModal",
  props: {
    visible: { type: Boolean },
    mutedList: {},
  ...
  setup(e, { emit: n }) {
    ...
    return (l, d) => {
      ...
      return y(), ne(u, {
        ...
        default: E(() => [
          c("div", ph, [
            e.memberListLoading ? (y(), w("div", bh, v(t(i)(t(r).LOADING)), 1)) : e.mutedList.length === 0 ? (y(), w("div", yh, v(t(i)(t(r).NO_MUTED_MEMBERS)), 1)) : (y(), w("table", Eh, [
              c("thead", null, [
                c("tr", null, [
              ...
              c("tbody", null, [
                (y(!0), w(Ee, null, ke(e.mutedList, (p) => (y(), w("tr", {
                  key: p.userId
                }, [
                  c("td", _h, [
                    c("div", wh, [
                      ...
                      g(t(Ct), {
                        ...
                        default: E(() => [
                          c("span", Ch, v(e.getUserNameFromCache(p.userId)), 1)
                        ]),
                        _: 2
                      }, 1032, ["content"])
                    ])
                  ]),
                  c("td", Ih, v(p.endTime > 0 ? new Date(p.endTime * 1e3).toLocaleString() : "-"), 1),
                  c("td", Ah, [
                    g($t, {
...
}), Sh = { class: "member-list-panel-modal" }, Th = {
  key: 0,
  class: "member-list-empty"
}, Rh = {
  key: 1,
  ...
  key: 2,
  class: "member-list-table"
}, xh = { class: "member-table-user" }, Nh = { class: "member-table-user-cell" }, kh = { class: "member-table-user-name" }, Dh = { class: "member-table-time" }, Oh = { class: "member-table-action" }, Uh = /* @__PURE__ */ Se({
  __name: "BannedModal",
  props: {
    visible: { type: Boolean },
    bannedList: {},
  ...
  setup(e, { emit: n }) {
    ...
    return (l, d) => {
      ...
      return y(), ne(u, {
        ...
        default: E(() => [
          c("div", Sh, [
            e.memberListLoading ? (y(), w("div", Th, v(t(i)(t(r).LOADING)), 1)) : e.bannedList.length === 0 ? (y(), w("div", Rh, v(t(i)(t(r).NO_BANNED_MEMBERS)), 1)) : (y(), w("table", Lh, [
              c("thead", null, [
                c("tr", null, [
                  c("th", null, v(t(i)(t(r).USER)), 1),
              ...
              c("tbody", null, [
                (y(!0), w(Ee, null, ke(e.bannedList, (p) => (y(), w("tr", {
                  key: p.userId
                }, [
                  c("td", xh, [
                    c("div", Nh, [
                      ...
                      g(t(Ct), {
                        ...
                        default: E(() => [
                          c("span", kh, v(e.getUserNameFromCache(p.userId)), 1)
                        ]),
                        _: 2
                      }, 1032, ["content"])
                    ])
                  ]),
                  c("td", Dh, v(p.endTime > 0 ? new Date(p.endTime * 1e3).toLocaleString() : "-"), 1),
                  c("td", Oh, [
                    g($t, {
...
}), Ph = { class: "dropdown-header" }, Vh = /* @__PURE__ */ Se({
...
function zh() {
  ...
  return {
    ...
    showModerationDropdown: (S, M, Z, V) => {
      n.visible = !0, n.x = S, n.y = M, n.itemId = Z, n.content = V;
    },
    hideModerationDropdown: () => {
      n.visible = !1;
    },
    showAudienceDropdown: (S, M, Z, V) => {
      i.visible = !0, i.x = S, i.y = M, i.userId = Z, i.userName = V;
    },
...
const Gh = { class: "live-control-container" }, Bh = { class: "live-control-viewport" }, Wh = { class: "right-sidebar" }, Ri = 20, Hh = /* @__PURE__ */ Se({
  __name: "live-control",
  setup(e) {
    var Gn;
    const n = Do(), i = _i(), s = P(() => n.params.liveId), o = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__, { t: a } = De(), { currentLive: l, fetchLiveDetail: d, fetchLiveStats: u, endLive: p, updateLive: f } = Ft(), { audienceList: h, audienceCount: m } = $a(), b = (Gn = Yi().components) == null ? void 0 : Gn.roomControl, {
      mutedList: R,
      bannedList: S,
      memberLoading: M,
      muteMember: Z,
    ...
    } = zh(), ae = P(() => Oa() || ""), $ = C(!0), ce = C(null), _e = C(!1), Ue = C("chat"), Ne = C(0), je = C(null), Xe = C(/* @__PURE__ */ new Map()), ct = C(null), pe = Ui({
      onlineCount: 0,
      totalViewers: 0,
      totalMsgCount: 0,
    ...
    const Ve = C([]), Re = C(1), mt = O, at = C(0), F = C([]), se = P(
      ...
      if (!mt.value && s.value)
        try {
          ...
          Ve.value = Fe.map(it), at.value = Math.max(0, fe.value - Ci), Re.value = G, F.value = F.value.filter(
            (To) => Fe.some((Ro) => Ro.id === To)
          );
        } catch (G) {
          console.error("[moderation] load failed:", G), j.error(a(r.OPERATION_FAILED));
        }
    }, Qi = async () => {
      await Pt(Re.value), j.success(a(r.REFRESHED));
    }, wi = (_) => {
      ...
      if (_.length > 0 && _.every((G) => F.value.includes(G)))
        ...
        _.forEach((Y) => G.add(Y)), F.value = Array.from(G);
      }
    }, We = (_) => ({
      normal: "Normal",
      porn: "Porn",
      ...
      try {
        await aa([_.id]), j.info(a(r.DELETED)), await Mt([_.id]);
      } catch (I) {
      ...
      const _ = [...F.value];
      try {
        await aa(_), j.info(a(r.DELETED)), await Mt(_);
      } catch (I) {
    ...
    const en = P(
      ...
      s.value && (ea(_, en.value) || (G ? (confirmDialogTitle.value = a(r.CONFIRM_UNMUTE_USER), confirmDialogContent.value = a("Unmute Confirm", { name: I }), confirmAction.value = async () => {
        try {
          await U(_), $e("success", a("Unmuted Success", { name: I })), ui();
        } catch (Y) {
          const { code: K, info: be } = xt(Y), Ce = Y instanceof Error ? Y : new Error(String(Y)), Fe = K ? gt(K, be) : Ce.message || a(r.UNKNOWN_HOST);
          $e("error", a("Operation Failed", { error: Fe }));
        } finally {
          confirmDialogVisible.value = !1;
        }
        ...
        try {
          await T(_, ws), $e("success", a("Muted Success", { name: I })), ui();
        } catch (Y) {
          const { code: K, info: be } = xt(Y), Ce = Y instanceof Error ? Y : new Error(String(Y)), Fe = K ? gt(K, be) : Ce.message || a(r.UNKNOWN_HOST);
          $e("error", a("Mute Failed", { error: Fe }));
        } finally {
          confirmDialogVisible.value = !1;
        }
      }), confirmDialogVisible.value = !0));
    }, Fn = (_, I, G) => {
      s.value && (ea(_, en.value) || (G ? (confirmDialogTitle.value = a(r.CONFIRM_UNBAN_USER), confirmDialogContent.value = a("Unban Confirm", { name: I }), confirmAction.value = async () => {
        try {
      ...
      di(), ve.value = !0;
    }, po = (_) => Array.isArray(R.value) && R.value.some((I) => I.userId === _), Pn = (_) => Array.isArray(S.value) && S.value.some((I) => I.userId === _), bo = (_) => {
      ...
      if (s.value)
        try {
          ...
          if (K) {
            const be = Qn(K, K.Owner_Account || "-"), Ce = Jn(K);
            K.anchor ? ct.value = {
            ...
            const Fe = K.CreateTime ? K.CreateTime * 1e3 : null;
            if (je.value = Fe, Fe) {
          ...
          if ((I = Ce.message) != null && I.includes("network") || (G = Ce.message) != null && G.includes("fetch"))
            ...
            const Fe = K ? gt(K, be) : Ce.message || a(r.NETWORK_ERROR);
            $e("error", a("Request Failed", { error: Fe }));
          }
        } finally {
          $.value = !1;
        }
...
}), gm = /* @__PURE__ */ ci(Hh, [["__scopeId", "data-v-9a0414f7"]]), Yh = { class: "gift-config-container" }, jh = { class: "gift-config-page-header" }, Xh = { class: "gift-config-title" }, Kh = { class: "gift-config-actions" }, qh = { class: "gift-search-input" }, Zh = { class: "gift-id" }, Qh = { class: "gift-id-text" }, Jh = { class: "gift-thumbnail" }, ev = ["src", "alt"], tv = { key: 1 }, iv = ["onClick"], nv = { class: "gift-lang-tags" }, av = ["onClick"], ov = {
  key: 1,
  class: "gift-lang-empty"
}, sv = { class: "gift-loading-container" }, lv = { class: "gift-loading-text" }, rv = { class: "gift-empty-container" }, cv = { class: "gift-empty-text" }, uv = { class: "textarea-count-wrapper" }, dv = {
  key: 0,
  class: "form-field__error-tip"
}, hv = { class: "gift-lang-config-container" }, vv = { class: "gift-lang-config-info-banner" }, mv = {
  width: "16",
  height: "16",
  viewBox: "0 0 16 16",
  fill: "none",
  style: { "flex-shrink": "0" }
}, fv = { class: "gift-lang-config-table" }, gv = { class: "gift-lang-table-cell-name" }, pv = {
  key: 1,
  class: "gift-lang-table-empty"
}, bv = { class: "gift-lang-table-cell-desc" }, yv = {
  key: 1,
  class: "gift-lang-table-empty"
}, Ev = { class: "gift-category-edit-tags" }, _v = ["onClick"], wv = { class: "gift-category-add-wrapper" }, Cv = { class: "category-select-list" }, Iv = {
  key: 0,
  class: "category-select-empty"
}, Av = { class: "category-select-footer" }, mi = 0, Li = 2147483647, Jt = 1, ei = 99, pm = /* @__PURE__ */ Se({
  __name: "gift-config",
  setup(e) {
    var Mt;
    ...
    const R = P(() => d.value.giftLangConfig), S = P(() => d.value.editingLang);
    P(() => d.value.editingGiftForLang);
    const M = P(() => d.value.langEditForm);
    P(() => d.value.editingCategoryGift);
    const Z = P(() => d.value.allCategories), V = P(() => d.value.giftCategoryIds);
    ...
    const q = P({
    ...
    ), N = C(!1), L = C(!1), T = C(null), U = C(null), k = C(!1), x = C(!1), A = Ui({
      id: "",
      name: "",
      iconUrl: "",
      price: 0,
      ...
      var te, We;
      (te = T.value) == null || te.reset(), (We = U.value) == null || We.reset(), l.closeDialog();
    }, ge = () => {
      var z, te;
      me(), (z = T.value) == null || z.reset(), (te = U.value) == null || te.reset(), l.openCreateDialog();
    }, le = async (z) => {
      var te, We;
      (te = T.value) == null || te.reset(), (We = U.value) == null || We.reset(), A.id = z.id, A.name = z.name, A.iconUrl = z.iconUrl, A.price = z.price, A.animationUrl = z.animationUrl || "", A.levelNum = z.level ? parseInt(z.level) : void 0, A.description = z.description || "", A.extensionInfo = z.extensionInfo || "", A.enabled = z.enabled ?? !0, l.openEditDialog(z), await Je(), z.iconUrl && T.value && T.value.switchToUrlMode(), z.animationUrl && U.value && U.value.switchToUrlMode();
    }, me = () => {
      ...
      const z = ((We = T.value) == null ? void 0 : We.isUrlInputMode) ?? !0, te = z && (((Oe = (St = (ut = T.value) == null ? void 0 : ut.urlInputValue) == null ? void 0 : St.trim) == null ? void 0 : Oe.call(St)) || "");
      if (!k.value && !A.iconUrl.trim() && !te) {
        z && ((Tt = T.value) == null || Tt.setUrlError(o(r.ENTER_THUMBNAIL_URL))), j.error(o(r.UPLOAD_THUMBNAIL_OR_ENTER_URL));
        return;
      }
    ...
    }, Pt = (z) => l.requestDelete(z), Qi = () => void l.confirmDelete(), wi = () => l.onLanguageChanged();
    return At(async () => {
      L.value = await Da(), Pi.on("languageChanged", wi), await l.init();
    }), Ei(() => {
      Pi.off("languageChanged", wi), u(), l.dispose();
    }), (z, te) => {
      const We = ee("t-input"), ut = ee("t-button"), St = ee("t-card"), Oe = ee("t-form-item"), Tt = ee("t-input-number"), jt = ee("t-textarea"), Vt = ee("t-form"), qe = ee("t-dialog"), zt = ee("t-option"), Ji = ee("t-select");
      return y(), w("div", Yh, [
        c("div", jh, [
          c("h1", Xh, v(t(o)(t(r).GIFT_MANAGEMENT)), 1),
          c("div", Kh, [
            c("div", qh, [
              g(We, {
                "model-value": h.value,
          ...
          default: E(() => [
            g(Zi, {
              ...
              "cell-categories": E(({ row: X }) => {
                ...
                return [
                  c("div", {
                    ...
                    c("span", null, v(((ye = X.categories) == null ? void 0 : ye.join(", ")) || "-"), 1),
                    g(t(Fi), {
              ...
              "cell-languageList": E(({ row: X }) => [
                c("div", nv, [
                  X.languageList && X.languageList.length > 0 ? (y(!0), w(Ee, { key: 0 }, ke(X.languageList, (ye) => (y(), w("span", {
                    key: t(ii)(ye),
                    class: "gift-lang-tag",
                    onClick: (Xt) => at(X.id, t(xa)(t(ii)(ye)))
                  }, v(t(o)(t(Na)(t(ii)(ye)))), 9, av))), 128)) : (y(), w("span", ov, "-")),
                  g(t(Fi), {
              ...
              loading: E(() => [
                c("div", sv, [
                  ...
                  c("span", lv, v(t(o)(t(r).LOADING)), 1)
                ])
              ]),
              empty: E(() => [
                c("div", rv, [
                  c("span", cv, v(t(o)(t(r).NO_GIFT_DATA)), 1)
                ])
              ]),
              _: 1
            }, 8, ["data", "loading"])
          ...
          footer: E(() => {
            ...
            return [
              ...
              g(ut, {
                theme: "primary",
                shape: "round",
                disabled: N.value || !m.value && !A.id || !A.name.trim() || ((X = T.value) == null ? void 0 : X.isValidating) || ((ye = U.value) == null ? void 0 : ye.isValidating) || ((Xt = T.value) == null ? void 0 : Xt.hasUrlError) || ((Rt = U.value) == null ? void 0 : Rt.hasUrlError),
                loading: N.value,
                onClick: Ve
              }, {
                default: E(() => [
                ...
                return [
                  ...
                  g(Oe, {
                    ...
                    default: E(() => [
                      g(Bi, {
                        ...
                        onFileReady: te[3] || (te[3] = (ye) => k.value = !!ye)
                  ...
                  g(Oe, {
                    ...
                    default: E(() => [
                      g(Bi, {
                        ...
                        onFileReady: te[5] || (te[5] = (ye) => x.value = !!ye)
                  ...
                  g(Oe, {
                    ...
                    default: E(() => [
                      ...
                      t(Q)(A.extensionInfo) > t(hi) ? (y(), w("div", dv, v(t(o)("Extension info max bytes", { max: t(hi) })), 1)) : ue("", !0)
                    ]),
                    _: 1
                  }, 8, ["label"])
                ];
          ...
          default: E(() => [
            c("div", hv, [
              ...
              c("table", fv, [
                ...
                c("tbody", null, [
                  (y(!0), w(Ee, null, ke(t(ka), (X) => (y(), w("tr", { key: X }, [
                    c("td", null, v(t(o)(t(Ut)[X].label)), 1),
                    c("td", gv, [
                      R.value[X].name ? (y(), w(Ee, { key: 0 }, [
                        B(v(R.value[X].name), 1)
                      ], 64)) : (y(), w("span", pv, v(t(o)(t(r).NOT_CONFIGURED)), 1))
                    ]),
                    c("td", bv, [
                      R.value[X].description ? (y(), w(Ee, { key: 0 }, [
                        B(v(R.value[X].description), 1)
                      ], 64)) : (y(), w("span", yv, v(t(o)(t(r).NOT_CONFIGURED)), 1))
                    ]),
                    c("td", null, [
                      g($t, {
                        actions: Xe(X)
            ...
            g(Vt, {
              ...
              default: E(() => [
                g(Oe, {
                  ...
                  default: E(() => [
                    g(We, {
                      "model-value": M.value.name,
                      placeholder: S.value ? t(o)(t(r).ENTER_LANGUAGE_GIFT_NAME, { lang: t(o)(t(Ut)[S.value].label) }) : "",
                      status: t(Q)(M.value.name) > t(Ze) ? "error" : "default",
                      tips: t(Q)(M.value.name) > t(Ze) ? t(o)(t(r).GIFT_NAME_MAX_BYTES, { max: t(Ze) }) : "",
                      "onUpdate:modelValue": ve
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Q)(M.value.name) > t(Ze) }])
                        }, v(t(Q)(M.value.name)) + "/" + v(t(Ze)), 3)
                      ]),
                      _: 1
                    }, 8, ["model-value", "placeholder", "status", "tips"])
                  ]),
                ...
                g(Oe, {
                  ...
                  default: E(() => [
                    g(We, {
                      "model-value": M.value.description,
                      placeholder: S.value ? t(o)(t(r).ENTER_LANGUAGE_GIFT_DESCRIPTION, { lang: t(o)(t(Ut)[S.value].label) }) : "",
                      status: t(Q)(M.value.description) > t(Qe) ? "error" : "default",
                      tips: t(Q)(M.value.description) > t(Qe) ? t(o)(t(r).GIFT_DESC_MAX_BYTES, { max: t(Qe) }) : "",
                      "onUpdate:modelValue": ae
                    }, {
                      suffix: E(() => [
                        c("span", {
                          class: we(["input-suffix-count", { "byte-overflow": t(Q)(M.value.description) > t(Qe) }])
                        }, v(t(Q)(M.value.description)) + "/" + v(t(Qe)), 3)
                      ]),
                      _: 1
                    }, 8, ["model-value", "placeholder", "status", "tips"])
                  ]),
        ...
        g(qe, {
          visible: oe.value,
          "onUpdate:visible": te[12] || (te[12] = (X) => oe.value = X),
          ...
          "confirm-btn": { content: t(o)(t(r).CLOSE), shape: "round" },
          "cancel-btn": null,
          onConfirm: te[13] || (te[13] = (X) => oe.value = !1)
        }, {
          default: E(() => [
            c("div", Ev, [
              V.value.length > 0 ? (y(!0), w(Ee, { key: 0 }, ke(V.value, (X) => (y(), w("span", {
                key: X,
          ...
          default: E(() => [
            c("div", Cv, [
              g(Ji, {
                ...
                default: E(() => [
                  (y(!0), w(Ee, null, ke(D.value, (X) => (y(), ne(zt, {
                    key: X.id,
                    value: X.id,
                    label: X.name
              ...
              D.value.length === 0 ? (y(), w("div", Iv, v(t(o)(t(r).NO_AVAILABLE_CATEGORIES)), 1)) : ue("", !0)
            ]),
            c("div", Av, [
              g(ut, {
                theme: "primary",
...
}), Mv = { class: "gift-category-container" }, Sv = { class: "gift-category-page-header" }, Tv = { class: "gift-category-title-section" }, Rv = ["viewBox", "stroke-width", "stroke-linecap"], Lv = ["d"], xv = { class: "gift-category-actions" }, Nv = {
  key: 0,
  class: "create-category-tooltip"
}, kv = { class: "gift-category-table-wrapper" }, Dv = { class: "gift-id" }, Ov = { class: "gift-id-text" }, Uv = { class: "category-name" }, $v = { class: "category-desc" }, Fv = { class: "category-lang-tags" }, Pv = ["onClick"], Vv = {
  key: 1,
  class: "category-lang-empty"
}, zv = { class: "category-count" }, Gv = { class: "category-loading-container" }, Bv = { class: "category-loading-text" }, Wv = { class: "category-empty-container" }, Hv = { class: "category-empty-text" }, Yv = { class: "category-lang-config-container" }, jv = { class: "category-lang-config-info-banner" }, Xv = {
  width: "16",
  height: "16",
  viewBox: "0 0 16 16",
  fill: "none",
  style: { "flex-shrink": "0" }
}, Kv = { class: "category-lang-config-table" }, qv = { class: "category-lang-table-cell-name" }, Zv = {
  key: 1,
  class: "category-lang-table-empty"
}, Qv = { class: "category-lang-table-cell-desc" }, Jv = {
  key: 1,
  class: "category-lang-table-empty"
}, bm = /* @__PURE__ */ Se({
  __name: "gift-category",
  setup(e) {
    const n = _i(), { t: i } = De(), s = Fa(), o = new Ss({
      actions: {
      ...
      a.value = o.getState();
    }), d = P(() => a.value.loading), u = P(() => a.value.categoryList), p = P(() => a.value.isEdit), f = P(() => a.value.formData), h = P(() => a.value.categoryLangConfig), m = P(() => a.value.editingLang), b = P(() => a.value.langEditForm), R = P({
    ...
    return At(() => {
      o.init(), Pi.on("languageChanged", U);
    }), Ei(() => {
      Pi.off("languageChanged", U), l(), o.dispose();
    }), (k, x) => {
      ...
      return y(), w("div", Mv, [
        c("div", Sv, [
          ...
          c("div", xv, [
            c("div", {
              ...
              u.value.length >= t(nn) ? (y(), w("div", Nv, v(t(i)(t(r).CATEGORY_LIMIT_REACHED)), 1)) : ue("", !0)
            ], 2)
          ])
        ]),
        c("div", kv, [
          g(Zi, {
            ...
            "cell-description": E(({ row: $ }) => [
              c("span", $v, v($.description || "-"), 1)
            ]),
            "cell-languageList": E(({ row: $ }) => [
              c("div", Fv, [
                $.languageList && $.languageList.length > 0 ? (y(!0), w(Ee, { key: 0 }, ke($.languageList, (ce) => (y(), w("span", {
                  key: t(ii)(ce),
                  class: "category-lang-tag",
                  onClick: (_e) => O($.id, ce)
                }, v(t(i)(t(Na)(t(ii)(ce)))), 9, Pv))), 128)) : (y(), w("span", Vv, "-")),
                g(t(Fi), {
            ...
            loading: E(() => [
              c("div", Gv, [
                ...
                c("span", Bv, v(t(i)(t(r).LOADING)), 1)
              ])
            ]),
            empty: E(() => [
              c("div", Wv, [
                c("span", Hv, v(t(i)(t(r).CREATE_CATEGORY_FIRST)), 1)
              ])
            ]),
            _: 1
          }, 8, ["data", "loading"])
          ...
          default: E(() => [
            c("div", Yv, [
              ...
              c("table", Kv, [
                ...
                c("tbody", null, [
                  (y(!0), w(Ee, null, ke(t(ka), ($) => (y(), w("tr", { key: $ }, [
                    c("td", null, v(t(i)(t(Ut)[$].label)), 1),
                    c("td", qv, [
                      h.value[$].name ? (y(), w(Ee, { key: 0 }, [
                        B(v(h.value[$].name), 1)
                      ], 64)) : (y(), w("span", Zv, v(t(i)(t(r).NOT_CONFIGURED)), 1))
                    ]),
                    c("td", Qv, [
                      h.value[$].description ? (y(), w(Ee, { key: 0 }, [
                        B(v(h.value[$].description), 1)
                      ], 64)) : (y(), w("span", Jv, v(t(i)(t(r).NOT_CONFIGURED)), 1))
                    ]),
                    c("td", null, [
                      g($t, {
                        actions: N($)
        ...
        g(ae, {
          visible: M.value,
          "onUpdate:visible": x[10] || (x[10] = ($) => M.value = $),
              ...
              default: E(() => [
                ...
                g(he, {
                  ...
                  default: E(() => [
                    g(ie, {
                      modelValue: oe.value,
                      "onUpdate:modelValue": x[9] || (x[9] = ($) => oe.value = $),
...
let Le = null, em = !0;
const ga = C([]), pa = C(!0), ba = C(null), tm = C({}), im = C(null);
let Te = null;
const ki = C([]), bn = C(1), yn = C(!0), En = C(!1);
function ya() {
  return Te || (Te = new $s({
    pageSize: 8,
    initialPage: 1,
    ...
    ki.value = e.pageData, bn.value = e.currentPage, yn.value = e.hasMore, En.value = e.loading;
  }), Te);
}
function Ft() {
  const e = () => {
    Le || (Le = new Ts({
      onStateChange: (M) => {
        M.liveList !== void 0 && (ga.value = M.liveList), M.hasMore !== void 0 && (pa.value = M.hasMore), M.currentLive !== void 0 && (ba.value = M.currentLive), M.loading !== void 0 && (tm.value = M.loading), M.error !== void 0 && (im.value = M.error);
      },
      getActive: () => em
  ...
  return tt(() => {
    ...
    if (e(), ya(), Te) {
      const M = Te.getSnapshot();
      ki.value = M.pageData, bn.value = M.currentPage, yn.value = M.hasMore, En.value = M.loading;
    }
    Te == null || Te.goToFirstPage().catch((M) => {
      console.error("[useLiveMonitorState] Failed to load first page:", M);
    });
  }), Le || e(), ya(), {
    init: (M) => {
      if (console.log("[useLiveMonitorState] init called", { hasCore: !!Le, configKeys: Object.keys(M) }), Le || (console.warn("[useLiveMonitorState] core is null, initializing..."), e(), console.log("[useLiveMonitorState] after initCore, hasCore:", !!Le)), !Le) {
        console.error("[useLiveMonitorState] core is still null after initCore! Cannot initialize.");
        return;
      }
      Le.init(M), Te == null || Te.goToFirstPage().catch((Z) => {
    ...
    currentLive: ba,
    setCurrentLive: (M) => {
      Le == null || Le.setCurrentLive(M);
    },
    fetchLiveList: async (M) => {
      if (!Te)
        return console.warn("[useLiveMonitorState] fetchLiveList: controller is null, returning empty list"), [];
      switch (M == null ? void 0 : M.action) {
        case "first":
          await Te.goToFirstPage();
          break;
        case "prev":
          await Te.prevPage();
          break;
    ...
    fetchLiveDetail: async (M) => Le ? Le.fetchLiveDetail(M) : (console.warn("[useLiveMonitorState] fetchLiveDetail: core is null, returning null"), null),
    fetchLiveStats: async (M) => Le ? Le.fetchLiveStats(M) : (console.warn("[useLiveMonitorState] fetchLiveStats: core is null, returning empty object"), {}),
    startPlay: async (M) => {
      if (!Le) {
        console.warn("[useLiveMonitorState] startPlay: core is null, skipping");
        return;
      }
      return Le.startPlay(M);
    },
    stopPlay: async (M) => {
      if (!Le) {
        console.warn("[useLiveMonitorState] stopPlay: core is null, skipping", M);
        return;
      }
      return Le.stopPlay(M);
    },
    paginatedList: {
      pageData: ki,
      currentPage: bn,
      hasMore: yn,
      loading: En,
      nextPage: () => (Te == null ? void 0 : Te.nextPage()) ?? Promise.resolve(),
      prevPage: () => (Te == null ? void 0 : Te.prevPage()) ?? Promise.resolve(),
      goToFirstPage: () => (Te == null ? void 0 : Te.goToFirstPage()) ?? Promise.resolve(),
      refreshCurrentPage: () => (Te == null ? void 0 : Te.refreshCurrentPage()) ?? Promise.resolve()
    }
  };
}
export {
