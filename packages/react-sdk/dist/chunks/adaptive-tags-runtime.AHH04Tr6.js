import { c8 as B, c9 as $, s as T, p as C, j as g, t as D, b5 as P } from "./main-layout.BaegCxnU.js";
import { s as _, t as R, a as F, f as G } from "./utils.BGTYS6E9.js";
import { au as q, I as H } from "./layout.DppKPdLU.js";
import { j as k } from "./logger.DCFRj533.js";
class K extends $ {
  constructor(e, t, s) {
...
const z = B(J, "switchMap"), N = 600 * 1e3;
class ne {
  constructor(e) {
...
function A(o) {
  ...
  for (let a = 0; a < u.length; a++) {
    const c = u[a], w = u.length - a - 1, O = w > 0 ? f : 0, I = h > 0 ? r : 0, U = p + I + c + (w > 0 ? r + O : 0), S = y - U, j = Math.max(60, S - i - l);
    if (M > j || S < E + l)
      break;
    p += I + c, h++;
  }
