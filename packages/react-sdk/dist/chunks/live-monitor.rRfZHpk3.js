...
import st, { useState as _, useRef as ee, useEffect as J, useCallback as w, isValidElement as rn, createElement as nn, Component as an, useMemo as _e, forwardRef as on, useImperativeHandle as sn, useLayoutEffect as mr, useSyncExternalStore as tr } from "react";
...
import { MessagePlugin as wt, Dialog as ge, Button as Y, Input as fe, Select as sr, InputNumber as Qt, Checkbox as vn, Card as Wr, Tabs as Bt, Switch as En, Tooltip as xe, Loading as Nn, Textarea as Cn } from "tdesign-react";
import { w as yn, bb as _n, b0 as bn, a2 as In, a9 as Ln, aF as Sn, aD as Tn, m as An, u as wn, co as Rn, cn as Mn, b$ as On, b_ as Dn, aS as W, N as Nt, aZ as xn, bP as zr, bQ as Br, b7 as Un, b as kn, _ as Pn, bi as Hr, bl as Fn, a1 as Gn, cc as fr, ci as Vn, bA as gr, cg as Wn, cf as zn, ce as Bn, bK as Hn, bz as Kn, au as Yn, bJ as $n, bC as qn, aU as Xn, a0 as jn, ar as vr, A as je, O as ke, aT as Zn, bh as Jn, bn as Qn, bq as Ut, i as Ue, ap as ea, bR as Kr, x as cr, a4 as ta, c2 as ra, as as Er, Z as Nr, aA as na, cd as aa, aj as ia, aV as oa, R as sa, b5 as ca, a6 as la, aL as da, $ as Ht, bt as ua, aW as Yr, bI as ha, bf as Ot, bZ as ma, a8 as pa, ae as fa, V as Rt, ac as ga, bm as va, aY as tt, k as Ea, bv as Cr, D as Na, a as Ke, q as Ze, r as Me, o as Oe, p as gt, bS as Ca, z as $r, F as Pe, b1 as ya, y as qr, aO as _a, v as ba, bs as yr, s as _r, t as Ia, T as Kt, d as vt, f as we, C as Re, S as La, aE as Sa } from "./main-layout.DUWbMPfj.js";
import { c as Ta, g as Aa, s as lr, a as wa, D as Ra, d as Ma, e as Oa, m as Da, b as xa, i as Ua, P as ka } from "./gift-category.DaeXtH9F.js";
import { I as a, N as Yt, g as yt, O as dr, J as Pa, H as Fa, F as Xr, D as be, t as ur, k as lt } from "./en-US.rgXKsoPj.js";
import { c as Ga } from "./config.BhtXZwQl.js";
...
function Jr(r) {
  const { liveId: n, pageSize: t } = r, [i, c] = _(!1), [o, s] = _(0), [p, l] = _([]), [d, f] = _(1), [g, v] = _(0), [h, N] = _(!1), [m, T] = _([]), [A, E] = _([]), [S, R] = _(!1), [C, I] = _(null), P = ee(!0);
  J(() => (P.current = !0, () => {
    P.current = !1;
  }), []);
  const B = w(async () => {
    ...
    N(!0);
    try {
      const G = await bn({ pageSize: t, liveId: n, ...b });
    ...
    try {
      ...
      return await In({ ids: b.ids, items: G, liveId: b.liveId ?? n });
    } catch (G) {
      throw console.error("[useRiskControlState] approveTextModerationItems failed:", G), G;
    }
  }, [n, p]), Z = w(async (b) => {
    try {
      return await Ln({ content: b.keywords.join(","), liveId: n });
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await An(n, b.memberAccounts, b.muteTime), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await wn(n, b.memberAccounts), await j();
    } catch (G) {
    ...
    R(!0), I(null);
    try {
      await Rn(n, b.memberAccounts, b.duration, b.reason), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    R(!0), I(null);
    try {
      await Mn(n, b.memberAccounts), await X();
    } catch (G) {
      I(G);
    } finally {
      R(!1);
    ...
    if (!n) throw new Error("liveId is required");
    try {
      return await On(n, "default", "您的内容涉嫌违规");
    } catch (b) {
...
const q = {
  success: (r) => wt.success(r),
  error: (r) => wt.error(r),
  warning: (r) => wt.error(r),
  info: (r) => wt.info(r)
}, Qr = ({
  visible: r,
  liveId: n = "",
...
function Pt({
  ...
  return !o || p ? /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: xn(n) }) : /* @__PURE__ */ e("div", { className: r, title: i, "aria-label": d, children: /* @__PURE__ */ e(
    "img",
    {
      src: o,
      alt: d,
...
const Za = ({
  ...
  var H, D, Z, j, X;
  const { t: h } = ve(), { startPlay: N, stopPlay: m } = mt(), T = (H = yt().components) == null ? void 0 : H.liveMonitor, A = ((D = r.avatarUrl) == null ? void 0 : D.trim()) || "", E = (c == null ? void 0 : c.avatarUrl) || ((Z = r.anchor) == null ? void 0 : Z.avatarUrl) || A || zr(r), S = (c == null ? void 0 : c.nick) || ((j = r.anchor) == null ? void 0 : j.nick) || Br(r, h(a.UNKNOWN_HOST)), R = ((X = r.stats) == null ? void 0 : X.viewCount) ?? 0, C = _e(() => `live_monitor_view_${r.liveId}`, [r.liveId]), I = ee(""), P = ee(0), B = ee(null);
  return J(() => {
    const M = r.liveId;
    if (!M) return;
    const L = ++P.current;
    ...
    return (async () => {
      ...
      try {
        ...
        !y && P.current === L && ($ === kt.LOGIN_TIMEOUT || $ === kt.USER_SIG_ILLEGAL) && (Pa(), Fa(), localStorage.removeItem("tuiLiveMonitor-userInfo"), window.location.href = "/#/config-required");
      }
    })(), () => {
      y = !0, P.current += 1;
      const $ = I.current || M;
  ...
  return T.current = l, J(() => {
    ...
    const E = A.filter((S) => !g.has(S));
    E.length !== 0 && Xr(E).then((S) => {
      N.current || v((R) => {
        const C = new Map(R);
  ...
  const {
    ...
    fetchLiveDetail: l,
    isUnmountedRef: d
  } = r, f = _t(), { t: g } = ve(), [v, h] = _({ visible: !1, liveId: "", liveName: "", closing: !1 }), [N, m] = _({ visible: !1, liveId: "", liveName: "" }), [T, A] = _(!1), E = ee(!1), [S, R] = _(!1), C = w((X, M) => {
  ...
  const { pageSize: n, isSearchModeRef: t, isUnmountedRef: i, pageVersionRef: c } = r, [o, s] = _(/* @__PURE__ */ new Map()), p = ee(null), l = ee(""), d = w(() => {
    p.current && (clearTimeout(p.current), p.current = null);
  }, []), f = w(() => {
    const m = /* @__PURE__ */ new Date(), T = new Date(m.getTime() - 3600 * 1e3), A = (E) => {
    ...
    l.current = S;
    try {
      const { startTime: R, endTime: C } = f(), I = await Un(E, 10, R, C);
      if (i.current || c.current !== A || l.current !== S)
        return;
      s((P) => {
        const B = new Map(P);
        return E.forEach((H) => {
      ...
      !i.current && c.current === A && l.current === S && !t.current && (p.current = setTimeout(() => {
        g(m, T, A);
      }, ti));
    }
  }, [n, t, i, c, d, f]), v = w(() => [], []), h = w((...m) => {
    const T = [];
    for (const A of m)
      for (const E of A || [])
...
const To = () => {
  const { t: r } = ve(), { init: n, stopPlay: t, endLive: i, fetchLiveDetail: c, currentLive: o } = mt(), {
    ...
    paginatedList: h,
    userProfileMap: N
  } = Ja(), [m, T] = _(""), [A, E] = _(!1), S = ee(!1), [R, C] = _(null), [I, P] = _(null), {
    getAdaptiveResult: B,
  ...
  return J(() => {
    ...
    (async () => {
      try {
        const te = await ur();
        if (te && te.sdkAppId !== 0) {
          console.log("[LiveMonitor] Initializing SDK with account:", te.userId), Ga({
...
var Zt, Ar;
function li() {
  return Ar || (Ar = 1, Zt = ci()), Zt;
}
var di = li();
const ui = /* @__PURE__ */ Aa(di);
...
function Et(r, n, t, i, c) {
  ...
  return {
    x: wr(r.x, s, t.width, i),
    y: wr(r.y, p, t.height, i)
  };
}
function wr(r, n, t, i) {
  var c = n * i / 2 - t / 2;
...
function Si() {
  ...
  t.current || (t.current = new Pn());
  const i = t.current, c = w((s) => {
...
function Ti(r = {}) {
  const { loop: n = 1, autoPlay: t = !0 } = r, i = ee(null), c = ee(null), o = ee(!1), s = w(() => {
    if (c.current) {
      try {
    ...
    try {
      await new Promise((m, T) => {
        N.load(
          ...
          (A) => {
            try {
              h.loops = n, h.setVideoItem(A), t && (h.startAnimation(), o.current = !0), m();
            } catch (E) {
              T(E);
            }
          },
...
function Ve(r) {
  const { confirm: n, onSuccess: t, ...i } = r, [c, o] = _(null), s = w((h) => {
    o(null), t == null || t(h);
...
const Ft = on(function({
  ...
  sn(R, () => ({
    ...
    reset: () => {
      K.current.reset(), ne.current = null, le(null), Se(!1), se(!1), b(n || ""), L(""), U(""), H(!1), Z(0), X(!1), g && x(!!n), A == null || A(null);
    },
    ...
    b(n), n && g && x(!0), T && (ne.current = null, le(null), se(!1), A == null || A(null));
  }, [n]), J(() => {
    g && n ? x(!0) : g && x(!1);
  }, [g]), J(() => {
    if (!S) return;
  ...
  J(() => {
    ...
    const Q = Ie.current, oe = new lr.Player(Q);
  ...
  const [Le, Te] = _(!1), [ye, Qe] = _(""), [Wt, pt] = _({ x: 0, y: 0 }), [zt, bt] = _(1), [It, et] = _(null), [hr, $e] = _(null), [Lt, St] = _(!1), Tt = w((Q, oe) => {
    et(oe);
  }, []), [At, ft] = _(!1), We = ee(null);
  J(() => () => {
  ...
  const k = w(async (Q) => {
    ...
    if (T) {
      ne.current = Q, le(Q);
      const oe = Q.type.startsWith("video/"), Ee = Kn(Q);
      Se(oe), se(Ee), A == null || A(Q);
      return;
    }
    H(!0), Z(0);
    try {
    ...
    Q == null || Q.stopPropagation(), K.current.cancelValidation(), V(!1), U(""), t(""), b(""), L(""), H(!1), Z(0), X(!1), T && (ne.current = null, le(null), Se(!1), se(!1), A == null || A(null));
  };
  return /* @__PURE__ */ u("div", { className: `image-upload-container ${m}`, children: [
    ...
    n && (y || !g) && /* @__PURE__ */ e(
      "div",
      {
        ...
        children: gr(n) ? /* @__PURE__ */ e("div", { ref: Ie, className: "svga-preview-container" }) : qn(n) ? /* @__PURE__ */ e("video", { src: n, muted: !0, loop: !0, autoPlay: !0, playsInline: !0 }) : /* @__PURE__ */ e("img", { src: n, alt: "preview", onError: (Q) => {
    ...
    /* @__PURE__ */ e(
      ge,
      {
        ...
        children: /* @__PURE__ */ e("div", { className: "image-crop-area", children: Lt || !At ? /* @__PURE__ */ u("div", { className: "image-crop-loading", children: [
          /* @__PURE__ */ e("div", { className: "loading-spinner" }),
...
function wi({ visible: r, onClose: n, onSuccess: t, uploadEnabled: i = !1, extraFieldsSlot: c, onCreate: o }) {
  var Se, ae, se;
  const { t: s } = ve(), p = jn.map((F) => ({
    value: F.value,
    label: s(F.labelKey)
  })), [l, d] = _(vr()), [f, g] = _([]), [v, h] = _(!1), [N, m] = _(!1), [T, A] = _(""), [E, S] = _(""), [R, C] = _(!1), [I, P] = _(""), [B, H] = _(""), [D, Z] = _(null), [j, X] = _(""), M = ee(null), [L, y] = _(!1), x = (F, te) => {
    F === "success" ? q.success(te) : q.error(te);
  }, $ = async (F, te) => {
    try {
      await ea(F), x("success", s(a.COPY_LABEL_COPIED, { label: te }));
    } catch (he) {
    ...
    var F;
    d(vr()), g([]), h(!1), m(!1), A(""), S(""), C(!1), P(""), H(""), Z(null), X(""), y(!1), (F = M.current) == null || F.reset();
  }, U = () => {
    O(), n();
    ...
    ge,
    {
      ...
      children: N ? (
        ...
        /* @__PURE__ */ u(ut, { className: "create-live-form", labelWidth: lt(100), children: [
          ...
          /* @__PURE__ */ e(de, { label: s(a.LAYOUT_TEMPLATE), requiredMark: !0, help: s(((se = Jn(l.seatTemplate)) == null ? void 0 : se.descKey) || ""), children: /* @__PURE__ */ e(
            sr,
            {
              options: p,
          ...
          Qn(l.seatTemplate) && /* @__PURE__ */ e(de, { label: s(a.MAX_SEATS), help: s(a.MAX_SEATS_HELP), children: /* @__PURE__ */ e(
            Qt,
            {
...
function Ri({ visible: r, live: n, onClose: t, onSuccess: i, uploadEnabled: c = !1, extraFieldsSlot: o, onUpdate: s, onFetchDetail: p }) {
  var b, G;
  const { t: l } = ve(), [d, f] = _(Er()), [g, v] = _([]), [h, N] = _(!1), m = ee([]), [T, A] = _(Nr), [E, S] = _(!1), [R, C] = _(""), [I, P] = _(""), { loading: B, execute: H } = ht({
    action: async (V) => {
  ...
  J(() => {
    n != null && n.coverUrl ? na(n.coverUrl).then(A) : A(Nr);
  ...
  const X = () => {
    ...
    try {
      ...
      try {
        ...
        y("error", z instanceof cr ? z.message : l("Cover processing failed"));
        return;
      }
      const U = aa(g);
      if (U) {
      ...
      const K = ia(g), ne = oa(m.current, K);
      await H({
...
function Vt({
  ...
  bodyStyle: g,
  fitContent: v = !1,
  fitContentMaxRows: h = Ra
}) {
  const N = ee(null), m = ee(null), T = ee(null), A = ee(null), E = ee(null), [S, R] = _({}), C = ee({}), [I, P] = _(0);
  Mi(() => P((L) => L + 1));
  const B = w((L) => L.fitContent || v && L.width === void 0, [v]), H = _e(() => {
    const L = {};
    for (const y of r) {
      let x;
      if (B(y)) {
  ...
  mr(() => {
    ...
    const x = () => {
      ...
      for (const { column: ae } of L)
        z[ae.key] !== void 0 && (le[ae.key] = xa(z[ae.key], ae.minWidth, ae.maxWidth));
      C.current = le;
    }, $ = () => {
      var K;
      const V = C.current;
      ...
      const O = ((K = A.current) == null ? void 0 : K.clientWidth) ?? 0, U = Ma(
        r,
        V,
        O,
        B
  ...
  return J(() => {
    ...
    /* @__PURE__ */ e("div", { ref: A, className: `fixed-header-table__body ${s}`.trim(), style: g, children: l ? /* @__PURE__ */ e("div", { className: "fixed-header-table__loading", children: d }) : n.length === 0 ? /* @__PURE__ */ e("div", { className: "fixed-header-table__empty", children: f }) : /* @__PURE__ */ u(
      "table",
      {
        ref: E,
        className: `fixed-header-table__table ${c}`.trim(),
...
function Ao() {
  ...
  J(() => (l.init(), () => l.dispose()), []);
  const f = Ui(), g = _e(() => ca({ hasExtraColumn: !!(s != null && s.tableExtraColumns) }).map((y) => {
    switch (y.key) {
      case "liveId":
        return {
          ...y,
      ...
      case "createdAt":
        return {
          ...
          render: (x) => /* @__PURE__ */ e("span", { className: "live-list-text", children: da(x.createdAt) })
        };
      case "customer-extra":
        return {
          ...y,
  ...
  }), [n, s, l]), { lives: v, loading: h, refreshing: N, currentPage: m, hasMoreData: T, searchInput: A, obsModal: E, confirmDialog: S, isCreateModalVisible: R, isEditModalVisible: C, editingLive: I } = d;
      ...
      /* @__PURE__ */ u("div", { className: "header-actions", children: [
        /* @__PURE__ */ e(
          fe,
          {
            ...
            suffixIcon: /* @__PURE__ */ e(rr, { size: 16 }),
            style: { width: 220 },
            status: W(A) > Ht ? "error" : "default",
            tips: W(A) > Ht ? n(a.INPUT_EXCEEDS_LENGTH_LIMIT) : ""
          }
        ),
        /* @__PURE__ */ e(
          Y,
...
function Pi({
  ...
  const T = (d == null ? void 0 : d.userId) || "", A = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__;
  J(() => {
    if (A) {
...
const Gi = 12 * 1024, Vi = (r) => new TextEncoder().encode(r).length, ct = { current: {} }, Wi = st.memo(
  ({ message: r, style: n }) => {
    var l, d;
    const t = r.sender.userId, i = t === ct.current.anchorUserId, c = r.sender.nameCard || r.sender.userName || t, o = r.messageType === 0 ? r.textContent : r.data || "", s = ha(o);
    return /* @__PURE__ */ u(
      "div",
      {
  ...
  const { t: s } = ve(), { loginUserInfo: p } = jr(), { audienceList: l, disableSendMessage: d } = Ba(), [f, g] = _(!1), [v, h] = _({ top: 0, left: 0 }), [N, m] = _(null), [T, A] = _(""), [E, S] = _(!1), R = ee(null), C = ee(null), I = n;
  ct.current.t = s;
...
function Ki({
  ...
  var H, D, Z;
  const { currentLive: m, currentUserId: T, handleLeaveLive: A } = Pi({
    liveId: t,
    onLiveEnded: h
  }), E = _e(
    () => {
...
function Ji({
  ...
  return J(() => {
    ...
    return E.observe(N, { childList: !0, subtree: !0, characterData: !0 }), T(), () => {
      A.disconnect(), E.disconnect(), m !== null && cancelAnimationFrame(m);
    };
...
function to(r, n) {
  ...
  } = Jr({ liveId: r || "", pageSize: Rt }), [o, s] = _([]), [p, l] = _(!1), [d, f] = _(1), [g, v] = _(0), [h, N] = _([]), [m, T] = _(null), [A, E] = _(null), S = _e(() => fa(g, Rt), [g]), R = w(
    async (b = 1) => {
      if (r) {
        l(!0);
        try {
  ...
  const C = w(async () => {
    ...
    action: async () => {
      if (!A) throw new Error("No target item");
      await c({ keywords: [A.content] });
    },
    confirm: {
    ...
    onSuccess: async () => {
      q.success(n(a.BYPASS_CORRECTION_SUCCESS)), A && await P([A.id]), E(null);
    },
    onError: (b) => {
      q.error(n(a.OPERATION_FAILED, { error: b.message || n(a.UNKNOWN_ERROR) }));
    }
...
function ro(r, n, t) {
  const {
    ...
    banMember: f,
    unbanMember: g
  } = Jr({ liveId: r || "", pageSize: 20 }), [v, h] = _([]), [N, m] = _([]), [T, A] = _(!1), [E, S] = _(null), [R, C] = _(null), [I, P] = _(null), [B, H] = _(null);
  _e(() => {
    Array.isArray(i) && h(i);
  }, [i]), _e(() => {
    Array.isArray(c) && m(c);
  ...
  const D = (O, U) => {
    ...
    action: async () => {
      ...
      await l({ memberAccounts: [E.userId], muteTime: Ea });
    },
    confirm: {
    ...
    action: async () => {
      ...
      await f({ memberAccounts: [I.userId], duration: Na });
    },
    confirm: {
  ...
  }, [r, n, p]), V = w((O) => v.some((U) => U.userId === O), [v]);
  return {
    mutedList: v,
    bannedList: N,
    memberListLoading: T,
...
function wo() {
  ...
  (At = t.components) == null || At.liveMonitor;
  const { t: c } = ve(), {
    init: o,
    fetchLiveDetail: s,
    fetchLiveStats: p,
  ...
  const v = typeof __MOCK_MODE__ < "u" && __MOCK_MODE__, [h, N] = _(v), [m, T] = _(null), [A, E] = _(!1), [S, R] = _("chat"), [C, I] = _(!0), { successMsg: P, errorMsg: B } = ki(), [H, D] = _(null), [Z, j] = _(!1), [X, M] = _(!1), L = Ua(), y = Ve({
    action: async () => {
...
function no({
  ...
  const f = ee(null), g = ee(null), [v, h] = _(!1), [N, m] = _(!1), [T, A] = _(!1), [E, S] = _(!1), R = () => {
    var D, Z;
    ...
    try {
      ...
      try {
        ...
        q.error(V instanceof cr ? V.message : d(a.OPERATION_FAILED, { error: V.message || d(a.UNKNOWN_HOST) }));
        return;
      }
      const G = {
        ...i,
    ...
    ge,
    {
      ...
      children: /* @__PURE__ */ u("div", { className: "gift-lang-config-container", children: [
        ...
        /* @__PURE__ */ u("table", { className: "gift-lang-config-table", children: [
          ...
          /* @__PURE__ */ e("tbody", { children: $r.map((p) => {
            const l = t[p], d = Pe[p];
            return /* @__PURE__ */ u("tr", { children: [
    ...
    /* @__PURE__ */ e(
      ge,
      {
        ...
        children: /* @__PURE__ */ u("div", { className: "gift-category-edit-tags", children: [
          t.map((A) => {
            const E = i.find((R) => String(R.id) === String(A)), S = (E == null ? void 0 : E.name) || A;
            return /* @__PURE__ */ u("span", { className: "gift-category-edit-tag", children: [
              S,
              /* @__PURE__ */ e("button", { className: "gift-category-edit-tag-close", onClick: () => d(A), children: /* @__PURE__ */ e("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", children: /* @__PURE__ */ e("path", { d: "M9 3L3 9M3 3L9 9", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
            ] }, A);
          }),
      ...
      ge,
      {
        ...
        children: /* @__PURE__ */ u("div", { className: "category-select-list", children: [
          /* @__PURE__ */ e(
            ...
            {
              value: o,
              onChange: (A) => g(String(A)),
              placeholder: T(a.SELECT_CATEGORY_LOWERCASE),
              style: { width: "100%" },
              children: c.map((A) => /* @__PURE__ */ e(oo, { value: A.id, label: A.name }, A.id))
            }
          ),
...
function lo() {
  var t;
  const { t: r } = Ai(), n = (t = yt().components) == null ? void 0 : t.giftConfig;
  return (i) => {
    const {
      onEdit: c,
      onDelete: o,
      ...
      },
      {
        ...
        render: (f) => /* @__PURE__ */ u("div", { className: "gift-lang-tags", children: [
          f.languageList && f.languageList.length > 0 ? f.languageList.map((g) => {
            const v = ya(g), h = qr[v], N = h ? Pe[h] : null;
            return /* @__PURE__ */ e(
              "span",
              {
      ...
      },
      {
        ...
        render: (f) => /* @__PURE__ */ e("span", { className: "gift-create-time", children: _a(f.createdAt) })
      }
    ];
...
function Mo() {
  ...
  J(() => {
    const h = () => {
      ...
      if (!T) return;
      const A = T.getBoundingClientRect(), E = m - A.top - 60 - 24;
      f(Math.max(200, E));
    };
  ...
  const g = async () => {
    ...
    if (h.name && W(h.name) > we) {
      q.error(r("Category name max bytes", { max: we }));
      return;
    }
  ...
  return /* @__PURE__ */ u("div", { className: "gift-category-container", children: [
    /* @__PURE__ */ u("div", { className: "gift-category-page-header", children: [
      ...
      /* @__PURE__ */ e("div", { className: "gift-category-actions", children: /* @__PURE__ */ u("div", { className: `create-category-btn-wrapper${o.categoryList.length >= Kt ? " disabled" : ""}`, children: [
        /* @__PURE__ */ u(
          Y,
          {
            shape: "round",
            ...
            disabled: o.categoryList.length >= Kt,
            children: [
              "＋ ",
              r("Add Category")
            ]
        ...
        o.categoryList.length >= Kt && /* @__PURE__ */ e("div", { className: "create-category-tooltip", children: r("Category limit reached") })
      ] }) })
    ] }),
          ...
          },
          {
            ...
            render: (h) => /* @__PURE__ */ u("div", { className: "category-lang-tags", children: [
              h.languageList && h.languageList.length > 0 ? h.languageList.map((N) => {
                const m = typeof N == "string" ? N : N.language || "", T = qr[m], A = T ? Pe[T] : null;
                return /* @__PURE__ */ e(
                  "span",
                  {
                    className: "category-lang-tag",
                    onClick: () => h && T && c.openLangEditDialog(h.id, T),
                    children: A ? r(A.label) : m
                  },
                  m
                );
          ...
          /* @__PURE__ */ e(de, { label: r("Category Name"), requiredMark: !0, children: /* @__PURE__ */ u("div", { className: "form-field__input-wrapper", children: [
            /* @__PURE__ */ e(
              fe,
              {
                ...
                status: W(o.formData.name) > we ? "error" : "default",
                suffix: /* @__PURE__ */ u("span", { className: `input-suffix-count${W(o.formData.name) > we ? " byte-overflow" : ""}`, children: [
                  W(o.formData.name),
                  "/",
                  we
                ] })
            ...
            W(o.formData.name) > we && /* @__PURE__ */ e("div", { className: "form-field__error-tip", children: r("Category name max bytes", { max: we }) })
          ] }) }),
      ...
      ge,
      {
        ...
        children: /* @__PURE__ */ u("div", { className: "category-lang-config-container", children: [
          ...
          /* @__PURE__ */ u("table", { className: "category-lang-config-table", children: [
            ...
            /* @__PURE__ */ e("tbody", { children: $r.map((h) => {
          ...
          /* @__PURE__ */ e(de, { label: r(a.CATEGORY_NAME), children: /* @__PURE__ */ u("div", { className: "form-field__input-wrapper", children: [
            /* @__PURE__ */ e(
              fe,
              {
                ...
                status: W(o.langEditForm.name) > we ? "error" : "default",
                suffix: /* @__PURE__ */ u("span", { className: `input-suffix-count${W(o.langEditForm.name) > we ? " byte-overflow" : ""}`, children: [
            ...
            W(o.langEditForm.name) > we && /* @__PURE__ */ e("div", { className: "form-field__error-tip", children: r(a.CATEGORY_NAME_MAX_BYTES, { max: we }) })
          ] }) }),
...
function mt() {
  ...
  const d = w((P) => {
    ...
    return s.pageData;
  }, []), g = w(async (P) => pe.createLive(P), []), v = w(async (P) => pe.updateLive(P), []), h = w(async (P) => pe.endLive(P), []), N = w(async (P) => pe.fetchLiveDetail(P), []), m = w(async (P) => pe.fetchLiveStats(P), []), T = w((P) => {
    pe == null || pe.setCurrentLive(P);
  }, []), A = w(async (P) => pe.stopPlay(P), []), E = w(async (P) => pe.startPlay(P), [A]), S = w(() => (ie == null ? void 0 : ie.nextPage()) ?? Promise.resolve(), []), R = w(() => (ie == null ? void 0 : ie.prevPage()) ?? Promise.resolve(), []), C = w(() => (ie == null ? void 0 : ie.goToFirstPage()) ?? Promise.resolve(), []), I = w(() => (ie == null ? void 0 : ie.refreshCurrentPage()) ?? Promise.resolve(), []);
  return {
    init: d,
    liveList: r,
    hasMore: t,
