...
class mi {
  ...
  async fetchLiveDetail(t) {
    ...
    try {
      ...
      if (n.status === "fulfilled")
        ...
        throw n.reason;
      const d = c.status === "fulfilled" ? (a = c.value) == null ? void 0 : a.Response : null;
      return g && l.status === "fulfilled" && l.value && (g.streamInfo = l.value), g && d && (g.stats = this.mergeStatisticData(g, d)), g && (this.liveList.some((C) => C.liveId === g.liveId) ? this.liveList = this.liveList.map(
  ...
  mergeStatisticData(t, e) {
    ...
    return e ? {
      ...
      totalUniqueCommenters: e.TotalUniqueCommenters || ((d = t.stats) == null ? void 0 : d.totalUniqueCommenters),
...
function q(s, t = 8e3, e = !1) {
  return new Promise((i, r) => {
    ...
    if (ue(s)) {
      ...
      fe(s, t > 8e3 ? t : 15e3).then(() => i(!0)).catch(r);
      return;
    }
  ...
  return r.sort((n, c) => {
    ...
    switch (e) {
      ...
      case "viewerCount":
        ...
        break;
      case "duration": {
        const g = n.endedAt ? n.endedAt - n.createdAt : Date.now() / 1e3 - n.createdAt, d = c.endedAt ? c.endedAt - c.createdAt : Date.now() / 1e3 - c.createdAt;
        l = g - d;
        break;
      }
      case "status": {
        const g = n.endedAt ? 1 : 0, d = c.endedAt ? 1 : 0;
        l = g - d;
        break;
      }
      default:
...
const ki = b.mutedList, Bi = b.bannedList, De = 600, Me = 86400, ft = (s) => Array.isArray(s) ? s.filter((t) => !!t && typeof t == "object") : [], j = (s, ...t) => {
...
async function Wi(s) {
  var i;
  const t = await te(s);
  return ft(((i = t.Response) == null ? void 0 : i.MutedAccountList) || t.MutedAccountList).map((r) => ({
    userId: j(r, "Member_Account", "userId", "UserID"),
    endTime: dt(r, "MutedUntil", "endTime")
  })).filter((r) => r.userId);
}
function $i(s, t) {
...
async function Ki(s) {
  var i;
  const t = await Qt(s);
  return ft(((i = t.Response) == null ? void 0 : i.BannedAccountList) || t.BannedAccountList).map((r) => ({
    userId: j(r, "Member_Account", "userId", "UserID"),
    endTime: dt(r, "BannedUntil", "endTime"),
    ...
    if (t) {
      ...
      try {
        ...
        e ? (this.setState({
          ...
          currentPage: 1,
          hasMoreData: !1
        }), this.opts.toast.success(this.opts.t(o.SEARCH_SUCCESS))) : (this.setState({
          lives: [],
          currentPage: 1,
          hasMoreData: !1
        }), this.opts.toast.error(this.opts.t(o.LIVE_NOT_FOUND)));
      } catch (e) {
...
class cr {
  ...
  async openLangEditDialog(t, e) {
    var c;
    const i = this.state.categoryList.find((l) => l.id === t), r = f[e].code, a = (c = i == null ? void 0 : i.languageList) == null ? void 0 : c.find((l) => x(l).langCode === r);
    let n = { ...ct };
    if (a) {
      const l = x(a);
