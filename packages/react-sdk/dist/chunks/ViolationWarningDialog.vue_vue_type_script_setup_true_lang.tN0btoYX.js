...
import { a2 as m, M as n } from "./en-US.BxRaQHCQ.js";
import { ax as x, bl as S } from "./main-layout.DMGRi_CK.js";
import { useUIKit as k } from "@tencentcloud/uikit-base-component-vue3";
import { u as L } from "./useAsyncAction.YVuKppg7.js";
const y = ["title", "aria-label"], G = ["src", "alt"], R = {
  ...
  setup(o) {
    const s = o, e = f(""), l = f(!1), a = _(() => s.name ? `${s.name}头像` : "主播头像"), r = _(() => x(s.name));
    A(() => s.src, (c) => {
