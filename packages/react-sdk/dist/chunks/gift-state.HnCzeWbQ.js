import { aw as u, ax as s, ay as g } from "./en-US.Cyn41QJd.js";
...
async function G(i) {
  ...
  if (e && e.ErrorCode === 0 && e.Response) {
    const t = e.Response.GiftList || [], a = e.Response.CategoryList || [], { giftToCategories: r, giftToCategoryIds: n } = w(a), f = t.map((h) => L(h, r, n)), c = a.map((h) => C(h));
    return {
      gifts: f,
...
const x = 500;
function F(i, e, t = {}) {
  const a = t.ttl ?? x, r = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map();
  return async (...f) => {
...
class q {
  constructor(e = {}) {
    this.giftList = [], this.giftCategoryList = [], this.loading = {}, this.error = null, this.destroyed = !1, this.onStateChange = e.onStateChange, this.deduplicatedFetchGiftList = F(
