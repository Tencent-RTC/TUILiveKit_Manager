...
`) + n + " header " + i + ": " + o : r;
      ...
      var yr, wr, hn, gn, ie, kt, At, Oe, st, br, It, ze, Sr, mn, vn, Er, yn, wn, Rr = !(P.isIE = function() {
...
`), u = r.$getConfig(i), s = !1;
      ...
      ae(Mn = H, S = Zr = S), Mn.prototype = S === null ? Object.create(S) : (ei.prototype = S.prototype, new ei()), H.resolveGzipConfig = function(e) {
      ...
      var ai = function(r) {
        ...
        document.elementFromPoint && (this.pendingTimeouts.forEach(function(B) {
          ...
          return K(zt, void 0, void 0, function() {
            var B, X, Ae, ye, ci, fi, Gt, ht, De, Hn, et, gt, Vt, ue, $t, ce, jn, di, oe, qn, Wn, Jt, Xt, pi, Ie, mt, vt, yt, wt, Kt, Bn, tt, Eo = this;
            return se(this, function(bt) {
              switch (bt.label) {
                case 0:
                  ...
                  return vt = v <= De, yt = !1, jn = { samePointerMap: {}, maximumSamePointer: {} }, d || (oe = Gt.map(function(z) {
                    return z.slice(0, h);
                  }), Qt = oe.map(function(z) {
                    return z.join(" < ");
                    ...
                    return ne[1] - z[1];
                  })[0], hi = zn[0], oe = { samePointerMap: Qt, maximumSamePointerClass: hi, maximumSamePointerCounter: zn[1] }, jn = { samePointerMap: oe.samePointerMap, maximumSamePointer: ((tt = {})[di = oe.maximumSamePointerClass] = oe = oe.maximumSamePointerCounter, tt) }, Hn = oe, tt = yo.some(function(z) {
                    return di.startsWith(z);
                  }), yt = L <= oe && !tt), vt || yt ? [3, 1] : (k = !1, I = null, [3, 8]);
                case 1:
                  return k ? (oe = I?.whitePointCount >= v, tt = I?.samePointCount >= L, qn = oe && tt ? "both" : oe ? "whitePoint" : "sameElement", Wn = t ? "error" : "domChange", Jt = window.innerWidth, Xt = window.innerHeight, pi = Math.round(I?.samePointCount / w * 100), Ie = { whitePointCount: I?.whitePointCount, samePointCount: I?.samePointCount, maximumSamePointer: I?.maximumSamePointer, linkMsg: I?.linkMsg }, mt = function(z, ne) {
...
class Ai {
  ...
  log(O, T, q, G) {
    ...
    const ae = this.formatTimestamp(), x = this.config.prefix ? `[${this.config.prefix}]` : "", K = `${ae}${x}[${T}] ${q}`;
    switch (O) {
      case "debug":
        console.debug(K, G ?? "");
        break;
   ...
   */
  formatTimestamp() {
    const O = /* @__PURE__ */ new Date(), T = String(O.getHours()).padStart(2, "0"), q = String(O.getMinutes()).padStart(2, "0"), G = String(O.getSeconds()).padStart(2, "0"), ae = String(O.getMilliseconds()).padStart(3, "0");
    return `[${T}:${q}:${G}.${ae}]`;
  }
  /**
   * 上报错误到 RUM (Aegis)
