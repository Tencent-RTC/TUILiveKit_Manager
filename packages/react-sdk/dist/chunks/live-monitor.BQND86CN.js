...
import { R as Ys, O as js, a9 as Xs, D as Ks, J as r, X as an, Y as Rn, Q as qs, aa as Zs, U as Qs, T as Js, g as Yi, aq as el, l as oi, a6 as Ua, x as tl, _ as il, a1 as nl, ai as sa } from "./en-US.DVkRUkOo.js";
...
import { a as rl } from "./moderation-store.DMk54_Cz.js";
let ni = null;
function cl() {
  return ni || (ni = new Wo({
    onStateChange: (e) => {
...
}), gm = /* @__PURE__ */ ci(Hl, [["__scopeId", "data-v-6b683c0f"]]);
function la(e, n) {
  var i = Object.keys(e);
...
}), bm = /* @__PURE__ */ ci(jh, [["__scopeId", "data-v-06a99f87"]]), Xh = { class: "gift-config-container" }, Kh = { class: "gift-config-page-header" }, qh = { class: "gift-config-title" }, Zh = { class: "gift-config-actions" }, Qh = { class: "gift-search-input" }, Jh = { class: "gift-id" }, ev = { class: "gift-id-text" }, tv = { class: "gift-thumbnail" }, iv = ["src", "alt"], nv = { key: 1 }, av = ["onClick"], ov = { class: "gift-lang-tags" }, sv = ["onClick"], lv = {
  key: 1,
