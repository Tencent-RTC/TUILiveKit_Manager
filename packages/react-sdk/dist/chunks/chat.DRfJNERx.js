...
import { as as ae, au as oe, br as ne, bJ as ie, bI as se, u as le, m as ue, R as ce, Q as de, p as ve } from "./main-layout.D1Nd74n1.js";
import { c as W, n as fe, j as z, h as o } from "./logger.BVGT9iyh.js";
import "./gift.DS3VsJtB.js";
import { aL as O, aM as ge, aQ as me, aG as Me, V as he, ag as Le, aO as be, af as we, aN as q, ay as G, Y as pe, aP as ye } from "./layout.CDdU53J3.js";
import { s as Ce, t as Se } from "./utils.BBdymNKO.js";
import { C as Pe } from "./chat-state.DJR83CuK.js";
...
function qe(s) {
  ...
  const J = () => {
    ...
    (e ? G : q)({ pageSize: 1 }).then(() => {
      z(e ? "text_moderation" : "text_moderation_custom"), z(e ? "moderation" : "moderation_custom");
    }).catch(() => {
    });
  };
  O().then((e) => {
  ...
  const Y = async () => {
    ...
    try {
      ...
      if (!P) {
        ...
        t = V.map((M) => M.id), P = V.map(({ id: M, content: L, userId: E }) => ({ id: M, content: L, userId: E }));
      }
      if (g.value === "custom") {
