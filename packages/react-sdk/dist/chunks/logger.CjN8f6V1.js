...
var en = { exports: {} }, Po = en.exports, vi;
function Lo() {
  return vi || (vi = 1, (function(E, O) {
    ((T, z) => {
      E.exports = z();
    })(Po, function() {
      var T, z;
      ...
      var R, A, re, _i = /_?t(\d)?(imestamp)?=\d+&?/g, Jn = ["aegis.qq.com", "tamaegis.com", "/aegis-sdk", "rumt-", "/flog.core.min.js", "pingfore.qq.com", "pingfore.tencent.com", "zhiyan.tencent-cloud.net", "h.trace.qq.com", "btrace.qq.com", "beacon.qq.com", "dmplog.qq.com", "qq.com/report", "svibeacon.onezapp.com", "cube.weixinbridge.com", "doubleclick.net", "pcmgrmonitor.3g.qq.com", "tdm.qq.com", "report.qqweb.qq.com", "tpstelemetry.tencent.com", "galileotelemetry.tencent.com", "insight.cloud.tencent.com", "facebook.com", "facebook.net", "google", "yahoo.com", "twitter.com", "ga-audiences", "report.idqqimg.com", "arms-retcode.aliyuncs.com", "px.effirst.com", "sentry", "baidu.com", "hot-update.json", "u.c.b.r.o.w.s.e.r", "report.url.cn", "sockjs-node", "m3u8", "flv"], Fi = ["ResizeObserver loop limit exceeded", "ResizeObserver loop completed", "Failed to execute 'transaction'", "window.indexedDB.deleteDatabase is not a function"], Xn = ["ext1", "ext2", "ext3", "ext4", "ext5", "ext6", "ext7", "ext8", "ext9", "ext10", "level", "trace", "tag", "seq", "code"], Ui = ["static", "fetch"], Z = "unknown";
      ...
      function Qn(e, t) {
        return t === void 0 && (t = 2048), String(e).replace(_i, "").slice(0, t);
      }
      function Et(e) {
      ...
      function We(e, t) {
        return typeof e != "string" || !e || t && -1 < e.indexOf(t) || Gi.test(e) || Jn.some(function(n) {
      ...
      function er(e, t, n, r) {
        ...
        i ? r === A.LOG && Array.isArray(t) ? (e = t.filter(function(o) {
          return o = or(r, o.level), ar(i[o]);
        })).length && n(e) : (e = or(r), ar(i[e]) && n(t)) : n(t);
      }
      function Rt(e, t) {
        var n, r = [], i = e.config;
        return e.lifeCycle.on("destroy", function() {
          ...
          Array.isArray(o) ? r = r.concat(o) : r.push(o), t && r.length >= t || e.sendNow && 0 < r.length ? (r = sr(r), 0 < (r = Array.isArray(r) ? r : []).length && a(r.splice(0, r.length)), n && clearTimeout(n)) : (n && clearTimeout(n), n = setTimeout(function() {
            n = null, r = sr(r), 0 < (r = Array.isArray(r) ? r : []).length && a(r.splice(0, r.length));
          }, i.delay));
        };
      }
      function Hi(e, t) {
        return Array.isArray(e) ? t(e.map(function(n) {
          return r = x(x({}, n), { msg: typeof n.msg == "string" ? n.msg : [].concat(n.msg).map(we).join(" ") }), Xn.forEach(function(i) {
            r[i] || delete r[i];
          }), r;
          var r;
        ...
        return function(n, r) {
          ...
          n != null && n.log && n != null && n.type ? (i = function(l, c, f) {
            switch (c) {
              ...
              case A.SPEED:
                var p = l, d = f;
                return d = d && d !== "undefined" ? x(x({}, e.bean), { from: d }) : x({}, e.bean), de(Zn(p, d));
              case A.EVENT:
      ...
      function ji(e, t) {
        return function(n, r) {
          ...
          (u = typeof l == "function" ? u.map(function(c) {
            ...
            return c !== !1;
          }) : u).length && (i = u, n = Xn, !Array.isArray(i) || i.length <= 1 || (o = [], a = [], !(a = typeof n == "string" ? [n] : n)) || a.length <= 0 || (a.forEach(function(c) {
      ...
      var qi = ["application/xhtml+xml", "application/xml", "application/pdf", "application/pkcs12", "application/javascript", "application/x-javascript", "application/ecmascript", "application/vnd.mspowerpoint", "application/vnd.apple.mpegurl", "application/ogg", "text/css", "text/javascript", "image", "audio", "video", "video/mp2t"], Wi = /\.(json|js|css|jpg|jpeg|png|svg|apng|webp|gif|bmp|mp4|mp3|ts|mpeg|wav|webm|ogg|flv|m3u8|ttf|woff2|otf|eot|woff|html|htm|shtml|shtm|)$/i, Tt = ["ret", "retcode", "code", "errcode"], an = function() {
 ...
 ` + t.stack;
        ...
        return Array.isArray(e) ? (o += "[", n = e.length, e.forEach(function(a, s) {
          o = (o += typeof a == "object" && 1 < t ? sn(a, t - 1) : zi(a)) + (s === n - 1 ? "" : ",");
        }), o += "]") : e instanceof Object || typeof e == "object" ? (o = "{", r = Object.keys(e), i = r.length, r.forEach(function(a, s) {
          typeof e[a] == "object" && 1 < t ? o += '"' + a + '":' + sn(e[a], t - 1) : o += Bi(a, e[a]), o += s === i - 1 || s < i - 1 && e[r[s + 1]] === void 0 ? "" : ",";
        }), o += "}") : o += e, o;
      }, Bi = function(e, t) {
        var n = typeof t, r = "";
      ...
      }, Gi = /data:(image|text|application|font)\/.*;base64/, Vi = ((S = {})[A.LOG] = "log", S[A.MEMORY] = "log", S[A.SPEED] = "speed", S[A.PERFORMANCE] = "performance", S[A.VITALS] = "webvitals", S[A.PV] = "pv", S[A.EVENT] = "event", S[A.CUSTOM] = "custom", S[A.SET_DATA] = "miniProgramData", S[A.LOAD_PACKAGE] = "miniProgramData", S), ir = ((S = {})[R.ERROR] = "jsError", S[R.PROMISE_ERROR] = "jsError", S[R.BLANK_SCREEN] = "whiteScreen", S[R.SCRIPT_ERROR] = "assetsException", S[R.IMAGE_ERROR] = "assetsException", S[R.CSS_ERROR] = "assetsException", S[R.MEDIA_ERROR] = "assetsException", S), or = function(e, t) {
        return e === A.LOG && t && ir[t] ? ir[t] : Vi[e] || "";
      }, ar = function(e) {
        ...
        return function(t) {
          return e.sendPipeline([function(n, r) {
            return r({ url: e.config.url || "", data: Kn(ur(n)), method: "post", contentType: "application/json", type: A.LOG, log: n, requestConfig: { timeout: 5e3 }, success: function() {
      ...
      }, Ot = { generateTraceId: fr(16), generateSpanId: fr(8) }, xt = Array(32);
      function fr(e) {
        return function() {
      ...
      function Ji(e) {
        if (e = String(e).replace(/[\t\n\f\r ]+/g, ""), !Xi.test(e)) throw new TypeError("Failed to execute 'atob': The string to be decoded is not correctly encoded.");
        var t;
      ...
      function ze(e) {
        if (e && e.reduce && e.length) return e.length === 1 ? function(t, n) {
          ...
          return function(r, i) {
            return i === void 0 && (i = pr), t(r, function(o) {
              return n?.(o, i);
            });
          };
        });
      ...
      var Te = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", Xi = /^(?:[A-Za-z\d+\/]{4})*?(?:[A-Za-z\d+\/]{2}(?:==)?|[A-Za-z\d+\/]{3}=?)?$/, Ki = (be.prototype.generate = function(e, t, n) {
        ...
        var t = typeof btoa == "function" ? btoa : $i, r = r || {}, n = r.host, n = n === void 0 ? "" : n, r = r.pathname, r = r === void 0 ? "" : r, i = cn(), o = cn();
      ...
      C.use = function(e) {
            ...
            m({ url: "" + h, type: A.WHITE_LIST, success: function(b) {
              try {
                ...
                v === 0 && Array.isArray(L) ? (y = {}, L.forEach(function(k) {
                  ...
                  er(n, k.logs, k.resolve, k.sendType);
                }), 0 < N && c(N)) : u();
              } catch {
                u();
              }
        ...
        var r = this;
        return ze([nr(this), tr(this, e?.type), function(i, o) {
        ...
        return ze(Q([function(a, s) {
          ...
          if (i !== A.SDK_ERROR && i !== A.WHITE_LIST) return r.rateLimitReady ? void er(r, a, s, i) : (r.rateLimitPool || (r.rateLimitPool = []), void (r.rateLimitPool.length < 200 && r.rateLimitPool.push({ logs: a, resolve: s, sendType: i })));
          s(a);
        }, ji(r = n = this, i = t)], e, [tr(this, t), nr(this), function(a, s) {
          var u;
      ...
      }, le), Qi = new _({ name: "aid", aid: "", init: function(e) {
        try {
      ...
      } }), Pt = new _({ name: "reportAssetSpeed" }), Yi = Pt = new _({ name: "reportAssetSpeed", collectCur: 0, collectEntryType: "resource", ASSETS_INITIATOR_TYPE: ["img", "css", "script", "link", "audio", "video"], getFromParam: function(e) {
...
`), a = e.isWhiteList && e.config.assetLog, s = e.config.slowAssetLog && i, u = { level: i ? e.LogType.SLOW_ASSET_REQUEST : e.LogType.ASSERT_REQUEST, msg: o, ext1: n.toString() || "", errorMsg: "", originFrom: e.getOriginFrom() };
        ...
        function t(i) {
          ...
          i && (i = i.target || i.srcElement, !(o = i?.src || i?.href) || typeof o != "string" || -1 < window.location.href.indexOf(o) || (i = typeof ((i = r.api) == null ? void 0 : i.resourceTypeHandler) == "function" ? (i = r.api) == null ? void 0 : i.resourceTypeHandler(o) : "", a = performance.getEntriesByType(n.collectEntryType).find(function(l) {
            return l.name === o;
          }), We(o, r.hostUrl)) || (s = n.getFromParam(e), u = Number((u = a) == null ? void 0 : u.responseStatus), u = Number.isFinite(u) && 0 < u ? u : 400, u = { url: Qn(o), status: u, duration: Number((a?.duration || 0).toFixed(2)), method: "get", type: i || "static", isHttps: Et(o), urlQuery: qe(o, !0), nextHopProtocol: "", domainLookup: 0, connectTime: 0, from: s }, n.publish(u, e)));
        }
        ...
        return { url: Qn(e.name), method: "get", duration: Number(e.duration.toFixed(2)), status: o, type: r || "static", isHttps: Et(e.name), nextHopProtocol: e.nextHopProtocol || "", urlQuery: qe(e.name, !0), domainLookup: St(e.domainLookupEnd - e.domainLookupStart), connectTime: St(e.connectEnd - e.connectStart), transferSize: 0 < i ? i : -1, from: n };
      ...
      } }), Zi = window.navigator.userAgent.toLowerCase(), P = {};
      function le(e) {
      ...
      function C(e) {
        ...
        this.isGetSample = !1, this.isHidden = !1, this.config = { version: 0, delay: 1e3, onError: !0, repeat: 60, random: 1, aid: !0, device: !0, pagePerformance: !0, webVitals: !0, speedSample: !0, onClose: !0, reportLoadPackageSpeed: !0, hostUrl: "https://rumt-zh.com", env: "production", url: "", offlineUrl: "", whiteListUrl: "", rateLimitUrl: "", pvUrl: "", speedUrl: "", customTimeUrl: "", performanceUrl: "", performanceUrlForHippy: "", webVitalsUrl: "", eventUrl: "", setDataReportUrl: "", memoryUrl: "", reportImmediately: !0, gzip: !0 }, this.isWhiteList = !1, this.whitelistUseGzip = !0, this.whitelistUseGzipReady = !1, this.lifeCycle = new Di(), this.bean = {}, this.rateLimitConfigs = null, this.rateLimitReady = !1, this.rateLimitSampled = !1, this.rateLimitPool = [], this.normalLogPipeline = ze([Rt(this, 5), Hi, function(g, m) {
          var b = t.config;
          ...
          o && clearTimeout(o), o = setTimeout(function() {
            ...
            !u && i.config && (u = !0, g = i.config.whiteListUrl, (m = g === void 0 ? "" : g) && i.sendPipeline([function(b, y) {
              y({ url: m, type: A.WHITE_LIST, success: function(w) {
                s = !0;
                try {
                  var v = w.data || JSON.parse(w), L = v.retcode, N = v.result, k = N === void 0 ? {} : N, I = (L === 0 ? (a = k.is_in_white_list, i.isWhiteList = a, i.updateWhitelistGzipState(k.use_gzip), 0 <= k.rate && k.rate <= 1 && (i.config.random = k.rate, i.isGetSample = !1)) : i.disableWhitelistGzipState(), i.isWhiteList && l.length ? cr(i)(l.splice(0), function() {
          ...
          a || (b = (b = i.config) == null ? void 0 : b.api) != null && b.reportRequest ? m(g.concat(l.splice(0)).map(function(y) {
            ...
            return y.level !== R.INFO && y.level !== R.API_RESPONSE ? (lr(y), !0) : (s || (l.push(y), 200 <= l.length && (l.length = 200)), !1);
          })).length && m(b);
        }), function(g, m) {
          try {
        ...
        }, cr(this)]), this.eventPipeline = ze([Rt(this, 10), (r = this, function(g) {
...
`) + n + " header " + i + ": " + o : r;
      ...
      function hn(o, t, n) {
        ...
        return Ui.indexOf(o) === -1 && (r = t === void 0 ? "" : t, i = (n === void 0 ? "" : n).split("?")[0], o = Wi.test(i) || qi.some(function(a) {
      ...
      function eo(e) {
        return (e = ((t) => {
          ...
          if (r === 1 || r === 9 || r === 11) {
            ...
            for (var i = t.firstChild; i; i = i.nextSibling) n += Ar(t);
          } else if (r === 3 || r === 4) return t.nodeValue;
          return n;
        })(e)) ? e.replace(/^\s+|\s+$/g, "") : "";
      }
      var wr, br, gn, mn, ie, kt, At, Oe, st, Sr, It, Ge, Er, vn, yn, Rr, wn, bn, Tr = !(P.isIE = function() {
        return "ActiveXObject" in window;
      }), xe = [], Or = /^\/[^/]/, xr = !1, pe = [], Ve = { maxRetryCount: 10, retryInterval: function(e) {
        return 1e3 * (2 << e);
      }, whenRetryEndStillFail: "discard", maxStorageCount: 50 }, to = (new _({ name: "reportApiSpeed" }), new _({ name: "reportApiSpeed", override: !1, onNewAegis: function(e) {
        var t, n;
        this.override || (this.override = !0, (n = e.config.api) != null && n.injectTraceHeader && (this.traceRequestHeader = new Ki(n.injectTraceHeader, (t = n?.injectTraceIgnoreUrls) != null ? t : [], n?.injectTraceUrls, n?.traceFlag)), this.overrideFetch(e.config, e), this.overrideXhr(e.config, e));
...
`), Y = (q.payload = l?.body, q.ret = L, q.isErr = +N, q.from = f || n.getFromParam(t), { msg: Y, code: L, trace: v, errorMsg: "", from: f || n.getFromParam(t), originFrom: p, level: R.API_RESPONSE }), U = e.slowApiLog && vr(q?.duration, e, q);
              Y.level = U ? R.SLOW_NET_REQUEST : mr(b, N), (U || Y.level !== R.API_RESPONSE || t.isWhiteList || (U = (U = t.config) == null ? void 0 : U.api) != null && U.reportRequest) && n.publishNormalLog(Y, t), n.publishSpeed(q, t);
            }, 0);
          }).catch(function(g) {
...
` + g);
        ...
        pe.push(i), !xr && window.fetch && (xr = !0, mn = window.fetch, window.fetch = function(a, s) {
          s === void 0 && (s = {});
          var u = typeof a == "string" ? a : a?.url;
          if ((p = o?.test) != null && p.call(o, u)) return mn(u, s);
          Or.test(u) && (u = "" + location.origin + u);
          var l, c, f, p = (i || {}).traceRequestHeader;
          p && (l = (l = (s || {}).headers) === void 0 ? {} : l, c = (f = gr()).host, c = (p = p.generate(u, l, { host: c, pathname: f.pathname }) || {}).name, f = p.value) && c && (s.headers = Object.assign(l, ((p = {})[c] = f, p)));
        ...
        var n, r = this, i = { name: this.name, ignoreHackReg: (i = e.api) == null ? void 0 : i.ignoreHackReg, traceRequestHeader: (i = e.api) != null && i.injectTraceHeader ? this.traceRequestHeader : null, getCurrentFrom: function() {
          ...
          var l, c, f = Date.now(), p = ((e?.api || {}).injectTraceHeader && (c = (l = gr()).host, l = (c = r.traceRequestHeader.generate(o.aegisUrl, {}, { host: c, pathname: l.pathname }) || {}).name, c = c.value, l) && c && o.setRequestHeader(l, c), o.addEventListener("loadend", function() {
...
`);
                    v.ret = D, v.isErr = +j, v.payload = a, e.slowApiLog && vr(v?.duration, e, v) ? r.publishNormalLog({ msg: J, level: R.SLOW_NET_REQUEST, code: D, trace: I, errorMsg: "", from: s || r.getFromParam(t), originFrom: u }, t) : r.publishNormalLog({ msg: J, level: mr(!!g, j), code: D, trace: I, errorMsg: "", from: s || r.getFromParam(t), originFrom: u }, t), r.publishSpeed(v, t);
                  });
                } catch {
        ...
        }) || (xe.push(n), !Tr && window.XMLHttpRequest && (wr = window.XMLHttpRequest.prototype.send, br = window.XMLHttpRequest.prototype.open, gn = window.XMLHttpRequest.prototype.setRequestHeader, Tr = !0, window.XMLHttpRequest.prototype.open = function() {
          this.aegisMethod = arguments[0];
          var o, a = arguments[1];
          if (Or.test(a) && (a = "" + location.origin + a), this.aegisUrl = a, (a = (o = n.ignoreHackReg) == null ? void 0 : o.test) == null || !a.call(o, this.aegisUrl)) if (this.aegisXhrStartTime = Date.now(), this.sendByAegis) P.isIE() || (this.timeout = 5e3);
      ...
      } })), lt = {}, no = new _({ name: "reportBridgeSpeed", override: !1, onNewAegis: function(e) {
        ...
        n.reportBridgeSpeed && n.h5Bridge && n.h5BridgeFunc.length && n.h5BridgeFunc.forEach(function(r) {
          ...
          lt[r] = i, n.h5Bridge[r] = function() {
            ...
            i(s, u, l, function(d) {
              var h = Yn(d, n.api), g = h.code, h = h.isErr, g = { url: s + "-" + u, name: s + "-" + u, duration: Date.now() - f, type: "bridge", ret: g, isErr: +h, from: p };
        ...
        var t = this, n = e.config;
        n && (typeof n.getNetworkType == "function" ? n.getNetworkType : Pr)(function(r) {
      ...
      }, ro = window.WebSocket, Se = [], io = { construct: function(e, t) {
        var n = new e(t[0], t[1]);
      ...
      } }, Lr = new _({ name: "onError" }), oo = Lr = new _({ name: "onError", onNewAegis: function(e) {
        this.startListen(e);
      }, getFromParam: function(e) {
        return e.getCurrentPageUrl();
...
error msg: ` + ((c = l?.error) == null ? void 0 : c.message) : "") : ""), level: R.INFO, from: s.getFromParam(e), originFrom: e.getOriginFrom() };
        ...
        window.onerror = function() {
          ...
          var f, p = we(l[0]);
          typeof (f = p) != "string" || !f || Fi.some(function(d) {
...
` + we(l[4] || ""), level: R.ERROR, from: s.getFromParam(e), originFrom: e.getOriginFrom() }, e), u?.call.apply(u, Q([window], l));
          ...
          Lr.countInstance() === 0 && (window.document.removeEventListener("unhandledrejection", t), window.document.removeEventListener("error", n, !0));
          ...
          var c;
          (c = s.publishWsErrorLog) != null && c.call(s, l, e);
        } }, this.hackWebsocketConfig = r, r = this.hackWebsocketConfig, window.Proxy) && window.WebSocket && (i = window.WebSocket, window && !i.isHack && (o = new Proxy(WebSocket, io), i.isHack = !0, window.WebSocket = o), a = r, Se.find(function(l) {
          return l.key === a.key;
        }) || a && Se.push(a));
        ...
        }, this.option.hackWebsocketConfig && (e = this.option.hackWebsocketConfig, window.WebSocket = ro, (t = Se.findIndex(function(n) {
          return n.key === e.key;
        })) !== -1) && Se.splice(t, 1);
      } }), Cr = (new _({ name: "clickElementLog" }), function(e) {
        ...
        if (e.parentNode) for (var n = e.parentNode.childNodes, r = 0; r < n.length; r += 1) {
          var i = n[r];
          if (i === e) return Cr(e.parentNode) + "/" + e.tagName + "[" + (t + 1) + "]";
        ...
        for (var t = "", n = e.firstChild; n; n = n.nextSibling) t += Ar(n);
        return t;
      }, ao = new _({ name: "clickElementLog", listeners: [], onNewAegis: function(e) {
        this.startListen(e);
      }, startListen: function(e) {
        for (var t = function(o) {
          n.listeners.push(((a, s, u, l) => {
            ...
            var u, l, c;
            s && !((f, p) => {
              d = kr(((d = (f = f).ignoreElements) == null ? void 0 : d.ignoreClasses) || []) || /* @__PURE__ */ new Map();
              for (var d, h = (f = { ignoreIds: kr(((f = f.ignoreElements) == null ? void 0 : f.ignoreIds) || []) || /* @__PURE__ */ new Map(), ignoreClasses: d }).ignoreClasses, g = f.ignoreIds, m = !(g.size === 0 && h.size === 0), b = p, y = (Mt(p.getAttribute("id") || "", " "), Mt(p.getAttribute("class") || "", ""), 0), w = !1; b && m && b.getAttribute; ) {
                if (w) return !0;
                if (10 <= y) break;
              ...
              return !1;
            })(e.config, s) && (u = Cr(s), l = eo(s), c = s.getBoundingClientRect && s.getBoundingClientRect(), s = { op: o, view_type: s?.nodeName || "", view_text: l.slice(0, 127), view_tag: u, page: yr(), page_id: yr(), view_pos: { p0: (parseInt(String(c.left), 10) || -1) + "," + (parseInt(String(c.top), 10) || -1), p1: (parseInt(String(c.left + window.scrollX), 10) || -1) + "," + (parseInt(String(c.top + window.scrollY), 10) || -1) } }, e.normalLogPipeline({ msg: s, level: R.CLICK_EVENT, errorMsg: "", originFrom: e.getOriginFrom() }));
          }, !0));
      ...
      } }), Nt = (new _({ name: "consoleLog" }), { log: console.log, error: console.error, warn: console.warn, info: console.info, debug: console.debug, trace: console.trace }), so = new _({ name: "consoleLog", onNewAegis: function(e) {
        this.startListen(e);
      }, startListen: function(e) {
        var t;
...
message: ` + i, level: R.CONSOLE_LOG, errorMsg: "", originFrom: t.getOriginFrom() }));
      ...
      Ge = { passive: !0, capture: !0 }, Er = /* @__PURE__ */ new Date(), vn = function(e, t) {
        Oe || (Oe = t, st = e, Sr = /* @__PURE__ */ new Date(), wn(removeEventListener), yn());
      }, yn = function() {
        var e;
        0 <= st && st < Sr - Er && (e = { entryType: "first-input", name: Oe.type, target: Oe.target, cancelable: Oe.cancelable, startTime: Oe.timeStamp, processingStart: Oe.timeStamp + st }, It.forEach(function(t) {
          t(e);
        }), It = []);
      }, Rr = function(e) {
        var t, n, r, i, o, a;
      ...
      }, !0), Ir(), self.webVitals = { firstInputPolyfill: function(e) {
        It.push(e), yn();
      }, resetFirstInputPolyfill: Ir, get firstHiddenTime() {
        return bn;
      } };
      function he(e, t) {
        var n = Dr(), r = "navigate";
        return 0 <= Ur ? r = "back-forward-cache" : n && (document.prerendering || 0 < xn() ? r = "prerender" : document.wasDiscarded ? r = "restore" : n.type && (r = n.type.replace(/_/g, "-"))), { name: e, value: t === void 0 ? -1 : t, rating: "good", delta: 0, entries: [], id: "v3-".concat(Date.now(), "-").concat(Math.floor(8999999999999 * Math.random()) + 1e12), navigationType: r };
      }
      function $e(e, t, n) {
        try {
          var r;
      ...
      function Rn() {
        return Ke < 0 && (Ke = Hr(), jr(), Xe(function() {
          setTimeout(function() {
            Ke = Hr(), jr();
          }, 0);
        })), { get firstHiddenTime() {
      ...
      function Mr(e, t) {
        t = t || {}, Ft(function() {
          ...
          o && (n = ge(e, i, qr, t.reportAllChanges), Xe(function(a) {
            i = he("FCP"), n = ge(e, i, qr, t.reportAllChanges), Sn(function() {
      ...
      function lo(e) {
        ...
        }, addEventListener("pointerup", i, ct), addEventListener("pointercancel", o, ct)) : Br(t, e));
      }
      function uo(e) {
        e.forEach(function(t) {
          t.interactionId && (Pn = Math.min(Pn, t.interactionId), qt = Math.max(qt, t.interactionId), $r = qt ? (qt - Pn) / 7 + 1 : 0);
        });
      }
      function Nr() {
        return Jr() - Kr;
      ...
      var Pe, ut, Fr, Ht, On, _e, Ur = -1, Xe = function(e) {
        addEventListener("pageshow", function(t) {
          t.persisted && (Ur = t.timeStamp, e(t));
        }, !0);
      }, Dr = function() {
        ...
        document.visibilityState === "hidden" && -1 < Ke && (Ke = e.type === "visibilitychange" ? e.timeStamp : 0, co());
      }, jr = function() {
      ...
      }, qr = [1800, 3e3], Wr = [0.1, 0.25], ct = { passive: !0, capture: !0 }, fo = /* @__PURE__ */ new Date(), Br = function(e, t) {
        Pe || (Pe = t, ut = e, Fr = /* @__PURE__ */ new Date(), Gr(removeEventListener), zr());
      }, zr = function() {
        var e;
        0 <= ut && ut < Fr - fo && (e = { entryType: "first-input", name: Pe.type, target: Pe.target, cancelable: Pe.cancelable, startTime: Pe.timeStamp, processingStart: Pe.timeStamp + ut }, Ht.forEach(function(t) {
          t(e);
        }), Ht = []);
      }, Gr = function(e) {
        ["mousedown", "keydown", "touchstart", "pointerdown"].forEach(function(t) {
      ...
      }, Vr = [100, 300], $r = 0, Pn = 1 / 0, qt = 0, Jr = function() {
        return On ? $r : performance.interactionCount || 0;
      }, Xr = [200, 500], Kr = 0, ve = [], Ln = {}, Qr = [2500, 4e3], Cn = {}, po = (Fe.prototype.start = function() {
      ...
      }, Fe), Le = (new _({ name: "webVitals" }), { FCP: -1, LCP: -1, FID: -1, CLS: -1, INP: -1, TTI: -1, from: void 0 }), kn = /* @__PURE__ */ new Map(), ho = new _({ name: "webVitals", onNewAegis: function(e) {
        ...
        if (ot() && typeof window.PerformanceObserver == "function" && typeof performance.getEntriesByName == "function") try {
          kn.set(e, { isWebVitalsReported: !1, hasFirstEntry: !1, custom: null }), Mr(Je), l = Je, c = {}, Ft(function() {
            function p(y) {
            ...
            b && (d = ge(l, m, Qr, c.reportAllChanges), h = En(function() {
              ...
              m = he("LCP"), d = ge(l, m, Qr, c.reportAllChanges), Sn(function() {
            ...
            var h = Rn(), g = he("FID"), m = $e("first-input", d), b = ge(s, g, Vr, u.reportAllChanges);
            m && _t(En(function() {
              d(m.takeRecords()), m.disconnect();
            })), m && Xe(function() {
              g = he("FID"), b = ge(s, g, Vr, u.reportAllChanges), Ht = [], ut = -1, Pe = null, Gr(addEventListener), Ht.push(p), zr();
            });
          }), o = Je, a = {}, Mr(En(function() {
            function p(y) {
            ...
            b && (d = ge(o, h, Wr, a.reportAllChanges), _t(function() {
              p(b.takeRecords()), d(!0);
            }), Xe(function() {
              h = he("CLS", g = 0), d = ge(o, h, Wr, a.reportAllChanges), Sn(function() {
                return d();
              });
            }), setTimeout(d, 0));
          })), r = Je, i = {}, Ft(function() {
            var p;
            "interactionCount" in performance || (On = On || $e("event", uo, { type: "event", buffered: !0, durationThreshold: 0 }));
            function d(b) {
              b.forEach(function(y) {
                y.interactionId && _r(y), y.entryType !== "first-input" || ve.some(function(w) {
                  return w.entries.some(function(v) {
                    return y.duration === v.duration && y.startTime === v.startTime;
                  });
                }) || _r(y);
              }), b = Math.min(ve.length - 1, Math.floor(Nr() / 50)), (b = ve[b]) && b.latency !== h.value && (h.value = b.latency, h.entries = b.entries, m());
            }
            var h = he("INP"), g = $e("event", d, { durationThreshold: (p = i.durationThreshold) != null ? p : 40 }), m = ge(r, h, Xr, i.reportAllChanges);
            g && ("PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && g.observe({ type: "first-input", buffered: !0 }), _t(function() {
              d(g.takeRecords()), h.value < 0 && 0 < Nr() && (h.value = 0, h.entries = []), m(!0);
            }), Xe(function() {
              ve = [], Kr = Jr(), h = he("INP"), m = ge(r, h, Xr, i.reportAllChanges);
            }));
          }), n = function(p) {
            Je({ name: "TTI", value: p });
          }, ot() && new po(n).start(), Tn(function() {
      ...
      } }), Yr = (new _({ name: "pagePerformance" }), 3), ft = /* @__PURE__ */ new Map(), go = new _({ name: "pagePerformance", performanceMap: {}, onNewAegis: function(e) {
        var t;
...
`), u = r.$getConfig(i), s = !1;
        ...
        var r, i = this, o = ["script", "style", "link", "br"], a = [], s = {}, u = (hr("paint") && (r = new PerformanceObserver(function(f) {
          ...
          c = null;
          for (var b = 0, y = [g, h.loadEventStart - h.domInteractive, m]; b < y.length; b++) if (y[b] <= 0 && 0 < Yr) {
            c = setTimeout(function() {
              return l(m);
            }, 3e3);
            break;
          }
          c ? --Yr : (u.disconnect(), r?.disconnect(), t?.(f));
        }), c = setTimeout(function() {
          return l();
        }, 3e3);
        ...
        return !1;
      } }), mo = (new _({ name: "spa" }), ["replaceState", "pushState", "popstate", "hashchange"]), vo = new _({ name: "spa", originFireUrl: "", onNewAegis: function(e) {
        var t = this;
        history.pushState = this.wr("pushState") || history.pushState, history.replaceState = this.wr("replaceState") || history.replaceState, this.sendPv = this.sendPv.bind(this), e.config.spa && this.sendPv(e), mo.forEach(function(n) {
      ...
      var Ee = null, An = !1, yo = 0, Re = /* @__PURE__ */ new Map(), In = "__MONITOR_SESSION_V1__";
      function Mn(e) {
        try {
      ...
      ae(Nn = H, S = ei = S), Nn.prototype = S === null ? Object.create(S) : (ti.prototype = S.prototype, new ti()), H.resolveGzipConfig = function(e) {
...
self.onmessage=async function(e){
  try{
    ...
    self.postMessage({id:id,error:err.message||"compress error"});
                  ...
                  y ? (g = yo += 1, m = setTimeout(function() {
                    var w = Re.get(g);
      ...
      }, H.sessionID = wo("aegis", un).sessionId, H.compressionSupported = null;
      var ei, Nn, S = H;
      function H(e) {
        var t, n, r, i, o, a, s = ei.call(this, e) || this;
        s.sendNow = !1, s.isReportReady = !1, s.reportRequestQueue = [], s.speedLogPipeline = ze([Rt(s), (i = s.config, function(f, p) {
          ...
          return s.sendPipeline([function(p, d) {
            d({ type: A.SPEED, url: "" + s.config.speedUrl, method: "post", contentType: "application/json", data: Zn(p, x(x({}, s.bean), { from: s.getCurrentPageUrl() })), log: p });
          }], A.SPEED)(f);
        }]), e.asyncPlugin = !0;
        try {
...
It is recommended that you contact us for feedback and thank you for your support.`, "color: red"), s.sendSDKError(f);
      ...
      var bo = new _({ name: "onClose", onNewAegis: function(e) {
        var t, n = this;
      ...
      }, $), ni = { THRESHOLDS: { SMALL: 3e5 }, LEVELS: [{ maxArea: 1e5, scale: 1, defaultQuality: 0.7 }, { maxArea: 3e5, scale: 1, defaultQuality: 0.6 }, { maxArea: 8e5, scale: 0.7, defaultQuality: 0.6 }, { maxArea: 15e5, scale: 0.5, defaultQuality: 0.65 }, { maxArea: 25e5, scale: 0.45, defaultQuality: 0.65 }, { maxArea: 1 / 0, scale: 0.45, defaultQuality: 0.65 }] };
      function $(n) {
      ...
      function _n(e) {
        return ni.LEVELS.find(function(t) {
          return e <= t.maxArea;
        });
      }
      function ri(e) {
      ...
      function Wt(e, t, n, r, i) {
        ...
        return (e = e[0]) ? (a = o = !1, a = ci(r) ? (o = li(e, r), li(e, i)) : (o = ui(e, t), ui(e, n)), { isWhitePoint: o && !a, selectorPointers: s }) : { isWhitePoint: !1, selectorPointers: s };
      }
      function oi(e) {
        try {
          var t, n, r, i, o, a, s = e.config.blankScreen;
          return s === !0 ? x({}, Ye) : (n = "containerMatchers" in (t = s) || "ignoreMatchers" in t, r = "containers" in t || "ignoreContainers" in t, i = Fn(x({}, Ye), t), n ? (ci(i.containerMatchers) || (i.containerMatchers = ri(Ye.containerMatchers)), typeof i.ignoreMatchers == "object" && i.ignoreMatchers !== null || (i.ignoreMatchers = ri(Ye.ignoreMatchers)), i.containers = [], i.ignoreContainers = []) : r && (o = ii(i.containers), a = ii(i.ignoreContainers), i.containers = o.length ? o : Q(Ye.containers), i.ignoreContainers = a, i.containerMatchers = { tagName: [], id: [], className: [] }, i.ignoreMatchers = { tagName: [], id: [], className: [] }), i);
        } catch {
          return x({}, Ye);
        }
      }
      ...
      function ai(e, t, n, r) {
        return t === void 0 && (t = "image/webp"), n === void 0 && (n = 1920), r === void 0 && (r = 1080), K(void 0, void 0, void 0, function() {
          ...
          return se(this, function(a) {
            switch (a.label) {
              case 0:
                return a.trys.push([0, 2, , 3]), i = Math.min(window.innerWidth, n), o = Math.min(window.innerHeight, r), i = _n(i * o), o = i.scale, i = i.defaultQuality, [4, new Ro(s = (s = { scale: o, quality: e ?? i, format: { "image/webp": "webp", "image/jpeg": "jpeg", "image/png": "png" }[t] || "webp", maxWidth: n, maxHeight: r, useCORS: !0, viewportOnly: !0, debug: !1 }) === void 0 ? {} : s).capture()];
              case 1:
                return [2, a.sent()];
              case 2:
              ...
              switch (bt.label) {
                case 0:
                  ...
                  return vt = v <= De, yt = !1, qn = { samePointerMap: {}, maximumSamePointer: {} }, d || (oe = Gt.map(function(B) {
                    ...
                    return ne[1] - B[1];
                  })[0], gi = Gn[0], oe = { samePointerMap: Qt, maximumSamePointerClass: gi, maximumSamePointerCounter: Gn[1] }, qn = { samePointerMap: oe.samePointerMap, maximumSamePointer: ((nt = {})[pi = oe.maximumSamePointerClass] = oe = oe.maximumSamePointerCounter, nt) }, jn = oe, nt = So.some(function(B) {
                    return pi.startsWith(B);
                  }), yt = L <= oe && !nt), vt || yt ? [3, 1] : (k = !1, I = null, [3, 8]);
                case 1:
                  return k ? (oe = I?.whitePointCount >= v, nt = I?.samePointCount >= L, Wn = oe && nt ? "both" : oe ? "whitePoint" : "sameElement", Bn = t ? "error" : "domChange", Jt = window.innerWidth, Xt = window.innerHeight, hi = Math.round(I?.samePointCount / w * 100), Ie = { whitePointCount: I?.whitePointCount, samePointCount: I?.samePointCount, maximumSamePointer: I?.maximumSamePointer, linkMsg: I?.linkMsg }, mt = function(B, ne) {
                    ne = { msg: "decect blankscreen triggerReason: " + Wn + " triggerType: " + Bn + `

whitePointCount: ` + Ie.whitePointCount + " whitePointerThreshold: " + v + (d ? "" : `

sameElementsCount: ` + Ie.samePointCount + " samePointerThreshold: " + L + " sameElementPercent: " + hi + "%") + `
...
linkError: ` + Ie.linkMsg : ""), level: R.BLANK_SCREEN, errorMsg: B || null, originFrom: e.getOriginFrom() }, e.normalLogPipeline(ne);
                    ...
                    if (B && typeof B == "string") {
                      var mi = B.length / 1024;
                      if (30 < mi) return void mt(null, x(x({}, ne), { success: !1, reason: "size_exceeded", size: Math.round(mi), maxSize: 30 }));
                    }
                    mt(B, ne);
                  }), [3, 4]) : [3, 2] : [3, 5]) : [3, 7];
                case 2:
                ...
                case 7:
                  I = x(x({ msg: "blank_screen", level: R.BLANK_SCREEN, whitePointCount: De, samePointCount: jn }, qn), t ? { linkLogType: t?.type, linkLogLevel: t?.level, linkErrorMsg: t?.errorMsg, linkMsg: t?.msg } : {}), k = !0, n = setTimeout(function() {
                    return K(Oo, void 0, void 0, function() {
          ...
          var W;
          k || zt.isAwaitingClientScreenshot || N === Qe.ERROR && !t || (N = t ? Qe.ERROR : Qe.DOM_CHANGE, clearTimeout(n), W = oi(e).debounceDuration, n = setTimeout(function() {
            return K(zt, void 0, void 0, function() {
              return se(this, function(X) {
                switch (X.label) {
                  case 0:
          ...
          (j = new MutationObserver(function(W) {
            var X = si(W[0].target), X = f.includes(X.selector);
            W.length === 1 && X || U();
      ...
      } }), To = (new _({ name: "lagMonitor" }), new _({ name: "lagMonitor", observer: null, lagRecords: [], onNewAegis: function(e) {
      ...
      } }), S.use(oo), S.use(to), S.use(Yi), S.use(go), S.use(ho), S.use(Qi), S.use(M), S.use(vo), S.use(bo), S.use(ao), S.use(so), S.use(To), S.use(_), S.use(no), S.use(Ue), S;
    });
  })(en)), en.exports;
}
var Co = Lo();
const Ri = /* @__PURE__ */ xo(Co);
function Ti() {
  return {
    // 凭证（基础设施层使用）
    sdkAppId: 0,
...
function Bo(E) {
  const O = Me.getState();
  Me = E ?? xi, Me.reset(), Me.setState(O);
}
function Pi() {
  return Me.getState();
}
...
let fe = null, tn = null;
function Vn() {
  const E = Pi().credentials?.sdkAppId;
...
function Vo(E) {
  ...
  return fe = new Ri({
    ...
    uin: O,
    ...E
  }), (E.autoUpdateUin || !E.uin && Vn()) && Ci(), fe;
}
function $o(E) {
...
function No(E = Io) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  yi.has(T) || (yi.add(T), He("app_init", "live_manager", E), Fo());
}
...
function _o(E) {
  ...
  if (!O) return;
  const T = `${O}:${E}`;
  wi.has(T) || (wi.add(T), He("capability", E, "on"));
}
const bi = /* @__PURE__ */ new Set(), nn = [];
let Si = !1;
function Fo() {
  if (!Si) {
    Si = !0;
...
function Mi(E) {
  ...
  if (!O) return !1;
  const T = `${O}:${E}`;
  return bi.has(T) || (bi.add(T), He("feature_use", E)), !0;
}
function Uo(E) {
  Mi(E) || nn.includes(E) || nn.push(E);
}
let Ei = null;
function Do(E) {
  if (E === Ei) return;
...
class Ni {
   ...
   */
  log(O, T, z, G) {
    if (Zt[O] < Zt[$n] || this.config.minLevel && Zt[O] < Zt[this.config.minLevel] || !this.config.enableConsole) return;
...
const ta = new Ni({ prefix: "LiveKit" }), na = (E) => new Ni({ prefix: E });
export {
  Ri as A,
  Go as B,
  Yo as C,
